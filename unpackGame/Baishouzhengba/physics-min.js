...
(function t(e, i, o) {
    ...
    1: [ function(t, e, i) {
        ...
        var s = new n.default.Vec3(), a = new n.default.Vec3(), l = cc.Vec3, h = function() {
            ...
            return o.__preload = function(t) {
                this._rigidBody = t, this._sharedBody = cc.director.getPhysics3DManager().physicsWorld.getSharedBody(this._rigidBody.node), 
                ...
                var e = this._sharedBody.body;
                e.isSleeping() && e.wakeUp(), l.copy(s, t), e.vectorToWorldFrame(s, s), e.torque.x += s.x, 
                e.torque.y += s.y, e.torque.z += s.z;
            }, e = t, (i = [ {
                key: "isAwake",
                get: function get() {
                ...
                set: function set(t) {
                    var e = this._sharedBody.body;
                    e.mass = t, 0 == e.mass ? e.type = n.default.Body.STATIC : e.type = this._rigidBody.isKinematic ? n.default.Body.KINEMATIC : n.default.Body.DYNAMIC, 
                    e.updateMassProperties(), e.isSleeping() && e.wakeUp();
                }
            }, {
                key: "isKinematic",
                set: function set(t) {
    ...
    2: [ function(t, e, i) {
        ...
        var h = cc.Node._LocalDirtyFlag.PHYSICS_SCALE, c = cc.Quat, p = cc.Vec3, u = cc.js.array.fastRemoveAt, d = new p(), y = new c(), f = [], v = {
            ...
            var t, e;
            function i(t, e) {
                this.node = void 0, this.wrappedWorld = void 0, this.body = new n.default.Body(), 
                this.shapes = [], this.wrappedBody = null, this.index = -1, this.ref = 0, this.onCollidedListener = this.onCollided.bind(this), 
                this.wrappedWorld = e, this.node = t, this.body.material = this.wrappedWorld.world.defaultMaterial, 
                this.body.addEventListener("cc-collide", this.onCollidedListener), this._updateGroup(), 
                this.node.on(cc.Node.EventType.GROUP_CHANGED, this._updateGroup, this);
            }
            i.getSharedBody = function(t, e) {
                var o = t._id;
                if (i.sharedBodiesMap.has(o)) return i.sharedBodiesMap.get(o);
                var n = new i(t, e);
                return i.sharedBodiesMap.set(t._id, n), n;
            }, t = i, (e = [ {
                key: "enabled",
                set: function set(t) {
                    if (t) {
                        if (this.index < 0) {
                            ...
                            if (o.x = parseFloat(y.x.toFixed(12)), o.y = parseFloat(y.y.toFixed(12)), o.z = parseFloat(y.z.toFixed(12)), 
                            o.w = parseFloat(y.w.toFixed(12)), e._localMatDirty & h) {
                    ...
                    } else this.index >= 0 && (0 == this.shapes.length && null == this.wrappedBody || 0 == this.shapes.length && null != this.wrappedBody && !this.wrappedBody.rigidBody.enabledInHierarchy || 0 == this.shapes.length && null != this.wrappedBody && !this.wrappedBody.isEnabled) && (this.body.sleep(), 
            ...
            return o._updateGroup = function() {
                ...
                void 0 === t && (t = !1);
                var e = this.node, i = (0, s.updateWorldTransform)(e, t);
                if (t || i) {
                    if (this.body.aabbNeedsUpdate = !0, p.copy(this.body.position, e.__wpos), c.copy(this.body.quaternion, e.__wrot), 
                    e._localMatDirty & h) {
                ...
                c.copy(y, this.body.quaternion), (0, s.updateWorldRT)(this.node, d, y));
            }, o.destroy = function() {
                this.body.removeEventListener("cc-collide", this.onCollidedListener), this.node.off(cc.Node.EventType.GROUP_CHANGED, this._updateGroup, this), 
                i.sharedBodiesMap.delete(this.node._id), delete n.default.World.idToBodyMap[this.body.id], 
                this.node = null, this.wrappedWorld = null, this.body = null, this.shapes = null, 
                ...
                if (e) {
                    ...
                    for (o = 0; o < this.shapes.length; o++) {
                        var h = this.shapes[o];
                        v.type = a.deprecatedEventMap[v.type], h.collider.emit(v.type, v), v.type = t.event, 
    ...
    4: [ function(t, e, i) {
        ...
        var c = cc.Vec3, p = cc.js.array.fastRemoveAt, u = function() {
            var t, e;
            function i() {
                this.bodies = [], this._world = void 0, this._raycastResult = new n.default.RaycastResult(), 
                this._world = new n.default.World(), this._world.broadphase = new n.default.NaiveBroadphase(), 
            ...
            t = i, (e = [ {
                ...
                key: "defaultMaterial",
                set: function set(t) {
                    this._world.defaultMaterial.friction = t.friction, this._world.defaultMaterial.restitution = t.restitution, 
            ...
            return o.onPostStep = function() {
                ...
                if (t.useFixedDigit) for (var e = t.fixDigits.position, i = t.fixDigits.rotation, o = this._world.bodies, r = 0; r < o.length; r++) {
                    ...
                    if (s.type != n.default.Body.STATIC && !s.isSleeping()) {
                        ...
                        var l = s.quaternion;
                        l.x = parseFloat(l.x.toFixed(i)), l.y = parseFloat(l.y.toFixed(i)), l.z = parseFloat(l.z.toFixed(i)), 
                ...
                this.syncSceneToPhysics(), this._world.step(t, e, i), this.syncPhysicsToScene(), 
                this.emitEvents();
    ...
    6: [ function(t, e, i) {
        ...
        var h = cc.Vec3, c = new h(), p = function(t) {
            ...
            function o(e) {
                var i;
                return (i = t.call(this) || this).halfExtent = new n.default.Vec3(), h.multiplyScalar(i.halfExtent, e, .5), 
                i._shape = new n.default.Box(i.halfExtent.clone()), i;
            }
            ...
            return s.onLoad = function() {
                ...
                key: "size",
                set: function set(t) {
                    this.collider.node.getWorldScale(c), h.multiplyScalar(this.halfExtent, t, .5), h.multiply(this.box.halfExtents, this.halfExtent, c), 
                    this.box.updateConvexPolyhedronRepresentation(), -1 != this._index && (0, r.commitShapeUpdates)(this._body);
                }
            } ]), o;
        }(s.CannonShape);
        i.CannonBoxShape = p;
    ...
    7: [ function(t, e, i) {
        ...
        var l = {
            ...
            selfCollider: null,
            otherCollider: null
        }, h = cc.Vec3, c = new h(), p = function() {
            function t() {
                this._offset = new n.default.Vec3(), this._orient = new n.default.Quaternion(), 
                this._index = -1, this.onTriggerListener = this.onTrigger.bind(this);
            }
            var e, i, o = t.prototype;
            return o.__preload = function(t) {
                this._collider = t, (0, r.setWrap)(this._shape, this), this._shape.addEventListener("cc-trigger", this.onTriggerListener), 
                ...
                this._sharedBody.reference = !1, this._shape.removeEventListener("cc-trigger", this.onTriggerListener), 
                delete n.default.World.idToShapeMap[this._shape.id], this._sharedBody = null, (0, 
                r.setWrap)(this._shape, null), this._offset = null, this._orient = null, this._shape = null, 
                this._collider = null, this.onTriggerListener = null;
            }, o.setScale = function() {
                this._setCenter(this._collider.center);
            }, o.setIndex = function(t) {
                this._index = t;
            }, o.setOffsetAndOrient = function(t, e) {
                cc.Vec3.copy(t, this._offset), cc.Vec3.copy(e, this._orient), this._offset = t, 
                this._orient = e;
                ...
                e && (l.selfCollider = e.collider, l.otherCollider = i ? i.collider : null, l.type = s.deprecatedEventMap[l.type], 
                this._collider.emit(l.type, l), l.type = t.event, this._collider.emit(l.type, l));
            }, e = t, (i = [ {
                key: "shape",
                get: function get() {
                    return this._shape;
                ...
                set: function set(e) {
                    ...
                    this._shape.material = t.idToMaterial[e._uuid], this._shape.material.friction = e.friction, 
    ...
    8: [ function(t, e, i) {
        ...
        var l = new cc.Vec3(), h = function(t) {
            var e, i, o, s;
            function h(e) {
                var i;
                return (i = t.call(this) || this)._radius = void 0, i._radius = e, i._shape = new n.default.Sphere(i._radius), 
                i;
            }
            ...
            e.__proto__ = i, o = h, (s = [ {
                ...
                set: function set(t) {
                    this.collider.node.getWorldScale(l);
                    var e = l.maxAxis();
    ...
    11: [ function(t, e, i) {
        ...
        var d = cc._decorator, y = d.ccclass, f = d.property, v = cc.js.array.fastRemove, m = cc.math.equals, g = y("cc.PhysicsMaterial")((l = a = function(t) {
            var e, i, o, n;
            function a() {
                var e;
                return h(e = t.call(this) || this, "_friction", r, c(e)), h(e, "_restitution", s, c(e)), 
                cc.EventTarget.call(c(e)), a.allMaterials.push(c(e)), "" == e._uuid && (e._uuid = "pm_" + a._idCounter++), 
                e;
            }
        ...
        }(cc.Asset), a.allMaterials = [], a._idCounter = 0, r = u((n = l).prototype, "_friction", [ f ], {
            configurable: !0,
            enumerable: !0,
            writable: !0,
        ...
        }), s = u(n.prototype, "_restitution", [ f ], {
            configurable: !0,
            enumerable: !0,
            writable: !0,
            initializer: function initializer() {
        ...
        }), u(n.prototype, "friction", [ f ], Object.getOwnPropertyDescriptor(n.prototype, "friction"), n.prototype), 
        u(n.prototype, "restitution", [ f ], Object.getOwnPropertyDescriptor(n.prototype, "restitution"), n.prototype), 
        o = n)) || o;
        i.PhysicsMaterial = g, cc.js.mixin(g.prototype, cc.EventTarget.prototype), cc.PhysicsMaterial = g;
    }, {} ],
    12: [ function(t, e, i) {
        "use strict";
        ...
        var v = cc._decorator, m = v.ccclass, g = v.executeInEditMode, w = v.executionOrder, b = v.menu, x = v.property, _ = cc.Vec3, B = (o = m("cc.BoxCollider3D"), 
        n = w(98), r = b("i18n:MAIN_MENU.component.physics/Collider/Box 3D"), s = x({
            type: cc.Vec3
        }), o(a = n(a = r(a = g((f((l = function(t) {
            var e, i, o, n;
            function r() {
                var e;
                return u(e = t.call(this) || this, "_size", h, d(e)), e._shape = (0, c.createBoxShape)(e._size), 
                e;
            }
            return i = t, (e = r).prototype = Object.create(i.prototype), e.prototype.constructor = e, 
            e.__proto__ = i, o = r, (n = [ {
                key: "size",
                get: function get() {
                    return this._size;
    ...
    13: [ function(t, e, i) {
        ...
        var g = cc._decorator, w = g.ccclass, b = g.property, x = cc.Vec3, _ = (o = w("cc.Collider3D"), 
        n = b({
            ...
            function r() {
                var e;
                return (e = t.call(this) || this)._isSharedMaterial = !0, y(e, "_material", c, f(e)), 
                y(e, "_isTrigger", p, f(e)), y(e, "_center", u, f(e)), cc.EventTarget.call(f(e)), 
                e;
            }
            ...
            e.__proto__ = i, o = r, (n = [ {
                ...
                set: function set(t) {
                    ...
                    t.on("physics_material_update", this._updateMaterial, this), this._isSharedMaterial = !1, 
                    ...
                    this._material = t), this._updateMaterial();
                }
            }, {
                key: "isTrigger",
                get: function get() {
            ...
            var s = r.prototype;
            return s.on = function() {}, s.off = function() {}, s.once = function() {}, s.emit = function() {}, 
        ...
        m(h.prototype, "isTrigger", [ r ], Object.getOwnPropertyDescriptor(h.prototype, "isTrigger"), h.prototype), 
        m(h.prototype, "center", [ s ], Object.getOwnPropertyDescriptor(h.prototype, "center"), h.prototype), 
        c = m(h.prototype, "_material", [ a ], {
            configurable: !0,
            enumerable: !0,
            writable: !0,
            initializer: function initializer() {
        ...
        i.Collider3D = _, cc.js.mixin(_.prototype, cc.EventTarget.prototype);
    }, {
    ...
    14: [ function(t, e, i) {
        ...
        var u = cc._decorator, d = u.ccclass, y = u.executeInEditMode, f = u.executionOrder, v = u.menu, m = u.property, g = d("cc.SphereCollider3D")(o = f(98)(o = v("i18n:MAIN_MENU.component.physics/Collider/Sphere 3D")(o = y((p((n = function(t) {
            var e, i, o, n;
            function a() {
                var e;
                return l(e = t.call(this) || this, "_radius", r, h(e)), e._shape = (0, s.createSphereShape)(e._radius), 
                e;
            }
            return i = t, (e = a).prototype = Object.create(i.prototype), e.prototype.constructor = e, 
            e.__proto__ = i, o = a, (n = [ {
                key: "radius",
                get: function get() {
                    return this._radius;
        ...
        }(a.Collider3D)).prototype, "radius", [ m ], Object.getOwnPropertyDescriptor(n.prototype, "radius"), n.prototype), 
        r = p(n.prototype, "_radius", [ m ], {
            configurable: !0,
            enumerable: !0,
            writable: !0,
            initializer: function initializer() {
    ...
    15: [ function(t, e, i) {
        ...
        var o, n, r, s, a, l, h, c, p, u, d, y, f, v, m, g = t("./rigid-body-component");
        function w(t, e, i, o) {
            i && Object.defineProperty(t, e, {
                enumerable: i.enumerable,
                configurable: i.configurable,
        ...
        var B = cc._decorator, S = B.ccclass, E = B.executeInEditMode, M = B.executionOrder, C = B.menu, A = B.property, z = B.requireComponent, F = B.disallowMultiple, T = cc.Vec3, R = (o = S("cc.ConstantForce"), 
        n = M(98), r = z(g.RigidBody3D), s = C("i18n:MAIN_MENU.component.physics/Constant Force 3D"), 
        a = A({
            displayOrder: 0
        }), l = A({
            displayOrder: 1
            ...
            displayOrder: 3
        }), o(p = n(p = r(p = s(p = F(p = E((m = function(t) {
            var e, i;
            function o() {
                for (var e, i = arguments.length, o = new Array(i), n = 0; n < i; n++) {
                    o[n] = arguments[n];
                }
                return (e = t.call.apply(t, [ this ].concat(o)) || this)._rigidbody = null, w(e, "_force", d, x(e)), 
                w(e, "_localForce", y, x(e)), w(e, "_torque", f, x(e)), w(e, "_localTorque", v, x(e)), 
                e._mask = 0, e;
            }
            i = t, (e = o).prototype = Object.create(i.prototype), e.prototype.constructor = e, 
            e.__proto__ = i;
            ...
            return s.onLoad = function() {
                this._rigidbody = this.node.getComponent(g.RigidBody3D), this._maskUpdate(this._force, 1), 
        ...
        }(cc.Component), d = _((u = m).prototype, "_force", [ A ], {
            configurable: !0,
            enumerable: !0,
            writable: !0,
            initializer: function initializer() {
    ...
    16: [ function(t, e, i) {
        ...
        var o, n, r, s, a, l, h, c, p, u, d, y, f, v, m, g, w, b, x, _, B, S = t("../instance");
        function E(t, e, i, o) {
            i && Object.defineProperty(t, e, {
                enumerable: i.enumerable,
                configurable: i.configurable,
        ...
        var z = cc._decorator, F = z.ccclass, T = z.disallowMultiple, R = z.executeInEditMode, P = z.executionOrder, q = z.menu, I = z.property, V = cc.Vec3, O = (o = F("cc.RigidBody3D"), 
        n = P(99), r = q("i18n:MAIN_MENU.component.physics/Rigid Body 3D"), s = I({
            displayOrder: 0
        }), a = I({
            displayOrder: 1
        }), l = I({
            ...
            displayOrder: 7
        }), o(y = n(y = r(y = R(y = T((A((f = function(t) {
            var e, i, o, n;
            function r() {
                var e;
                return (e = t.call(this) || this)._allowSleep = !0, E(e, "_mass", v, M(e)), E(e, "_linearDamping", m, M(e)), 
                E(e, "_angularDamping", g, M(e)), E(e, "_fixedRotation", w, M(e)), E(e, "_isKinematic", b, M(e)), 
                E(e, "_useGravity", x, M(e)), E(e, "_linearFactor", _, M(e)), E(e, "_angularFactor", B, M(e)), 
                e._body = (0, S.createRigidBody)(), e;
            }
            i = t, (e = r).prototype = Object.create(i.prototype), e.prototype.constructor = e, 
            e.__proto__ = i, o = r, (n = [ {
                key: "allowSleep",
        ...
        A(f.prototype, "linearDamping", [ a ], Object.getOwnPropertyDescriptor(f.prototype, "linearDamping"), f.prototype), 
        A(f.prototype, "angularDamping", [ l ], Object.getOwnPropertyDescriptor(f.prototype, "angularDamping"), f.prototype), 
        A(f.prototype, "isKinematic", [ h ], Object.getOwnPropertyDescriptor(f.prototype, "isKinematic"), f.prototype), 
        A(f.prototype, "useGravity", [ c ], Object.getOwnPropertyDescriptor(f.prototype, "useGravity"), f.prototype), 
        A(f.prototype, "fixedRotation", [ p ], Object.getOwnPropertyDescriptor(f.prototype, "fixedRotation"), f.prototype), 
        A(f.prototype, "linearFactor", [ u ], Object.getOwnPropertyDescriptor(f.prototype, "linearFactor"), f.prototype), 
        A(f.prototype, "angularFactor", [ d ], Object.getOwnPropertyDescriptor(f.prototype, "angularFactor"), f.prototype), 
        v = A(f.prototype, "_mass", [ I ], {
            configurable: !0,
            enumerable: !0,
            writable: !0,
            initializer: function initializer() {
        ...
        }), m = A(f.prototype, "_linearDamping", [ I ], {
            configurable: !0,
            enumerable: !0,
            writable: !0,
            initializer: function initializer() {
        ...
        }), g = A(f.prototype, "_angularDamping", [ I ], {
            configurable: !0,
            enumerable: !0,
            writable: !0,
            initializer: function initializer() {
        ...
        }), w = A(f.prototype, "_fixedRotation", [ I ], {
            configurable: !0,
            enumerable: !0,
            writable: !0,
            initializer: function initializer() {
        ...
        }), b = A(f.prototype, "_isKinematic", [ I ], {
            configurable: !0,
            enumerable: !0,
            writable: !0,
            initializer: function initializer() {
        ...
        }), _ = A(f.prototype, "_linearFactor", [ I ], {
            configurable: !0,
            enumerable: !0,
            writable: !0,
            initializer: function initializer() {
        ...
        }), B = A(f.prototype, "_angularFactor", [ I ], {
            configurable: !0,
            enumerable: !0,
            writable: !0,
            initializer: function initializer() {
    ...
    17: [ function(t, e, i) {
        ...
        i.PhysicsMaterial = c.PhysicsMaterial, cc.Physics3DManager = o.Physics3DManager, 
        cc.Collider3D = s.Collider3D, cc.BoxCollider3D = r.BoxCollider3D, cc.SphereCollider3D = a.SphereCollider3D, 
        cc.RigidBody3D = l.RigidBody3D, cc.PhysicsRayResult = n.PhysicsRayResult, cc.ConstantForce = h.ConstantForce;
    }, {
        "./assets/physics-material": 11,
    ...
    20: [ function(t, e, i) {
        ...
        var m = cc._decorator, g = m.property, w = (0, m.ccclass)("cc.Physics3DManager")((r = v((n = function() {
            var t, e;
            function i() {
                this.physicsWorld = void 0, this.raycastClosestResult = new d.PhysicsRayResult(), 
                this.raycastResults = [], y(this, "_enabled", r, this), y(this, "_allowSleep", s, this), 
                y(this, "_gravity", a, this), y(this, "_maxSubStep", l, this), y(this, "_fixedTime", h, this), 
                y(this, "_useFixedTime", c, this), this.useAccumulator = !1, this._accumulator = 0, 
                this.useFixedDigit = !1, this.useInternalTime = !1, this.fixDigits = {
                    position: 5,
                    rotation: 12,
                    timeNow: 3
                ...
                }, 1), cc.director._scheduler && cc.director._scheduler.enableForTarget(this), this.physicsWorld = (0, 
                p.createPhysicsWorld)(), this._lastTime = performance.now(), this.gravity = this._gravity, 
                this.allowSleep = this._allowSleep, this._material = new u.PhysicsMaterial(), this._material.friction = .1, 
                this._material.restitution = .1, this._material.on("physics_material_update", this._updateMaterial, this), 
            ...
            return o.update = function(t) {
                ...
                if (void 0 === e && (e = 0), void 0 === i && (i = 1 / 0), void 0 === o && (o = !0), 
                this.raycastResultPool.reset(), this.raycastResults.length = 0, "string" == typeof e) {
                    var n = cc.game.groupList.indexOf(e);
                    -1 == n && (n = 0), this.raycastOptions.groupIndex = n;
                } else this.raycastOptions.groupIndex = e;
                return this.raycastOptions.maxDistance = i, this.raycastOptions.queryTrigger = o, 
    ...
    21: [ function(t, e, i) {
        ...
        var n = cc.Vec3, r = function() {
            ...
            return r._assign = function(t, e, i) {
                ...
                var e = new t();
                return n.copy(e._hitPoint, this._hitPoint), e._distance = this._distance, e._collidier = this._collidier, 
                e;
            }, e = t, (i = [ {
                key: "hitPoint",
                get: function get() {
    ...
    22: [ function(t, e, i) {
        ...
        }, i.PhysicsWorld = i.RigidBody = i.SphereShape = i.BoxShape = void 0, i.BoxShape = o, 
        i.SphereShape = n, i.RigidBody = r, i.PhysicsWorld = s;
    }, {} ],
    23: [ function(t, e, i) {
        "use strict";
        i.__esModule = !0, i.stringfyVec3 = function(t) {
            ...
            var o = t.parent;
            o ? (x(o, !0), c.transformMat4(y, e, h.invert(w, o._worldMatrix)), p.multiply(g, p.conjugate(g, o.__wrot), i), 
            t.setPosition(y), t.setRotation(g)) : (t.setPosition(e), t.setRotation(i));
        };
        var o = cc.Node._LocalDirtyFlag, n = o.PHYSICS_TRS, r = o.ALL_TRS, s = o.SKEW, a = cc.RenderFlow.FLAG_TRANSFORM, l = cc.Mat3, h = cc.Mat4, c = cc.Vec3, p = cc.Quat, u = cc.Trs, d = [], y = cc.v3(), f = cc.quat(), v = new l(), m = v.m, g = cc.quat(), w = cc.mat4(), b = {};
        function x(t, e) {
            void 0 === e && (e = !1);
            ...
            if (!E) return !1;
            for (d.length = S; S; ) {
                i = d[--S], !e && (b[i._id] = i), o = i._worldMatrix, a = i._matrix, s = i._trs, 
                w = i.__wpos = i.__wpos || cc.v3(), x = i.__wrot = i.__wrot || cc.quat(), _ = i.__wscale = i.__wscale || cc.v3(), 
                i._localMatDirty & n && u.toMat4(a, s), i._localMatDirty |= M, (M |= i._localMatDirty & n) & n ? (B ? (r = B._worldMatrix, 
                u.toPosition(y, s), c.transformMat4(w, y, r), h.multiply(o, r, a), u.toRotation(f, s), 
                p.multiply(x, B.__wrot, f), l.fromQuat(v, p.conjugate(g, x)), l.multiplyMat4(v, v, o), 
                _.x = m[0], _.y = m[4], _.z = m[8]) : (u.toPosition(w, s), u.toRotation(x, s), u.toScale(_, s), 
                h.copy(o, a)), B = i) : B = i;
            }
            return !0;
        }
    ...
    24: [ function(t, e, i) {
        (function(o) {
            "use strict";
            !function(t) {
                if ("object" == _typeof2(i) && void 0 !== e) e.exports = t(); else if ("function" == typeof define && define.amd) define([], t); else {
                    var n;
                ...
                return function e(i, o, n) {
                    ...
                    3: [ function(t, e) {
                        ...
                        o.prototype.setFromPoints = function(t, e, i, o) {
                            ...
                            return e && (e.vadd(r, r), e.vadd(s, s)), o && (r.x -= o, r.y -= o, r.z -= o, s.x += o, 
                            s.y += o, s.z += o), this;
                            ...
                            t.copy(l), e.set(h.x, l.y, l.z), i.set(h.x, h.y, l.z), o.set(l.x, h.y, h.z), n.set(h.x, l.y, h.z), 
                    ...
                    6: [ function(t, e) {
                        ...
                        function r(t, e, n, r, s) {
                            i.apply(this), this.nx = n || 10, this.ny = r || 10, this.nz = s || 10, this.aabbMin = t || new o(100, 100, 100), 
                        ...
                        new o(), r.prototype.collisionPairs = function(t, e, i) {
                            for (var o = t.numObjects(), r = t.bodies, a = this.aabbMax, l = this.aabbMin, h = this.nx, c = this.ny, p = this.nz, u = c * p, d = p, y = 1, f = a.x, v = a.y, m = a.z, g = l.x, w = l.y, b = l.z, x = h / (f - g), _ = c / (v - w), B = p / (m - b), S = (f - g) / h, E = (v - w) / c, M = (m - b) / p, C = .5 * Math.sqrt(S * S + E * E + M * M), A = n.types, z = A.SPHERE, F = A.PLANE, T = (A.BOX, 
                            A.COMPOUND, A.CONVEXPOLYHEDRON, this.bins), R = this.binLengths, P = this.bins.length, q = 0; q !== P; q++) {
                                R[q] = 0;
                            }
                            var I = Math.ceil;
                            function V(t, e, i, o, n, r, s) {
                                var a = (t - g) * x | 0, l = (e - w) * _ | 0, f = (i - b) * B | 0, v = I((o - g) * x), m = I((n - w) * _), S = I((r - b) * B);
                                a < 0 ? a = 0 : a >= h && (a = h - 1), l < 0 ? l = 0 : l >= c && (l = c - 1), f < 0 ? f = 0 : f >= p && (f = p - 1), 
                                v < 0 ? v = 0 : v >= h && (v = h - 1), m < 0 ? m = 0 : m >= c && (m = c - 1), S < 0 ? S = 0 : S >= p && (S = p - 1), 
                                l *= d, f *= y, v *= u, m *= d, S *= y;
                            ...
                            for (l = Math.min, a = Math.max, q = 0; q !== o; q++) {
                                ...
                                switch (O.type) {
                                  case z:
                                    var k = it.position.x, N = it.position.y, j = it.position.z, L = O.radius;
                                    V(k - L, N - L, j - L, k + L, N + L, j + L, it);
                                    break;

                                  case F:
                                    O.worldNormalNeedsUpdate && O.computeWorldNormal(it.quaternion);
                                    var W = O.worldNormal, D = g + .5 * S - it.position.x, U = w + .5 * E - it.position.y, G = b + .5 * M - it.position.z, H = s;
                                    H.set(D, U, G);
                                    for (var K = 0, Q = 0; K !== h; K++, Q += u, H.y = U, H.x += S) {
                    ...
                    10: [ function(t, e) {
                        ...
                        function l(t, e) {
                            ...
                            this.result = new r(), this.hasHit = !1, this.callback = function() {};
                        }
                        l.prototype.constructor = l, l.CLOSEST = 1, l.ANY = 2, l.ALL = 4;
                        var h = new a(), c = [];
                        l.prototype.intersectWorld = function(t, e) {
                            return this.mode = e.mode || l.ANY, this.result = e.result || new r(), this.skipBackfaces = !!e.skipBackfaces, 
                            this.checkCollisionResponse = !!e.checkCollisionResponse, this.collisionFilterMask = void 0 !== e.collisionFilterMask ? e.collisionFilterMask : -1, 
                        ...
                        var p = new i(), u = new i();
                        function d(t, e, i, o) {
                            o.vsub(e, V), i.vsub(e, p), t.vsub(e, u);
                            var n, r, s = V.dot(V), a = V.dot(p), l = V.dot(u), h = p.dot(p), c = p.dot(u);
                        ...
                        l.prototype.intersectBody = function(t, e) {
                            ...
                            if ((!i || t.collisionResponse) && 0 != (this.collisionFilterGroup & t.collisionFilterMask) && 0 != (t.collisionFilterGroup & this.collisionFilterMask)) for (var o = y, n = f, r = 0, s = t.shapes.length; r < s; r++) {
                                ...
                                t.quaternion.vmult(t.shapeOffsets[r], o), o.vadd(t.position, o), this.intersectShape(a, n, o, t), 
                        ...
                        var v = new i(), m = new i(), g = new i(), w = new i();
                        ...
                        l.prototype.intersectHeightfield = function(t, e, i, o, r) {
                            ...
                            var s = _;
                            s.from.copy(this.from), s.to.copy(this.to), n.pointToLocalFrame(i, e, s.from, s.from), 
                            n.pointToLocalFrame(i, e, s.to, s.to), s._updateDirection();
                            var l, h, c, p, u = B;
                            l = h = 0, c = p = t.data.length - 1;
                            var d = new a();
                            s.getAABB(d), t.getIndexOfPosition(d.lowerBound.x, d.lowerBound.y, u, !0), l = Math.max(l, u[0]), 
                            h = Math.max(h, u[1]), t.getIndexOfPosition(d.upperBound.x, d.upperBound.y, u, !0), 
                            c = Math.min(c, u[0] + 1), p = Math.min(p, u[1] + 1);
                            for (var y = l; y < c; y++) {
                                for (var f = h; f < p; f++) {
                                    if (this.result._shouldStop) return;
                                    if (t.getAabbAtIndex(y, f, d), d.overlapsRay(s)) {
                                        if (t.getConvexTrianglePillar(y, f, !1), n.pointToWorldFrame(i, e, t.pillarOffset, x), 
                                        this.intersectConvex(t.pillarConvex, e, x, o, r, b), this.result._shouldStop) return;
                                        t.getConvexTrianglePillar(y, f, !0), n.pointToWorldFrame(i, e, t.pillarOffset, x), 
                                        this.intersectConvex(t.pillarConvex, e, x, o, r, b);
                                    }
                                }
                            }
                        ...
                        l.prototype.intersectSphere = function(t, e, i, o, n) {
                            var r = this.from, s = this.to, a = t.radius, l = Math.pow(s.x - r.x, 2) + Math.pow(s.y - r.y, 2) + Math.pow(s.z - r.z, 2), h = 2 * ((s.x - r.x) * (r.x - i.x) + (s.y - r.y) * (r.y - i.y) + (s.z - r.z) * (r.z - i.z)), c = Math.pow(r.x - i.x, 2) + Math.pow(r.y - i.y, 2) + Math.pow(r.z - i.z, 2) - Math.pow(a, 2), p = Math.pow(h, 2) - 4 * l * c, u = S, d = E;
                            if (!(p < 0)) if (0 === p) r.lerp(s, p, u), u.vsub(i, d), d.normalize(), this.reportIntersection(d, u, n, o, -1); else {
                                ...
                                if (y >= 0 && y <= 1 && (r.lerp(s, y, u), u.vsub(i, d), d.normalize(), this.reportIntersection(d, u, n, o, -1)), 
                        ...
                        l.prototype.intersectConvex = function(t, e, i, o, n, r) {
                            for (var s = M, a = C, l = r && r.faceList || null, h = t.faces, c = t.vertices, p = t.faceNormals, u = this._direction, y = this.from, f = this.to, b = y.distanceTo(f), x = l ? l.length : h.length, _ = this.result, B = 0; !_._shouldStop && B < x; B++) {
                                ...
                                if (!(Math.abs(T) < this.precision)) {
                                    var R = s.dot(a) / T;
                                    if (!(R < 0)) {
                                        u.mult(R, v), v.vadd(y, v), m.copy(c[E[0]]), z.vmult(m, m), F.vadd(m, m);
                                        for (var P = 1; !_._shouldStop && P < E.length - 1; P++) {
                                            g.copy(c[E[P]]), w.copy(c[E[P + 1]]), z.vmult(g, g), z.vmult(w, w), F.vadd(g, g), 
                                            F.vadd(w, w);
                                            var q = v.distanceTo(y);
                                            !d(v, m, g, w) && !d(v, g, m, w) || q > b || this.reportIntersection(s, v, n, o, S);
                                        }
                                    }
                                }
                            }
                        }, l.prototype[s.types.CONVEXPOLYHEDRON] = l.prototype.intersectConvex;
                        var A = new i(), z = new i(), F = new i(), T = new i(), R = new i(), P = new i(), q = (new a(), 
                        []), I = new n();
                        l.prototype.intersectTrimesh = function(t, e, i, o, r, s) {
                            var a = A, l = q, h = I, c = C, p = z, u = F, y = T, f = P, b = R, x = (s && s.faceList, 
                            t.indices), _ = (t.vertices, t.faceNormals, this.from), B = this.to, S = this._direction;
                            h.position.copy(i), h.quaternion.copy(e), n.vectorToLocalFrame(i, e, S, p), n.pointToLocalFrame(i, e, _, u), 
                            n.pointToLocalFrame(i, e, B, y), y.x *= t.scale.x, y.y *= t.scale.y, y.z *= t.scale.z, 
                            u.x *= t.scale.x, u.y *= t.scale.y, u.z *= t.scale.z, y.vsub(u, p), p.normalize();
                            var E = u.distanceSquared(y);
                            t.tree.rayQuery(this, h, l);
                            for (var M = 0, V = l.length; !this.result._shouldStop && M !== V; M++) {
                                var O = l[M];
                                t.getNormal(O, a), t.getVertex(x[3 * O], m), m.vsub(u, c);
                                var k = p.dot(a), N = a.dot(c) / k;
                                if (!(N < 0)) {
                                    p.scale(N, v), v.vadd(u, v), t.getVertex(x[3 * O + 1], g), t.getVertex(x[3 * O + 2], w);
                                    var j = v.distanceSquared(u);
                                    !d(v, g, m, w) && !d(v, m, g, w) || j > E || (n.vectorToWorldFrame(e, a, b), n.pointToWorldFrame(i, e, v, f), 
                                    this.reportIntersection(b, f, r, o, O));
                                }
                            }
                            l.length = 0;
                        ...
                        function k(t, e, i) {
                            i.vsub(t, V);
                            var o = V.dot(e);
                            return e.mult(o, O), O.vadd(t, O), i.distanceTo(O);
                        }
                    }, {
                        "../collision/AABB": 3,
                        "../collision/RaycastResult": 11,
                    ...
                    11: [ function(t, e) {
                        ...
                        e.exports = o, o.prototype.reset = function() {
                            ...
                            this.hitPointWorld.copy(o), this.shape = n, this.body = r, this.distance = s;
                        };
                    }, {
                        "../math/Vec3": 32
                    } ],
                    ...
                    13: [ function(t, e) {
                        ...
                        t("../math/Vec3"));
                        function s(t, e, s) {
                            var a = void 0 !== (s = s || {}).maxForce ? s.maxForce : 1e6, l = s.pivotA ? s.pivotA.clone() : new r(), h = s.pivotB ? s.pivotB.clone() : new r();
                            this.axisA = s.axisA ? s.axisA.clone() : new r(), this.axisB = s.axisB ? s.axisB.clone() : new r(), 
                            i.call(this, t, l, e, h, a), this.collideConnected = !!s.collideConnected, this.angle = void 0 !== s.angle ? s.angle : 0;
                            var c = this.coneEquation = new o(t, e, s), p = this.twistEquation = new n(t, e, s);
                            this.twistAngle = void 0 !== s.twistAngle ? s.twistAngle : 0, c.maxForce = 0, c.minForce = -a, 
                    ...
                    14: [ function(t, e) {
                        ...
                        function o(t, e, n) {
                            n = i.defaults(n, {
                                collideConnected: !0,
                                wakeUpBodies: !0
                            }), this.equations = [], this.bodyA = t, this.bodyB = e, this.id = o.idCounter++, 
                            this.collideConnected = n.collideConnected, n.wakeUpBodies && (t && t.wakeUp(), 
                            e && e.wakeUp());
                        }
                    ...
                    15: [ function(t, e) {
                        ...
                        function n(t, e, n, r) {
                            i.call(this, t, e), void 0 === n && (n = t.position.distanceTo(e.position)), void 0 === r && (r = 1e6), 
                            this.distance = n;
                    ...
                    16: [ function(t, e) {
                        ...
                        function s(t, e, s) {
                            var a = void 0 !== (s = s || {}).maxForce ? s.maxForce : 1e6, l = s.pivotA ? s.pivotA.clone() : new r(), h = s.pivotB ? s.pivotB.clone() : new r();
                            i.call(this, t, l, e, h, a), (this.axisA = s.axisA ? s.axisA.clone() : new r(1, 0, 0)).normalize(), 
                            (this.axisB = s.axisB ? s.axisB.clone() : new r(1, 0, 0)).normalize();
                            var c = this.rotationalEquation1 = new o(t, e, s), p = this.rotationalEquation2 = new o(t, e, s), u = this.motorEquation = new n(t, e, a);
                    ...
                    17: [ function(t, e) {
                        ...
                        function r(t, e, r) {
                            var s = void 0 !== (r = r || {}).maxForce ? r.maxForce : 1e6, a = new n(), l = new n(), h = new n();
                            t.position.vadd(e.position, h), h.scale(.5, h), e.pointToLocalFrame(h, l), t.pointToLocalFrame(h, a), 
                            i.call(this, t, a, e, l, s), this.xA = t.vectorToLocalFrame(n.UNIT_X), this.xB = e.vectorToLocalFrame(n.UNIT_X), 
                            this.yA = t.vectorToLocalFrame(n.UNIT_Y), this.yB = e.vectorToLocalFrame(n.UNIT_Y), 
                            this.zA = t.vectorToLocalFrame(n.UNIT_Z), this.zB = e.vectorToLocalFrame(n.UNIT_Z);
                            var c = this.rotationalEquation1 = new o(t, e, r), p = this.rotationalEquation2 = new o(t, e, r), u = this.rotationalEquation3 = new o(t, e, r);
                    ...
                    18: [ function(t, e) {
                        ...
                        function r(t, e, r, s, a) {
                            i.call(this, t, r), a = void 0 !== a ? a : 1e6, this.pivotA = e ? e.clone() : new n(), 
                    ...
                    19: [ function(t, e) {
                        ...
                        function r(t, e, n) {
                            ...
                            o.call(this, t, e, -r, r), this.axisA = n.axisA ? n.axisA.clone() : new i(1, 0, 0), 
                            this.axisB = n.axisB ? n.axisB.clone() : new i(0, 1, 0), this.angle = void 0 !== n.angle ? n.angle : 0;
                        }
                        r.prototype = new o(), r.prototype.constructor = r;
                        var s = new i(), a = new i();
                        r.prototype.computeB = function(t) {
                            var e = this.a, i = this.b, o = this.axisA, r = this.axisB, l = s, h = a, c = this.jacobianElementA, p = this.jacobianElementB;
                            return o.cross(r, l), r.cross(o, h), c.rotational.copy(h), p.rotational.copy(l), 
                    ...
                    20: [ function(t, e) {
                        ...
                        function n(t, e, n) {
                            n = void 0 !== n ? n : 1e6, i.call(this, t, e, 0, n), this.si = null, this.sj = null, 
                            this.restitution = 0, this.ri = new o(), this.rj = new o(), this.ni = new o();
                        }
                        t("../math/Mat3"), n.prototype = new i(), n.prototype.constructor = n;
                        var r = new o(), s = new o(), a = new o();
                        n.prototype.computeB = function(t) {
                            var e = this.a, i = this.b, o = this.bi, n = this.bj, l = this.ri, h = this.rj, c = r, p = s, u = o.velocity, d = o.angularVelocity, y = (o.force, 
                            o.torque, n.velocity), f = n.angularVelocity, v = (n.force, n.torque, a), m = this.jacobianElementA, g = this.jacobianElementB, w = this.ni;
                            l.cross(w, c), h.cross(w, p), w.negate(m.spatial), c.negate(m.rotational), g.spatial.copy(w), 
                            g.rotational.copy(p), v.copy(n.position), v.vadd(h, v), v.vsub(o.position, v), v.vsub(l, v);
                            var b = w.dot(v), x = this.restitution + 1;
                            return -b * e - (x * y.dot(w) - x * u.dot(w) + f.dot(p) - d.dot(c)) * i - t * this.computeGiMf();
                        };
                    ...
                    21: [ function(t, e) {
                        ...
                        function n(t, e, o, r) {
                            this.id = n.id++, this.minForce = void 0 === o ? -1e6 : o, this.maxForce = void 0 === r ? 1e6 : r, 
                        ...
                        n.prototype.computeGiMf = function() {
                            var t = this.jacobianElementA, e = this.jacobianElementB, i = this.bi, o = this.bj, n = i.force, h = i.torque, c = o.force, p = o.torque, u = i.invMassSolve, d = o.invMassSolve;
                            return n.scale(u, r), c.scale(d, s), i.invInertiaWorldSolve.vmult(h, a), o.invInertiaWorldSolve.vmult(p, l), 
                        ...
                        n.prototype.computeGiMGt = function() {
                            ...
                            return s.vmult(t.rotational, h), l += h.dot(t.rotational), a.vmult(e.rotational, h), 
                        ...
                        new o(), new o(), new o(), new o(), new o(), n.prototype.addToWlambda = function(t) {
                            ...
                            o.invInertiaWorldSolve.vmult(e.rotational, r), o.wlambda.addScaledVector(t, r, o.wlambda), 
                            n.invInertiaWorldSolve.vmult(i.rotational, r), n.wlambda.addScaledVector(t, r, n.wlambda);
                    ...
                    23: [ function(t, e) {
                        ...
                        function r(t, e, n) {
                            var r = void 0 !== (n = n || {}).maxForce ? n.maxForce : 1e6;
                            o.call(this, t, e, -r, r), this.axisA = n.axisA ? n.axisA.clone() : new i(1, 0, 0), 
                            this.axisB = n.axisB ? n.axisB.clone() : new i(0, 1, 0), this.maxAngle = Math.PI / 2;
                        }
                        r.prototype = new o(), r.prototype.constructor = r;
                        var s = new i(), a = new i();
                        r.prototype.computeB = function(t) {
                    ...
                    24: [ function(t, e) {
                        ...
                        function n(t, e, n) {
                            n = void 0 !== n ? n : 1e6, o.call(this, t, e, -n, n), this.axisA = new i(), this.axisB = new i(), 
                    ...
                    25: [ function(t, e) {
                        ...
                        function o(t, e, n) {
                            ...
                            }), this.id = o.idCounter++, this.materials = [ t, e ], this.friction = n.friction, 
                            this.restitution = n.restitution, this.contactEquationStiffness = n.contactEquationStiffness, 
                            this.contactEquationRelaxation = n.contactEquationRelaxation, this.frictionEquationStiffness = n.frictionEquationStiffness, 
                    ...
                    26: [ function(t, e) {
                        function i(t) {
                            var e = "";
                            "string" == typeof (t = t || {}) ? (e = t, t = {}) : "object" == _typeof2(t) && (e = ""), 
                    ...
                    27: [ function(t, e) {
                        ...
                        p._sin = a, p._cos = l, p._sinArr = n, p._sin360 = s, p._sinNative = h, p._cosNative = c, 
                        p._radian2angle = o, p._calculateSinByDigit = r, p._digit = 1, Object.defineProperty(p, "digit", {
                            get: function get() {
                                return this._digit;
                            },
                            set: function set(t) {
                            ...
                            set: function set(t) {
                                this._mode != t && (this._mode = t, 0 == t ? (p.sin = Math.sin, p.cos = Math.cos) : 1 == t ? (p.digit = p._digit, 
                                p.sin = a, p.cos = l) : 2 == t && (p.sin = h, p.cos = c));
                            }
                        }), e.exports = p;
                    }, {} ],
                    28: [ function(t, e) {
                    ...
                    29: [ function(t, e) {
                        ...
                        o.prototype.identity = function() {
                            ...
                            var e = t.x, i = t.y, o = t.z, n = t.w, r = e + e, s = i + i, a = o + o, l = e * r, h = e * s, c = e * a, p = i * s, u = i * a, d = o * a, y = n * r, f = n * s, v = n * a, m = this.elements;
                            return m[0] = 1 - (p + d), m[1] = h - v, m[2] = c + f, m[3] = h + v, m[4] = 1 - (l + d), 
                            m[5] = u - y, m[6] = c - f, m[7] = u + y, m[8] = 1 - (l + p), this;
                    ...
                    30: [ function(t, e) {
                        ...
                        n.prototype.set = function(t, e, i, o) {
                            ...
                            var i = o.sin(.5 * e);
                            return this.x = t.x * i, this.y = t.y * i, this.z = t.z * i, this.w = o.cos(.5 * e), 
                            this;
                        ...
                        n.prototype.setFromVectors = function(t, e) {
                            ...
                            return e.x = i * c + s * a + o * h - r * l, e.y = o * c + s * l + r * a - i * h, 
                            e.z = r * c + s * h + i * l - o * a, e.w = s * c - i * a - o * l - r * h, e;
                            ...
                            return (t = t || new n()).x = -this.x, t.y = -this.y, t.z = -this.z, t.w = this.w, 
                            t;
                            ...
                            switch (e) {
                              case "YZX":
                                var c = s * a + l * h;
                                if (c > .499 && (i = 2 * o.atan2(s, h), n = Math.PI / 2, r = 0), c < -.499 && (i = -2 * o.atan2(s, h), 
                                n = -Math.PI / 2, r = 0), isNaN(i)) {
                            ...
                            return "XYZ" === n ? (this.x = l * s * a + r * h * c, this.y = r * h * a - l * s * c, 
                            this.z = r * s * c + l * h * a, this.w = r * s * a - l * h * c) : "YXZ" === n ? (this.x = l * s * a + r * h * c, 
                            this.y = r * h * a - l * s * c, this.z = r * s * c - l * h * a, this.w = r * s * a + l * h * c) : "ZXY" === n ? (this.x = l * s * a - r * h * c, 
                            this.y = r * h * a + l * s * c, this.z = r * s * c + l * h * a, this.w = r * s * a - l * h * c) : "ZYX" === n ? (this.x = l * s * a - r * h * c, 
                            this.y = r * h * a + l * s * c, this.z = r * s * c - l * h * a, this.w = r * s * a + l * h * c) : "YZX" === n ? (this.x = l * s * a + r * h * c, 
                            this.y = r * h * a + l * s * c, this.z = r * s * c - l * h * a, this.w = r * s * a - l * h * c) : "XZY" === n && (this.x = l * s * a - r * h * c, 
                            this.y = r * h * a - l * s * c, this.z = r * s * c + l * h * a, this.w = r * s * a + l * h * c), 
                            this;
                            ...
                            return (s = c * y + p * f + u * v + d * m) < 0 && (s = -s, y = -y, f = -f, v = -v, 
                            m = -m), 1 - s > 1e-6 ? (r = Math.acos(s), a = o.sin(r), l = o.sin((1 - e) * r) / a, 
                            h = o.sin(e * r) / a) : (l = 1 - e, h = e), i.x = l * c + h * y, i.y = l * p + h * f, 
                            i.z = l * u + h * v, i.w = l * d + h * m, i;
                        }, n.prototype.integrate = function(t, e, i, o) {
                            o = o || new n();
                            var r = t.x * i.x, s = t.y * i.y, a = t.z * i.z, l = this.x, h = this.y, c = this.z, p = this.w, u = .5 * e;
                            return o.x += u * (r * p + s * c - a * h), o.y += u * (s * p + a * l - r * c), o.z += u * (a * p + r * h - s * l), 
                            o.w += u * (-r * l - s * h - a * c), o;
                        };
                    }, {
                        "./CMath": 27,
                    ...
                    32: [ function(t, e) {
                        ...
                        o.ZERO = new o(0, 0, 0), o.UNIT_X = new o(1, 0, 0), o.UNIT_Y = new o(0, 1, 0), o.UNIT_Z = new o(0, 0, 1), 
                        o.prototype.cross = function(t, e) {
                            var i = t.x, n = t.y, r = t.z, s = this.x, a = this.y, l = this.z;
                            return (e = e || new o()).x = a * r - l * n, e.y = l * i - s * r, e.z = s * n - a * i, 
                            e;
                            ...
                            return r > 0 ? (r = 1 / r, t.x = e * r, t.y = i * r, t.z = n * r) : (t.x = 1, t.y = 0, 
                            t.z = 0), t;
                            ...
                            return (e = e || new o()).x = t.x * this.x, e.y = t.y * this.y, e.z = t.z * this.z, 
                            e;
                        }, o.prototype.scale = o.prototype.mult, o.prototype.addScaledVector = function(t, e, i) {
                            return (i = i || new o()).x = this.x + t * e.x, i.y = this.y + t * e.y, i.z = this.z + t * e.z, 
                            i;
                    ...
                    33: [ function(t, e) {
                        ...
                        function h(t) {
                            t = t || {}, i.apply(this), this.id = h.idCounter++, this.world = null, this.preStep = null, 
                            this.postStep = null, this.vlambda = new o(), this.collisionFilterGroup = "number" == typeof t.collisionFilterGroup ? t.collisionFilterGroup : 1, 
                            this.collisionFilterMask = "number" == typeof t.collisionFilterMask ? t.collisionFilterMask : -1, 
                            this.collisionResponse = !0, this.position = new o(), this.previousPosition = new o(), 
                            this.interpolatedPosition = new o(), this.initPosition = new o(), t.position && (this.position.copy(t.position), 
                            this.previousPosition.copy(t.position), this.interpolatedPosition.copy(t.position), 
                            this.initPosition.copy(t.position)), this.velocity = new o(), t.velocity && this.velocity.copy(t.velocity), 
                            this.initVelocity = new o(), this.force = new o();
                            ...
                            this.type = e <= 0 ? h.STATIC : h.DYNAMIC, _typeof2(t.type) == _typeof2(h.STATIC) && (this.type = t.type), 
                            ...
                            this.timeLastSleepy = 0, this._wakeUpAfterNarrowphase = !1, this.torque = new o(), 
                            ...
                            this.interpolatedQuaternion.copy(t.quaternion)), this.angularVelocity = new o(), 
                            t.angularVelocity && this.angularVelocity.copy(t.angularVelocity), this.initAngularVelocity = new o(), 
                            this.shapes = [], this.shapeOffsets = [], this.shapeOrientations = [], this.inertia = new o(), 
                            this.invInertia = new o(), this.invInertiaWorld = new n(), this.invMassSolve = 0, 
                            this.invInertiaSolve = new o(), this.invInertiaWorldSolve = new n(), this.fixedRotation = void 0 !== t.fixedRotation && t.fixedRotation, 
                            this.useGravity = !0, this.angularDamping = void 0 !== t.angularDamping ? t.angularDamping : .01, 
                            this.linearFactor = new o(1, 1, 1), t.linearFactor && this.linearFactor.copy(t.linearFactor), 
                            this.angularFactor = new o(1, 1, 1), t.angularFactor && this.angularFactor.copy(t.angularFactor), 
                            this.aabb = new s(), this.aabbNeedsUpdate = !0, this.boundingRadius = 0, this.wlambda = new o(), 
                            t.shape && this.addShape(t.shape), this.hasTrigger = !0, this.updateMassProperties();
                        }
                        h.prototype = new i(), h.prototype.constructor = h, h.COLLIDE_EVENT_NAME = "collide", 
                        h.DYNAMIC = 1, h.STATIC = 2, h.KINEMATIC = 4, h.AWAKE = 0, h.SLEEPY = 1, h.SLEEPING = 2, 
                        h.idCounter = 0, h.wakeupEvent = {
                            type: "wakeup"
                            ...
                            if (this.allowSleep) {
                                ...
                                e === h.AWAKE && i < o ? (this.sleepState = h.SLEEPY, this.timeLastSleepy = t, this.dispatchEvent(h.sleepyEvent)) : e === h.SLEEPY && i > o ? this.wakeUp() : e === h.SLEEPY && t - this.timeLastSleepy > this.sleepTimeLimit && (this.sleep(), 
                            ...
                            return e = e || new o(), t.vsub(this.position, e), this.quaternion.conjugate().vmult(e, e), 
                            e;
                            ...
                            return e = e || new o(), this.quaternion.vmult(t, e), e.vadd(this.position, e), 
                            e;
                        ...
                        h.prototype.addShape = function(t, e, i) {
                            var n = new o(), s = new r();
                            return e && n.copy(e), i && s.copy(i), this.shapes.push(t), this.shapeOffsets.push(n), 
                            this.shapeOrientations.push(s), this.aabbNeedsUpdate = !0, this.updateMassProperties(), 
                            this.updateBoundingRadius(), this.updateHasTrigger(), l.idToShapeMap[t.id] = t, 
                            t.body = this, this;
                            ...
                            this.aabbNeedsUpdate = !0, this.updateMassProperties(), this.updateBoundingRadius(), 
                        ...
                        h.prototype.computeAABB = function() {
                            for (var t = this.shapes, e = this.shapeOffsets, i = this.shapeOrientations, o = t.length, n = c, r = p, s = this.quaternion, a = this.aabb, l = u, h = 0; h !== o; h++) {
                                var d = t[h];
                                s.vmult(e[h], n), n.vadd(this.position, n), i[h].mult(s, r), d.calculateWorldAABB(n, r, l.lowerBound, l.upperBound), 
                        ...
                        h.prototype.updateMassProperties = function() {
                            ...
                            a.calculateInertia(t, this.mass, e), this.invInertia.set(e.x > 0 && !i ? 1 / e.x : 0, e.y > 0 && !i ? 1 / e.y : 0, e.z > 0 && !i ? 1 / e.z : 0), 
                            ...
                            (this.type === h.DYNAMIC || this.type === h.KINEMATIC) && this.sleepState !== h.SLEEPING) {
                                var o = this.velocity, n = this.angularVelocity, r = this.position, s = this.force, a = this.torque, l = this.quaternion, c = this.invMass, p = this.invInertiaWorld, u = this.linearFactor, d = c * t;
                                o.x += s.x * d * u.x, o.y += s.y * d * u.y, o.z += s.z * d * u.z;
                                var y = p.elements, f = this.angularFactor, v = a.x * f.x, m = a.y * f.y, g = a.z * f.z;
                                n.x += t * (y[0] * v + y[1] * m + y[2] * g), n.y += t * (y[3] * v + y[4] * m + y[5] * g), 
                                n.z += t * (y[6] * v + y[7] * m + y[8] * g), r.x += o.x * t, r.y += o.y * t, r.z += o.z * t, 
                                l.integrate(this.angularVelocity, t, this.angularFactor, l), e && (i ? l.normalizeFast() : l.normalize()), 
                    ...
                    34: [ function(t, e) {
                        ...
                        new n(), s.prototype.addWheel = function(t) {
                            ...
                            var s = new i();
                            for (this.getVehicleAxisWorld(this.indexForwardAxis, s), s.dot(n.velocity) < 0 && (this.currentVehicleSpeedKmHour *= -1), 
                            r = 0; r < o; r++) {
                                this.castRay(e[r]);
                            }
                            ...
                            for (r = 0; r < o; r++) {
                                ...
                                d.raycastResult.hitPointWorld.vsub(n.position, l), n.applyImpulse(a, l);
                            }
                            ...
                            for (var t = this.chassisBody.mass, e = this.wheelInfos, i = e.length, o = 0; o < i; o++) {
                                ...
                                if (n.isInContact) {
                                    ...
                                    r -= (a < 0 ? n.dampingCompression : n.dampingRelaxation) * a, n.suspensionForce = r * t, 
                        ...
                        s.prototype.castRay = function(t) {
                            ...
                            if (t.raycastResult.groundObject = 0, u) {
                                ...
                                t.suspensionLength < y && (t.suspensionLength = y), t.suspensionLength > f && (t.suspensionLength = f, 
                            ...
                            this.updateWheelTransformWorld(r), r.directionLocal.scale(-1, e), i.copy(r.axleLocal), 
                            e.cross(i, n), n.normalize(), i.normalize();
                        ...
                        s.prototype.updateFriction = function(t) {
                            for (var e = d, o = this.wheelInfos, n = o.length, r = this.chassisBody, s = f, a = y, l = 0; l < n; l++) {
                                v = (M = o[l]).raycastResult.body, M.sideImpulse = 0, M.forwardImpulse = 0, s[l] || (s[l] = new i()), 
                                a[l] || (a[l] = new i());
                            }
                            for (l = 0; l < n; l++) {
                            ...
                            for (this.sliding = !1, l = 0; l < n; l++) {
                                ...
                                if (M.slipInfo = 1, v) {
                                    ...
                                    m = w(r, v, M.raycastResult.hitPointWorld, s[l], g);
                                ...
                                if (M.forwardImpulse = 0, M.skidInfo = 1, v) {
                                    ...
                                    M.sliding = !1, E > _ && (this.sliding = !0, M.sliding = !0, b = x / Math.sqrt(E), 
                                    M.skidInfo *= b);
                                }
                            }
                            ...
                            for (l = 0; l < n; l++) {
                                ...
                                if (0 !== M.sideImpulse) {
                                    ...
                                    var T = new i();
                                    a[l].scale(M.sideImpulse, T), r.vectorToLocalFrame(C, C), C["xyz"[this.indexUpAxis]] *= M.rollInfluence, 
                                    r.vectorToWorldFrame(C, C), r.applyImpulse(T, C), T.scale(-1, T), v.applyImpulse(T, F);
                                }
                            }
                        };
                        ...
                        function w(t, e, i, o, n) {
                            ...
                            return t.getVelocityAtWorldPoint(s, a), e.getVelocityAtWorldPoint(s, l), a.vsub(l, h), 
                            n < (r = -o.dot(h) * (1 / (S(t, i, o) + S(e, i, o)))) && (r = n), r < -n && (r = -n), 
                            r;
                        }
                        var b = new i(), x = new i(), _ = new i(), B = new i();
                        function S(t, e, i) {
                            var o = b, n = x, r = _, s = B;
                            return e.vsub(t.position, o), o.cross(i, n), t.invInertiaWorld.vmult(n, s), s.cross(o, r), 
                            t.invMass + i.dot(r);
                        }
                        ...
                        function A(t, e, i, o, n) {
                            ...
                            var r = E, s = M, a = C;
                            return t.getVelocityAtWorldPoint(e, r), i.getVelocityAtWorldPoint(o, s), r.vsub(s, a), 
                    ...
                    35: [ function(t, e) {
                        ...
                        function l(t) {
                            if (this.wheelBodies = [], this.coordinateSystem = void 0 === t.coordinateSystem ? new r(1, 2, 3) : t.coordinateSystem.clone(), 
                        ...
                        e.exports = l, l.prototype.addWheel = function(t) {
                            var e = (t = t || {}).body;
                            e || (e = new i(1, new o(1.2))), this.wheelBodies.push(e), this.wheelForces.push(0), 
                            new r();
                    ...
                    36: [ function(t, e) {
                        ...
                        o.prototype.update = function() {
                            ...
                            var m = s, g = a, w = l, b = h, x = c;
                            for (n = 0; n !== t; n++) {
                                var _, B, S, E = this.particles[n];
                                for (m.set(0, 0, 0), g.set(0, 0, 0), u = (S = this.neighbors[n]).length, y = 0; y !== u; y++) {
                                    var M = S[y];
                                    E.position.vsub(M.position, b);
                                    var C = b.norm();
                                    _ = -M.mass * (this.pressures[n] / (this.densities[n] * this.densities[n] + o) + this.pressures[y] / (this.densities[y] * this.densities[y] + o)), 
                                    this.gradw(b, w), w.mult(_, w), m.vadd(w, m), M.velocity.vsub(E.velocity, x), x.mult(1 / (1e-4 + this.densities[n] * this.densities[y]) * this.viscosity * M.mass, x), 
                                    B = this.nablaw(C), x.mult(B, x), g.vadd(x, g);
                                }
                    ...
                    37: [ function(t, e) {
                        ...
                        var n = new i(), r = new i(), s = new i(), a = new i(), l = new i(), h = new i(), c = new i(), p = new i(), u = new i(), d = new i(), y = new i();
                        o.prototype.applyForce = function() {
                            var t = this.stiffness, e = this.damping, i = this.restLength, o = this.bodyA, f = this.bodyB, v = n, m = r, g = s, w = a, b = y, x = l, _ = h, B = c, S = p, E = u, M = d;
                            this.getWorldAnchorA(x), this.getWorldAnchorB(_), x.vsub(o.position, B), _.vsub(f.position, S), 
                            _.vsub(x, v);
                            var C = v.norm();
                            m.copy(v), m.normalize(), f.velocity.vsub(o.velocity, g), f.angularVelocity.cross(S, b), 
                            g.vadd(b, g), o.angularVelocity.cross(B, b), g.vsub(b, g), m.mult(-t * (C - i) - e * g.dot(m), w), 
                            o.force.vsub(w, o.force), f.force.vadd(w, f.force), B.cross(w, E), S.cross(w, M), 
                            o.torque.vsub(E, o.torque), f.torque.vadd(M, f.torque);
                        };
                    }, {
                        "../math/Vec3": 32
                    } ],
                    38: [ function(t, e) {
                        ...
                        function s(t) {
                            ...
                            this.suspensionLength = 0, this.sideImpulse = 0, this.forwardImpulse = 0, this.raycastResult = new n(), 
                            this.worldTransform = new o(), this.isInContact = !1;
                        }
                        e.exports = s;
                        var a = new i(), l = new i();
                    ...
                    39: [ function(t, e) {
                        ...
                        r.prototype = new i(), r.prototype.constructor = r, r.prototype.updateConvexPolyhedronRepresentation = function() {
                            ...
                            var o = t;
                            o.isZero() ? (i.x = 2 / 12 * e, i.y = 2 / 12 * e, i.z = 2 / 12 * e) : (i.x = 1 / 12 * e * (4 * o.y * o.y + 4 * o.z * o.z), 
                            i.y = 1 / 12 * e * (4 * o.x * o.x + 4 * o.z * o.z), i.z = 1 / 12 * e * (4 * o.y * o.y + 4 * o.x * o.x));
                            ...
                            i[4].set(0, -o.y, 0), i[5].set(0, 0, -o.z), void 0 !== e) for (var n = 0; n !== i.length; n++) {
                                e.vmult(i[n], i[n]);
                            }
                            return i;
                        ...
                        r.prototype.calculateWorldAABB = function(t, e, i, o) {
                            ...
                            for (var s = 1; s < 8; s++) {
                                ...
                                l > o.x && (o.x = l), h > o.y && (o.y = h), c > o.z && (o.z = c), l < i.x && (i.x = l), 
                                h < i.y && (i.y = h), c < i.z && (i.z = c);
                            }
                        };
                    }, {
                        "../math/Vec3": 32,
                    ...
                    40: [ function(t, e) {
                        ...
                        r.prototype.computeEdges = function() {
                            ...
                            for (var t = 0; t < this.faces.length; t++) {
                                ...
                                if (i.dot(n) < 0) for (console.error(".faceNormals[" + t + "] = Vec3(" + i.toString() + ") looks like it points into the shape? The vertices follow. Make sure they are ordered CCW around the normal, using the right hand rule."), 
                        ...
                        r.prototype.clipAgainstHull = function(t, e, i, n, r, s, a, l, c) {
                            ...
                            for (var v = [], m = i.faces[u], g = m.length, w = 0; w < g; w++) {
                                var b = i.vertices[m[w]], x = new o();
                                x.copy(b), r.vmult(x, x), n.vadd(x, x), v.push(x);
                            }
                        ...
                        r.prototype.findSeparatingAxis = function(t, e, i, o, n, r, s, a) {
                            var l = c, h = p, v = u, m = d, g = y, w = f, b = Number.MAX_VALUE;
                            ...
                            for (var M = 0; M !== this.uniqueEdges.length; M++) {
                                ...
                                for (var C = 0; C !== t.uniqueEdges.length; C++) {
                                    if (n.vmult(t.uniqueEdges[C], g), m.cross(g, w), !w.almostZero()) {
                                        w.normalize();
                                        var A = this.testSepAxis(w, t, e, i, o, n);
                                        if (!1 === A) return !1;
                                        A < b && (b = A, r.copy(w));
                                    }
                                }
                        ...
                        var g = new o(), w = new o();
                        r.prototype.calculateLocalInertia = function(t, e) {
                            this.computeLocalAABB(g, w);
                            var i = w.x - g.x, o = w.y - g.y, n = w.z - g.z;
                            e.x = 1 / 12 * t * (4 * o * o + 4 * n * n), e.y = 1 / 12 * t * (4 * i * i + 4 * n * n), 
                        ...
                        var b = new o(), x = new o(), _ = new o(), B = new o(), S = new o(), E = new o(), M = new o(), C = new o();
                        r.prototype.clipFaceAgainstHull = function(t, e, i, o, n, r, s) {
                            ...
                            if (!(m < 0)) {
                                ...
                                f.length;
                                for (var R = z.length, P = 0; P < R; P++) {
                                    var q = this.vertices[z[P]], I = this.vertices[z[(P + 1) % R]];
                                    q.vsub(I, l), h.copy(l), i.vmult(h, h), e.vadd(h, h), c.copy(this.faceNormals[m]), 
                                    i.vmult(c, c), e.vadd(c, c), h.cross(c, p), p.negate(p), u.copy(q), i.vmult(u, u), 
                                    e.vadd(u, u), u.dot(p);
                                    var V = z.connectedFaces[P];
                                    d.copy(this.faceNormals[V]);
                                    var O = this.getPlaneConstantOfFace(V);
                                    y.copy(d), i.vmult(y, y);
                                    var k = O - y.dot(e);
                                    for (this.clipFaceAgainstPlane(f, v, y, k); f.length; ) {
                                        f.shift();
                                    }
                                    for (;v.length; ) {
                                        f.push(v.shift());
                                ...
                                for (d.copy(this.faceNormals[m]), O = this.getPlaneConstantOfFace(m), y.copy(d), 
                                i.vmult(y, y), k = O - y.dot(e), F = 0; F < f.length; F++) {
                                    var N = y.dot(f[F]) + k;
                                    if (N <= n && (N = n), N <= r) {
                                        var j = f[F];
                                        if (N <= 0) {
                        ...
                        r.prototype.calculateWorldAABB = function(t, e, i, o) {
                            for (var n, r, s, a, l, h, c = this.vertices.length, p = this.vertices, u = 0; u < c; u++) {
                                ...
                                (d.y < r || void 0 === r) && (r = d.y), (d.y > l || void 0 === l) && (l = d.y), 
                        ...
                        r.project = function(t, e, i, o, r) {
                            var s = t.vertices.length, a = R, l = 0, h = 0, c = P, p = t.vertices;
                        ...
                        function r(t, e, r, s, a) {
                            if (a) {
                                for (var l = s, h = n.cos, c = n.sin, p = r / 2, u = [], d = [], y = [ 0 ], f = [ 1 ], v = [], m = 2 * Math.PI / l, g = 0; g < l; g++) {
                                    u.push(new i(t * h(m * g), p, t * c(m * g))), u.push(new i(t * h(m * g), -p, t * c(m * g))), 
                                    g < l - 1 ? (d.push([ 2 * g + 2, 2 * g + 3, 2 * g + 1, 2 * g ]), y.push(2 * g + 2), 
                                    f.push(2 * g + 3)) : d.push([ 0, 1, 2 * g + 1, 2 * g ]), (l % 2 == 1 || g < l / 2) && v.push(new i(h(m * (g + .5)), 0, c(m * (g + .5))));
                                }
                                d.push(f);
                                var w = [];
                            ...
                            l = s;
                            var b = [], x = (v = [], []), _ = [], B = [];
                            for (h = n.cos, c = n.sin, b.push(new i(e * h(0), e * c(0), .5 * -r)), _.push(0), 
                            b.push(new i(t * h(0), t * c(0), .5 * r)), B.push(1), g = 0; g < l; g++) {
                                m = 2 * Math.PI / l * (g + 1);
                                var S = 2 * Math.PI / l * (g + .5);
                                g < l - 1 ? (b.push(new i(e * h(m), e * c(m), .5 * -r)), _.push(2 * g + 2), b.push(new i(t * h(m), t * c(m), .5 * r)), 
                                B.push(2 * g + 3), x.push([ 2 * g + 2, 2 * g + 3, 2 * g + 1, 2 * g ])) : x.push([ 0, 1, 2 * g + 1, 2 * g ]), 
                    ...
                    42: [ function(t, e) {
                        ...
                        function s(t, e) {
                            ...
                            }), this.pillarConvex = new o(), this.pillarOffset = new n(), this.updateBoundingSphereRadius(), 
                            this._cachedPillars = {};
                        }
                        e.exports = s, s.prototype = new i(), s.prototype.update = function() {
                            ...
                            this.data[t][e] = i, this.clearCachedConvexTrianglePillar(t, e, !1), t > 0 && (this.clearCachedConvexTrianglePillar(t - 1, e, !0), 
                            ...
                            return i[0] = s, i[1] = a, o && (s < 0 && (s = 0), a < 0 && (a = 0), s >= r.length - 1 && (s = r.length - 1), 
                        ...
                        s.prototype.getTriangleAt = function(t, e, i, o, n, r) {
                            ...
                            var p = this.elementSize, u = Math.pow(t / p - l, 2) + Math.pow(e / p - h, 2) > Math.pow(t / p - (l + 1), 2) + Math.pow(e / p - (h + 1), 2);
                        ...
                        s.prototype.getNormalAt = function(t, e, i, o) {
                            ...
                            this.getTriangleAt(t, e, i, n, r, s), r.vsub(n, a), s.vsub(n, l), a.cross(l, o), 
                            o.normalize();
                            ...
                            i ? (o.set((t + 1) * a, (e + 1) * a, s[t + 1][e + 1]), n.set(t * a, (e + 1) * a, s[t][e + 1]), 
                            r.set((t + 1) * a, e * a, s[t + 1][e])) : (o.set(t * a, e * a, s[t][e]), n.set((t + 1) * a, e * a, s[t + 1][e]), 
                            r.set(t * a, (e + 1) * a, s[t][e + 1]));
                        }, s.prototype.getConvexTrianglePillar = function(t, e, i) {
                            var r = this.pillarConvex, s = this.pillarOffset;
                            if (this.cacheEnabled) {
                                if (a = this.getCachedConvexTrianglePillar(t, e, i)) return this.pillarConvex = a.convex, 
                            ...
                            i ? (s.set((t + .75) * l, (e + .75) * l, u), p[0].set(.25 * l, .25 * l, a[t + 1][e + 1] - u), 
                            ...
                            h[4][1] = 5, h[4][2] = 2, h[4][3] = 1), r.computeNormals(), r.computeEdges(), r.updateBoundingSphereRadius(), 
                    ...
                    44: [ function(t, e) {
                        ...
                        function n() {
                            i.call(this, {
                                type: i.types.PLANE
                            }), this.worldNormal = new o(), this.worldNormalNeedsUpdate = !0, this.boundingSphereRadius = Number.MAX_VALUE;
                        }
                    ...
                    45: [ function(t, e) {
                        ...
                        t("../math/Vec3"), t("../math/Quaternion"), t("../material/Material"), o.prototype = new i(), 
                    ...
                    47: [ function(t, e) {
                        ...
                        function l(t, e) {
                            ...
                            this.aabb = new r(), this.edges = null, this.scale = new o(1, 1, 1), this.tree = new s(), 
                        ...
                        l.prototype.updateTree = function() {
                            ...
                            for (var i = new r(), n = new o(), s = new o(), a = new o(), l = [ n, s, a ], h = 0; h < this.indices.length / 3; h++) {
                                var c = 3 * h;
                                this._getUnscaledVertex(this.indices[c], n), this._getUnscaledVertex(this.indices[c + 1], s), 
                                this._getUnscaledVertex(this.indices[c + 2], a), i.setFromPoints(l), t.insert(i, h);
                            }
                            t.removeEmptyNodes();
                        };
                        var c = new r();
                        l.prototype.getTrianglesInAABB = function(t, e) {
                            ...
                            for (var t = h, e = this.normals, i = 0; i < this.indices.length / 3; i++) {
                                ...
                                this.getVertex(n, f), this.getVertex(r, v), this.getVertex(s, m), l.computeNormal(v, f, m, t), 
                                e[o] = t.x, e[o + 1] = t.y, e[o + 2] = t.z;
                            }
                        ...
                        l.prototype.computeLocalAABB = function(t) {
                            ...
                            for (var r = 0; r !== o; r++) {
                                this.getVertex(r, n), n.x < e.x ? e.x = n.x : n.x > i.x && (i.x = n.x), n.y < e.y ? e.y = n.y : n.y > i.y && (i.y = n.y), 
                        ...
                        l.prototype.calculateWorldAABB = function(t, e, i, o) {
                            var n = b, r = x;
                            n.position = t, n.quaternion = e, this.aabb.toWorldFrame(n, r), i.copy(r.lowerBound), 
                            o.copy(r.upperBound);
                            ...
                            for (var r = [], s = [], h = 0; h <= i; h++) {
                                for (var c = 0; c <= o; c++) {
                                    var p = c / o * n, u = h / i * Math.PI * 2, d = (t + e * a.cos(u)) * a.cos(p), y = (t + e * a.cos(u)) * a.sin(p), f = e * a.sin(u);
                                    r.push(d, y, f);
                                }
                            }
                            for (h = 1; h <= i; h++) {
                                for (c = 1; c <= o; c++) {
                                    var v = (o + 1) * h + c - 1, m = (o + 1) * (h - 1) + c - 1, g = (o + 1) * (h - 1) + c, w = (o + 1) * h + c;
                                    s.push(v, m, w), s.push(m, g, w);
                                }
                            }
                            return new l(r, s);
                        };
                    ...
                    48: [ function(t, e) {
                        ...
                        o.prototype.solve = function(t, e) {
                            ...
                            if (0 !== y) for (var g = 0; g !== v; g++) {
                                f[g].updateSolveMassProperties();
                            }
                            var w = r, b = s, x = n;
                            for (w.length = y, b.length = y, x.length = y, g = 0; g !== y; g++) {
                                var _ = d[g];
                            ...
                            if (0 !== y) {
                                ...
                                for (c = 0; c !== p; c++) {
                                    l = 0;
                                    for (var E = 0; E !== y; E++) {
                                        _ = d[E], i = b[E], o = w[E], (h = x[E]) + (a = o * (i - _.computeGWlambda() - _.eps * h)) < _.minForce ? a = _.minForce - h : h + a > _.maxForce && (a = _.maxForce - h), 
                                        x[E] += a, l += a > 0 ? a : -a, _.addToWlambda(a);
                                    }
                                    if (l * l < u) break;
                                }
                                for (g = 0; g !== v; g++) {
                                    var M, C = (M = f[g]).velocity, A = M.angularVelocity;
                                    M.vlambda.vmul(M.linearFactor, M.vlambda), C.vadd(M.vlambda, C), M.wlambda.vmul(M.angularFactor, M.wlambda), 
                                    A.vadd(M.wlambda, A);
                                }
                    ...
                    50: [ function(t, e) {
                        ...
                        function n(t) {
                            ...
                            this.nodes = [], this.nodePool = []; this.nodePool.length < 128; ) {
                        ...
                        n.prototype.createNode = function() {
                            ...
                            for (var g = 0; g !== c; g++) {
                                var w = l[g], b = (v = n.indexOf(w.bi), n.indexOf(w.bj)), x = i[v], _ = i[b];
                    ...
                    57: [ function(t, e) {
                        ...
                        u.prototype.createContactEquation = function(t, e, i, o, n, r) {
                            ...
                            l > 0) {
                                ...
                                return f.bi = v.bi = i, f.bj = v.bj = o, f.minForce = v.minForce = -u * d, f.maxForce = v.maxForce = u * d, 
                                f.ri.copy(t.ri), f.rj.copy(t.rj), v.ri.copy(t.ri), v.rj.copy(t.rj), t.ni.tangents(f.t, v.t), 
                                ...
                                f.enabled = v.enabled = t.enabled, e.push(f, v), !0;
                            }
                            return !1;
                        };
                        ...
                        u.prototype.createFrictionFromAverage = function(t) {
                            ...
                            if (this.createFrictionEquationsFromContact(e, this.frictionResult) && 1 !== t) {
                                ...
                                for (var n = e.bi, r = (e.bj, 0); r !== t; r++) {
                                    (e = this.result[this.result.length - 1 - r]).bodyA !== n ? (d.vadd(e.ni, d), y.vadd(e.ri, y), 
                                    f.vadd(e.rj, f)) : (d.vsub(e.ni, d), y.vadd(e.rj, y), f.vadd(e.ri, f));
                                }
                                var s = 1 / t;
                                y.scale(s, i.ri), f.scale(s, i.rj), o.ri.copy(i.ri), o.rj.copy(i.rj), d.normalize(), 
                                d.tangents(i.t, o.t);
                            }
                        };
                        var v = new s(), m = new s(), g = new l(), w = new l();
                        u.prototype.getContacts = function(t, e, i, n, r, s, a) {
                            ...
                            for (var l = g, h = w, c = v, p = m, u = 0, d = t.length; u !== d; u++) {
                                var y = t[u], f = e[u], b = null;
                                y.material && f.material && (b = i.getContactMaterial(y.material, f.material) || null);
                                for (var x = 0 == y.collisionResponse || 0 == f.collisionResponse || y.type & o.KINEMATIC && f.type & o.STATIC || y.type & o.STATIC && f.type & o.KINEMATIC || y.type & o.KINEMATIC && f.type & o.KINEMATIC, _ = 0; _ < y.shapes.length; _++) {
                                    y.quaternion.mult(y.shapeOrientations[_], l), y.quaternion.vmult(y.shapeOffsets[_], c), 
                                    c.vadd(y.position, c);
                                    for (var B = y.shapes[_], S = 0; S < f.shapes.length; S++) {
                                        f.quaternion.mult(f.shapeOrientations[S], h), f.quaternion.vmult(f.shapeOffsets[S], p), 
                                        p.vadd(f.position, p);
                                        var E = f.shapes[S];
                                        if (B.collisionFilterMask & E.collisionFilterGroup && E.collisionFilterMask & B.collisionFilterGroup && !(c.distanceTo(p) > B.boundingSphereRadius + E.boundingSphereRadius)) {
                                            ...
                                            this.currentContactMaterial = M || b || i.defaultContactMaterial;
                            ...
                            p.rj.mult(-e.radius, p.rj), p.ri.vadd(i, p.ri), p.ri.vsub(s.position, p.ri), p.rj.vadd(o, p.rj), 
                            p.rj.vsub(a.position, p.rj), this.result.push(p), this.createFrictionEquationsFromContact(p, this.frictionResult);
                        };
                        var b = new s(), x = new s(), _ = new s();
                        u.prototype[n.types.PLANE | n.types.TRIMESH] = u.prototype.planeTrimesh = function(t, e, i, o, n, r, l, h, c, p, u) {
                            ...
                            for (var f = 0; f < e.vertices.length / 3; f++) {
                                ...
                                if (d.vsub(i, m), y.dot(m) <= 0) {
                                    ...
                                    g.ni.copy(y);
                                    var w = _;
                                    y.scale(m.dot(y), w), d.vsub(w, w), g.ri.copy(w), g.ri.vsub(l.position, g.ri), g.rj.copy(d), 
                                    g.rj.vsub(h.position, g.rj), this.result.push(g), this.createFrictionEquationsFromContact(g, this.frictionResult);
                                }
                            }
                        };
                        var B = new s(), S = new s(), E = (new s(), new s()), M = new s(), C = new s(), A = new s(), z = new s(), F = new s(), T = new s(), R = new s(), P = new s(), q = new s(), I = new s(), V = new i(), O = [];
                        u.prototype[n.types.SPHERE | n.types.TRIMESH] = u.prototype.sphereTrimesh = function(t, e, i, o, n, s, l, h, c, p, u) {
                            var d = C, y = A, f = z, v = F, m = T, g = R, w = V, b = M, x = S, _ = O;
                            a.pointToLocalFrame(o, s, i, m);
                            var k = t.radius;
                            w.lowerBound.set(m.x - k, m.y - k, m.z - k), w.upperBound.set(m.x + k, m.y + k, m.z + k), 
                            e.getTrianglesInAABB(w, _);
                            for (var N = E, j = t.radius * t.radius, L = 0; L < _.length; L++) {
                                for (var W = 0; W < 3; W++) {
                                    if (e.getVertex(e.indices[3 * _[L] + W], N), N.vsub(m, x), x.norm2() <= j) {
                                        if (b.copy(N), a.pointToWorldFrame(o, s, b, N), N.vsub(i, x), u) return !0;
                                        (G = this.createContactEquation(l, h, t, e, c, p)).ni.copy(x), G.ni.normalize(), 
                                        G.ri.copy(G.ni), G.ri.scale(t.radius, G.ri), G.ri.vadd(i, G.ri), G.ri.vsub(l.position, G.ri), 
                                        G.rj.copy(N), G.rj.vsub(h.position, G.rj), this.result.push(G), this.createFrictionEquationsFromContact(G, this.frictionResult);
                                    }
                                }
                            }
                            for (L = 0; L < _.length; L++) {
                                for (W = 0; W < 3; W++) {
                                    e.getVertex(e.indices[3 * _[L] + W], d), e.getVertex(e.indices[3 * _[L] + (W + 1) % 3], y), 
                                    y.vsub(d, f), m.vsub(y, g);
                                    var D = g.dot(f);
                                    m.vsub(d, g);
                                    var U = g.dot(f);
                                    if (U > 0 && D < 0 && (m.vsub(d, g), v.copy(f), v.normalize(), U = g.dot(v), v.scale(U, g), 
                                    g.vadd(d, g), (Z = g.distanceTo(m)) < t.radius)) {
                                        if (u) return !0;
                                        var G = this.createContactEquation(l, h, t, e, c, p);
                                        g.vsub(m, G.ni), G.ni.normalize(), G.ni.scale(t.radius, G.ri), a.pointToWorldFrame(o, s, g, g), 
                                        g.vsub(h.position, G.rj), a.vectorToWorldFrame(s, G.ni, G.ni), a.vectorToWorldFrame(s, G.ri, G.ri), 
                                        this.result.push(G), this.createFrictionEquationsFromContact(G, this.frictionResult);
                                    }
                                }
                            }
                            for (var H = P, K = q, Q = I, X = B, Y = (L = 0, _.length); L !== Y; L++) {
                                ...
                                if (X.scale(Z, g), m.vsub(g, g), Z = g.distanceTo(m), r.pointInTriangle(g, H, K, Q) && Z < t.radius) {
                                    if (u) return !0;
                                    G = this.createContactEquation(l, h, t, e, c, p), g.vsub(m, G.ni), G.ni.normalize(), 
                                    G.ni.scale(t.radius, G.ri), a.pointToWorldFrame(o, s, g, g), g.vsub(h.position, G.rj), 
                                    a.vectorToWorldFrame(s, G.ni, G.ni), a.vectorToWorldFrame(s, G.ri, G.ri), this.result.push(G), 
                                    this.createFrictionEquationsFromContact(G, this.frictionResult);
                                }
                            }
                            _.length = 0;
                        };
                        var k = new s(), N = new s(), j = new s(), L = new s(), W = new s();
                        u.prototype[n.types.SPHERE | n.types.PLANE] = u.prototype.spherePlane = function(t, e, i, o, n, r, s, a, l, h, c) {
                            if (j.set(0, 0, 1), r.vmult(j, j), j.negate(j), j.normalize(), j.mult(t.radius, L), 
                            i.vsub(o, k), j.mult(j.dot(k), N), k.vsub(N, W), -k.dot(j) <= t.radius) {
                                if (c) return !0;
                                var p = this.createContactEquation(s, a, t, e, l, h);
                                p.ni.copy(j), p.ri.copy(L), p.rj.copy(W);
                                var u = p.ri, d = p.rj;
                                u.vadd(i, u), u.vsub(s.position, u), d.vadd(o, d), d.vsub(a.position, d), this.result.push(p), 
                        ...
                        u.prototype[n.types.SPHERE | n.types.BOX] = u.prototype.sphereBox = function(t, e, i, o, n, r, s, a, l, h, c) {
                            ...
                            for (var d = t.radius, y = !1, f = $, v = tt, m = et, g = null, w = 0, b = 0, x = 0, _ = null, B = 0, S = u.length; B !== S && !1 === y; B++) {
                                var E = Q;
                                E.copy(u[B]);
                                var M = E.norm();
                                E.normalize();
                                ...
                                if (C < M + d && C > 0) {
                                    ...
                                    var F = A.norm(), T = z.norm();
                                    A.normalize(), z.normalize();
                                    var R = K.dot(A), P = K.dot(z);
                                    if (R < F && R > -F && P < T && P > -T) {
                                        var q = Math.abs(C - M - d);
                                        if ((null === _ || q < _) && (_ = q, b = R, x = P, g = M, f.copy(E), v.copy(A), 
                                        m.copy(z), w++, c)) return !0;
                                    }
                                }
                            }
                            if (w) {
                                ...
                                f.mult(-d, I.ri), I.ni.copy(f), I.ni.negate(I.ni), f.mult(g, f), v.mult(b, v), f.vadd(v, f), 
                                m.mult(x, m), f.vadd(m, I.rj), I.ri.vadd(i, I.ri), I.ri.vsub(s.position, I.ri), 
                            ...
                            for (var V = p.get(), O = J, k = 0; 2 !== k && !y; k++) {
                                for (var N = 0; 2 !== N && !y; N++) {
                                    for (var j = 0; 2 !== j && !y; j++) {
                                        if (V.set(0, 0, 0), k ? V.vadd(u[0], V) : V.vsub(u[0], V), N ? V.vadd(u[1], V) : V.vsub(u[1], V), 
                                        j ? V.vadd(u[2], V) : V.vsub(u[2], V), o.vadd(V, O), O.vsub(i, O), O.norm2() < d * d) {
                                            if (c) return !0;
                                            y = !0, (I = this.createContactEquation(s, a, t, e, l, h)).ri.copy(O), I.ri.normalize(), 
                                            I.ni.copy(I.ri), I.ri.mult(d, I.ri), I.rj.copy(V), I.ri.vadd(i, I.ri), I.ri.vsub(s.position, I.ri), 
                                            I.rj.vadd(o, I.rj), I.rj.vsub(a.position, I.rj), this.result.push(I), this.createFrictionEquationsFromContact(I, this.frictionResult);
                                        }
                                    }
                                }
                            ...
                            p.release(V), V = null;
                            var L = p.get(), W = p.get(), D = (I = p.get(), p.get()), U = (q = p.get(), u.length);
                            for (k = 0; k !== U && !y; k++) {
                                for (N = 0; N !== U && !y; N++) {
                                    if (k % 3 != N % 3) {
                                        u[N].cross(u[k], L), L.normalize(), u[k].vadd(u[N], W), I.copy(i), I.vsub(W, I), 
                                        I.vsub(o, I);
                                        var G = I.dot(L);
                                        for (L.mult(G, D), j = 0; j === k % 3 || j === N % 3; ) {
                                            j++;
                                        }
                                        ...
                                        if (H < u[j].norm() && it < d) {
                                            ...
                                            W.vadd(D, ot.rj), ot.rj.copy(ot.rj), q.negate(ot.ni), ot.ni.normalize(), ot.ri.copy(ot.rj), 
                                            ot.ri.vadd(o, ot.ri), ot.ri.vsub(i, ot.ri), ot.ri.normalize(), ot.ri.mult(d, ot.ri), 
                                            ot.ri.vadd(i, ot.ri), ot.ri.vsub(s.position, ot.ri), ot.rj.vadd(o, ot.rj), ot.rj.vsub(a.position, ot.rj), 
                                            this.result.push(ot), this.createFrictionEquationsFromContact(ot, this.frictionResult);
                                        }
                                    }
                                }
                            }
                        ...
                        var it = new s(), ot = new s(), nt = new s(), rt = new s(), st = new s(), at = new s(), lt = new s(), ht = new s(), ct = new s(), pt = new s();
                        u.prototype[n.types.SPHERE | n.types.CONVEXPOLYHEDRON] = u.prototype.sphereConvex = function(t, e, i, o, n, r, s, a, l, h, c) {
                            ...
                            for (var u = e.faceNormals, d = e.faces, y = e.vertices, f = t.radius, v = 0; v !== y.length; v++) {
                                ...
                                var w = rt;
                                if (g.vsub(i, w), w.norm2() < f * f) return !!c || (b = !0, (q = this.createContactEquation(s, a, t, e, l, h)).ri.copy(w), 
                                q.ri.normalize(), q.ni.copy(q.ri), q.ri.mult(f, q.ri), g.vsub(o, q.rj), q.ri.vadd(i, q.ri), 
                                q.ri.vsub(s.position, q.ri), q.rj.vadd(o, q.rj), q.rj.vsub(a.position, q.rj), this.result.push(q), 
                            ...
                            for (var b = !1, x = (v = 0, d.length); v !== x && !1 === b; v++) {
                                ...
                                if (i.vsub(E, z), A < 0 && z.dot(S) > 0) {
                                    for (var F = [], T = 0, R = B.length; T !== R; T++) {
                                        var P = p.get();
                                        r.vmult(y[B[T]], P), o.vadd(P, P), F.push(P);
                                    }
                                    if (H(F, S, i)) {
                                        if (c) return !0;
                                        b = !0;
                                        ...
                                        S.mult(-A, I);
                                        var V = p.get();
                                        S.mult(-f, V), i.vsub(o, q.rj), q.rj.vadd(V, q.rj), q.rj.vadd(I, q.rj), q.rj.vadd(o, q.rj), 
                                        q.rj.vsub(a.position, q.rj), q.ri.vadd(i, q.ri), q.ri.vsub(s.position, q.ri), p.release(I), 
                                        p.release(V), this.result.push(q), this.createFrictionEquationsFromContact(q, this.frictionResult), 
                                        T = 0;
                                        for (var O = F.length; T !== O; T++) {
                                            p.release(F[T]);
                                        }
                                        return;
                                    }
                                    for (T = 0; T !== B.length; T++) {
                                        var k = p.get(), N = p.get();
                                        r.vmult(y[B[(T + 1) % B.length]], k), r.vmult(y[B[(T + 2) % B.length]], N), o.vadd(k, k), 
                                        o.vadd(N, N);
                                        var j = ot;
                                        N.vsub(k, j);
                                        var L = nt;
                                        ...
                                        var G = p.get();
                                        if (W.vsub(i, G), U > 0 && U * U < j.norm2() && G.norm2() < f * f) {
                                            if (c) return !0;
                                            for (q = this.createContactEquation(s, a, t, e, l, h), W.vsub(o, q.rj), W.vsub(i, q.ni), 
                                            q.ni.normalize(), q.ni.mult(f, q.ri), q.rj.vadd(o, q.rj), q.rj.vsub(a.position, q.rj), 
                                            q.ri.vadd(i, q.ri), q.ri.vsub(s.position, q.ri), this.result.push(q), this.createFrictionEquationsFromContact(q, this.frictionResult), 
                            ...
                            e.convexPolyhedronRepresentation.id = e.id, this.planeConvex(t, e.convexPolyhedronRepresentation, i, o, n, r, s, a, t, e, c);
                        };
                        ...
                        u.prototype[n.types.PLANE | n.types.CONVEXPOLYHEDRON] = u.prototype.planeConvex = function(t, e, i, o, n, r, s, a, l, h, c) {
                            ...
                            for (var d = 0, y = yt, f = 0; f !== e.vertices.length; f++) {
                                if (p.copy(e.vertices[f]), r.vmult(p, p), o.vadd(p, p), p.vsub(i, y), u.dot(y) <= 0) {
                                    ...
                                    u.mult(u.dot(y), m), p.vsub(m, m), m.vsub(i, v.ri), v.ni.copy(u), p.vsub(o, v.rj), 
                                    v.ri.vadd(i, v.ri), v.ri.vsub(s.position, v.ri), v.rj.vadd(o, v.rj), v.rj.vsub(a.position, v.rj), 
                                    this.result.push(v), d++, this.enableFrictionReduction || this.createFrictionEquationsFromContact(v, this.frictionResult);
                                }
                            }
                        ...
                        u.prototype[n.types.CONVEXPOLYHEDRON] = u.prototype.convexConvex = function(t, e, i, o, n, r, s, a, l, h, c, p, u) {
                            ...
                            if (!(i.distanceTo(o) > t.boundingSphereRadius + e.boundingSphereRadius) && t.findSeparatingAxis(e, i, n, o, r, d, p, u)) {
                                ...
                                for (var v = 0, m = 0; m !== y.length; m++) {
                                    if (c) return !0;
                                    var g = this.createContactEquation(s, a, t, e, l, h), w = g.ri, b = g.rj;
                                    d.negate(g.ni), y[m].normal.negate(f), f.mult(y[m].depth, f), y[m].point.vadd(f, w), 
                                    b.copy(y[m].point), w.vsub(i, w), b.vsub(o, b), w.vadd(i, w), w.vsub(s.position, w), 
                                    b.vadd(o, b), b.vsub(a.position, b), this.result.push(g), v++, this.enableFrictionReduction || this.createFrictionEquationsFromContact(g, this.frictionResult);
                                }
                                this.enableFrictionReduction && v && this.createFrictionFromAverage(v);
                            }
                        };
                        var gt = new s(), wt = new s(), bt = new s();
                        ...
                        u.prototype[n.types.PARTICLE | n.types.CONVEXPOLYHEDRON] = u.prototype.convexParticle = function(t, e, i, o, n, r, s, a, l, h, c) {
                            ...
                            if (f.copy(o), f.vsub(i, f), n.conjugate(_t), _t.vmult(f, f), t.pointIsInside(f)) {
                                ...
                                for (var v = 0, m = t.faces.length; v !== m; v++) {
                                    var g = [ t.worldVertices[t.faces[v][0]] ], w = t.worldFaceNormals[v];
                                    o.vsub(g[0], Et);
                                    var b = -w.dot(Et);
                                ...
                                if (-1 !== p) {
                                    ...
                                    var _ = x.ri, B = x.rj;
                                    _.vadd(o, _), _.vsub(a.position, _), B.vadd(i, B), B.vsub(s.position, B), this.result.push(x), 
                        ...
                        u.prototype[n.types.CONVEXPOLYHEDRON | n.types.HEIGHTFIELD] = u.prototype.convexHeightfield = function(t, e, i, o, n, r, s, l, h, c, p) {
                            ...
                            var g = Math.floor((m.x - y) / d) - 1, w = Math.ceil((m.x + y) / d) + 1, b = Math.floor((m.y - y) / d) - 1, x = Math.ceil((m.y + y) / d) + 1;
                            if (!(w < 0 || x < 0 || g > u.length || b > u[0].length)) {
                                g < 0 && (g = 0), w < 0 && (w = 0), b < 0 && (b = 0), x < 0 && (x = 0), g >= u.length && (g = u.length - 1), 
                                w >= u.length && (w = u.length - 1), x >= u[0].length && (x = u[0].length - 1), 
                                b >= u[0].length && (b = u[0].length - 1);
                                var _ = [];
                                e.getRectMinMax(g, b, w, x, _);
                                var B = _[0], S = _[1];
                                if (!(m.z - y > S || m.z + y < B)) for (var E = g; E < w; E++) {
                                    for (var M = b; M < x; M++) {
                                        var C = !1;
                                        if (e.getConvexTrianglePillar(E, M, !1), a.pointToWorldFrame(o, r, e.pillarOffset, f), 
                                        ...
                                        p && C) return !0;
                                        if (e.getConvexTrianglePillar(E, M, !0), a.pointToWorldFrame(o, r, e.pillarOffset, f), 
                                        i.distanceTo(f) < e.pillarConvex.boundingSphereRadius + t.boundingSphereRadius && (C = this.convexConvex(t, e.pillarConvex, i, f, n, r, s, l, h, c, p, v, null)), 
                                        p && C) return !0;
                                    }
                                }
                        ...
                        var Ft = new s(), Tt = new s();
                        u.prototype[n.types.SPHERE | n.types.HEIGHTFIELD] = u.prototype.sphereHeightfield = function(t, e, i, o, n, r, s, l, h, c, p) {
                            var u = e.data, d = t.radius, y = e.elementSize, f = Tt, v = Ft;
                            a.pointToLocalFrame(o, r, i, v);
                            var m = Math.floor((v.x - d) / y) - 1, g = Math.ceil((v.x + d) / y) + 1, w = Math.floor((v.y - d) / y) - 1, b = Math.ceil((v.y + d) / y) + 1;
                            if (!(g < 0 || b < 0 || m > u.length || w > u[0].length)) {
                                m < 0 && (m = 0), g < 0 && (g = 0), w < 0 && (w = 0), b < 0 && (b = 0), m >= u.length && (m = u.length - 1), 
                                g >= u.length && (g = u.length - 1), b >= u[0].length && (b = u[0].length - 1), 
                                w >= u[0].length && (w = u[0].length - 1);
                                var x = [];
                                e.getRectMinMax(m, w, g, b, x);
                                var _ = x[0], B = x[1];
                                if (!(v.z - d > B || v.z + d < _)) for (var S = this.result, E = m; E < g; E++) {
                                    for (var M = w; M < b; M++) {
                                        var C = S.length, A = !1;
                                        if (e.getConvexTrianglePillar(E, M, !1), a.pointToWorldFrame(o, r, e.pillarOffset, f), 
                    ...
                    58: [ function(t, e) {
                        ...
                        t("../equations/FrictionEquation"), t("./Narrowphase")), s = t("../utils/EventTarget"), a = t("../collision/ArrayCollisionMatrix"), l = t("../collision/ObjectCollisionMatrix"), h = t("../collision/OverlapKeeper"), c = t("../material/Material"), p = t("../material/ContactMaterial"), u = t("../objects/Body"), d = t("../utils/TupleDictionary"), y = t("../collision/RaycastResult"), f = t("../collision/AABB"), v = t("../collision/Ray"), m = t("../collision/NaiveBroadphase");
                        function g(t) {
                            t = t || {}, s.apply(this), this.dt = -1, this.allowSleep = !!t.allowSleep, this.contacts = [], 
                            ...
                            this.time = 0, this.timeFixed = 0, this.stepnumber = 0, this.default_dt = 1 / 60, 
                            this.nextId = 0, this.gravity = new i(), t.gravity && this.gravity.copy(t.gravity), 
                            this.broadphase = void 0 !== t.broadphase ? t.broadphase : new m(), this.bodies = [], 
                            this.solver = void 0 !== t.solver ? t.solver : new n(), this.constraints = [], this.narrowphase = new r(this), 
                            this.collisionMatrix = new a(), this.collisionMatrixPrevious = new a(), this.bodyOverlapKeeper = new h(), 
                            this.shapeOverlapKeeper = new h(), this.materials = [], this.contactmaterials = [], 
                            this.contactMaterialTable = new d(), this.defaultMaterial = new c("default"), this.defaultContactMaterial = new p(this.defaultMaterial, this.defaultMaterial, {
                                ...
                                type: "removeBody",
                                body: null
                            }, this.idToBodyMap = {}, this.broadphase.setWorld(this), this.substeps = 0, this.cm = new l(), 
                            this.tm = new l(), this.triggerDic = new d(), this.oldTriggerDic = new d(), this.contactsDic = new d(), 
                        ...
                        if (g.prototype.getContactMaterial = function(t, e) {
                            ...
                            g.SLEEPING = !1, -1 === this.bodies.indexOf(t) && (t.index = this.bodies.length, 
                            this.bodies.push(t), t.world = this, t.initPosition.copy(t.position), t.initVelocity.copy(t.velocity), 
                            ...
                            this.addBodyEvent.body = t, this.cm.setNumObjects(this.bodies.length), g.idToBodyMap[t.id] = t, 
                            ...
                            if (-1 !== o) {
                                ...
                                this.collisionMatrix.setNumObjects(e), this.removeBodyEvent.body = t, delete g.idToBodyMap[t.id], 
                                this.cm.setNumObjects(e), this.dispatchEvent(this.removeBodyEvent);
                            }
                        ...
                        new i(), g.prototype.step = function(t, e, i) {
                            if (i = i || 10, 0 === (e = e || 0)) this.internalStep(t), this.time += t, this.substeps = 1; else {
                                ...
                                for (var o = this.accumulator % t / t, n = 0; n !== this.bodies.length; n++) {
                                    var r = this.bodies[n];
                                    r.previousPosition.lerp(r.position, o, r.interpolatedPosition), r.previousQuaternion.slerp(r.quaternion, o, r.interpolatedQuaternion), 
                        ...
                        new o(), new o(), new o(), new i(), g.prototype.internalStep = function(t) {
                            this.dt = t;
                            var e, i = this.contacts, o = R, n = P, r = this.numObjects(), s = this.bodies, a = this.solver, l = this.gravity, h = this.doProfiling, c = this.profile, p = u.DYNAMIC, d = this.constraints, y = T, f = (l.norm(), 
                            l.x), v = l.y, m = l.z, w = 0;
                            for (h && (e = performance.now()), w = 0; w !== r; w++) {
                                if ((O = s[w]).useGravity && O.type === p) {
                                    var b = O.force, x = O.mass;
                                    b.x += x * f, b.y += x * v, b.z += x * m;
                                }
                            }
                            w = 0;
                            for (var _ = this.subsystems.length; w !== _; w++) {
                                this.subsystems[w].update();
                            }
                            h && (e = performance.now()), o.length = 0, n.length = 0, this.broadphase.collisionPairs(this, o, n), 
                            ...
                            if (this.frictionEquations.length = 0, this.narrowphase.getContacts(o, n, this, i, E, this.frictionEquations, y), 
                            0 != i.length || !g.SLEEPING) {
                                for (h && (c.narrowphase = performance.now() - e), h && (e = performance.now()), 
                                w = 0; w < this.frictionEquations.length; w++) {
                                    a.addEquation(this.frictionEquations[w]);
                                }
                                for (var I = i.length, V = 0; V !== I; V++) {
                                    var O = (L = i[V]).bi, k = L.bj, N = L.si, j = L.sj;
                                    N.material && j.material ? N.material.restitution >= 0 && j.material.restitution >= 0 && (L.restitution = N.material.restitution * j.material.restitution) : O.material && k.material && O.material.restitution >= 0 && k.material.restitution >= 0 && (L.restitution = O.material.restitution * k.material.restitution), 
                                    a.addEquation(L), O.allowSleep && O.type === u.DYNAMIC && O.sleepState === u.SLEEPING && k.sleepState === u.AWAKE && k.type !== u.STATIC && k.velocity.norm2() + k.angularVelocity.norm2() >= 2 * Math.pow(k.sleepSpeedLimit, 2) && (O._wakeUpAfterNarrowphase = !0), 
                                    k.allowSleep && k.type === u.DYNAMIC && k.sleepState === u.SLEEPING && O.sleepState === u.AWAKE && O.type !== u.STATIC && O.velocity.norm2() + O.angularVelocity.norm2() >= 2 * Math.pow(O.sleepSpeedLimit, 2) && (k._wakeUpAfterNarrowphase = !0), 
                                    this.collisionMatrix.set(O, k, !0), this.collisionMatrixPrevious.get(O, k) || (z.body = k, 
                                    z.contact = L, O.dispatchEvent(z), z.body = O, k.dispatchEvent(z)), this.bodyOverlapKeeper.set(O.id, k.id), 
                                    this.shapeOverlapKeeper.set(N.id, j.id);
                                }
                                for (this.emitContactEvents(), h && (c.makeContactConstraints = performance.now() - e, 
                                ...
                                for (w = 0; w !== r; w++) {
                                    if ((O = s[w]).type & p) {
                                        var G = U(1 - O.linearDamping, t), H = O.velocity;
                                        H.mult(G, H);
                                        var K = O.angularVelocity;
                                        if (K) {
                                            var Q = U(1 - O.angularDamping, t);
                                            K.mult(Q, K);
                                        }
                                    }
                                }
                                ...
                                for (this.clearForces(), this.broadphase.dirty = !0, h && (c.integrate = performance.now() - e), 
                                this.time += t, this.timeFixed += t, this.stepnumber += 1, this.dispatchEvent(C), 
                                w = 0; w !== r; w++) {
                                    var Z = (O = s[w]).postStep;
                                    Z && Z.call(O);
                                }
                                if (this.allowSleep) {
                                    for (w = 0; w !== r; w++) {
                            ...
                            if (r) {
                                for (i = 0, o = _.length; i < o; i += 2) {
                                    s = this.getShapeById(_[i]), a = this.getShapeById(_[i + 1]), M.shapeA = s, M.shapeB = a, 
                                    M.bodyA = s.body, M.bodyB = a.body, this.dispatchEvent(M);
                                }
                            ...
                            if (0 != this.substeps) {
                                for (var t, e, i = this.triggerDic.getLength(); i--; ) {
                                    if (t = this.triggerDic.getKeyByIndex(i), null != (e = this.triggerDic.getDataByKey(t))) {
                                        var o = e.si, n = e.sj;
                                        this.tm.get(o, n) ? q.event = "onTriggerStay" : (this.tm.set(o, n, !0), q.event = "onTriggerEnter"), 
                                        q.selfShape = o, q.otherShape = n, q.selfBody = o.body, q.otherBody = n.body, o.dispatchEvent(q), 
                                        q.selfShape = n, q.otherShape = o, q.selfBody = n.body, q.otherBody = o.body, n.dispatchEvent(q);
                                    }
                                }
                                for (i = this.oldTriggerDic.getLength(); i > 0; ) {
                                    i--, t = this.oldTriggerDic.getKeyByIndex(i), null == this.triggerDic.getDataByKey(t) && null != (e = this.oldTriggerDic.getDataByKey(t)) && (o = e.si, 
                                    n = e.sj, this.tm.set(o, n, !1), this.oldTriggerDic.del(o.id, n.id) && i--, q.event = "onTriggerExit", 
                                    q.selfShape = o, q.otherShape = n, q.selfBody = o.body, q.otherBody = n.body, o.dispatchEvent(q), 
                                    q.selfShape = n, q.otherShape = o, q.selfBody = n.body, q.otherBody = o.body, n.dispatchEvent(q));
                                }
                            ...
                            if (0 != this.substeps) {
                                ...
                                for (o = this.contactsDic.getLength(); o--; ) {
                                    if (t = this.contactsDic.getKeyByIndex(o), null != (e = this.contactsDic.getDataByKey(t))) {
                                        ...
                                        this.cm.get(a, l) ? I.event = "onCollisionStay" : (this.cm.set(a, l, !0), I.event = "onCollisionEnter"), 
                                        I.bi = a, I.contact = e[0], I.contacts = e, I.body = l, I.selfShape = n, I.otherShape = r, 
                                        a.dispatchEvent(I), I.body = a, I.selfShape = r, I.otherShape = n, l.dispatchEvent(I);
                                    }
                                }
                                var h = V;
                                for (o = h.length; o--; ) {
                                ...
                                for (o = this.oldContactsDic.getLength(); o--; ) {
                                    t = this.oldContactsDic.getKeyByIndex(o), null == this.contactsDic.getDataByKey(t) && (n = (e = this.oldContactsDic.getDataByKey(t)).si, 
                                    r = e.sj, a = n.body, l = r.body, this.cm.get(a, l) && (a.isSleeping() && l.isSleeping() || (this.cm.set(a, l, !1), 
                                    I.bi = a, I.contact = e, I.event = "onCollisionExit", I.body = l, I.selfShape = n, 
                                    I.otherShape = r, I.contacts.length = 0, I.contacts.push(e), a.dispatchEvent(I), 
                                    I.body = a, I.selfShape = r, I.otherShape = n, l.dispatchEvent(I))));
                                }
                                this.contactsDic.reset(), this.oldContactsDic.reset(), F = V, V = this.contacts.slice(), 
