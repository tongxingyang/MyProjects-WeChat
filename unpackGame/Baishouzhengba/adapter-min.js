...
!function i(a, c, u) {
    ...
    2: [ function(e, t, n) {
        "use strict";
        var r = window.fsUtils, o = r.getUserDataPath, i = r.readJsonSync, c = r.makeDirSync, a = r.writeFileSync, s = r.copyFile, l = r.downloadFile, u = r.writeFile, f = r.deleteFile, d = r.rmdirSync, p = r.unzip, h = !1, m = null, g = !1, v = [], y = [], b = !1, _ = /the maximum size of the file storage/, w = 0, E = /^https?:\/\/.*/, x = {
            cacheDir: "gamecaches",
    ...
    3: [ function(e, t, n) {
        "use strict";
        var o, i, f = e("../cache-manager"), r = window.fsUtils, d = r.fs, p = r.downloadFile, a = r.readText, c = r.readArrayBuffer, u = r.readJson, h = r.loadSubpackage, m = r.getUserDataPath, g = /^https?:\/\/.*/, s = cc.assetManager.downloader, l = cc.assetManager.parser, v = cc.assetManager.presets, y = __globalAdapter.isSubContext;
        s.maxConcurrency = 8, s.maxRequestsPerFrame = 64, v.scene.maxConcurrency = 10, v.scene.maxRequestsPerFrame = 64;
        var b = {}, _ = {};
        function w(e, t, n) {
            "function" == typeof t && (n = t, t = null), g.test(e) ? n && n(new Error("Can not load remote scripts")) : (__cocos_require__(e), 
            n && n(null));
        }
        function E(e, t, n) {
        ...
        var I = l.parsePVRTex, R = l.parsePKMTex;
        var j = y ? function(e, t, n) {
            n(null, e = F(e, t).url);
        } : C;
        s.downloadDomAudio = E, s.downloadScript = w, l.parsePVRTex = D, l.parsePKMTex = P, 
        s.register({
            ".js": w,
            ".mp3": C,
            ".ogg": C,
            ...
            bundle: function bundle(e, u, s) {
                ...
                })) : (g.test(e) || !y && e.startsWith(m()) ? (l = e, t = "src/scripts/".concat(r, "/index.js"), 
                f.makeBundleFolder(r)) : _[r] ? (l = "".concat(i, "remote/").concat(r), t = "src/scripts/".concat(r, "/index.js"), 
        ...
        var L, F = y ? function(e, t) {
            return g.test(e) || (e = o + "/" + e), {
                url: e
            };
        } : function(e, t) {
            var n, r, o = !1, i = !1;
            return !e.startsWith(m()) && g.test(e) ? t.reload || ((n = f.cachedFiles.get(e)) ? (i = !0, 
    ...
    20: [ function(e, t, n) {
        ...
        var v = "http://www.w3.org/1999/xhtml", i = {}, y = i.ELEMENT_NODE = 1, b = i.ATTRIBUTE_NODE = 2, _ = i.TEXT_NODE = 3, w = i.CDATA_SECTION_NODE = 4, E = i.ENTITY_REFERENCE_NODE = 5, x = (i.ENTITY_NODE = 6, 
        ...
        function Q(e, t, n, r, o) {
            ...
            switch (e.nodeType) {
              ...
              case N:
                var h, m = e.publicId, g = e.systemId;
                return t.push("<!DOCTYPE ", e.name), void (m ? (t.push(' PUBLIC "', m), g && "." != g && t.push('" "', g), 
                t.push('">')) : g && "." != g ? t.push(' SYSTEM "', g, '">') : ((h = e.internalSubset) && t.push(" [", h, "]"), 
                t.push(">")));
        ...
        a.prototype = {
            parse: function parse(e, t, n) {
                ...
                r.startDocument(), h(t, t = {}), function(n, e, r, o, i) {
                    ...
                    for (;;) {
                        try {
                            var m, g, v = n.indexOf("<", h);
                            if (v < 0) return n.substr(h).match(/^\s*$/) || (m = o.doc, g = m.createTextNode(n.substr(h)), 
                            m.appendChild(g), o.currentElement = g);
                            switch (h < v && t(v), n.charAt(v + 1)) {
                              case "/":
                                var y = n.indexOf(">", v + 3), b = n.substring(v + 2, y), _ = d.pop();
                                y < 0 ? (b = n.substring(v + 2).replace(/[\s<].*/, ""), i.error("end tag name: " + b + " is not complete:" + _.tagName), 
                                y = v + 1 + b.length) : b.match(/\s</) && (b = b.replace(/[\s<].*/, ""), i.error("end tag name: " + b + " maybe not complete"), 
                                y = v + 1 + b.length);
    ...
    24: [ function(e, t, n) {
        ...
        var d = 0, p = 1, h = 2, m = 3, g = 4, v = 1, y = {}, o = function() {
            !function(e, t) {
            ...
            function o(e) {
                ...
                }(this, o), (t = r.call(this))._$sn = v++, t.HAVE_NOTHING = d, t.HAVE_METADATA = p, 
                t.HAVE_CURRENT_DATA = h, t.HAVE_FUTURE_DATA = m, t.HAVE_ENOUGH_DATA = g, t.readyState = d;
    ...
    44: [ function(e, t, n) {
        ...
        var y = function() {
            ...
            return e = u, (t = [ {
                ...
                key: "open",
                value: function value(e, t) {
                    d.set(this, e), f.set(this, t), v.call(this, u.OPENED);
                }
            }, {
                ...
                value: function value(e) {
                    ...
                    var n = wx.request({
                        ...
                        success: function success(e) {
                            ...
                            switch (c.status = n, h.set(c, r), g.call(c, "loadstart"), v.call(c, u.HEADERS_RECEIVED), 
                            v.call(c, u.LOADING), c.responseType) {
                              case "json":
                                c.responseText = t;
                                try {
                            ...
                            v.call(c, u.DONE), g.call(c, "load"), g.call(c, "loadend");
                        },
                        fail: function fail(e) {
                            var t = e.errMsg;
                            -1 !== t.indexOf("abort") ? g.call(c, "abort") : -1 !== t.indexOf("timeout") ? g.call(c, "timeout") : g.call(c, "error", t), 
                            g.call(c, "loadend");
                        }
                    });
                    m.set(this, n);
    ...
    51: [ function(e, t, n) {
        ...
        var o = x(e("./Canvas")), i = x(e("./navigator")), a = x(e("./XMLHttpRequest")), c = x(e("./WebSocket")), u = x(e("./Image")), s = x(e("./ImageBitmap")), l = x(e("./Audio")), f = x(e("./FileReader")), d = x(e("./HTMLElement")), p = x(e("./HTMLImageElement")), h = x(e("./HTMLCanvasElement")), m = x(e("./HTMLMediaElement")), g = x(e("./HTMLAudioElement")), v = x(e("./HTMLVideoElement")), y = x(e("./WebGLRenderingContext")), b = e("./EventIniter/index.js"), _ = x(e("./localStorage")), w = x(e("./location")), E = e("./WindowProperties");
        function x(e) {
            return e && e.__esModule ? e : {
                default: e
            };
    ...
    52: [ function(e, t, n) {
        ...
        cc.VideoPlayer.prototype._updateVideoSource = function() {
            ...
            var t, n, r, o, i, a, c, u, s, l, f, d, p, h, m, g;
            ...
            t.getWorldToScreenMatrix2D(b), v.multiply(b, b, y), n = cc.view._scaleX, r = cc.view._scaleY, 
            ...
            p = f.y / o, h = b.m[12] * n - s + d, m = b.m[13] * r - l + p, g = cc.view.getFrameSize().height, 
            this._video.x = h, this._video.y = g - u - m, this._actualWidth = this._video.width = c, 
