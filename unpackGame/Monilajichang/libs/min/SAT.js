var t, o = require("../../@babel/runtime/helpers/typeof");
...
t = function() {
    ...
    function s() {
        this.a = null, this.b = null, this.overlapN = new o(), this.overlapV = new o(), 
        this.clear();
    }
    t.Vector = o, t.V = o, o.prototype.copy = o.prototype.copy = function(t) {
        ...
        return this.x = o * Math.cos(t) - e * Math.sin(t), this.y = o * Math.sin(t) + e * Math.cos(t), 
        this;
        ...
        var t = this.r;
        return new n(this.pos.clone().add(this.offset).sub(new o(t, t)), 2 * t, 2 * t);
        ...
        if (!this.points || this.points.length !== t.length) {
            ...
            for (e = 0; e < t.length; e++) {
                ...
                p === i || p.x !== i.x || p.y !== i.y ? (r.push(new o()), n.push(new o()), s.push(new o())) : (t.splice(e, 1), 
                e -= 1);
            }
        }
        ...
        for (var e = this.points, r = e.length, n = 0; n < r; n++) e[n].x += t, e[n].y += o;
        return this._recalc(), this;
        ...
        for (t = 0; t < i; t++) {
            var h = o[t].copy(n[t]);
            h.x += s.x, h.y += s.y, 0 !== p && h.rotate(p);
        }
        for (t = 0; t < i; t++) {
        ...
        for (var t = this.calcPoints, e = t.length, r = t[0].x, s = t[0].y, p = t[0].x, i = t[0].y, h = 1; h < e; h++) {
            var a = t[h];
            a.x < r ? r = a.x : a.x > p && (p = a.x), a.y < s ? s = a.y : a.y > i && (i = a.y);
        }
        return new n(this.pos.clone().add(new o(r, s)), p - r, i - s);
        ...
        for (var t = this.calcPoints, e = t.length, r = 0, n = 0, s = 0, p = 0; p < e; p++) {
            ...
            r += (i.x + h.x) * a, n += (i.y + h.y) * a, s += a;
        }
        return new o(r /= s *= 3, n /= s);
    }, t.Box = n, n.prototype.toPolygon = n.prototype.toPolygon = function() {
        var t = this.pos, e = this.w, n = this.h;
        return new r(new o(t.x, t.y), [ new o(), new o(e, 0), new o(e, n), new o(0, n) ]);
    }, t.Response = s, s.prototype.clear = s.prototype.clear = function() {
    ...
    function c(t, o, e, r, n, s) {
        ...
        if (y(e, n, i), y(r, n, a), a[0] += c, a[1] += c, i[0] > a[1] || a[0] > i[1]) return p.push(u), 
        h.push(i), h.push(a), !0;
        if (s) {
            var l, f, v = 0;
            i[0] < a[0] ? (s.aInB = !1, i[1] < a[1] ? (v = i[1] - a[0], s.bInA = !1) : v = (l = i[1] - a[0]) < (f = a[1] - i[0]) ? l : -f) : (s.bInA = !1, 
            i[1] > a[1] ? (v = i[0] - a[1], s.aInB = !1) : v = (l = i[1] - a[0]) < (f = a[1] - i[0]) ? l : -f);
            var x = Math.abs(v);
            x < s.overlap && (s.overlap = x, s.overlapN.copy(n), v < 0 && s.overlapN.reverse());
        }
    ...
    function g(t, o, e) {
        for (var r = p.pop().copy(o.pos).add(o.offset).sub(t.pos), n = o.r, s = n * n, i = t.calcPoints, h = i.length, a = p.pop(), u = p.pop(), y = 0; y < h; y++) {
            var c = y === h - 1 ? 0 : y + 1, v = 0 === y ? h - 1 : y - 1, g = 0, A = null;
            a.copy(t.edges[y]), u.copy(r).sub(i[y]), e && u.len2() > s && (e.aInB = !1);
            var d = l(a, u);
            if (d === f) {
                a.copy(t.edges[v]);
                var b = p.pop().copy(r).sub(i[v]);
                if ((d = l(a, b)) === x) {
                    if ((w = u.len()) > n) return p.push(r), p.push(a), p.push(u), p.push(b), !1;
                    e && (e.bInA = !1, A = u.normalize(), g = n - w);
                }
                p.push(b);
            } else if (d === x) {
                if (a.copy(t.edges[c]), u.copy(r).sub(i[c]), (d = l(a, u)) === f) {
                    if ((w = u.len()) > n) return p.push(r), p.push(a), p.push(u), !1;
                    e && (e.bInA = !1, A = u.normalize(), g = n - w);
                }
            } else {
                var B = a.perp().normalize(), w = u.dot(B), P = Math.abs(w);
                if (w > 0 && P > n) return p.push(r), p.push(B), p.push(u), !1;
                e && (A = B, g = n - w, (w >= 0 || g < 2 * n) && (e.bInA = !1));
            }
            A && e && Math.abs(g) < Math.abs(e.overlap) && (e.overlap = g, e.overlapN.copy(A));
        }
        return e && (e.a = t, e.b = o, e.overlapV.copy(e.overlapN).scale(e.overlap)), p.push(r), 
        p.push(a), p.push(u), !0;
    }
    function A(t, o, e) {
    ...
    return t.pointInCircle = function(t, o) {
        ...
        if (i > s) return p.push(r), !1;
        if (e) {
            var h = Math.sqrt(i);
            e.a = t, e.b = o, e.overlap = n - h, e.overlapN.copy(r.normalize()), e.overlapV.copy(r).scale(e.overlap), 
            e.aInB = t.r <= o.r && h <= o.r - t.r, e.bInA = o.r <= t.r && h <= t.r - o.r;
        }
        return p.push(r), !0;
        ...
        if (r && e) {
            var n = e.a, s = e.aInB;
            e.overlapN.reverse(), e.overlapV.reverse(), e.a = e.b, e.b = n, e.aInB = e.bInA, 
            e.bInA = s;
        }
        return r;
    }, t.testPolygonPolygon = A, t;
}, "function" == typeof define && define.amd ? define(t) : "object" === ("undefined" == typeof exports ? "undefined" : o(exports)) ? module.exports = t() : (void 0).SAT = t();