...
!function(e) {
    ...
    GameGlobal.__isAdapterInjected || (GameGlobal.__isAdapterInjected = !0, function() {
        ...
        i.sharedCanvas && (sharedCanvas.__proto__.__proto__ = new a.default("canvas"), sharedCanvas.addEventListener = r.addEventListener, 
        ...
        if ("undefined" == typeof __devtoolssubcontext && "devtools" === e) {
            ...
            for (var o in r.document) {
                var u = Object.getOwnPropertyDescriptor(i.document, o);
                u && !0 !== u.configurable || Object.defineProperty(i.document, o, {
                    value: r.document[o]
                });
            }
    ...
    var a = b(n(9)), i = n(17), u = b(n(10)), l = b(n(18)), c = b(n(19)), s = b(n(20)), f = b(n(11)), d = b(n(12)), p = b(n(21)), h = b(n(4)), y = b(n(22)), v = b(n(23));
    function b(e) {
        return e && e.__esModule ? e : {
            default: e
        };
    }
    t.document = u.default, t.navigator = l.default, t.XMLHttpRequest = c.default, t.WebSocket = s.default, 
    ...
    function u(t, n) {
        ...
        return !n || "object" != (0, e.default)(n) && "function" != typeof n ? t : n;
    }
    function l(t, n) {
    ...
    }(), i = (r = o(5)) && r.__esModule ? r : {
        default: r
    }, u = o(8), l = o(2), c = function(t) {
        function n() {
            ...
            }, o.insertBefore = u.noop, o.innerHTML = "", o.tagName = t.toUpperCase(), o;
        }
        return function(t, n) {
            if ("function" != typeof n && null !== n) throw new TypeError("Super expression must either be null or a function, not " + (0, 
            e.default)(n));
    ...
    var c = new WeakMap(), s = new WeakMap(), f = (new WeakMap(), new WeakMap(), function(t) {
        function n(e) {
            !function(e, t) {
                if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function");
            }(this, n);
            ...
            t.HAVE_ENOUGH_DATA = 4, t.readyState = 0, (0, u.isSubContext)()) return console.warn("HTMLAudioElement is not supported in SubContext."), 
            l(t);
            s.set(t, "");
            var o = wx.createInnerAudioContext();
            return c.set(t, o), o.onCanplay(function() {
                t.dispatchEvent({
                    type: "load"
                }), t.dispatchEvent({
                    type: "loadend"
        ...
        return function(t, n) {
            ...
            key: "play",
            value: function() {
                (0, u.isSubContext)() || c.get(this).play();
            }
        }, {
            key: "pause",
            value: function() {
                (0, u.isSubContext)() || c.get(this).pause();
            }
        }, {
            key: "canPlayType",
            value: function() {
            ...
            value: function() {
                var e = new n();
                return (0, u.isSubContext)() || (e.loop = c.get(this).loop, e.autoplay = c.get(this).loop, 
                e.src = this.src), e;
            }
        }, {
            key: "currentTime",
            get: function() {
                return (0, u.isSubContext)() ? 0 : c.get(this).currentTime;
            },
            set: function(e) {
                (0, u.isSubContext)() || c.get(this).seek(e);
            }
        }, {
            key: "src",
            get: function() {
            ...
            set: function(e) {
                s.set(this, e), (0, u.isSubContext)() || (c.get(this).src = e);
            }
        }, {
            key: "loop",
            get: function() {
                return !(0, u.isSubContext)() && c.get(this).loop;
            },
            set: function(e) {
                (0, u.isSubContext)() || (c.get(this).loop = e);
            }
        }, {
            key: "autoplay",
            get: function() {
                return !(0, u.isSubContext)() && c.get(this).autoplay;
            },
            set: function(e) {
                (0, u.isSubContext)() || (c.get(this).autoplay = e);
            }
        }, {
            key: "paused",
            get: function() {
                return !(0, u.isSubContext)() && c.get(this).paused;
            }
        } ]), n;
    }());
    n.default = f;
    ...
    var o, r = function(e) {
        ...
        if (null != e) for (var n in e) Object.prototype.hasOwnProperty.call(e, n) && (t[n] = e[n]);
        return t.default = e, t;
    }(n(1)), a = (o = n(10)) && o.__esModule ? o : {
        default: o
    }, i = n(8), u = function e(t) {
        !function(e, t) {
            if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function");
        }(this, e), this.target = r.canvas, this.currentTarget = r.canvas, this.touches = [], 
        this.targetTouches = [], this.changedTouches = [], this.preventDefault = i.noop, 
        this.stopPropagation = i.noop, this.type = t;
    };
    function l(e) {
        return function(t) {
            var n = new u(e);
    ...
    }(), o = new WeakMap(), r = new WeakMap(), a = new WeakMap(), i = new WeakMap(), u = new WeakMap();
    function l(e) {
    ...
    var s = function() {
        ...
        return n(e, [ {
            ...
            key: "open",
            value: function(t, n) {
                r.set(this, t), o.set(this, n), c.call(this, e.OPENED);
            }
        }, {
            ...
            value: function() {
                ...
                wx.request({
                    ...
                    success: function(n) {
                        ...
                        if (t.status = r, i.set(t, a), l.call(t, "loadstart"), c.call(t, e.HEADERS_RECEIVED), 
                        c.call(t, e.LOADING), t.response = o, o instanceof ArrayBuffer) {
                            t.responseText = "";
                            for (var u = new Uint8Array(o), s = u.byteLength, f = 0; f < s; f++) t.responseText += String.fromCharCode(u[f]);
                        } else t.responseText = o;
                        c.call(t, e.DONE), l.call(t, "load"), l.call(t, "loadend");
                    },
                    fail: function(e) {
                        var n = e.errMsg;
                        -1 !== n.indexOf("abort") ? l.call(t, "abort") : l.call(t, "error", n), l.call(t, "loadend");
                    }
                });
            }
        }, {
    ...
    }(), r = n(8), a = new WeakMap(), i = function() {
        function e(t) {
