    ...
    class h extends e.Graphics {
        ...
        _createDrawTexture(t, s = 0, i = 0, h = 0, a = 0, r = null, l = 1, n = null, o = null, _) {
            ...
            if (h || (h = t.sourceWidth), a || (a = t.sourceHeight), t.getIsReady()) {
                var c = h / t.sourceWidth, d = a / t.sourceHeight;
            ...
            e.DrawTextureCmd.create.call(this, t, s, i, h, a, r, l, n, o, _);
        }
        changeSource() {
            this._isChanged = !1;
            var t = this._source;
            if (t && t.bitmap) {
                var s = this.width, i = this.height, h = this._sizeGrid, a = t.sourceWidth, r = t.sourceHeight;
                if (!h || a === s && r === i) {
    ...
    class y extends c {
        ...
        onScrollBarChange(t = null) {
            ...
            this.renderItems(this._createdLine * s, 0), this._createdLine += r); else {
                ...
                let t = !0;
                var l = 0;
                a > this._startIndex ? (r = a - this._startIndex, l = this._startIndex + s * (i + 1), 
                this._isMoved = !0) : a < this._startIndex && (r = this._startIndex - a, t = !1, 
