window.wxMiniGame = function(e, t) {
    ...
    class i {
        static isLocalNativeFile(e) {
            for (var t = 0, i = r.nativefiles.length; t < i; t++) if (-1 != e.indexOf(r.nativefiles[t])) return !0;
            return !1;
        }
        static isNetFile(e) {
            return (-1 != e.indexOf("http://") || -1 != e.indexOf("https://")) && -1 == e.indexOf(r.window.wx.env.USER_DATA_PATH);
        }
        static getFileInfo(e) {
            var t = e, a = i.fakeObj[t];
            return null == a ? null : a;
        }
        static read(e, a = "utf8", n = null, s = "", o = !1, l = "") {
            var r;
            r = "" == s || -1 == s.indexOf("http://") && -1 == s.indexOf("https://") ? e : i.getFileNativePath(e), 
            r = t.URL.getAdptedFilePath(r), i.fs.readFile({
                filePath: r,
                encoding: a,
                success: function(e) {
                ...
                fail: function(e) {
                    e && "" != s ? i.downFiles(s, a, n, s, o, l) : null != n && n.runWith([ 1 ]);
                }
            });
        }
        static isFile(e) {
        ...
        static downFiles(e, t = "utf8", a = null, n = "", s = !1, o = "", l = !0) {
            i.down({
                url: e,
                success: function(r) {
                    200 === r.statusCode ? i.readFile(r.tempFilePath, t, a, n, s, o, l) : 403 === r.statusCode ? null != a && a.runWith([ 0, e ]) : null != a && a.runWith([ 1, r ]);
                },
                fail: function(e) {
        ...
        static readFile(e, a = "utf8", n = null, s = "", o = !1, l = "", d = !0) {
            e = t.URL.getAdptedFilePath(e), i.fs.readFile({
                filePath: e,
                encoding: a,
                success: function(t) {
                    (-1 != s.indexOf("http://") || -1 != s.indexOf("https://")) && (r.AutoCacheDownFile || o) ? (null != n && n.runWith([ 0, t ]), 
        ...
        static downOtherFiles(e, t = null, a = "", n = !1, s = !0) {
            i.down({
                url: e,
                success: function(e) {
                    200 === e.statusCode ? (r.autoCacheFile || n) && -1 == a.indexOf("qlogo.cn") && -1 == a.indexOf(".php") ? (null != t && t.runWith([ 0, e.tempFilePath ]), 
        ...
        static downLoadFile(e, a = "", n = null, s = "utf8") {
        ...
        static copyTOCache(e, a, n, s = "", o = !0) {
            var l = e.split("/"), d = l[l.length - 1], u = a, c = i.getFileInfo(a), h = i.getFileNativePath(d);
            i.fakeObj[u] = {
                md5: d,
                readyUrl: a,
                size: 0,
            ...
            var f = r.sizeLimit, p = i.getCacheUseSize();
            c ? c.readyUrl != a ? i.fs.getFileInfo({
                filePath: e,
                success: function(t) {
                    o && p + 4194304 + t.size >= f && (t.size > r.minClearSize && (r.minClearSize = t.size), 
        ...
        static onClearCacheRes() {
            ...
            for (var n = 0, s = 1, o = t.length; s < o; s++) {
                var l = t[s];
                if (n >= e) break;
                n += l.size, i.deleteFile("", l.readyUrl);
            }
        }
        ...
        static deleteFile(e, t = "", a = null, n = "", s = 0) {
            var o = i.getFileInfo(t), l = i.getFileNativePath(o.md5);
            i.fs.unlink({
                filePath: l,
                success: function(o) {
                    if ("" != e) {
                        var l = i.getFileNativePath(e);
                        i.fs.copyFile({
                            srcPath: e,
                            destPath: l,
                            success: function(o) {
        ...
        static onSaveFile(e, a, n = !0, s = "", o = null, l = 0) {
            var r = e;
            if (null == i.filesListObj.fileUsedSize && (i.filesListObj.fileUsedSize = 0), n) {
                ...
                i.filesListObj[r] = {
                    ...
                    encoding: s,
                    tempFilePath: d
                }, i.filesListObj.fileUsedSize = parseInt(i.filesListObj.fileUsedSize) + l, i.writeFilesList(r, JSON.stringify(i.filesListObj), !0), 
                null != o && o.runWith([ 0 ]);
            } else if (i.filesListObj[r]) {
                var u = parseInt(i.filesListObj[r].size);
                i.filesListObj.fileUsedSize = parseInt(i.filesListObj.fileUsedSize) - u, i.fakeObj[r].md5 == i.filesListObj[r].md5 && delete i.fakeObj[r], 
                delete i.filesListObj[r], i.writeFilesList(r, JSON.stringify(i.filesListObj), !1), 
                null != o && o.runWith([ 0 ]);
            }
        }
        static writeFilesList(e, t, a) {
            ...
            i.fs.writeFile({
                ...
                success: function(e) {},
                fail: function(e) {}
            }), !r.isZiYu && r.isPosMsgYu && r.window.wx.postMessage({
                url: e,
        ...
        static setNativeFileDir(e) {
            i.fileNativeDir = r.window.wx.env.USER_DATA_PATH + e;
        }
    }
    ...
    class a extends t.SoundChannel {
        constructor(e) {
            super(), this._sound = e, this._audio = e._sound, this._onCanplay = this.onCanPlay.bind(this), 
            this._onError = this.onError.bind(this), this._onEnd = this.__onEnd.bind(this), 
        ...
        stop() {
            super.stop(), this.isStopped = !0, t.SoundManager.removeChannel(this), this.completeHandler = null, 
            this._audio && (this._audio.stop(), this.loop || (this.offEventListener(), this._sound.dispose(), 
            this._sound = null, this._audio = null));
        }
        pause() {
    ...
    class n extends t.EventDispatcher {
        ...
        static _createSound() {
            return n._id++, r.window.wx.createInnerAudioContext();
        }
        load(e) {
            ...
            if (this.url = e, this.readyUrl = e, r.autoCacheFile && i.getFileInfo(e)) this.onDownLoadCallBack(e, 0); else if (r.autoCacheFile) if (i.isLocalNativeFile(e)) {
                if (r.subNativeFiles && 0 == r.subNativeheads.length) for (var n in r.subNativeFiles) {
                    var s = r.subNativeFiles[n];
                    r.subNativeheads = r.subNativeheads.concat(s);
                    for (let e = 0; e < s.length; e++) r.subMaps[s[e]] = n + "/" + s[e];
                }
                if (r.subNativeFiles && -1 != e.indexOf("/")) {
                    var o = e.split("/")[0] + "/";
                    if (o && -1 != r.subNativeheads.indexOf(o)) {
                        var l = r.subMaps[o];
                        e = e.replace(o, l);
                    }
                }
                this.onDownLoadCallBack(e, 0);
            } else i.isNetFile(e) ? i.downOtherFiles(e, t.Handler.create(this, this.onDownLoadCallBack, [ e ]), e) : this.onDownLoadCallBack(e, 0); else this.onDownLoadCallBack(e, 0);
        }
        onDownLoadCallBack(e, a, n = null) {
            var s;
            if (!a && this._sound) if (r.autoCacheFile) {
                if (n) s = n; else if (i.isLocalNativeFile(e)) {
                    var o = "" != t.URL.rootPath ? t.URL.rootPath : t.URL._basePath, l = e;
                    "" == o || -1 == e.indexOf("http://") && -1 == e.indexOf("https://") || (s = e.split(o)[1]), 
                    s || (s = l);
                } else {
                    var d = i.getFileInfo(e);
                    s = d && d.md5 ? d.tempFilePath || i.getFileNativePath(d.md5) : e;
                }
                this._sound.src = this.readyUrl = s;
            } else this._sound.src = this.readyUrl = e; else this.event(t.Event.ERROR);
        }
        play(e = 0, i = 0) {
            if (!this.url) return null;
            var n = new a(this);
            return n.url = this.url, n.loops = i, n.loop = 0 === i, n.startTime = e, n.isStopped = !1, 
            t.SoundManager.addChannel(n), n;
        }
        get duration() {
    ...
    class s {
        ...
        static _createInputElement() {
            ...
            t.Laya.stage.on("resize", null, s._onStageResize), r.window.wx.onWindowResize && r.window.wx.onWindowResize(function(e) {}), 
            t.SoundManager._soundClass = n, t.SoundManager._musicClass = n;
            var e = r.systemInfo.model, i = r.systemInfo.system;
        ...
        static wxinputFocus(e) {
            ...
            i && !i.editable || (r.window.wx.offKeyboardConfirm(), r.window.wx.offKeyboardInput(), 
            r.window.wx.showKeyboard({
                defaultValue: i.text,
                ...
                success: function(e) {},
                fail: function(e) {}
            }), r.window.wx.onKeyboardConfirm(function(e) {
                var a = e ? e.value : "";
            ...
            }), r.window.wx.onKeyboardInput(function(e) {
                var a = e ? e.value : "";
        ...
        static hideKeyboard() {
            r.window.wx.offKeyboardConfirm(), r.window.wx.offKeyboardInput(), r.window.wx.hideKeyboard({
                success: function(e) {
                    console.log("隐藏键盘");
                },
                fail: function(e) {
    ...
    class o extends t.EventDispatcher {
        constructor() {
            super();
        }
        _loadResourceFilter(e, a) {
            ...
            if (r.subNativeFiles && 0 == r.subNativeheads.length) for (var l in r.subNativeFiles) {
                var d = r.subNativeFiles[l];
                r.subNativeheads = r.subNativeheads.concat(d);
                for (var u = 0; u < d.length; u++) r.subMaps[d[u]] = l + "/" + d[u];
            }
            if (r.subNativeFiles && -1 != a.indexOf("/")) {
                var c = a.split("/")[0] + "/";
                if (c && -1 != r.subNativeheads.indexOf(c)) {
                    var h = r.subMaps[c];
                    a = a.replace(c, h);
                }
            }
        ...
        static onDownLoadCallBack(e, a, n, s = null) {
            if (n) a.event(t.Event.ERROR, "Load sound failed"); else {
                var o;
                if (r.autoCacheFile) if (s) o = s; else if (i.isLocalNativeFile(e)) o = e; else {
                    var l = i.getFileInfo(e);
                    o = l && l.md5 ? l.tempFilePath || i.getFileNativePath(l.md5) : e;
        ...
        _loadHttpRequestWhat(e, a) {
            var n = r.getUrlEncode(e, a);
            if (t.Loader.preLoadedMap[e]) this.onLoaded(t.Loader.preLoadedMap[e]); else {
                var s = t.URL.formatURL(e);
                if (r.AutoCacheDownFile) if (i.isLocalNativeFile(e) || i.getFileInfo(s)) {
                    var l = e, d = i.getFileInfo(s);
                    d && d.md5 && (l = d.tempFilePath || i.getFileNativePath(d.md5)), i.readFile(l, n, new t.Handler(o, o.onReadNativeCallBack, [ e, a, this ]), e);
                } else i.isNetFile(s) ? i.downFiles(s, n, new t.Handler(o, o.onReadNativeCallBack, [ e, a, this ]), s, !0) : i.readFile(e, n, new t.Handler(o, o.onReadNativeCallBack, [ e, a, this ]), e); else i.isNetFile(s) ? this._loadHttpRequest(s, a, this, this.onLoaded, this, this.onProgress, this, this.onError) : i.readFile(e, n, new t.Handler(o, o.onReadNativeCallBack, [ e, a, this ]), e);
            }
        }
        static onReadNativeCallBack(e, i = null, a = null, n = 0, s = null) {
            var o;
            n ? 1 == n && a._loadHttpRequest(e, i, a, a.onLoaded, a, a.onProgress, a, a.onError) : (o = i == t.Loader.JSON || i == t.Loader.ATLAS || i == t.Loader.PREFAB || i == t.Loader.PLF ? r.getJson(s.data) : i == t.Loader.XML ? t.Utils.parseXMLFromString(s.data) : s.data, 
            !r.isZiYu && r.isPosMsgYu && i != t.Loader.BUFFER && r.window.wx.postMessage({
                url: e,
                data: o,
                isLoad: "filedata"
            }), a.onLoaded(o));
        ...
        static _transformImgUrl(e, a, n) {
            if (r.isZiYu || i.isLocalNativeFile(e)) n._loadImage(e, !1); else if (r.autoCacheFile) {
                var s = t.URL.formatURL(e);
        ...
        static onCreateImage(e, a, n = !1, s = "") {
            var o;
            if (r.autoCacheFile) if (n) if (r.isZiYu) {
                var l = t.URL.formatURL(e);
                o = i.ziyuFileTextureData[l] ? i.ziyuFileTextureData[l] : e;
            } else o = e; else if ("" != s) o = s; else {
                var d = i.getFileInfo(t.URL.formatURL(e));
                o = d.tempFilePath || i.getFileNativePath(d.md5);
            } else o = n ? e : s;
            a._loadImage(o, !1);
        }
    }
    class l {
        ...
        static getItem(e) {
            return r.window.wx.getStorageSync(e);
        }
        static setJSON(e, t) {
            l.setItem(e, t);
        }
        ...
        static removeItem(e) {
            r.window.wx.removeStorageSync(e);
        }
        static clear() {
            r.window.wx.clearStorageSync();
        }
        static getStorageInfoSync() {
            try {
                var e = r.window.wx.getStorageInfoSync();
    ...
    class r {
        ...
        static enable() {
            r.init(t.Laya.isWXPosMsg, t.Laya.isWXOpenDataContext);
        }
        static init(e = !1, a = !1) {
            r._inited || (r._inited = !0, r.window = window, r.window.hasOwnProperty("wx") && (r.window.navigator.userAgent.indexOf("MiniGame") < 0 || (r.isZiYu = a, 
            r.isPosMsgYu = e, r.EnvConfig = {}, r.isZiYu || (i.setNativeFileDir("/layaairGame"), 
            i.getCacheList(i.fileNativeDir, t.Handler.create(r, r.onMkdirCallBack))), r.systemInfo = r.window.wx.getSystemInfoSync(), 
            r.window.focus = function() {}, t.Laya._getUrlPath = function() {
                return "";
            }, r.window.logtime = function(e) {}, r.window.alertTimeLog = function(e) {}, r.window.resetShareInfo = function() {}, 
            r.window.CanvasRenderingContext2D = function() {}, r.window.CanvasRenderingContext2D.prototype = r.window.wx.createCanvas().getContext("2d").__proto__, 
            r.window.document.body.appendChild = function() {}, r.EnvConfig.pixelRatioInt = 0, 
            t.Browser._pixelRatio = r.pixelRatio(), r._preCreateElement = t.Browser.createElement, 
            t.Browser.createElement = r.createElement, t.RunDriver.createShaderCondition = r.createShaderCondition, 
            t.Utils.parseXMLFromString = r.parseXMLFromString, t.Input._createInputElement = s._createInputElement, 
            ...
            t.Loader.prototype._loadHttpRequestWhat = o.prototype._loadHttpRequestWhat, t.LocalStorage._baseClass = l, 
            l.__init__(), r.window.wx.onMessage && r.window.wx.onMessage(r._onMessage))));
        }
        static _onMessage(e) {
            switch (e.type) {
              case "changeMatrix":
        ...
        static exitMiniProgram() {
            r.window.wx.exitMiniProgram();
        }
        static onMkdirCallBack(e, t) {
            e ? (i.fakeObj = {}, i.filesListObj = {}) : (i.filesListObj = JSON.parse(t.data), 
            i.fakeObj = JSON.parse(t.data));
            let a = i.fs.readdirSync(i.fileNativeDir);
            if (a.length) {
                var n, s, o = {};
                for (let e in i.filesListObj) "fileUsedSize" != e && (o[(n = i.filesListObj[e]).md5] = n.readyUrl);
                for (let e = 0, t = a.length; e < t; e++) if ((s = a[e]) != i.fileListName) {
                    if (!o[s]) {
                        let e = i.getFileNativePath(s);
                        i.fs.unlink({
                            filePath: e,
                            success: function(e) {
                ...
                for (let e in o) delete i.filesListObj[o[e]], delete i.fakeObj[o[e]], console.log("删除错误记录：", o[e]);
            }
        }
        static pixelRatio() {
            if (!r.EnvConfig.pixelRatioInt) try {
                return r.EnvConfig.pixelRatioInt = r.systemInfo.pixelRatio, r.systemInfo.pixelRatio;
            } catch (e) {}
            return r.EnvConfig.pixelRatioInt;
        }
        static createElement(e) {
            var t;
            if ("canvas" == e) return 1 == r.idx ? r.isZiYu ? (t = r.window.sharedCanvas).style = {} : t = r.window.canvas : t = r.window.wx.createCanvas(), 
            r.idx++, t;
            if ("textarea" == e || "input" == e) return r.onCreateInput(e);
            if ("div" == e) {
                var i = r._preCreateElement(e);
                return i.contains = function(e) {
                    return null;
                }, i.removeChild = function(e) {}, i;
            }
            return r._preCreateElement(e);
        }
        static onCreateInput(e) {
            var t = r._preCreateElement(e);
        ...
        static sendAtlasToOpenDataContext(e) {
            if (!r.isZiYu) {
                ...
                i.meta.image.split(",");
                if (i.meta && i.meta.image) for (var a = i.meta.image.split(","), n = e.indexOf("/") >= 0 ? "/" : "\\", s = e.lastIndexOf(n), o = s >= 0 ? e.substr(0, s + 1) : "", l = 0, d = a.length; l < d; l++) a[l] = o + a[l]; else a = [ e.replace(".json", ".png") ];
                for (l = 0; l < a.length; l++) {
                    var u = a[l];
                    r.postInfoToContext(t.Laya.URL.formatURL(e), t.Laya.URL.formatURL(u), i);
                }
            }
        }
        static postInfoToContext(e, a, n) {
            var s = {
                frames: n.frames,
                meta: n.meta
            }, o = a, l = i.getFileInfo(t.URL.formatURL(a));
            if (l) var d = l.tempFilePath || i.getFileNativePath(l.md5); else d = o;
            if (!d) throw "获取图集的磁盘url路径不存在！";
            r.window.wx.postMessage({
                url: e,
                atlasdata: s,
                imgNativeUrl: d,
                imgReadyUrl: o,
        ...
        static sendSinglePicToOpenDataContext(e) {
            ...
            if (n) {
                var s = n.tempFilePath || i.getFileNativePath(n.md5);
                e = a;
            } else s = e;
            if (!s) throw "获取图集的磁盘url路径不存在！";
            e = t.Laya.URL.formatURL(e), r.window.wx.postMessage({
                url: e,
                imgNativeUrl: s,
                imgReadyUrl: e,
    ...
    r._inited = !1, r.autoCacheFile = !0, r.minClearSize = 5242880, r.sizeLimit = 209715200, 
    r.nativefiles = [ "layaNativeDir", "wxlocal" ], r.subNativeFiles = [], r.subNativeheads = [], 
    r.subMaps = [], r.AutoCacheDownFile = !1, r.parseXMLFromString = function(e) {
        var t;
        e = e.replace(/>\s+</g, "><");
        try {
            t = new r.window.Parser.DOMParser().parseFromString(e, "text/xml");
        } catch (e) {
            e = VM2_INTERNAL_STATE_DO_NOT_USE_OR_PROGRAM_WILL_FAIL.handleException(e);
            throw "需要引入xml解析库文件";
        }
    ...
    class d extends t.EventDispatcher {
        ...
        static startListen(e) {
            if (d._callBack = e, !d._isListening) {
                d._isListening = !0;
                try {
                    r.window.wx.onAccelerometerChange(d.onAccelerometerChange);
                } catch (e) {}
            }
        }
        static stopListen() {
    ...
    class u {
        constructor() {}
        static __init__() {
            r.window.navigator.geolocation.getCurrentPosition = u.getCurrentPosition, r.window.navigator.geolocation.watchPosition = u.watchPosition, 
            r.window.navigator.geolocation.clearWatch = u.clearWatch;
        }
        static getCurrentPosition(e = null, t = null, i = null) {
            var a;
            (a = {}).success = function(t) {
                null != e && e(t);
            }, a.fail = t, r.window.wx.getLocation(a);
        }
        ...
        static _hasWatch() {
            var e;
            for (e in u._watchDic) if (u._watchDic[e]) return !0;
            return !1;
        }
        static _myLoop() {
    ...
    e.MiniAccelerator = d, e.MiniAdpter = r, e.MiniFileMgr = i, e.MiniInput = s, e.MiniLoader = o, 
    e.MiniLocalStorage = l, e.MiniLocation = u, e.MiniSound = n, e.MiniSoundChannel = a, 
    e.MiniVideo = class {
        constructor(e = 320, t = 240) {
            this.videoend = !1, this.videourl = "", this.videoElement = r.window.wx.createVideo({
                width: e,
                height: t,
                autoplay: !0
            });
