    ...
    var Ve = /* */ function(_Me3) {
        ...
        _createClass2(Ve, [ {
            ...
            value: function showUI() {
                ...
                this.showTime = 60*5, this.clickRandNum = G_Utils.random(5, 10), 
                this.showBannerTime = 60*10, 
                this.showNum1 = parseInt(5), this.showNum2 = parseInt(5), this.showNum3 = parseFloat(7), 
                this.showNum4 = parseFloat(8), this.showNum5 = parseFloat(9);
            }
        }, {
            key: "hideUI",
            value: function hideUI() {
    ...
    var dt = /* */ function(_Laya$Scene2) {
        ...
        _createClass2(dt, [ {
            ...
            value: function _openGameScene(e) {
                ...
                G_PlayerInfo._playerInfo = this._generateNewPlayerInfo("",""),
                1 && this._isLoaded && 1 && G_Scheduler.schedule("delay_open_game_scene", function() {
