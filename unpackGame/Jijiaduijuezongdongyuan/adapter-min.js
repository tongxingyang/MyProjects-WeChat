...
!function r(o, i, a) {
    ...
    2: [ function(e, t, n) {
        "use strict";
        var r = window.fsUtils, o = r.getUserDataPath, i = r.readJsonSync, c = r.makeDirSync, a = r.writeFileSync, s = r.copyFile, l = r.downloadFile, u = r.writeFile, f = r.deleteFile, d = r.rmdirSync, p = r.unzip, h = r.isOutOfStorage, m = !1, g = null, y = !1, v = [], b = [], w = !1, _ = 0, E = /^https?:\/\/.*/, r = {
            cacheDir: "gamecaches",
            ...
            writeCacheFile: function writeCacheFile(e) {
                g ? e && b.push(e) : (g = setTimeout(this._write.bind(this), this.writeFileInterval), 
                !0 === y ? e && v.push(e) : e && b.push(e));
            },
    ...
    3: [ function(e, t, n) {
        "use strict";
        var r, u, s = e("../cache-manager"), o = window.fsUtils, l = o.fs, f = o.downloadFile, i = o.readText, a = o.readArrayBuffer, c = o.readJson, d = o.loadSubpackage, p = o.getUserDataPath, h = /^https?:\/\/.*/, m = cc.assetManager.downloader, g = cc.assetManager.parser, y = cc.assetManager.presets, v = __globalAdapter.isSubContext;
        m.maxConcurrency = 8, m.maxRequestsPerFrame = 64, y.scene.maxConcurrency = 10, y.scene.maxRequestsPerFrame = 64;
        var b = {}, w = {};
        function _(e, t, n) {
            "function" == typeof t && (n = t, t = null), h.test(e) ? n && n(new Error("Can not load remote scripts")) : (__cocos_require__(e), 
            n && n(null));
        }
        function E(e, t, n) {
        ...
        function x(r, t, o, e, i) {
            var n = R(r, o);
            n.inLocal ? t(n.url, o, i) : n.inCache ? (s.updateLastTime(r), t(n.url, o, function(e, t) {
                e && s.removeCache(r), i(e, t);
            })) : f(r, null, o.header, e, function(e, n) {
                e ? i(e, null) : t(n, o, function(e, t) {
                    e || (s.tempFiles.add(r, n), s.cacheFile(r, n, o.cacheEnabled, o.__cacheBundleRoot__, !0)), 
                    i(e, t);
                });
            });
        }
        ...
        var O = v ? function(e, t, n) {
            e = (e = R(e, t).url).slice(r.length + 1);
        ...
        var D = g.parsePVRTex, e = function e(_e2, n, r) {
            a(_e2, function(e, t) {
                return e ? r(e) : void D(t, n, r);
            });
        }, P = g.parsePKMTex, o = function o(e, n, r) {
            a(e, function(e, t) {
                return e ? r(e) : void P(t, n, r);
            });
        };
        y = v ? function(e, t, n) {
            n(null, e = R(e, t).url);
        } : A;
        m.downloadDomAudio = E, m.downloadScript = _, g.parsePVRTex = e, g.parsePKMTex = o, 
        m.register({
            ".js": _,
            ".mp3": A,
            ".ogg": A,
            ...
            bundle: function bundle(e, t, a) {
                var n, c, r, o = cc.path.basename(e), i = t.version || cc.assetManager.downloader.bundleVers[o];
                b[o] ? (r = "subpackages/".concat(o, "/config.").concat(i ? i + "." : "", "json"), 
                d(o, t.onFileProgress, function(e) {
                    e ? a(e, null) : O(r, t, function(e, t) {
                        t && (t.base = "subpackages/".concat(o, "/")), a(e, t);
                    });
                })) : (h.test(e) || !v && e.startsWith(p()) ? (c = e, n = "src/scripts/".concat(o, "/index.js"), 
                s.makeBundleFolder(o)) : w[o] ? (c = "".concat(u, "remote/").concat(o), n = "src/scripts/".concat(o, "/index.js"), 
                s.makeBundleFolder(o)) : (c = "assets/".concat(o), n = "assets/".concat(o, "/index.js")), 
                __cocos_require__(n), t.__cacheBundleRoot__ = o, r = "".concat(c, "/config.").concat(i ? i + "." : "", "json"), 
                O(r, t, function(e, n) {
                    var r, o, i;
                    e ? a && a(e) : n.isZip ? (e = n.zipVersion, e = "".concat(c, "/res.").concat(e ? e + "." : "", "zip"), 
                    r = e, o = t, i = function i(e, t) {
                        e ? a && a(e) : (n.base = t + "/res/", (e = cc.sys).platform === e.ALIPAY_GAME && e.os === e.OS_ANDROID && (t = t + "res/", 
                        l.accessSync({
                            path: t
                        }) && (n.base = t)), a && a(null, n));
                    }, (e = s.cachedFiles.get(r)) ? (s.updateLastTime(r), i && i(null, e.url)) : h.test(r) ? f(r, null, o.header, o.onFileProgress, function(e, t) {
                        e ? i && i(e) : s.unzipAndCacheBundle(r, t, o.__cacheBundleRoot__, i);
                    }) : s.unzipAndCacheBundle(r, r, o.__cacheBundleRoot__, i)) : (n.base = c + "/", 
                    a && a(null, n));
                }));
            },
        ...
        var I, R = v ? function(e, t) {
            return {
                url: e = !h.test(e) ? r + "/" + e : e
            };
        } : function(e, t) {
            var n = !1, r = !1;
            return !e.startsWith(p()) && h.test(e) ? t.reload || ((t = s.cachedFiles.get(e)) ? (r = !0, 
            e = t.url) : (t = s.tempFiles.get(e)) && (n = !0, e = t)) : n = !0, {
                url: e,
                inLocal: n,
                inCache: r
            };
        };
        v ? (I = cc.assetManager.init, cc.assetManager.init = function(e) {
            I.call(cc.assetManager, e), r = e.subContextRoot || "";
        ...
        }), I = cc.assetManager.init, cc.assetManager.init = function(e) {
            I.call(cc.assetManager, e), e.subpackages && e.subpackages.forEach(function(e) {
                return b[e] = "subpackages/" + e;
            }), e.remoteBundles && e.remoteBundles.forEach(function(e) {
                return w[e] = !0;
            }), (u = e.server || "") && !u.endsWith("/") && (u += "/"), s.init();
        });
    }, {
        "../cache-manager": 2
    } ],
    ...
    9: [ function(e, t, n) {
        "use strict";
        var r = cc.internal.inputManager, i = {
            left: 0,
            top: 0,
            ...
            registerSystemEvent: function registerSystemEvent(e) {
                if (!this._isRegisterEvent) {
                    ...
                    for (n in o) {
                        !function() {
                            var t = o[n];
                            __globalAdapter[n](function(e) {
                                e.changedTouches && t.call(r, r.getTouchesByEvent(e, i));
                            });
                        }();
                    }
    ...
    12: [ function(e, t, n) {
        ...
        t.exports = function(e, t) {
            ...
            r = /[\d\.]+/.exec(n = "android p" === n ? "android p 9.0" : n), e.osVersion = r ? r[0] : n, 
            e.osMainVersion = parseInt(e.osVersion), e.browserType = null, e.browserVersion = null, 
            r = t.windowWidth, n = t.windowHeight, t = t.pixelRatio || 1, e.windowPixelResolution = {
                width: t * r,
                height: t * n
            }, e.localStorage = window.localStorage;
            var n = !__globalAdapter.isSubContext, o = !1;
            try {
    ...
    13: [ function(e, t, n) {
        ...
        t.exports = function(e) {
            e._setupContainer = function(e, t, n) {
                ...
                __globalAdapter.isSubContext || (t *= r, n *= r, (r = cc.game.canvas).width === t && r.height === n || (r.width = t, 
                r.height = n));
            };
        };
    }, {} ],
    ...
    20: [ function(e, t, n) {
        ...
        var i, m = "http://www.w3.org/1999/xhtml", a = {}, g = a.ELEMENT_NODE = 1, y = a.ATTRIBUTE_NODE = 2, v = a.TEXT_NODE = 3, b = a.CDATA_SECTION_NODE = 4, w = a.ENTITY_REFERENCE_NODE = 5, _ = (a.ENTITY_NODE = 6, 
        a.PROCESSING_INSTRUCTION_NODE = 7), E = a.COMMENT_NODE = 8, x = a.DOCUMENT_NODE = 9, S = a.DOCUMENT_TYPE_NODE = 10, T = a.DOCUMENT_FRAGMENT_NODE = 11, c = (a.NOTATION_NODE = 12, 
        {}), u = {};
        ...
        function f(e) {
            ...
            if (e._inc != t) {
                ...
                for (n in ee(e, "length", r.length), r) {
                    e[n] = r[n];
                }
                e._inc = t;
            }
        ...
        function O(e, t, n, r) {
            r ? t[N(t, r)] = n : t[t.length++] = n, !e || (t = (n.ownerElement = e).ownerDocument) && (r && R(t, e, r), 
        ...
        function F(e, t, n) {
            ...
            return j(e.ownerDocument || e, e), t.nodeType == T && (t.firstChild = t.lastChild = null), 
            t;
        }
        function k() {
            this._nsMap = {};
            ...
            switch (e.nodeType) {
              case g:
                ...
                for (var l, f, d, p, s = 0; s < a; s++) {
                    Q(l = i.item(s), 0, o) && (f = l.prefix || "", d = l.namespaceURI, p = f ? " xmlns:" + f : " xmlns", 
                    t.push(p, '="', d, '"'), o.push({
                        prefix: f,
                        namespace: d
                    })), Z(l, t, n, r, o);
                }
                if (Q(e, 0, o) && (f = e.prefix || "", d = e.namespaceURI, p = f ? " xmlns:" + f : " xmlns", 
                t.push(p, '="', d, '"'), o.push({
                    prefix: f,
                    namespace: d
                })), c || n && !/^(?:meta|link|img|br|hr|input)$/i.test(u)) {
                    if (t.push(">"), n && /^script$/i.test(u)) for (;c; ) {
                        c.data ? t.push(c.data) : Z(c, t, n, r, o), c = c.nextSibling;
                    } else for (;c; ) {
                        Z(c, t, n, r, o), c = c.nextSibling;
                    }
                    t.push("</", u, ">");
                } else t.push("/>");
                return;
              ...
              case S:
                ...
                return t.push("<!DOCTYPE ", e.name), void (h ? (t.push(' PUBLIC "', h), u && "." != u && t.push('" "', u), 
        ...
        s.prototype = Error.prototype, r(c, s), p.prototype = {
            ...
            setNamedItem: function setNamedItem(e) {
                ...
                return O(this._ownerElement, this, e, t), t;
            },
            setNamedItemNS: function setNamedItemNS(e) {
                var t = e.ownerElement;
                if (t && t != this._ownerElement) throw new s(10);
                return t = this.getNamedItemNS(e.namespaceURI, e.localName), O(this._ownerElement, this, e, t), 
                t;
            },
        ...
        }, r(a, A), r(a, A.prototype), I.prototype = {
            nodeName: "#document",
            nodeType: x,
            doctype: null,
            ...
            _inc: 1,
            insertBefore: function insertBefore(e, t) {
                if (e.nodeType != T) return null == this.documentElement && e.nodeType == g && (this.documentElement = e), 
                F(this, e, t), e.ownerDocument = this, e;
        ...
        }, o(I, A), I.prototype.getElementsByTagName = (k.prototype = {
            nodeType: g,
            ...
            appendChild: function appendChild(e) {
                return e.nodeType === T ? this.insertBefore(e, null) : function(e, t) {
                    ...
                    e.lastChild = t, j(e.ownerDocument, e, t), t;
                }(this, e);
            },
        ...
        }).getElementsByTagName, I.prototype.getElementsByTagNameNS = k.prototype.getElementsByTagNameNS, 
        o(k, A), H.prototype.nodeType = y, o(H, A), B.prototype = {
            data: "",
            ...
            nodeType: b
        }, o(V, B), K.prototype.nodeType = S, o(K, A), G.prototype.nodeType = 12, o(G, A), 
        z.prototype.nodeType = 6, o(z, A), q.prototype.nodeType = w, o(q, A), $.prototype.nodeName = "#document-fragment", 
        $.prototype.nodeType = T, o($, A), X.prototype.nodeType = _, o(X, A), Y.prototype.serializeToString = function(e, t, n) {
            return J.call(e, t, n);
        }, A.prototype.toString = J;
        try {
        ...
        n.DOMImplementation = C, n.XMLSerializer = Y;
    }, {} ],
    21: [ function(e, t, n) {
        "use strict";
        n.entityMap = {
    ...
    22: [ function(e, t, n) {
        "use strict";
        var r = /[A-Z_a-z\xC0-\xD6\xD8-\xF6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD]/, o = new RegExp("[\\-\\.0-9" + r.source.slice(1, -1) + "\\u00B7\\u0300-\\u036F\\u203F-\\u2040]"), i = new RegExp("^" + r.source + o.source + "*(?::" + r.source + o.source + "*)?$"), M = 0, C = 1, A = 2, D = 3, P = 4, I = 5, R = 6, j = 7;
        function a() {}
        function L(e, t) {
        ...
        function k(e) {}
        a.prototype = {
            parse: function parse(e, O, t) {
                var n = this.domBuilder;
                n.startDocument(), p(O, O = {}), function(n, r, o, i) {
                    function a(e) {
                        var t = e.slice(1, -1);
                    ...
                    function e(e) {
                        var t;
                        p < e && (t = n.substring(p, e).replace(/&#?\w+;/g, a), f && c(p), o.characters(t, 0, e - p), 
                        p = e);
                    }
                    function c(e, t) {
                        for (;s <= e && (t = l.exec(n)); ) {
                    ...
                    for (var u = 0, s = 0, l = /.*(?:\r\n?|\n)|.*$/g, f = o.locator, t = [ {
                        ...
                        try {
                            var h, m, g = n.indexOf("<", p);
                            if (g < 0) return n.substr(p).match(/^\s*$/) || (h = o.doc, m = h.createTextNode(n.substr(p)), 
                            h.appendChild(m), o.currentElement = m);
                            switch (p < g && e(g), n.charAt(g + 1)) {
                              case "/":
                                var y = n.indexOf(">", g + 3), v = n.substring(g + 2, y), b = t.pop();
                                y < 0 ? (v = n.substring(g + 2).replace(/[\s<].*/, ""), i.error("end tag name: " + v + " is not complete:" + b.tagName), 
                                y = g + 1 + v.length) : v.match(/\s</) && (v = v.replace(/[\s<].*/, ""), i.error("end tag name: " + v + " maybe not complete"), 
                                y = g + 1 + v.length);
                                var w = b.localNSMap, _ = b.tagName == v;
                                if (_ || b.tagName && b.tagName.toLowerCase() == v.toLowerCase()) {
                                    if (o.endElement(b.uri, b.localName, v), w) for (var E in w) {
                                        o.endPrefixMapping(E);
                                    }
                                    _ || i.fatalError("end tag name: " + v + " is not match the current start tagName:" + b.tagName);
                                } else t.push(b);
                                y++;
                                break;
                              ...
                              default:
                                f && c(g);
                                var x = new k(), v = t[t.length - 1].currentNSMap, y = function(e, t, n, r, o, i) {
                                    var a, c = ++t, u = M;
                                    for (;;) {
                                        var s = e.charAt(c);
                                        switch (s) {
                                          case "=":
                                            if (u === C) a = e.slice(t, c), u = D; else {
                                                if (u !== A) throw new Error("attribute equal must after attrName");
                                                u = D;
                                            }
                                            break;
                                          ...
                                          case '"':
                                            if (u === D || u === C) {
                                                ...
                                                l = e.slice(t, c).replace(/&#?\w+;/g, o), n.add(a, l, t - 1), u = I;
                                            } else {
                                                if (u != P) throw new Error('attribute value must after "="');
                                          ...
                                          case "":
                                            return i.error("unexpected end of input"), u == M && n.setTagName(e.slice(t, c)), 
                                            c;
                                          ...
                                          case ">":
                                            switch (u) {
                                              ...
                                              case A:
                                                u === A && (l = a), u == P ? (i.warning('attribute "' + l + '" missed quot(")!!'), 
                                ...
                                }(n, g, x, v, a, i), S = x.length;
                                if (!x.closed && function(e, t, n, r) {
                                    var o = r[n];
                                    null == o && ((o = e.lastIndexOf("</" + n + ">")) < t && (o = e.lastIndexOf("</" + n)), 
                                    r[n] = o);
                                    return o < t;
                                }(n, y, x.tagName, d) && (x.closed = !0, r.nbsp || i.warning("unclosed xml attribute")), 
                                f && S) {
                                    for (var b = L(f, {}), T = 0; T < S; T++) {
                                        var N = x[T];
                                        c(N.offset), N.locator = L(f, {});
                                    }
                                    o.locator = b, F(x, o, v) && t.push(x), o.locator = f;
                                } else F(x, o, v) && t.push(x);
                                "http://www.w3.org/1999/xhtml" !== x.uri || x.closed ? y++ : y = function(e, t, n, r, o) {
                ...
                }(e, t, n, this.errorHandler), n.endDocument();
            }
        }, k.prototype = {
    ...
    24: [ function(e, t, n) {
        ...
        function s(n) {
            ...
            return function() {
                var e, t = l(n);
                return e = r ? (e = l(this).constructor, Reflect.construct(t, arguments, e)) : t.apply(this, arguments), 
                t = this, !(e = e) || "object" !== o(e) && "function" != typeof e ? function(e) {
        ...
        var f = 0, d = 1, p = 2, h = 3, m = 4, g = 1, y = {}, v = function() {
            !function(e, t) {
            ...
            function o(e) {
                ...
                }(this), (t = r.call(this))._$sn = g++, t.HAVE_NOTHING = f, t.HAVE_METADATA = d, 
                t.HAVE_CURRENT_DATA = p, t.HAVE_FUTURE_DATA = h, t.HAVE_ENOUGH_DATA = m, t.readyState = f;
    ...
    26: [ function(e, t, n) {
        ...
        var r, i = (r = e("./Node")) && r.__esModule ? r : {
            default: r
        };
        function a(e, t) {
        ...
        function c(n) {
            ...
            return function() {
                var e, t = u(n);
                return e = r ? (e = u(this).constructor, Reflect.construct(t, arguments, e)) : t.apply(this, arguments), 
                t = this, !(e = e) || "object" !== o(e) && "function" != typeof e ? function(e) {
                    if (void 0 !== e) return e;
                    throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
                }(t) : e;
        ...
        var s = function() {
            ...
            function n() {
                ...
                }(this), (e = t.call(this)).className = "", e.children = [], e;
            }
            return n;
        }();
    ...
    28: [ function(e, t, n) {
        ...
        function o(e) {
            !function(e) {
                if (!(e instanceof o)) throw new TypeError("Cannot call a class as a function");
            }(this), this.touches = [], this.targetTouches = [], this.changedTouches = [], this.preventDefault = r.noop, 
            this.stopPropagation = r.noop, this.type = e, this.target = window.canvas, this.currentTarget = window.canvas;
        }
        function i(n) {
            return function(e) {
                var t = new o(n);
        ...
        var i = new WeakMap(), r = function() {
            ...
            return e = t, (n = [ {
                ...
                value: function value(e, t) {
                    ...
                    r || (r = {}, i.set(this, r)), r[e] || (r[e] = []), r[e].push(t), n.capture, n.once, 
                    n.passive;
                }
            }, {
    ...
    32: [ function(e, t, n) {
        ...
        var r, i = (r = e("./HTMLMediaElement")) && r.__esModule ? r : {
            default: r
        };
        function a(e, t) {
            return (a = Object.setPrototypeOf || function(e, t) {
    ...
    34: [ function(e, t, n) {
        ...
        function l(n) {
            ...
            return function() {
                var e, t = f(n);
                return e = r ? (e = f(this).constructor, Reflect.construct(t, arguments, e)) : t.apply(this, arguments), 
                t = this, !(e = e) || "object" !== o(e) && "function" != typeof e ? function(e) {
                    if (void 0 !== e) return e;
                    throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
                }(t) : e;
        ...
        var d = function() {
            ...
            function o() {
                ...
                return function(e) {
                    if (!(e instanceof o)) throw new TypeError("Cannot call a class as a function");
                }(this), (e = r.call(this)).className = "", e.childern = [], e.style = {
    ...
    36: [ function(e, t, n) {
        ...
        function u(n) {
            ...
            return function() {
                var e, t = s(n);
                return e = r ? (e = s(this).constructor, Reflect.construct(t, arguments, e)) : t.apply(this, arguments), 
                t = this, !(e = e) || "object" !== o(e) && "function" != typeof e ? function(e) {
                    if (void 0 !== e) return e;
                    throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
                }(t) : e;
    ...
    40: [ function(e, t, n) {
        ...
        var l = function() {
            ...
            function o() {
                ...
                return function(e) {
                    if (!(e instanceof o)) throw new TypeError("Cannot call a class as a function");
                }(this), (e = r.call(this)).childNodes = [], e;
            }
            return e = o, (t = [ {
                key: "appendChild",
                value: function value(e) {
    ...
    42: [ function(e, t, n) {
        ...
        var i = new WeakMap(), r = function() {
            function r(e) {
                ...
                this.readyState = 3, "string" != typeof e || !/(^ws:\/\/)|(^wss:\/\/)/.test(e)) throw new TypeError("Failed to construct 'WebSocket': The URL '".concat(e, "' is invalid"));
    ...
    44: [ function(e, t, n) {
        ...
        function s(n) {
            ...
            return function() {
                var e, t = c(n);
                return e = r ? (e = c(this).constructor, Reflect.construct(t, arguments, e)) : t.apply(this, arguments), 
                t = this, !(e = e) || "object" !== o(e) && "function" != typeof e ? l(t) : e;
            };
        }
        function l(e) {
        ...
        var v = function() {
            ...
            function c() {
                ...
                }(this), (e = r.call(this)).timeout = 0, e.onabort = null, e.onerror = null, e.onload = null, 
                ...
                value: function value() {
                    ...
                    e = wx.request({
                        ...
                        success: function success(e) {
                            ...
                            switch (a.status = n, h.set(a, e), g.call(a, "loadstart"), y.call(a, c.HEADERS_RECEIVED), 
                            y.call(a, c.LOADING), a.responseType) {
                              case "json":
                                a.responseText = t;
                                try {
                        ...
                        fail: function fail(e) {
                            e = e.errMsg;
                            -1 !== e.indexOf("abort") ? g.call(a, "abort") : -1 !== e.indexOf("timeout") ? g.call(a, "timeout") : g.call(a, "error", e), 
                            g.call(a, "loadend");
                        }
                    });
                    m.set(this, e);
        ...
        (n.default = v).UNSEND = 0, v.OPENED = 1, v.HEADERS_RECEIVED = 2, v.LOADING = 3, 
        v.DONE = 4, t.exports = n.default;
    }, {
        "./EventTarget.js": 30
    } ],
    45: [ function(e, t, n) {
    ...
    49: [ function(e, t, n) {
        ...
        console.log(o);
        var i = o.system, a = o.platform, e = o.language, o = o.version, i = -1 !== i.toLowerCase().indexOf("android") ? "Android; CPU ".concat(i) : "iPhone; CPU iPhone OS ".concat(i, " like Mac OS X"), o = "Mozilla/5.0 (".concat(i, ") AppleWebKit/603.1.30 (KHTML, like Gecko) Mobile/14E8301 MicroMessenger/").concat(o, " MiniGame NetType/WIFI Language/").concat(e), c = {
            platform: a,
            language: e,
    ...
    51: [ function(e, t, n) {
        ...
        var o = x(e("./Canvas")), i = x(e("./navigator")), a = x(e("./XMLHttpRequest")), c = x(e("./WebSocket")), u = x(e("./Image")), s = x(e("./ImageBitmap")), l = x(e("./Audio")), f = x(e("./FileReader")), d = x(e("./HTMLElement")), p = x(e("./HTMLImageElement")), h = x(e("./HTMLCanvasElement")), m = x(e("./HTMLMediaElement")), g = x(e("./HTMLAudioElement")), y = x(e("./HTMLVideoElement")), v = x(e("./WebGLRenderingContext")), b = e("./EventIniter/index.js"), w = x(e("./localStorage")), _ = x(e("./location")), E = e("./WindowProperties");
        function x(e) {
            return e && e.__esModule ? e : {
                default: e
            };
        ...
        n.canvas = S;
        var T = GameGlobal, N = T.setTimeout, O = T.setInterval, e = T.clearTimeout, o = T.clearInterval, S = T.requestAnimationFrame, T = T.cancelAnimationFrame;
        n.cancelAnimationFrame = T, n.requestAnimationFrame = S, n.clearInterval = o, n.clearTimeout = e, 
    ...
    58: [ function(e, t, n) {
        "use strict";
        var c, u, s, l, r, a, o = e("../../../common/utils");
        window.__globalAdapter && (c = window.__globalAdapter, e = (u = wx.getSystemInfoSync()).windowWidth, 
        s = u.windowHeight, l = s < e, c.isSubContext = void 0 === wx.getOpenDataContext, 
        c.isDevTool = "devtools" === u.platform, o.cloneMethod(c, wx, "getSystemInfoSync"), 
        o.cloneMethod(c, wx, "onTouchStart"), o.cloneMethod(c, wx, "onTouchMove"), o.cloneMethod(c, wx, "onTouchEnd"), 
        o.cloneMethod(c, wx, "onTouchCancel"), o.cloneMethod(c, wx, "createInnerAudioContext"), 
        o.cloneMethod(c, wx, "onAudioInterruptionEnd"), o.cloneMethod(c, wx, "onAudioInterruptionBegin"), 
        o.cloneMethod(c, wx, "createVideo"), o.cloneMethod(c, wx, "setPreferredFramesPerSecond"), 
        o.cloneMethod(c, wx, "showKeyboard"), o.cloneMethod(c, wx, "hideKeyboard"), o.cloneMethod(c, wx, "updateKeyboard"), 
        o.cloneMethod(c, wx, "onKeyboardInput"), o.cloneMethod(c, wx, "onKeyboardConfirm"), 
        o.cloneMethod(c, wx, "onKeyboardComplete"), o.cloneMethod(c, wx, "offKeyboardInput"), 
        o.cloneMethod(c, wx, "offKeyboardConfirm"), o.cloneMethod(c, wx, "offKeyboardComplete"), 
        o.cloneMethod(c, wx, "getOpenDataContext"), o.cloneMethod(c, wx, "onMessage"), o.cloneMethod(c, wx, "getSharedCanvas"), 
        o.cloneMethod(c, wx, "loadFont"), o.cloneMethod(c, wx, "onShow"), o.cloneMethod(c, wx, "onHide"), 
        o.cloneMethod(c, wx, "onError"), o.cloneMethod(c, wx, "offError"), r = !1, a = 1, 
        wx.onDeviceOrientationChange && wx.onDeviceOrientationChange(function(e) {
            ...
            startAccelerometer: function startAccelerometer(i) {
                r ? wx.startAccelerometer && wx.startAccelerometer({
                    ...
                    var t, n = {}, r = e.x, o = e.y;
                    l && (t = r, r = -o, o = t), n.x = r * a, n.y = o * a, n.z = e.z, i && i(n);
                }));
            },
        ...
        }), c.getSafeArea = function() {
            var e = u.safeArea, t = e.top, n = e.left, r = e.bottom, o = e.right, i = e.width, a = e.height;
            return "ios" === u.platform && !c.isDevTool && l && (t = s - (e = [ o, t, n, r, i, a ])[0], 
            n = e[1], r = s - e[2], o = e[3], a = e[4], i = e[5]), {
                top: t,
                left: n,
                bottom: r,
                right: o,
