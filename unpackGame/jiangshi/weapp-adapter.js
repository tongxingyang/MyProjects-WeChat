!function(e) {
    ...
    t.HTMLImageElement = function(e) {
        function t() {
            return a(this, t), u(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, "img"));
        }
        return c(t, e), t;
    }(i.default), t.HTMLCanvasElement = function(e) {
        function t() {
            return a(this, t), u(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, "canvas"));
        }
        return c(t, e), t;
    }(i.default);
}, function(e, t, n) {
    ...
    var s = new WeakMap(), l = new WeakMap(), f = (new WeakMap(), new WeakMap(), function(e) {
        function t(e) {
            ...
            n.HAVE_ENOUGH_DATA = 4, n.readyState = 0, (0, u.isSubContext)()) return console.warn("HTMLAudioElement is not supported in SubContext."), 
            c(n);
            l.set(n, "");
            var o = wx.createInnerAudioContext();
            return s.set(n, o), o.onCanplay(function() {
                n.dispatchEvent({
                    type: "load"
                }), n.dispatchEvent({
                    type: "loadend"
        ...
        return function(e, t) {
            ...
            value: function() {
                var e = new t();
                return (0, u.isSubContext)() || (e.loop = s.get(this).loop, e.autoplay = s.get(this).loop, 
                e.src = this.src), e;
            }
        }, {
            key: "currentTime",
    ...
    wx.onTouchStart(s("touchstart")), wx.onTouchMove(s("touchmove")), wx.onTouchEnd(s("touchend")), 
    ...
    var a = new WeakMap(), u = function() {
        function e(t) {
            var n = this, o = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : [];
            if (i(this, e), this.binaryType = "", this.bufferedAmount = 0, this.extensions = "", 
