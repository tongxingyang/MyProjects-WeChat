...
!function i(a, c, u) {
    ...
    2: [ function(e, t, n) {
        "use strict";
        var r = window.fsUtils, o = r.getUserDataPath, i = r.readJsonSync, c = r.makeDirSync, a = r.writeFileSync, s = r.copyFile, l = r.downloadFile, u = r.writeFile, f = r.deleteFile, d = r.rmdirSync, p = r.unzip, h = !1, m = null, v = !1, g = [], y = [], b = !1, _ = /the maximum size of the file storage/, w = 0, E = /^\w+:\/\/.*/, x = {
            cacheDir: "gamecaches",
            ...
            _cache: function _cache() {
                ...
                for (var n in this.cacheQueue) {
                    var e = function e(_e) {
                        if (h = !1, _e) {
                            if (_.test(_e.message)) return t.outOfStorage = !0, void (t.autoClear && t.clearLRU());
                    ...
                    }, r = this.cacheQueue[n], o = r.srcUrl, i = r.isCopy, a = r.cacheBundleRoot, c = Date.now().toString(), u = "", u = a ? "".concat(this.cacheDir, "/").concat(a, "/").concat(c).concat(w++).concat(cc.path.extname(n)) : "".concat(this.cacheDir, "/").concat(c).concat(w++).concat(cc.path.extname(n));
            ...
            unzipAndCacheBundle: function unzipAndCacheBundle(t, e, n, r) {
                var o = Date.now().toString(), i = "".concat(this.cacheDir, "/").concat(n, "/").concat(o).concat(w++), a = this;
    ...
    3: [ function(e, t, n) {
        "use strict";
        var o, i, f = e("../cache-manager"), r = window.fsUtils, d = r.fs, p = r.downloadFile, a = r.readText, c = r.readArrayBuffer, u = r.readJson, h = r.loadSubpackage, s = r.getUserDataPath, m = /^\w+:\/\/.*/, l = cc.assetManager.downloader, v = cc.assetManager.parser, g = cc.assetManager.presets, y = __globalAdapter.isSubContext;
        l.maxConcurrency = 8, l.maxRequestsPerFrame = 64, g.scene.maxConcurrency = 10, g.scene.maxRequestsPerFrame = 64;
        var b = {}, _ = {};
        function w(e, t, n) {
        ...
        var I = v.parsePVRTex, R = v.parsePKMTex;
        var j = y ? function(e, t, n) {
            n(null, e = F(e, t).url);
        } : C;
        l.downloadDomAudio = E, l.downloadScript = w, v.parsePVRTex = D, v.parsePKMTex = P, 
        l.register({
            ".js": w,
            ".mp3": C,
            ".ogg": C,
            ...
            bundle: function bundle(e, u, s) {
                ...
                })) : (m.test(e) ? (l = e, t = "src/scripts/".concat(r, "/index.js"), f.makeBundleFolder(r)) : _[r] ? (l = "".concat(i, "remote/").concat(r), 
                t = "src/scripts/".concat(r, "/index.js"), f.makeBundleFolder(r)) : (l = "assets/".concat(r), 
                t = "assets/".concat(r, "/index.js")), __cocos_require__(t), u.cacheEnabled = !0, 
                u.__cacheBundleRoot__ = r, n = "".concat(l, "/config.").concat(o ? o + "." : "", "json"), 
                O(n, u, function(e, o) {
                    var t, n, r, i, a, c;
        ...
        var L, F = y ? function(e, t) {
            ...
            var n, r, o = !1, i = !1;
            return !e.startsWith(s()) && m.test(e) ? t.reload || ((n = f.cachedFiles.get(e)) ? (i = !0, 
    ...
    7: [ function(e, t, n) {
        ...
        var o, i, a, c, u;
        cc && cc.EditBox && (o = cc.EditBox, i = cc.js, a = o.KeyboardReturnType, c = null, 
        u = o._ImplClass, i.extend(r, u), o._ImplClass = r, Object.assign(r.prototype, {
            init: function init(e) {
                e ? this._delegate = e : cc.error("EditBox init failed");
            },
            beginEditing: function beginEditing() {
                var e;
                c !== this && (e = this._delegate, c ? (c._eventListeners.onKeyboardComplete(), 
                __globalAdapter.updateKeyboard && __globalAdapter.updateKeyboard({
                    value: e._string
                })) : this._showKeyboard(), this._registerKeyboardEvent(), this._editing = !0, c = this, 
                e.editBoxEditingDidBegan());
            },
    ...
    8: [ function(e, t, n) {
        ...
        Object.assign(i, {
            ...
            _runMainLoop: function _runMainLoop() {
                var _e2, t = this, n = t.config, r = cc.director, o = !0, i = n.frameRate;
    ...
    20: [ function(e, t, n) {
        ...
        var g = "http://www.w3.org/1999/xhtml", i = {}, y = i.ELEMENT_NODE = 1, b = i.ATTRIBUTE_NODE = 2, _ = i.TEXT_NODE = 3, w = i.CDATA_SECTION_NODE = 4, E = i.ENTITY_REFERENCE_NODE = 5, x = (i.ENTITY_NODE = 6, 
        ...
        function L(e, t, n) {
            ...
            return R(e.ownerDocument || e, e), t.nodeType == O && (t.firstChild = t.lastChild = null), 
            t;
        }
        function F() {
            this._nsMap = {};
        ...
        u.prototype = Error.prototype, r(a, u), p.prototype = {
            ...
            normalize: function normalize() {
                for (var e = this.firstChild; e; ) {
                    var t = e.nextSibling;
                    t && t.nodeType == _ && e.nodeType == _ ? (this.removeChild(t), e.appendData(t.data)) : (e.normalize(), 
                    e = t);
                }
            },
        ...
        o(F, A), k.prototype.nodeType = b, o(k, A), H.prototype = {
            ...
            nodeType: w
        }, o(V, H), W.prototype.nodeType = N, o(W, A), K.prototype.nodeType = 12, o(K, A), 
        G.prototype.nodeType = 6, o(G, A), z.prototype.nodeType = E, o(z, A), q.prototype.nodeName = "#document-fragment", 
        q.prototype.nodeType = O, o(q, A), $.prototype.nodeType = x, o($, A), X.prototype.serializeToString = function(e, t, n) {
            return Y.call(e, t, n);
    ...
    22: [ function(e, t, n) {
        "use strict";
        var r = /[A-Z_a-z\xC0-\xD6\xD8-\xF6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD]/, o = new RegExp("[\\-\\.0-9" + r.source.slice(1, -1) + "\\u00B7\\u0300-\\u036F\\u203F-\\u2040]"), i = new RegExp("^" + r.source + o.source + "*(?::" + r.source + o.source + "*)?$"), C = 0, D = 1, P = 2, I = 3, R = 4, j = 5, L = 6, F = 7;
        function a() {}
        function k(e, t) {
                    ...
                    for (;;) {
                        try {
                            ...
                            switch (h < g && t(g), n.charAt(g + 1)) {
                              case "/":
                                var y = n.indexOf(">", g + 3), b = n.substring(g + 2, y), _ = d.pop();
                                y < 0 ? (b = n.substring(g + 2).replace(/[\s<].*/, ""), i.error("end tag name: " + b + " is not complete:" + _.tagName), 
                                y = g + 1 + b.length) : b.match(/\s</) && (b = b.replace(/[\s<].*/, ""), i.error("end tag name: " + b + " maybe not complete"), 
                                y = g + 1 + b.length);
                                var w = _.localNSMap, E = _.tagName == b;
                                if (E || _.tagName && _.tagName.toLowerCase() == b.toLowerCase()) {
                                    if (o.endElement(_.uri, _.localName, b), w) for (var x in w) {
                                        o.endPrefixMapping(x);
                                    }
                                    E || i.fatalError("end tag name: " + b + " is not match the current start tagName:" + _.tagName);
                                } else d.push(_);
                                y++;
                                break;
                              ...
                              default:
                                f && c(g);
                                var S = new B(), T = d[d.length - 1].currentNSMap, y = function(e, t, n, r, o, i) {
                                    var a, c = ++t, u = C;
                                    for (;;) {
                                        var s = e.charAt(c);
                                        switch (s) {
    ...
    51: [ function(e, t, n) {
        ...
        var o = x(e("./Canvas")), i = x(e("./navigator")), a = x(e("./XMLHttpRequest")), c = x(e("./WebSocket")), u = x(e("./Image")), s = x(e("./ImageBitmap")), l = x(e("./Audio")), f = x(e("./FileReader")), d = x(e("./HTMLElement")), p = x(e("./HTMLImageElement")), h = x(e("./HTMLCanvasElement")), m = x(e("./HTMLMediaElement")), v = x(e("./HTMLAudioElement")), g = x(e("./HTMLVideoElement")), y = x(e("./WebGLRenderingContext")), b = e("./EventIniter/index.js"), _ = x(e("./localStorage")), w = x(e("./location")), E = e("./WindowProperties");
        function x(e) {
            return e && e.__esModule ? e : {
                default: e
            };
    ...
    52: [ function(e, t, n) {
        "use strict";
        var v, g, y, r, o;
        cc && cc.VideoPlayer && cc.VideoPlayer.Impl && __globalAdapter.createVideo && (v = cc.Mat4, 
        g = cc.mat4(), y = cc.mat4(), r = cc.VideoPlayer.Impl, o = cc.VideoPlayer.Impl.prototype, 
        cc.VideoPlayer.prototype._updateVideoSource = function() {
            ...
            var t, n, r, o, i, a, c, u, s, l, f, d, p, h, m;
            this._video && this._visible && (e.getWorldMatrix(g), this._m00 === g.m[0] && this._m01 === g.m[1] && this._m04 === g.m[4] && this._m05 === g.m[5] && this._m12 === g.m[12] && this._m13 === g.m[13] && this._w === e._contentSize.width && this._h === e._contentSize.height || (this._m00 = g.m[0], 
            this._m01 = g.m[1], this._m04 = g.m[4], this._m05 = g.m[5], this._m12 = g.m[12], 
            this._m13 = g.m[13], this._w = e._contentSize.width, this._h = e._contentSize.height, 
            cc.Camera.findCamera(e).getWorldToScreenMatrix2D(y), v.multiply(y, y, g), t = cc.view._scaleX, 
            n = cc.view._scaleY, t /= r = cc.view._devicePixelRatio, n /= r, o = y.m[0] * t, 
            i = y.m[5] * n, a = this._w * o, c = this._h * i, u = a * e._anchorPoint.x, s = c * e._anchorPoint.y, 
            f = (l = cc.view._viewportRect).x / r, d = l.y / r, p = y.m[12] * t - u + f, h = y.m[13] * n - s + d, 
            m = cc.view.getFrameSize().height, this._video.x = p, this._video.y = m - c - h, 
            this._actualWidth = this._video.width = a, this._video.height = c));
        });
    }, {} ],
    53: [ function(e, t, n) {
        "use strict";
            ...
            downloadFile: function downloadFile(e, t, n, r, o) {
                var i = {
                    ...
                    success: function success(e) {
                        ...
                        console.warn("Download file failed: " + e.statusCode), o && o(new Error(e.statusCode), null));
                    },
                    fail: function fail(e) {
