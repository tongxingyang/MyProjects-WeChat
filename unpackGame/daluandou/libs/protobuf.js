!function(e, t) {
    (e.dcodeIO = e.dcodeIO || {}).ProtoBuf = function(e, t) {
        "use strict";
        var i = {};
        ...
        i.populateDefaults = !0, i.Util = (r = {}, r.IS_NODE = !("object" != typeof process || process + "" != "[object process]" || process.browser), 
        r.XHR = function() {
            for (var e = [ function() {
            ...
            var i = window.Laya.Laya;
            i.loader.load(e, new i.Handler(this, function(e) {
                return t(e);
            }));
            ...
            n._readString = function() {
                ...
                if (this.index === this.source.length) return null;
                var n = this.index;
                if (t.DELIM.lastIndex = 0, !t.DELIM.test(this.source.charAt(n++))) for (;n < this.source.length && !t.DELIM.test(this.source.charAt(n)); ) ++n;
                var s = this.source.substring(this.index, this.index = n);
                return '"' !== s && "'" !== s || (this._stringOpen = s), s;
            }, n.peek = function() {
            ...
            function mkId(e, i) {
                ...
                if (r = n * r | 0, !i && r < 0) throw Error("illegal id value: " + (n < 0 ? "-" : "") + e);
                return r;
            }
            function mkNumber(e) {
                var i = 1;
            ...
            return o.parse = function() {
                ...
                if (this.tn.next(), t.NUMBER.test(i)) return mkNumber(i);
                ...
                var r = this.tn.peek();
                if ("{" !== r) setOption(e.options, i, this._readValue(!0)); else for (this.tn.skip("{"); "}" !== (r = this.tn.next()); ) {
                    if (!t.NAME.test(r)) throw Error("illegal option name: " + i + "." + r);
                    this.tn.omit(":") ? setOption(e.options, i + "." + r, this._readValue(!0)) : this._parseOptionValue(e, i + "." + r);
                }
                ...
                i = this.tn.next()), !t.TYPEREF.test(i)) throw Error("illegal rpc service request type: " + i);
                if (n.request = i, this.tn.skip(")"), "returns" !== (i = this.tn.next()).toLowerCase()) throw Error("illegal rpc service request type delimiter: " + i);
                if (this.tn.skip("("), "stream" === (i = this.tn.next()).toLowerCase() && (n.response_stream = !0, 
                i = this.tn.next()), n.response = i, this.tn.skip(")"), "{" === (i = this.tn.peek())) {
                ...
                for (s.name = n, r && (this.tn.skip("="), i.id = mkId(this.tn.next()), s.isGroup = !0), 
                ...
                return this.tn.omit(";"), e.messages.push(s), s;
                ...
                if ("map" === i) {
                    ...
                    if (this.tn.skip("<"), n = this.tn.next(), !t.TYPE.test(n) && !t.TYPEREF.test(n)) throw Error("illegal message field type: " + n);
                    if (s.keytype = n, this.tn.skip(","), n = this.tn.next(), !t.TYPE.test(n) && !t.TYPEREF.test(n)) throw Error("illegal message field: " + n);
                    if (s.type = n, this.tn.skip(">"), n = this.tn.next(), !t.NAME.test(n)) throw Error("illegal message field name: " + n);
                    s.name = n, this.tn.skip("="), s.id = mkId(this.tn.next()), "[" === (n = this.tn.peek()) && this._parseFieldOptions(s), 
                    this.tn.skip(";");
                    ...
                    s.type = o.name, s.name = o.name.toLowerCase(), this.tn.omit(";");
                } else {
                    if (!t.TYPE.test(r) && !t.TYPEREF.test(r)) throw Error("illegal message field type: " + r);
                    if (s.type = r, n = this.tn.next(), !t.NAME.test(n)) throw Error("illegal message field name: " + n);
                    s.name = n, this.tn.skip("="), s.id = mkId(this.tn.next()), "[" === (n = this.tn.peek()) && this._parseFieldOptions(s), 
                    this.tn.skip(";");
                }
                ...
                var r, n = i, s = [];
                for (this.tn.skip("{"); "}" !== (i = this.tn.next()); ) (r = this._parseMessageField(e, "optional", i)).oneof = n, 
                s.push(r.id);
                ...
                for (i.name = r, this.tn.skip("{"); "}" !== (r = this.tn.next()); ) if ("option" === r) this._parseOption(i); else {
                    if (!t.NAME.test(r)) throw Error("illegal name: " + r);
                    this.tn.skip("=");
                    var n = {
                        name: r,
                        id: mkId(this.tn.next(), !0)
                    };
            ...
            var s = function(e, t, i, n, s) {
                r.call(this, e, t, i), this.className = "Namespace", this.children = [], this.options = n || {}, 
            ...
            function mkLong(e, i) {
                if (e && "number" == typeof e.low && "number" == typeof e.high && "boolean" == typeof e.unsigned && e.low == e.low && e.high == e.high) return new t.Long(e.low, e.high, void 0 === i ? e.unsigned : i);
            ...
            a.defaultFieldValue = function(i) {
                if ("string" == typeof i && (i = t.TYPES[i]), void 0 === i.defaultValue) throw Error("default value for type " + i.name + " is not supported");
                ...
                switch (this.type) {
                  ...
                  case t.TYPES.sfixed32:
                    return ("number" != typeof i || i == i && i % 1 != 0) && fail(typeof i, "not an integer"), 
                    i > 4294967295 ? 0 | i : i;
                  ...
                  case t.TYPES.sfixed64:
                    if (t.Long) try {
                        ...
                        e = VM2_INTERNAL_STATE_DO_NOT_USE_OR_PROGRAM_WILL_FAIL.handleException(e);
                        fail(typeof i, e.message);
                    } else fail(typeof i, "requires Long.js");
                  ...
                  case t.TYPES.bool:
                    return "boolean" != typeof i && fail(typeof i, "not a boolean"), i;

                  case t.TYPES.float:
                  case t.TYPES.double:
                    return "number" != typeof i && fail(typeof i, "not a number"), i;

                  case t.TYPES.string:
                    return "string" == typeof i || i && i instanceof String || fail(typeof i, "not a string"), 
                    "" + i;
                  ...
                  case t.TYPES.enum:
                    var n = this.resolvedType.getChildren(t.Reflect.Enum.Value);
                    for (o = 0; o < n.length; o++) {
                        if (n[o].name == i) return n[o].id;
                        if (n[o].id == i) return n[o].id;
                    }
                    if ("proto3" === this.syntax) return ("number" != typeof i || i == i && i % 1 != 0) && fail(typeof i, "not an integer"), 
                    (i > 4294967295 || i < 0) && fail(typeof i, "not in range for uint32"), i;
                    fail(i, "not a valid enum value");

                  case t.TYPES.group:
                  case t.TYPES.message:
                    if (i && "object" == typeof i || fail(typeof i, "object expected"), i instanceof this.resolvedType.clazz) return i;
                ...
                switch (this.type) {
                  ...
                  case t.TYPES.bytes:
                    ...
                    return (n = e.clone()).limit = n.offset + s, e.offset += s, n;
            ...
            var f = function(e, t, i, r, n, o) {
                s.call(this, e, t, i, r, o), this.className = "Message", this.extensions = void 0, 
                this.clazz = null, this.isGroup = !!n, this._fields = null, this._fieldsById = null, 
                this._fieldsByName = null;
            }, h = f.prototype = Object.create(s.prototype);
            function skipTillGroupEnd(e, i) {
            ...
            h.build = function(i) {
                ...
                var r = function(t, i) {
                    var r = i.getChildren(t.Reflect.Message.Field), n = i.getChildren(t.Reflect.Message.OneOf), s = function(o, a) {
                        ...
                        for (l = 0, f = r.length; l < f; ++l) {
                            var h = r[l];
                            this[h.name] = h.repeated ? [] : h.map ? new t.Map(h) : null, !h.required && "proto3" !== i.syntax || null === h.defaultValue || (this[h.name] = h.defaultValue);
                        }
                        var u;
                        if (arguments.length > 0) if (1 !== arguments.length || null === o || "object" != typeof o || !("function" != typeof o.encode || o instanceof s) || Array.isArray(o) || o instanceof t.Map || e.isByteBuffer(o) || o instanceof ArrayBuffer || t.Long && o instanceof t.Long) for (l = 0, 
                        f = arguments.length; l < f; ++l) void 0 !== (u = arguments[l]) && this.$set(r[l].name, u); else this.$set(o);
                    ...
                    }, o.$add = o.add, o.set = function(e, r, n) {
                        if (e && "object" == typeof e) {
                            for (var s in n = r, e) e.hasOwnProperty(s) && void 0 !== (r = e[s]) && this.$set(s, r, n);
                            return this;
                        }
                    ...
                    for (var a = 0; a < r.length; a++) {
                        ...
                        l instanceof t.Reflect.Message.ExtensionField || i.builder.options.populateAccessors && function(e) {
                            ...
                            null === i.getChild("set" + t) && (o["set" + t] = n), null === i.getChild("set_" + r) && (o["set_" + r] = n), 
                            null === i.getChild("get" + t) && (o["get" + t] = s), null === i.getChild("get_" + r) && (o["get_" + r] = s);
                        }(l);
                    }
                    function cloneRaw(i, r, n, s) {
                        ...
                        if (Array.isArray(i)) return a = [], i.forEach(function(e, t) {
                            a[t] = cloneRaw(e, r, n, s);
                        }), a;
                        if (a = {}, i instanceof t.Map) {
                            for (var l = i.entries(), f = l.next(); !f.done; f = l.next()) a[i.keyElem.valueToString(f.value[0])] = cloneRaw(f.value[1], r, n, i.valueElem.resolvedType);
                            return a;
                        }
                        var h = i.$type, u = void 0;
                        for (var c in i) i.hasOwnProperty(c) && (h && (u = h.getChild(c)) ? a[c] = cloneRaw(i[c], r, n, u.resolvedType) : a[c] = cloneRaw(i[c], r, n));
                        return a;
                    }
                    return o.encode = function(t, r) {
                        ...
                        return cloneRaw(this, !!e, !!t, this.$type);
                    }, o.encodeJSON = function() {
                        return JSON.stringify(cloneRaw(this, !0, !0, this.$type));
                    }, s.decode = function(t, r, n) {
                        "string" == typeof r && (n = r, r = -1), "string" == typeof t && (t = e.wrap(t, n || "base64"));
                        ...
                        if ("string" == typeof t && (t = e.wrap(t, r || "base64")), (t = e.isByteBuffer(t) ? t : e.wrap(t)).remaining() < 1) return null;
                ...
                for (var n, s = 0, o = this.children.length; s < o; s++) if ((n = this.children[s]) instanceof d || n instanceof f || n instanceof y) {
                    ...
                    r[n.name] = n.build();
                } else if (n instanceof f.Field) n.build(), this._fields.push(n), this._fieldsById[n.id] = n, 
                this._fieldsByName[n.name] = n; else if (!(n instanceof f.OneOf || n instanceof g)) throw Error("Illegal reflect child of " + this.toString(!0) + ": " + this.children[s].toString(!0));
                return this.clazz = r;
            }, h.encode = function(e, t, i) {
                for (var r, n, s = null, o = 0, a = this._fields.length; o < a; ++o) n = e[(r = this._fields[o]).name], 
                ...
                for (var t, i, r = 0, n = 0, s = this._fields.length; n < s; ++n) {
                    if (i = e[(t = this._fields[n]).name], t.required && null === i) throw Error("Missing at least one required field for " + this.toString(!0) + ": " + t);
                    r += t.calculate(i, e);
                }
                return r;
                ...
                for (var n, s, o, a, l = e.offset, f = new this.clazz(); e.offset < l + i || -1 === i && e.remaining() > 0; ) {
                    if (o = (n = e.readVarint32()) >>> 3, (s = 7 & n) === t.WIRE_TYPES.ENDGROUP) {
                        if (o !== r) throw Error("Illegal group end indicator for " + this.toString(!0) + ": " + o + " (" + (r ? r + " expected" : "not a group") + ")");
                        break;
                    }
                    if (a = this._fieldsById[o]) {
                        if (a.repeated && !a.options.packed) f[a.name].push(a.decode(s, e)); else if (a.map) {
                            var h = a.decode(s, e);
                            f[a.name].set(h[0], h[1]);
                        } else if (f[a.name] = a.decode(s, e), a.oneof) {
                            var u = f[a.oneof.name];
                            null !== u && u !== a.name && (f[u] = null), f[a.oneof.name] = a.name;
                        }
                    } else switch (s) {
                      case t.WIRE_TYPES.VARINT:
                        e.readVarint32();
                ...
                for (var p = 0, d = this._fields.length; p < d; ++p) if (null === f[(a = this._fields[p]).name]) if ("proto3" === this.syntax) f[a.name] = a.defaultValue; else {
                    if (a.required) {
                        var E = Error("Missing at least one required field for " + this.toString(!0) + ": " + a.name);
                        throw E.decoded = f, E;
                    }
            ...
            var u = function(e, i, n, s, o, a, l, h, u, c) {
                r.call(this, e, i, a), this.className = "Message.Field", this.required = "required" === n, 
                this.repeated = "repeated" === n, this.map = "map" === n, this.keyType = s || null, 
                this.type = o, this.resolvedType = null, this.id = l, this.options = h || {}, this.defaultValue = null, 
                this.oneof = u || null, this.syntax = c || "proto2", this.originalName = this.name, 
                this.element = null, this.keyElement = null, !this.builder.options.convertFieldsToCamelCase || this instanceof f.ExtensionField || (this.name = t.Util.toCamelCase(this.name));
            }, c = u.prototype = Object.create(r.prototype);
            c.build = function() {
            ...
            }, c.verifyValue = function(e, i) {
                i = i || !1;
                var r, n = this;
                function fail(e, t) {
                    throw Error("Illegal value for " + n.toString(!0) + " of type " + n.type.name + ": " + e + " (" + t + ")");
                }
                if (null === e) return this.required && fail(typeof e, "required"), "proto3" === this.syntax && this.type !== t.TYPES.message && fail(typeof e, "proto3 field without field presence cannot be null"), 
                null;
                if (this.repeated && !i) {
                    Array.isArray(e) || (e = [ e ]);
                    var s = [];
                ...
                return this.map && !i ? e instanceof t.Map ? e : (e instanceof Object || fail(typeof e, "expected ProtoBuf.Map or raw object for map field"), 
                new t.Map(this, e)) : (!this.repeated && Array.isArray(e) && fail(typeof e, "no array expected"), 
                this.element.verifyValue(e));
            }, c.hasWirePresence = function(e, i) {
                ...
                try {
                    ...
                    if (this.repeated) if (this.options.packed && t.PACKABLE_WIRE_TYPES.indexOf(this.type.wireType) >= 0) {
                        ...
                        if (l > 1) {
                            ...
                            o += l - 1, r.offset = o, r.append(f);
                        }
                        r.writeVarint32(a, o - l);
                    } else for (s = 0; s < i.length; s++) r.writeVarint32(this.id << 3 | this.type.wireType), 
                    this.element.encodeValue(this.id, i[s], r); else this.map ? i.forEach(function(i, n, s) {
                ...
                try {
                    ...
                    n += this.element.calculateLength(this.id, i[s]); else this.map ? i.forEach(function(i, r, s) {
                ...
                if (this.map) {
                    ...
                    if (n = a.defaultFieldValue(this.type), s = i.readVarint32(), i.remaining() < s) throw Error("Illegal number of bytes for " + this.toString(!0) + ": " + s + " required but got only " + i.remaining());
                    var f = i.clone();
                    for (f.limit = f.offset + s, i.offset += s; f.remaining() > 0; ) {
                        var h = f.readVarint32();
                        e = 7 & h;
                        var u = h >>> 3;
                        if (1 === u) l = this.keyElement.decode(f, e, u); else {
                            if (2 !== u) throw Error("Unexpected tag in map field key/value submessage");
                            n = this.element.decode(f, e, u);
                        }
                    }
                    return [ l, n ];
                }
            ...
            var p = function(e, t, i, r, n, s, o) {
                u.call(this, e, t, i, null, r, n, s, o), this.extension;
            };
            p.prototype = Object.create(u.prototype), i.Message.ExtensionField = p, i.Message.OneOf = function(e, t, i) {
                r.call(this, e, t, i), this.fields = [];
            };
            var d = function(e, t, i, r, n) {
                s.call(this, e, t, i, r, n), this.className = "Enum", this.object = null;
            };
            d.getName = function(e, t) {
                for (var i, r = Object.keys(e), n = 0; n < r.length; ++n) if (e[i = r[n]] === t) return i;
                return null;
            }, (d.prototype = Object.create(s.prototype)).build = function(e) {
                if (this.object && !e) return this.object;
                for (var i = new t.Builder.Enum(), r = this.getChildren(d.Value), n = 0, s = r.length; n < s; ++n) i[r[n].name] = r[n].id;
            ...
            var E = function(e, t, i, n) {
                r.call(this, e, t, i), this.className = "Enum.Value", this.id = n;
            };
            E.prototype = Object.create(r.prototype), i.Enum.Value = E;
            var g = function(e, t, i, n) {
                r.call(this, e, t, i), this.field = n;
            };
            g.prototype = Object.create(r.prototype), i.Extension = g;
            var y = function(e, t, i, r) {
                s.call(this, e, t, i, r), this.className = "Service", this.clazz = null;
            };
            (y.prototype = Object.create(s.prototype)).build = function(i) {
            ...
            var m = function(e, t, i, n) {
                r.call(this, e, t, i), this.className = "Service.Method", this.options = n || {};
            };
            (m.prototype = Object.create(r.prototype)).buildOpt = o.buildOpt, i.Service.Method = m;
            var v = function(e, t, i, r, n, s, o, a) {
                m.call(this, e, t, i, a), this.className = "Service.RPCMethod", this.requestName = r, 
                this.responseName = n, this.requestStream = s, this.responseStream = o, this.resolvedRequestType = null, 
                this.resolvedResponseType = null;
            };
            return v.prototype = Object.create(m.prototype), i.Service.RPCMethod = v, i;
            ...
            return r.isMessage = function(e) {
                    ...
                    for (;t.length > 0; ) {
                        ...
                        if (r.isMessage(s)) {
                            ...
                            this.ptr.addChild(o), l.length > 0) {
                                n.push(t), t = l, l = null, this.ptr = o, o = null;
                                continue;
                            }
                            l = null;
                        } else if (r.isEnum(s)) o = new i.Enum(this, this.ptr, s.name, s.options, s.syntax), 
                        s.values.forEach(function(e) {
                            o.addChild(new i.Enum.Value(this, o, e.name, e.id));
                        }, this), this.ptr.addChild(o); else if (r.isService(s)) o = new i.Service(this, this.ptr, s.name, s.options), 
                ...
                var r = "/";
                if ("string" == typeof i) {
                    if (window.GameMain.isWXPlatform && e.Util.IS_NODE && (i = require("path").resolve(i)), 
                    !0 === this.files[i]) return this.reset();
                    this.files[i] = !0;
                } else if ("object" == typeof i) {
                    var n = i.root;
                    window.GameMain.isWXPlatform && e.Util.IS_NODE && (n = require("path").resolve(n)), 
                ...
                if (t.imports && t.imports.length > 0) {
                    var o, a = !1;
                    "object" == typeof i ? (this.importRoot = i.root, a = !0, o = this.importRoot, i = i.file, 
                    (o.indexOf("\\") >= 0 || i.indexOf("\\") >= 0) && (r = "\\")) : "string" == typeof i ? this.importRoot ? o = this.importRoot : i.indexOf("/") >= 0 ? "" === (o = i.replace(/\/[^\/]*$/, "")) && (o = "/") : i.indexOf("\\") >= 0 ? (o = i.replace(/\\[^\\]*$/, ""), 
                    r = "\\") : o = "." : o = null;
                    for (var l = 0; l < t.imports.length; l++) if ("string" == typeof t.imports[l]) {
                        ...
                        if (f = o + r + f, !0 === this.files[f]) continue;
                    ...
                    } else i ? /\.(\w+)$/.test(i) ? this.import(t.imports[l], i.replace(/^(.+)\.(\w+)$/, function(e, t, i) {
                        return t + "_import" + l + "." + i;
                    })) : this.import(t.imports[l], i + "_import" + l) : this.import(t.imports[l]);
                    a && (this.importRoot = null);
                }
                t.package && this.define(t.package), t.syntax && function propagateSyntax(e) {
                    e.messages && e.messages.forEach(function(t) {
                        t.syntax = e.syntax, propagateSyntax(t);
                ...
                }), t.messages && (this.create(t.messages), this.ptr = u), t.enums && (this.create(t.enums), 
                this.ptr = u), t.services && (this.create(t.services), this.ptr = u), t.extends && this.create(t.extends), 
                this.reset();
        ...
        }(0, i.Reflect), i.loadProto = function(e, t, r) {
