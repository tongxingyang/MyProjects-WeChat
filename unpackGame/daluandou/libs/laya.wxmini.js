window.wxMiniGame = function(e, t) {
    ...
    class i {
        static isLocalNativeFile(e) {
            for (var t = 0, i = l.nativefiles.length; t < i; t++) if (-1 != e.indexOf(l.nativefiles[t])) return !0;
            return !1;
        }
        ...
        static readFile(e, n = "utf8", a = null, o = "", s = !1, r = "", d = !0) {
            e = t.URL.getAdptedFilePath(e), i.fs.readFile({
                ...
                encoding: n,
                success: function(t) {
                    (-1 != e.indexOf("http://") || -1 != e.indexOf("https://")) && (l.autoCacheFile || s) ? (null != a && a.runWith([ 0, t ]), 
                    i.copyFile(e, o, null, n, d)) : null != a && a.runWith([ 0, t ]);
                },
                fail: function(e) {
        ...
        static downOtherFiles(e, t = null, n = "", a = !1, o = !0) {
            i.wxdown({
                url: e,
                success: function(e) {
                    200 === e.statusCode ? (l.autoCacheFile || a) && -1 == n.indexOf("qlogo.cn") && -1 == n.indexOf(".php") ? (null != t && t.runWith([ 0, e.tempFilePath ]), 
                    i.copyFile(e.tempFilePath, n, null, "", o)) : null != t && t.runWith([ 0, e.tempFilePath ]) : null != t && t.runWith([ 1, e ]);
                },
                fail: function(e) {
        ...
        static downLoadFile(e, n = "", a = null, o = "utf8") {
            window.navigator.userAgent.indexOf("MiniGame") < 0 ? t.Laya.loader.load(e, a) : n == t.Loader.IMAGE || n == t.Loader.SOUND ? i.downOtherFiles(e, a, e, !0, !1) : i.downFiles(e, o, a, e, !0, n, !1);
        }
        static copyFile(e, n, a, o = "", s = !0) {
            ...
            c ? c.readyUrl != n ? i.fs.getFileInfo({
                filePath: e,
                success: function(t) {
                    s && f + 4194304 + t.size >= 52428800 && (t.size > l.minClearSize && (l.minClearSize = t.size), 
                    i.onClearCacheRes()), i.deleteFile(e, n, a, o, t.size);
                },
                fail: function(e) {
        ...
        static onClearCacheRes() {
            ...
            for (var n in i.filesListObj) "fileUsedSize" != n && t.push(i.filesListObj[n]);
            i.sortOn(t, "times", i.NUMERIC);
            for (var a = 0, o = 1, s = t.length; o < s; o++) {
                var r = t[o];
                if (a >= e) break;
                a += r.size, i.deleteFile("", r.readyUrl);
            }
        }
        static sortOn(e, t, n = 0) {
        ...
        static deleteFile(e, t = "", n = null, a = "", o = 0) {
            var s = i.getFileInfo(t), r = i.getFileNativePath(s.md5), l = "" != e;
            i.onSaveFile(t, e, l, a, n, o), i.fs.unlink({
                filePath: r,
                success: function(t) {
                    if ("" != e) {
                        var a = i.getFileNativePath(e);
                        i.fs.copyFile({
                            srcPath: e,
                            destPath: a,
                            success: function(e) {},
        ...
        static onSaveFile(e, n, a = !0, o = "", s = null, r = 0) {
            var l = e;
        ...
        static readSync(e, t = "utf8", n = null, a = "") {
            var o, s = i.getFileNativePath(e);
            try {
                o = i.fs.readFileSync(s, t), null != n && n.runWith([ 0, {
                    data: o
                } ]);
            } catch (e) {
    ...
    i.fs = window.wx.getFileSystemManager(), i.wxdown = window.wx.downloadFile, i.filesListObj = {}, 
    i.fakeObj = {}, i.fileListName = "layaairfiles.txt", i.ziyuFileData = {}, i.ziyuFileTextureData = {}, 
    i.loadPath = "", i.DESCENDING = 2, i.NUMERIC = 16;
    class n extends t.SoundChannel {
        constructor(e, t) {
            super(), this._audio = e, this._miniSound = t, this._onEnd = n.bindToThis(this.__onEnd, this), 
            e.onEnded(this._onEnd);
        }
        static bindToThis(e, t) {
            return e.bind(t);
        }
        __onEnd() {
        ...
        play() {
            this.isStopped = !1, t.SoundManager.addChannel(this), this._audio.play();
        }
        set startTime(e) {
        ...
        stop() {
            this.isStopped = !0, t.SoundManager.removeChannel(this), this.completeHandler = null, 
            this._audio && (this._audio.stop(), this.loop || (this._audio.offEnded(null), this._miniSound.dispose(), 
            this._audio = null, this._miniSound = null, this._onEnd = null));
        }
        pause() {
        ...
        resume() {
            this._audio && (this.isStopped = !1, t.SoundManager.addChannel(this), this._audio.play());
        }
        set volume(e) {
    ...
    class a extends t.EventDispatcher {
        constructor() {
            super(), this.loaded = !1;
        }
        static _createSound() {
        ...
        load(e) {
            if (a._musicAudio || (a._musicAudio = a._createSound()), i.isLocalNativeFile(e)) {
                if (-1 != e.indexOf("http://") || -1 != e.indexOf("https://")) if ("" != i.loadPath) e = e.split(i.loadPath)[1]; else {
                    var n = "" != t.URL.rootPath ? t.URL.rootPath : t.URL._basePath;
                    "" != n && (e = e.split(n)[1]);
                }
            } else e = t.URL.formatURL(e);
            if (this.url = e, this.readyUrl = e, a._audioCache[this.readyUrl]) this.event(t.Event.COMPLETE); else if (l.autoCacheFile && i.getFileInfo(e)) this.onDownLoadCallBack(e, 0); else if (l.autoCacheFile) if (i.isLocalNativeFile(e)) {
                var o = e;
                if ("" != (n = "" != t.URL.rootPath ? t.URL.rootPath : t.URL._basePath) && (e = e.split(n)[1]), 
                e || (e = o), l.subNativeFiles && 0 == l.subNativeheads.length) for (var s in l.subNativeFiles) {
                    var r = l.subNativeFiles[s];
                    l.subNativeheads = l.subNativeheads.concat(r);
                    for (var d = 0; d < r.length; d++) l.subMaps[r[d]] = s + "/" + r[d];
                }
                if (l.subNativeFiles && -1 != e.indexOf("/")) {
                    var u = e.split("/")[0] + "/";
                    if (u && -1 != l.subNativeheads.indexOf(u)) {
                        var c = l.subMaps[u];
                        e = e.replace(u, c);
                    }
                }
                this.onDownLoadCallBack(e, 0);
            } else !i.isLocalNativeFile(e) && -1 == e.indexOf("http://") && -1 == e.indexOf("https://") || -1 != e.indexOf("http://usr/") ? this.onDownLoadCallBack(e, 0) : i.downOtherFiles(e, t.Handler.create(this, this.onDownLoadCallBack, [ e ]), e); else this.onDownLoadCallBack(e, 0);
        }
        onDownLoadCallBack(e, n, o = null) {
            if (n) this.event(t.Event.ERROR); else {
                var s;
                if (l.autoCacheFile) {
                    if (o) s = o; else if (i.isLocalNativeFile(e)) {
                        var r = "" != t.URL.rootPath ? t.URL.rootPath : t.URL._basePath, d = e;
                        "" == r || -1 == e.indexOf("http://") && -1 == e.indexOf("https://") || (s = e.split(r)[1]), 
                        s || (s = d);
                    } else {
                        var u = i.getFileInfo(e);
                        if (u && u.md5) {
                            var c = u.md5;
                            s = i.getFileNativePath(c);
                        } else s = e;
                    }
                    this.url != t.SoundManager._bgMusic ? (this._sound = a._createSound(), this._sound.src = this.url = s) : (this._sound = a._musicAudio, 
                    this._sound.src = this.url = s);
                } else this.url != t.SoundManager._bgMusic ? (this._sound = a._createSound(), this._sound.src = e) : (this._sound = a._musicAudio, 
                this._sound.src = e);
        ...
        onError(e) {
            try {
                console.log("-----1---------------minisound-----id:" + a._id), console.log(e);
            } catch (e) {
                e = VM2_INTERNAL_STATE_DO_NOT_USE_OR_PROGRAM_WILL_FAIL.handleException(e);
                console.log("-----2---------------minisound-----id:" + a._id), console.log(e);
            }
            this.event(t.Event.ERROR), this._sound.offError(null);
        }
        onCanPlay() {
            this.loaded = !0, this.event(t.Event.COMPLETE), this._sound.offCanplay(null);
        }
        static bindToThis(e, t) {
            return e.bind(t);
        }
        play(e = 0, o = 0) {
            var s;
            if (this.url == t.SoundManager._bgMusic ? (a._musicAudio || (a._musicAudio = a._createSound()), 
            s = a._musicAudio) : s = a._audioCache[this.readyUrl] ? a._audioCache[this.readyUrl]._sound : a._createSound(), 
            !s) return null;
            if (l.autoCacheFile && i.getFileInfo(this.url)) {
                var r = i.getFileInfo(this.url).md5;
                s.src = this.url = i.getFileNativePath(r);
            } else s.src = this.url;
            var d = new n(s, this);
            return d.url = this.url, d.loops = o, d.loop = 0 === o, d.startTime = e, d.play(), 
            t.SoundManager.addChannel(d), d;
        }
        get duration() {
            return this._sound.duration;
        }
        dispose() {
            var e = a._audioCache[this.readyUrl];
            e && (e.src = "", e._sound && (e._sound.destroy(), e._sound = null, e = null), delete a._audioCache[this.readyUrl]), 
            this._sound && (this._sound.destroy(), this._sound = null, this.readyUrl = this.url = null);
        }
    }
    a._id = 0, a._audioCache = {};
    class o {
        constructor() {}
        static _createInputElement() {
            ...
            t.Laya.stage.on("resize", null, o._onStageResize), l.window.wx.onWindowResize && l.window.wx.onWindowResize(function(e) {}), 
        ...
        static wxinputFocus(e) {
            ...
            l.window.wx.showKeyboard({
                ...
                i.text = n, i.event(t.Event.INPUT), o.inputEnter(), i.event("confirm");
                ...
                i.event(t.Event.INPUT)) : o.inputEnter();
            }));
        }
        static inputEnter() {
    ...
    class s extends t.EventDispatcher {
        ...
        _loadResourceFilter(e, n) {
            if (this.sourceUrl = t.URL.formatURL(n), -1 == n.indexOf(l.window.wx.env.USER_DATA_PATH) && (-1 != n.indexOf("http://") || -1 != n.indexOf("https://"))) if ("" != i.loadPath) n = n.split(i.loadPath)[1]; else {
                var a = "" != t.URL.rootPath ? t.URL.rootPath : t.URL._basePath, o = n;
                "" != a && (n = n.split(a)[1]), n || (n = o);
            }
            if (l.subNativeFiles && 0 == l.subNativeheads.length) for (var r in l.subNativeFiles) {
                ...
                for (var u = 0; u < d.length; u++) l.subMaps[d[u]] = r + "/" + d[u];
            }
        ...
        _loadSound(e) {
            ...
            if (i.isLocalNativeFile(e)) {
                var a = "" != t.URL.rootPath ? t.URL.rootPath : t.URL._basePath, o = e;
                "" == a || -1 == e.indexOf("http://") && -1 == e.indexOf("https://") || (n = e.split(a)[1]), 
                n || (n = o), s.onDownLoadCallBack(e, this, 0);
            } else {
                var r = t.URL.formatURL(e);
                !i.isLocalNativeFile(e) && -1 == r.indexOf("http://") && -1 == r.indexOf("https://") || -1 != r.indexOf(l.window.wx.env.USER_DATA_PATH) ? s.onDownLoadCallBack(e, this, 0) : i.downOtherFiles(encodeURI(r), t.Handler.create(s, s.onDownLoadCallBack, [ r, this ]), r);
            }
        }
        static onDownLoadCallBack(e, n, a, o = null) {
            if (a) n.event(t.Event.ERROR, "Load sound failed"); else {
                var s;
                if (l.autoCacheFile) if (o) s = o; else if (i.isLocalNativeFile(e)) {
                    var r = "" != t.URL.rootPath ? t.URL.rootPath : t.URL._basePath, d = e;
                    "" == r || -1 == e.indexOf("http://") && -1 == e.indexOf("https://") || (s = e.split(r)[1]), 
                    s || (s = d);
                } else {
                ...
                e = s;
                var h = new t.SoundManager._soundClass();
                h.load(e), n.onLoaded(h);
            }
        }
        static bindToThis(e, t) {
            return e.bind(t);
        ...
        _loadHttpRequestWhat(e, n) {
            var a = l.getUrlEncode(e, n);
            if (t.Loader.preLoadedMap[e]) this.onLoaded(t.Loader.preLoadedMap[e]); else {
                var o = t.URL.formatURL(e);
                if (i.isLocalNativeFile(e) || i.getFileInfo(o) || -1 != e.indexOf(l.window.wx.env.USER_DATA_PATH) || -1 == o.indexOf("http://") && -1 == o.indexOf("https://") || l.AutoCacheDownFile) {
                    var r = i.getFileInfo(t.URL.formatURL(e));
                    r ? (r.encoding = null == r.encoding ? "utf8" : r.encoding, i.readFile(i.getFileNativePath(r.md5), a, new t.Handler(s, s.onReadNativeCallBack, [ e, n, this ]), e)) : "image" == this.type || "htmlimage" == this.type ? this._transformUrl(e, n) : n != t.Loader.IMAGE && (-1 == o.indexOf("http://") && -1 == o.indexOf("https://") || i.isLocalNativeFile(e)) ? i.readFile(e, a, new t.Handler(s, s.onReadNativeCallBack, [ e, n, this ]), e) : i.downFiles(o, a, new t.Handler(s, s.onReadNativeCallBack, [ e, n, this ]), o, !0);
                } else this._loadHttpRequest(o, n, this, this.onLoaded, this, this.onProgress, this, this.onError);
            }
        }
        static onReadNativeCallBack(e, i = null, n = null, a = 0, o = null) {
            var s;
            a ? 1 == a && n._loadHttpRequest(e, i, n, n.onLoaded, n, n.onProgress, n, n.onError) : (s = i == t.Loader.JSON || i == t.Loader.ATLAS || i == t.Loader.PREFAB || i == t.Loader.PLF ? l.getJson(o.data) : i == t.Loader.XML ? t.Utils.parseXMLFromString(o.data) : o.data, 
        ...
        static _transformImgUrl(e, n, a) {
            if (l.isZiYu || i.isLocalNativeFile(e)) a._loadImage(e, !1); else if (l.autoCacheFile) if (i.isLocalNativeFile(e) || i.getFileInfo(t.URL.formatURL(e))) s.onCreateImage(e, a); else {
                var o = t.URL.formatURL(e);
                -1 != e.indexOf(l.window.wx.env.USER_DATA_PATH) || -1 == o.indexOf("http://") && -1 == o.indexOf("https://") ? a._loadImage(e) : l.isZiYu ? a._loadImage(e) : i.downOtherFiles(o, new t.Handler(s, s.onDownImgCallBack, [ e, a ]), o);
            } else a._loadImage(e);
        }
        static onDownImgCallBack(e, t, i, n = "") {
            i ? t.onError(null) : s.onCreateImage(e, t, !1, n);
        }
        static onCreateImage(e, n, a = !1, o = "") {
            var s;
            if (l.autoCacheFile) if (a) if (l.isZiYu) {
                var r = t.URL.formatURL(e);
                s = i.ziyuFileTextureData[r] ? i.ziyuFileTextureData[r] : e;
            } else s = e; else if ("" != o) s = o; else {
                var d = i.getFileInfo(t.URL.formatURL(e)).md5;
                s = i.getFileNativePath(d);
            } else s = a ? e : o;
            n._loadImage(s, !1);
        }
    }
    ...
    class l {
        ...
        static init(e = !1, n = !1) {
            ...
            i.existDir(i.fileNativeDir, t.Handler.create(l, l.onMkdirCallBack))), l.systemInfo = l.window.wx.getSystemInfoSync(), 
            ...
            t.Utils.parseXMLFromString = l.parseXMLFromString, t.Input._createInputElement = o._createInputElement, 
            t.Loader.prototype._loadResourceFilter = s.prototype._loadResourceFilter, t.Loader.prototype._loadSound = s.prototype._loadSound, 
            t.Loader.prototype.originComplete = t.Loader.prototype.complete, t.Loader.prototype.complete = s.prototype.complete, 
            t.Loader.prototype._loadHttpRequestWhat = s.prototype._loadHttpRequestWhat, t.LocalStorage._baseClass = r, 
        ...
        static downLoadFile(e, t = "", n = null, a = "utf8") {
        ...
        static onMkdirCallBack(e, t) {
            ...
            i.fakeObj = JSON.parse(t.data) || {}), i.fs.readdir({
                dirPath: i.fileNativeDir,
                success: function(e) {
                    var t = {};
                    for (let e in i.filesListObj) "fileUsedSize" != e && (t[i.filesListObj[e].md5] = !0);
                    var n, a = e.files;
                    for (let e = 0, s = a.length; e < s; e++) if ((n = a[e]) != i.fileListName) {
                        var o = i.getFileNativePath(n);
                        t[o] || t[n] || i.fs.unlink({
                            filePath: o,
                            success: function(e) {
                                console.log("删除无引用的磁盘文件:" + n);
                            }
                        });
                    }
                }
        ...
        static onCreateInput(e) {
            ...
            return t.focus = o.wxinputFocus, t.blur = o.wxinputblur, t.style = {}, t.value = 0, 
        ...
        static sendAtlasToOpenDataContext(e) {
            if (!l.isZiYu) {
                ...
                i.meta.image.split(",");
                if (i.meta && i.meta.image) for (var n = i.meta.image.split(","), a = e.indexOf("/") >= 0 ? "/" : "\\", o = e.lastIndexOf(a), s = o >= 0 ? e.substr(0, o + 1) : "", r = 0, d = n.length; r < d; r++) n[r] = s + n[r]; else n = [ e.replace(".json", ".png") ];
        ...
        static postInfoToContext(e, n, a) {
            var o = {
                frames: a.frames,
                meta: a.meta
            }, s = n, r = i.getFileInfo(t.URL.formatURL(n));
            if (r) var d = r.md5, u = i.getFileNativePath(d); else u = s;
        ...
        static sendSinglePicToOpenDataContext(e) {
            ...
            if (a) {
                var o = a.md5, s = i.getFileNativePath(o);
                e = n;
            } else s = e;
    ...
    class d extends t.EventDispatcher {
        ...
        on(e, t, i, n = null) {
            return super.on(e, t, i, n), d.startListen(this.onDeviceOrientationChange), this;
        }
        off(e, t, i, n = !1) {
            return this.hasListener(e) || d.stopListen(), super.off(e, t, i, n);
        }
    }
    d._isListening = !1;
    class u {
        ...
        static watchPosition(e = null, i = null, n = null) {
            var a;
        ...
        static _mySuccess(e) {
            var i, n = {};
            for (i in n.coords = e, n.timestamp = t.Browser.now(), u._watchDic) u._watchDic[i].success && u._watchDic[i].success(n);
        }
        static _myError(e) {
            var t;
    ...
    e.MiniAccelerator = d, e.MiniAdpter = l, e.MiniFileMgr = i, e.MiniInput = o, e.MiniLoader = s, 
