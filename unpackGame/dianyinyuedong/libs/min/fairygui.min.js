window.fgui = {}, function(t) {
    ...
    t.AsyncOperation = class {
        ...
        internalCreateObject(i) {
            ...
            s.childCount = this.collectComponentChildren(i), this._itemList.push(s), this._index = 0, 
            Laya.timer.frameLoop(1, this, this.run);
        }
        collectComponentChildren(i) {
            var s, h, r, a, n, o, l = i.rawData;
            l.seek(0, 2);
            var _ = l.getInt16();
            for (r = 0; r < _; r++) {
                a = l.getInt16(), n = l.pos, l.seek(n, 0);
                var d = l.readByte(), c = l.readS(), u = l.readS();
                l.pos = n, null != c ? (h = null != (o = null != u ? t.UIPackage.getById(u) : i.owner) ? o.getItemById(c) : null, 
                s = new e(h, d), null != h && h.type == t.PackageItemType.Component && (s.childCount = this.collectComponentChildren(h))) : (s = new e(null, d), 
                d == t.ObjectType.List && (s.listItemCount = this.collectListChildren(l))), this._itemList.push(s), 
                l.pos = n + a;
            }
            return _;
        }
        collectListChildren(i) {
            i.seek(i.pos, 8);
            var s, h, r, a, n, o = 0, l = i.readS(), _ = i.getInt16();
            for (s = 0; s < _; s++) h = i.getInt16(), h += i.pos, null == (r = i.readS()) && (r = l), 
            r && null != (a = t.UIPackage.getItemByURL(r)) && (n = new e(a, a.objectType), a.type == t.PackageItemType.Component && (n.childCount = this.collectComponentChildren(a)), 
            this._itemList.push(n), o++), i.pos = h;
            return o;
        }
        run() {
    ...
    class e extends Laya.EventDispatcher {
        constructor() {
            super(), this._selectedIndex = 0, this._previousIndex = 0, this.changing = !1, this._pageIds = [], 
            this._pageNames = [], this._selectedIndex = -1, this._previousIndex = -1;
        }
        dispose() {
            this.offAll();
        }
        ...
        addPageAt(t, i = 0) {
            var s = "" + e._nextPageId++;
            i == this._pageIds.length ? (this._pageIds.push(s), this._pageNames.push(this.name)) : (this._pageIds.splice(i, 0, s), 
        ...
        setup(e) {
            var i, s, h = e.pos;
            e.seek(h, 0), this.name = e.readS(), this.autoRadioGroupDepth = e.readBool(), e.seek(h, 1);
            var r = e.getInt16();
            ...
            if (e.seek(h, 2), (r = e.getInt16()) > 0) for (null == this._actions && (this._actions = []), 
            i = 0; i < r; i++) {
    ...
    class e {
        static createEvent(t, i, s = null) {
            return e.$event.setTo(t, i, s ? s.target : i), s ? (e.$event.touchId = s.touchId, 
            e.$event.nativeEvent = s.nativeEvent) : e.$event.nativeEvent = null, e.$event._stoped = !1, 
            e.$event;
        }
    ...
    }(w = t.FillMethod || (t.FillMethod = {})), function(t) {
    ...
    }(v = t.FillOrigin || (t.FillOrigin = {})), function(t) {
        t[t.TopLeft = 0] = "TopLeft", t[t.TopRight = 1] = "TopRight", t[t.BottomLeft = 2] = "BottomLeft", 
        t[t.BottomRight = 3] = "BottomRight";
    ...
    class e {
        ...
        setXY(i, s) {
            if (this._x != i || this._y != s) {
                var h = i - this._x, r = s - this._y;
                this._x = i, this._y = s, this.handleXYChanged(), this instanceof t.GGroup && this.moveChildren(h, r), 
        ...
        center(e = !1) {
            var i;
            i = null != this._parent ? this.parent : this.root, this.setXY((i.width - this.width) / 2, (i.height - this.height) / 2), 
        ...
        localToGlobal(t = 0, i = 0, s = null) {
            ...
            s ? (s.x = t, s.y = i, this._displayObject.localToGlobal(s, !1)) : ((s = e.sHelperPoint).x = t, 
            s.y = i, this._displayObject.localToGlobal(s, !0));
        }
        globalToLocal(t = 0, i = 0, s = null) {
            return s ? (s.x = t, s.y = i, this._displayObject.globalToLocal(s, !1)) : ((s = e.sHelperPoint).x = t, 
            s.y = i, s = this._displayObject.globalToLocal(s, !0)), this._pivotAsAnchor && (s.x -= this._pivotX * this._width, 
            s.y -= this._pivotY * this._height), s;
        }
        ...
        __moving(i) {
            ...
            null != this._touchDownPoint && Math.abs(this._touchDownPoint.x - Laya.stage.mouseX) < s && Math.abs(this._touchDownPoint.y - Laya.stage.mouseY) < s || (this.reset(), 
            e.sDraggingQuery = !0, t.Events.dispatch(t.Events.DRAG_START, this._displayObject, i), 
            e.sDraggingQuery && this.dragBegin());
        }
        __moving2(i) {
            var s = Laya.stage.mouseX - e.sGlobalDragStart.x + e.sGlobalRect.x, h = Laya.stage.mouseY - e.sGlobalDragStart.y + e.sGlobalRect.y;
            if (null != this._dragBounds) {
                var r = t.GRoot.inst.localToGlobalRect(this._dragBounds.x, this._dragBounds.y, this._dragBounds.width, this._dragBounds.height, e.sDragHelperRect);
                s < r.x ? s = r.x : s + e.sGlobalRect.width > r.right && (s = r.right - e.sGlobalRect.width) < r.x && (s = r.x), 
                h < r.y ? h = r.y : h + e.sGlobalRect.height > r.bottom && (h = r.bottom - e.sGlobalRect.height) < r.y && (h = r.y);
            }
    ...
    t.GTextField = class extends t.GObject {
        ...
        handleControllerChanged(t) {
            super.handleControllerChanged(t), this._gearColor.controller == t && this._gearColor.apply();
        }
        getProp(e) {
            switch (e) {
              case t.ObjectPropID.Color:
    ...
    class e extends t.GTextField {
        ...
        renderWithBitmapFont() {
            ...
            s.clear(), this._lines ? i.returnList(this._lines) : this._lines = new Array();
            var h, r = this.leading - 1, a = this.width - 2 * e.GUTTER_X, n = 0, o = 0, l = 0, _ = 0, d = 0, c = 0, u = 0, g = 0, p = 0, f = "", y = e.GUTTER_Y, m = !this._widthAutoSize && !this._singleLine, w = this.fontSize, v = this._bitmapFont.resizable ? w / this._bitmapFont.size : 1;
            this._textWidth = 0, this._textHeight = 0;
            var C = this._text;
            null != this._templateVars && (C = this.parseTemplate(C));
            for (var b = C.length, S = 0; S < b; ++S) {
                var x = C.charAt(S), I = x.charCodeAt(0);
                if (10 != I) {
                    if (I >= 65 && I <= 90 || I >= 97 && I <= 122 ? (0 == c && (u = n), c++) : (c > 0 && (g = n), 
                    c = 0), 32 == I) _ = Math.ceil(w / 2), d = w; else {
                        var T = this._bitmapFont.glyphs[x];
                        T ? (_ = Math.ceil(T.advance * v), d = Math.ceil(T.lineHeight * v)) : (_ = 0, d = 0);
                    }
                    if (d > l && (l = d), d > o && (o = d), 0 != n && (n += this._letterSpacing), n += _, 
                    !m || n <= a) f += x; else {
                        if ((h = i.borrow()).height = o, h.textHeight = l, 0 == f.length) h.text = x; else if (c > 0 && g > 0) {
                            var P = (f += x).length - c;
                            h.text = t.ToolSet.trimRight(f.substr(0, P)), h.width = g, f = f.substr(P), n -= u;
                        } else h.text = f, h.width = n - (_ + this._letterSpacing), f = x, n = _, o = d, 
                        l = d;
                        h.y = y, y += h.height + r, h.width > this._textWidth && (this._textWidth = h.width), 
                        c = 0, u = 0, g = 0, this._lines.push(h);
                    }
                } else f += x, (h = i.borrow()).width = n, 0 == l && (0 == p && (p = w), 0 == o && (o = p), 
                l = o), h.height = o, p = o, h.textHeight = l, h.text = f, h.y = y, y += h.height + r, 
                h.width > this._textWidth && (this._textWidth = h.width), this._lines.push(h), f = "", 
                n = 0, o = 0, l = 0, c = 0, u = 0, g = 0;
            }
            f.length > 0 && ((h = i.borrow()).width = n, 0 == o && (o = p), 0 == l && (l = o), 
            h.height = o, h.textHeight = l, h.text = f, h.y = y, h.width > this._textWidth && (this._textWidth = h.width), 
            this._lines.push(h)), this._textWidth > 0 && (this._textWidth += 2 * e.GUTTER_X), 
            0 == this._lines.length ? this._textHeight = 0 : (h = this._lines[this._lines.length - 1], 
            this._textHeight = h.y + h.height + e.GUTTER_Y);
            var L, O = 0;
            if (L = this._widthAutoSize ? 0 == this._textWidth ? 0 : this._textWidth : this.width, 
            O = this._heightAutoSize ? 0 == this._textHeight ? 0 : this._textHeight : this.height, 
            this._updatingSize = !0, this.setSize(L, O), this._updatingSize = !1, this.doAlign(), 
            0 != L && 0 != O) {
                var k = e.GUTTER_X, B = 0, z = 0;
                a = this.width - 2 * e.GUTTER_X;
                for (var E = this._lines.length, j = this._bitmapFont.tint ? this._color : null, M = 0; M < E; M++) {
                    h = this._lines[M], k = e.GUTTER_X, B = "center" == this.align ? (a - h.width) / 2 : "right" == this.align ? a - h.width : 0, 
                    b = h.text.length;
                    for (var A = 0; A < b; A++) 10 != (I = (x = h.text.charAt(A)).charCodeAt(0)) && (32 != I ? null != (T = this._bitmapFont.glyphs[x]) ? (z = (h.height + h.textHeight) / 2 - Math.ceil(T.lineHeight * v), 
                    T.texture && s.drawTexture(T.texture, k + B + Math.ceil(T.x * v), h.y + z + Math.ceil(T.y * v), T.xMax * v, T.yMax * v, null, 1, j), 
                    k += this._letterSpacing + Math.ceil(T.advance * v)) : k += this._letterSpacing : k += this._letterSpacing + Math.ceil(w / 2));
                }
            }
        }
        handleSizeChanged() {
        ...
        doAlign() {
            if ("top" == this.valign || 0 == this._textHeight) this._yOffset = e.GUTTER_Y; else {
    ...
    class e extends t.GObject {
        constructor() {
            super(), this._sortingChildCount = 0, this._mask = null, this._children = [], this._controllers = [], 
        ...
        dispose() {
            ...
            this._boundsChanged = !1, this._mask = null, super.dispose();
        }
            ...
            if (!this._buildingDisplayList) {
                ...
                if (e instanceof t.GGroup) for (var s = 0; s < i; s++) {
                    ...
                    if (!e.displayObject.parent) {
                        var r = 0;
                        if (this._childrenRenderOrder == t.ChildrenRenderOrder.Ascent) {
                            for (s = 0; s < i && (h = this._children[s]) != e; s++) null != h.displayObject && null != h.displayObject.parent && r++;
                            this._container.addChildAt(e.displayObject, r);
                        } else if (this._childrenRenderOrder == t.ChildrenRenderOrder.Descent) {
                            for (s = i - 1; s >= 0 && (h = this._children[s]) != e; s--) null != h.displayObject && null != h.displayObject.parent && r++;
                            this._container.addChildAt(e.displayObject, r);
            ...
            if (this._displayObject) {
                ...
                if (0 != s) switch (this._childrenRenderOrder) {
                  ...
                  case t.ChildrenRenderOrder.Arch:
                    ...
                    for (e = 0; e < h; e++) null != (i = this._children[e]).displayObject && i.internalVisible && this._container.addChild(i.displayObject);
                    for (e = s - 1; e >= h; e--) null != (i = this._children[e]).displayObject && i.internalVisible && this._container.addChild(i.displayObject);
                }
            }
        }
        applyController(t) {
        ...
        adjustRadioGroupDepth(e, i) {
            ...
            a < n && (null != this._applyingController && this._children[n].handleControllerChanged(this._applyingController), 
        ...
        handleSizeChanged() {
            super.handleSizeChanged(), this._scrollPane ? this._scrollPane.onOwnerSizeChanged() : null != this._displayObject.scrollRect && this.updateMask(), 
        ...
        handleControllerChanged(t) {
            super.handleControllerChanged(t), null != this._scrollPane && this._scrollPane.handleControllerChanged(t);
        }
        ...
        constructFromResource2(e, i) {
            ...
            d.seek(0, 0), this._underConstruct = !0, this.sourceWidth = d.getInt32(), this.sourceHeight = d.getInt32(), 
            this.initWidth = this.sourceWidth, this.initHeight = this.sourceHeight, this.setSize(this.sourceWidth, this.sourceHeight), 
            d.readBool() && (this.minWidth = d.getInt32(), this.maxWidth = d.getInt32(), this.minHeight = d.getInt32(), 
            this.maxHeight = d.getInt32()), d.readBool() && (n = d.getFloat32(), o = d.getFloat32(), 
            this.internalSetPivot(n, o, d.readBool())), d.readBool() && (this._margin.top = d.getInt32(), 
            this._margin.bottom = d.getInt32(), this._margin.left = d.getInt32(), this._margin.right = d.getInt32());
            var c = d.readByte();
            if (c == t.OverflowType.Scroll) {
                var u = d.pos;
                d.seek(0, 7), this.setupScroll(d), d.pos = u;
            } else this.setupOverflow(c);
            d.readBool() && d.skip(8), this._buildingDisplayList = !0, d.seek(0, 1);
            var g, p = d.getInt16();
            for (s = 0; s < p; s++) {
                a = d.getInt16(), a += d.pos;
                var f = new t.Controller();
                this._controllers.push(f), f.parent = this, f.setup(d), d.pos = a;
            }
            d.seek(0, 2);
            var y = d.getInt16();
            for (s = 0; s < y; s++) {
                if (h = d.getInt16(), r = d.pos, null != e) g = e[i + s]; else {
                    d.seek(r, 0);
                    var m, w = d.readByte(), v = d.readS(), C = d.readS(), b = null;
                    if (null != v) b = null != (m = null != C ? t.UIPackage.getById(C) : this.packageItem.owner) ? m.getItemById(v) : null;
                    null != b ? ((g = t.UIObjectFactory.newObject(b)).packageItem = b, g.constructFromResource()) : g = t.UIObjectFactory.newObject2(w);
                }
                g._underConstruct = !0, g.setup_beforeAdd(d, r), g.parent = this, this._children.push(g), 
                d.pos = r + h;
            }
            for (d.seek(0, 3), this.relations.setup(d, !0), d.seek(0, 2), d.skip(2), s = 0; s < y; s++) a = d.getInt16(), 
            a += d.pos, d.seek(d.pos, 3), this._children[s].relations.setup(d, !1), d.pos = a;
            for (d.seek(0, 2), d.skip(2), s = 0; s < y; s++) a = d.getInt16(), a += d.pos, (g = this._children[s]).setup_afterAdd(d, d.pos), 
            g._underConstruct = !1, d.pos = a;
            d.seek(0, 4), d.skip(2), this.opaque = d.readBool();
            var S = d.getInt16();
            -1 != S && this.setMask(this.getChildAt(S).displayObject, d.readBool());
            var x, I = d.readS();
            l = d.getInt32(), _ = d.getInt32(), I ? (b = this.packageItem.owner.getItemById(I)) && b.pixelHitTestData && (x = new t.PixelHitTest(b.pixelHitTestData, l, _)) : 0 != l && -1 != _ && (x = new t.ChildHitArea(this.getChildAt(_).displayObject)), 
            ...
            this.setBoundsChangedFlag(), this.packageItem.objectType != t.ObjectType.Component && this.constructExtension(d), 
            this.onConstruct();
        }
        ...
        setup_afterAdd(t, e) {
            ...
            for (-1 != h && null != this._scrollPane && (this._scrollPane.pageController = this._parent.getControllerAt(h)), 
    ...
    class e extends t.GComponent {
        constructor() {
            super(), this._soundVolumeScale = 0, this._downEffect = 0, this._downEffectValue = 0, 
            this._downScaled = !1, this._mode = t.ButtonMode.Common, this._title = "", this._icon = "", 
            this._sound = t.UIConfig.buttonSound, this._soundVolumeScale = t.UIConfig.buttonSoundVolumeScale, 
        ...
        getTextField() {
            return this._titleObject instanceof t.GTextField ? this._titleObject : this._titleObject instanceof t.GLabel ? this._titleObject.getTextField() : this._titleObject instanceof e ? this._titleObject.getTextField() : null;
        }
        fireClick(i = !0) {
            i && this._mode == t.ButtonMode.Common && (this.setState(e.OVER), Laya.timer.once(100, this, this.setState, [ e.DOWN ], !1), 
            Laya.timer.once(200, this, this.setState, [ e.UP ], !1)), this.__click(t.Events.createEvent(Laya.Event.CLICK, this.displayObject));
        }
        setState(i) {
        ...
        constructExtension(i) {
            ...
            null != this._iconObject && (this._icon = this._iconObject.icon), this._mode == t.ButtonMode.Common && this.setState(e.UP), 
    ...
    t.GComboBox = class extends t.GComponent {
        ...
        setup_afterAdd(t, e) {
            if (super.setup_afterAdd(t, e), t.seek(e, 6) && t.readByte() == this.packageItem.objectType) {
                ...
                this._values[i] = t.readS(), null != (r = t.readS()) && (null == this._icons && (this._icons = []), 
    ...
    t.GGraph = class extends t.GObject {
        constructor() {
            ...
            this._cornerRadius = null, this._sides = 3, this._startAngle = 0;
        }
        ...
        drawRegularPolygon(t, e, i, s, h = 0, r = null) {
            ...
            this._startAngle = h, this._distances = r, this.updateGraph();
        }
        drawPolygon(t, e, i, s) {
    ...
    class e extends t.GComponent {
        ...
        getTextField() {
            return this._titleObject instanceof t.GTextField ? this._titleObject : this._titleObject instanceof e ? this._titleObject.getTextField() : this._titleObject instanceof t.GButton ? this._titleObject.getTextField() : null;
        }
        getProp(e) {
            switch (e) {
              case t.ObjectPropID.Color:
        ...
        setup_afterAdd(t, e) {
            if (super.setup_afterAdd(t, e), t.seek(e, 6) && t.readByte() == this.packageItem.objectType) {
                ...
                if (0 != s && (this.titleFontSize = s), t.readBool()) {
                    ...
                    null != h ? (null != (i = t.readS()) && (h.promptText = i), null != (i = t.readS()) && (h.restrict = i), 
                    0 != (s = t.getInt32()) && (h.maxLength = s), 0 != (s = t.getInt32()) && (4 == s ? h.keyboardType = Laya.Input.TYPE_NUMBER : 3 == s && (h.keyboardType = Laya.Input.TYPE_URL)), 
                    t.readBool() && (h.password = !0)) : t.skip(13);
                }
            }
        }
    }
    ...
    class e extends t.GComponent {
        ...
        addSelection(e, i) {
            if (this._selectionMode != t.ListSelectionMode.None) {
                ...
                if (this._virtual) {
                    ...
                    null != h.obj && (s = h.obj.asButton), h.selected = !0;
        ...
        setSelectionOnEvent(e, i) {
            if (e instanceof t.GButton && this._selectionMode != t.ListSelectionMode.None) {
                var s = !1, h = e, r = this.childIndexToItemIndex(this.getChildIndex(e));
                if (this._selectionMode == t.ListSelectionMode.Single) h.selected || (this.clearSelectionExcept(h), 
                h.selected = !0); else if (i.shiftKey) {
                    if (!h.selected) if (-1 != this._lastSelectedIndex) {
                        var a, n = Math.min(this._lastSelectedIndex, r), o = Math.max(this._lastSelectedIndex, r);
                        if (o = Math.min(o, this.numItems - 1), this._virtual) for (a = n; a <= o; a++) {
                ...
                } else i.ctrlKey || this._selectionMode == t.ListSelectionMode.Multiple_SingleClick ? h.selected = !h.selected : h.selected ? this.clearSelectionExcept(h) : (this.clearSelectionExcept(h), 
                h.selected = !0);
                s || (this._lastSelectedIndex = r), h.selected && this.updateSelectionController(r);
            }
        }
        resizeToFit(e = 1e6, i = 0) {
            ...
            if (e > s && (e = s), this._virtual) {
                ...
                for (var h = e - 1, r = null; h >= 0 && (r = this.getChildAt(h), this.foldInvisibleItems && !r.visible); ) h--;
                if (h < 0) this._layout == t.ListLayoutType.SingleColumn || this._layout == t.ListLayoutType.FlowHorizontal ? this.viewHeight = i : this.viewWidth = i; else {
                    var a = 0;
                    this._layout == t.ListLayoutType.SingleColumn || this._layout == t.ListLayoutType.FlowHorizontal ? ((a = r.y + r.height) < i && (a = i), 
                    this.viewHeight = a) : ((a = r.x + r.width) < i && (a = i), this.viewWidth = a);
                }
            }
        }
        getMaxItemWidth() {
        ...
        getSnappingPositionWithDir(i, s, h, r, a = null) {
            ...
            e.pos_param = s, o = this.getIndexOnPos1(!1), s = e.pos_param, o < this._virtualItems.length && o < this._realNumItems && (l = this._virtualItems[o].height, 
            ...
            e.pos_param = i, o = this.getIndexOnPos2(!1), i = e.pos_param, o < this._virtualItems.length && o < this._realNumItems && (l = this._virtualItems[o].width, 
            this.shouldSnapToNext(h, n - i, l) && (i += l + this._columnGap))) : (n = i, e.pos_param = i, 
            o = this.getIndexOnPos3(!1), i = e.pos_param, o < this._virtualItems.length && o < this._realNumItems && (l = this._virtualItems[o].width, 
        ...
        scrollToView(e, i = !1, s = !1) {
            if (this._virtual) {
                ...
                s = !0, null != this._scrollPane && this._scrollPane.scrollToView(h, i, s);
            } else {
                var l = this.getChildAt(e);
                null != this._scrollPane ? this._scrollPane.scrollToView(l, i, s) : null != this._parent && null != this._parent.scrollPane && this._parent.scrollPane.scrollToView(l, i, s);
            }
        }
        getFirstChildInView() {
        ...
        set numItems(t) {
            ...
            if (this._virtual) {
                ...
                var r = this._children.length;
                if (t > r) for (e = r; e < t; e++) null == this.itemProvider ? this.addItemFromPool() : this.addItemFromPool(this.itemProvider.runWith(e)); else this.removeChildrenToPool(t, r);
        ...
        getIndexOnPos1(t) {
            ...
            if (this.numChildren > 0 && !t) {
                if ((s = this.getChildAt(0).y) > e.pos_param) {
                    for (i = this._firstIndex - this._curLineItemCount; i >= 0; i -= this._curLineItemCount) if ((s -= this._virtualItems[i].height + this._lineGap) <= e.pos_param) return e.pos_param = s, 
                    i;
                    return e.pos_param = 0, 0;
                }
                for (i = this._firstIndex; i < this._realNumItems; i += this._curLineItemCount) {
                    if ((h = s + this._virtualItems[i].height + this._lineGap) > e.pos_param) return e.pos_param = s, 
                    i;
                    s = h;
                }
        ...
        getIndexOnPos2(t) {
            ...
            if (this.numChildren > 0 && !t) {
                if ((s = this.getChildAt(0).x) > e.pos_param) {
                    for (i = this._firstIndex - this._curLineItemCount; i >= 0; i -= this._curLineItemCount) if ((s -= this._virtualItems[i].width + this._columnGap) <= e.pos_param) return e.pos_param = s, 
                    i;
                    return e.pos_param = 0, 0;
                }
                for (i = this._firstIndex; i < this._realNumItems; i += this._curLineItemCount) {
                    if ((h = s + this._virtualItems[i].width + this._columnGap) > e.pos_param) return e.pos_param = s, 
                    i;
                    s = h;
                }
                return e.pos_param = s, this._realNumItems - this._curLineItemCount;
        ...
        getIndexOnPos3(t) {
            if (this._realNumItems < this._curLineItemCount) return e.pos_param = 0, 0;
            var i, s, h = this.viewWidth, r = Math.floor(e.pos_param / h), a = r * (this._curLineItemCount * this._curLineItemCount2), n = r * h;
            for (i = 0; i < this._curLineItemCount; i++) {
                if ((s = n + this._virtualItems[a + i].width + this._columnGap) > e.pos_param) return e.pos_param = n, 
                a + i;
                n = s;
            }
        ...
        handleScroll1(i) {
            ...
            this._firstIndex = a;
            var o, l, _, d, c, u = a, g = n > a, p = this.numChildren, f = n + p - 1, y = g ? f : n, m = 0, w = s, v = 0, C = 0, b = this.defaultItem, S = (this._scrollPane.viewWidth - this._columnGap * (this._curLineItemCount - 1)) / this._curLineItemCount;
            for (this.itemInfoVer++; u < this._realNumItems && (r || w < h); ) {
                ...
                this.removeChildToPool(l.obj), l.obj = null)), null == l.obj) {
                    if (g) {
                        for (c = y; c >= n; c--) if (null != (_ = this._virtualItems[c]).obj && _.updateFlag != this.itemInfoVer && _.obj.resourceURL == b) {
                            _.obj instanceof t.GButton && (_.selected = _.obj.selected), l.obj = _.obj, _.obj = null, 
                            c == y && y--;
                            break;
                        }
                    } else for (c = y; c <= f; c++) if (null != (_ = this._virtualItems[c]).obj && _.updateFlag != this.itemInfoVer && _.obj.resourceURL == b) {
                        _.obj instanceof t.GButton && (_.selected = _.obj.selected), l.obj = _.obj, _.obj = null, 
                        c == y && y++;
                        break;
                    }
                    null != l.obj ? this.setChildIndex(l.obj, g ? u - a : this.numChildren) : (l.obj = this._pool.getObject(b), 
                ...
                this.itemRenderer.runWith([ u % this._numItems, l.obj ]), u % this._curLineItemCount == 0 && (v += Math.ceil(l.obj.height) - l.height, 
                u == a && n > a && (C = Math.ceil(l.obj.height) - l.height)), l.width = Math.ceil(l.obj.width), 
                l.height = Math.ceil(l.obj.height)), l.updateFlag = this.itemInfoVer, l.obj.setXY(m, w), 
                u == a && (h += l.height), m += l.width + this._columnGap, u % this._curLineItemCount == this._curLineItemCount - 1 && (m = 0, 
                w += l.height + this._lineGap), u++;
            }
            for (d = 0; d < p; d++) (l = this._virtualItems[n + d]).updateFlag != this.itemInfoVer && null != l.obj && (l.obj instanceof t.GButton && (l.selected = l.obj.selected), 
            ...
            return 0 == v && 0 == C || this._scrollPane.changeContentSizeOnScrolling(0, v, 0, C), 
        ...
        handleScroll2(i) {
            ...
            var n = this._firstIndex;
            this._firstIndex = a;
            var o, l, _, d, c, u = a, g = n > a, p = this.numChildren, f = n + p - 1, y = g ? f : n, m = s, w = 0, v = 0, C = 0, b = this.defaultItem, S = (this._scrollPane.viewHeight - this._lineGap * (this._curLineItemCount - 1)) / this._curLineItemCount;
            for (this.itemInfoVer++; u < this._realNumItems && (r || m < h); ) {
                ...
                this.itemRenderer.runWith([ u % this._numItems, l.obj ]), u % this._curLineItemCount == 0 && (v += Math.ceil(l.obj.width) - l.width, 
                u == a && n > a && (C = Math.ceil(l.obj.width) - l.width)), l.width = Math.ceil(l.obj.width), 
                l.height = Math.ceil(l.obj.height)), l.updateFlag = this.itemInfoVer, l.obj.setXY(m, w), 
                u == a && (h += l.width), w += l.height + this._lineGap, u % this._curLineItemCount == this._curLineItemCount - 1 && (w = 0, 
            ...
            return 0 == v && 0 == C || this._scrollPane.changeContentSizeOnScrolling(v, 0, C, 0), 
        ...
        handleScroll3(i) {
            ...
            if (s = e.pos_param, h != this._firstIndex || i) {
                ...
                this._firstIndex = h;
                var a, n, o, l, _, d = r, c = this._virtualItems.length, u = this._curLineItemCount * this._curLineItemCount2, g = h % this._curLineItemCount, p = this.viewWidth, f = Math.floor(h / u) * u, y = f + 2 * u, m = this._defaultItem, w = (this._scrollPane.viewWidth - this._columnGap * (this._curLineItemCount - 1)) / this._curLineItemCount, v = (this._scrollPane.viewHeight - this._lineGap * (this._curLineItemCount2 - 1)) / this._curLineItemCount2;
                ...
                for (n = f; n < y; n++) if (!(n >= this._realNumItems) && (o = this._virtualItems[n]).updateFlag == this.itemInfoVer) {
                    if (null == o.obj) {
                        for (;d < c; ) {
                            if (null != (l = this._virtualItems[d]).obj && l.updateFlag != this.itemInfoVer) {
                    ...
                    a && (this._autoResizeItem && (this._curLineItemCount == this._columnCount && this._curLineItemCount2 == this._lineCount ? o.obj.setSize(w, v, !0) : this._curLineItemCount == this._columnCount ? o.obj.setSize(w, o.obj.height, !0) : this._curLineItemCount2 == this._lineCount && o.obj.setSize(o.obj.width, v, !0)), 
                ...
                for (n = d; n < c; n++) (o = this._virtualItems[n]).updateFlag != this.itemInfoVer && null != o.obj && (o.obj instanceof t.GButton && (o.selected = o.obj.selected), 
        ...
        readItems(t) {
            ...
            for (e = t.getInt16(), i = 0; i < e; i++) if (s = t.getInt16(), s += t.pos, null != (h = t.readS()) || (h = this.defaultItem)) {
                ...
                null != r && (this.addChild(r), this.setupItem(t, r)), t.pos = s;
            } else t.pos = s;
        }
        setupItem(e, i) {
            var s, h, r;
    ...
    class e extends t.GObject {
        constructor() {
            super(), this._contentSourceWidth = 0, this._contentSourceHeight = 0, this._contentWidth = 0, 
            this._contentHeight = 0, this._url = "", this._fill = t.LoaderFillType.None, this._align = "left", 
        ...
        dispose() {
            ...
            null != this._content2 && this._content2.dispose(), super.dispose();
        }
        get url() {
            return this._url;
        }
        ...
        setErrorState() {
            this._showErrorSign && (null == this._errorSign && null != t.UIConfig.loaderErrorSign && (this._errorSign = e._errorSignPool.getObject(t.UIConfig.loaderErrorSign)), 
        ...
        updateLayout() {
            ...
            this._content.pos(0, 0)); else {
                ...
                h = this.height / this._contentSourceHeight, 1 == s && 1 == h || (this._fill == t.LoaderFillType.ScaleMatchHeight ? s = h : this._fill == t.LoaderFillType.ScaleMatchWidth ? h = s : this._fill == t.LoaderFillType.Scale ? s > h ? s = h : h = s : this._fill == t.LoaderFillType.ScaleNoBorder && (s > h ? h = s : s = h), 
                this._shrinkOnly && (s > 1 && (s = 1), h > 1 && (h = 1)), this._contentWidth = this._contentSourceWidth * s, 
                this._contentHeight = this._contentSourceHeight * h)), null != this._content2 ? this._content2.setScale(s, h) : this._content.size(this._contentWidth, this._contentHeight), 
        ...
        setup_beforeAdd(t, e) {
            ...
            t.readBool() && (this.color = t.readColorS()), 0 != t.readByte() && t.skip(6), this._url && this.loadContent();
        }
    }
    ...
    t.GProgressBar = class extends t.GComponent {
        ...
        tweenValue(e, i) {
            ...
            return null != h ? (s = h.value.x, h.kill()) : s = this._value, this._value = e, 
        ...
        update(e) {
            ...
            this._barObjectH.x = this._barStartX + (s - this._barObjectH.width))), this._barObjectV && (this._barObjectV instanceof t.GImage && this._barObjectV.fillMethod != t.FillMethod.None ? this._barObjectV.fillAmount = 1 - i : (this._barObjectV.height = Math.floor(h * i), 
            this._barObjectV.y = this._barStartY + (h - this._barObjectV.height)))) : (this._barObjectH && (this._barObjectH instanceof t.GImage && this._barObjectH.fillMethod != t.FillMethod.None ? this._barObjectH.fillAmount = i : this._barObjectH.width = Math.floor(s * i)), 
            this._barObjectV && (this._barObjectV instanceof t.GImage && this._barObjectV.fillMethod != t.FillMethod.None ? this._barObjectV.fillAmount = i : this._barObjectV.height = Math.floor(h * i))), 
            this._aniObject instanceof t.GMovieClip && (this._aniObject.frame = Math.floor(100 * i));
        }
        constructExtension(t) {
    ...
    class e extends t.GComponent {
        constructor() {
            super(), null == e._inst && (e._inst = this), this.opaque = !1, this._popupStack = [], 
            this._justClosedPopups = [], this.displayObject.once(Laya.Event.DISPLAY, this, this.__addedToStage);
        }
        static get inst() {
        ...
        showPopup(t, e = null, i = null) {
            if (this._popupStack.length > 0) {
                ...
                if (-1 != s) for (var h = this._popupStack.length - 1; h >= s; h--) this.removeChild(this._popupStack.pop());
            }
            ...
            var n, o, l = 0, _ = 0;
            e ? (a = e.localToGlobal(), l = e.width, _ = e.height) : a = this.globalToLocal(Laya.stage.mouseX, Laya.stage.mouseY), 
            (n = a.x) + t.width > this.width && (n = n + l - t.width), o = a.y + _, (null == i && o + t.height > this.height || 0 == i) && (o = a.y - t.height - 1) < 0 && (o = 0, 
            n += l / 2), t.x = n, t.y = o;
        }
    ...
    class e extends t.GComponent {
        ...
        __gripMouseMove() {
            if (this.onStage) {
                var t = this.globalToLocal(Laya.stage.mouseX, Laya.stage.mouseY, e.sScrollbarHelperPoint);
                if (this._vertical) {
        ...
        __barMouseDown(t) {
            var i = this._grip.globalToLocal(Laya.stage.mouseX, Laya.stage.mouseY, e.sScrollbarHelperPoint);
    ...
    class e extends t.GComponent {
        ...
        __gripMouseMove(t) {
            if (this.canDrag) {
                var i, s = this.globalToLocal(Laya.stage.mouseX, Laya.stage.mouseY, e.sSilderHelperPoint), h = s.x - this._clickPos.x, r = s.y - this._clickPos.y;
        ...
        __barMouseDown(i) {
            if (this.changeOnClick) {
                var s, h = this._gripObject.globalToLocal(i.stageX, i.stageY, e.sSilderHelperPoint), r = t.ToolSet.clamp01((this._value - this._min) / (this._max - this._min));
    ...
    class e extends t.GList {
        ...
        getSelectedNodes(t) {
            t || (t = new Array()), e.helperIntList.length = 0, super.getSelection(e.helperIntList);
            for (var i = e.helperIntList.length, s = new Array(), h = 0; h < i; h++) {
        ...
        createCell(e) {
            ...
            null != h && (h.width = (e.level - 1) * this._indent), (s = i.getController("expanded")) && (s.on(t.Events.STATE_CHANGED, this, this.__expandedStateChanged), 
        ...
        getInsertIndexForNode(t) {
            ...
            null == e && (e = t.parent);
            for (var i = this.getChildIndex(e._cell) + 1, s = t.level, h = this.numChildren, r = i; r < h; r++) {
                if (this.getChildAt(r)._treeNode.level <= s) break;
                i++;
            }
            return i;
        }
        ...
        _afterExpanded(t) {
            if (t != this._rootNode) {
                ...
                null != t._cell) {
                    ...
                    e && (e.selectedIndex = 1), t._cell.on(Laya.Event.MOUSE_DOWN, this, this.__cellMouseDown), 
                    null != t._cell.parent && this.checkChildren(t, this.getChildIndex(t._cell));
                }
        ...
        checkChildren(t, e) {
            for (var i = t.numChildren, s = 0; s < i; s++) {
                ...
                null == h._cell && this.createCell(h), h._cell.parent || this.addChildAt(h._cell, e), 
        ...
        dispatchItemEvent(t, e) {
            if (0 != this._clickToExpand) {
                var i = t._treeNode;
                i && this._expandedStatusInEvt == i.expanded && (2 == this._clickToExpand || (i.expanded = !i.expanded));
            }
    ...
    t.PackageItem = class {
        constructor() {
            this.width = 0, this.height = 0, this.tileGridIndice = 0, this.interval = 0, this.repeatDelay = 0;
        }
        load() {
    ...
    t.RelationItem = class {
        ...
        internalAdd(i, s) {
            ...
            this._defs.push(h), (s || i == t.RelationType.Left_Center || i == t.RelationType.Center_Center || i == t.RelationType.Right_Center || i == t.RelationType.Top_Middle || i == t.RelationType.Middle_Middle || i == t.RelationType.Bottom_Middle) && (this._owner.pixelSnapping = !0);
        }
        remove(e) {
    ...
    class e {
        ...
        setup(e) {
            ...
            if (n && (this._footer = t.UIPackage.createObjectFromURL(n), null == this._footer)) throw new Error("FairyGUI: cannot create scrollPane this.footer from " + n);
        ...
        scrollToView(i, s, h) {
            ...
            r = this._owner.globalToLocalRect(e.sHelperRect.x, e.sHelperRect.y, e.sHelperRect.width, e.sHelperRect.height, e.sHelperRect)) : (r = e.sHelperRect).setTo(i.x, i.y, i.width, i.height) : r = i, 
            this._overlapSize.y > 0) {
                var a = this._yPos + this._viewSize.y;
                h || r.y <= this._yPos || r.height >= this._viewSize.y ? this._pageMode ? this.setPosY(Math.floor(r.y / this._pageSize.y) * this._pageSize.y, s) : this.setPosY(r.y, s) : r.y + r.height > a && (this._pageMode ? this.setPosY(Math.floor(r.y / this._pageSize.y) * this._pageSize.y, s) : r.height <= this._viewSize.y / 2 ? this.setPosY(r.y + 2 * r.height - this._viewSize.y, s) : this.setPosY(r.y + r.height - this._viewSize.y, s));
            }
            if (this._overlapSize.x > 0) {
                var n = this._xPos + this._viewSize.x;
                h || r.x <= this._xPos || r.width >= this._viewSize.x ? this._pageMode ? this.setPosX(Math.floor(r.x / this._pageSize.x) * this._pageSize.x, s) : this.setPosX(r.x, s) : r.x + r.width > n && (this._pageMode ? this.setPosX(Math.floor(r.x / this._pageSize.x) * this._pageSize.x, s) : r.width <= this._viewSize.x / 2 ? this.setPosX(r.x + 2 * r.width - this._viewSize.x, s) : this.setPosX(r.x + r.width - this._viewSize.x, s));
            }
        ...
        __mouseMove() {
            if (this._touchEffect && !this.owner.isDisposed && (null == e.draggingPane || e.draggingPane == this) && null == t.GObject.draggingObject) {
                var i, s, h, r = t.UIConfig.touchScrollSensitivity, a = this._owner.globalToLocal(Laya.stage.mouseX, Laya.stage.mouseY, e.sHelperPoint);
                if (this._scrollType == t.ScrollType.Vertical) {
                    if (!this._isHoldAreaDone) {
                        if (e._gestureFlag |= 1, (i = Math.abs(this._beginTouchPos.y - a.y)) < r) return;
                        if (0 != (2 & e._gestureFlag) && i < Math.abs(this._beginTouchPos.x - a.x)) return;
                    }
                    s = !0;
                } else if (this._scrollType == t.ScrollType.Horizontal) {
                    if (!this._isHoldAreaDone) {
                        if (e._gestureFlag |= 2, (i = Math.abs(this._beginTouchPos.x - a.x)) < r) return;
                        if (0 != (1 & e._gestureFlag) && i < Math.abs(this._beginTouchPos.y - a.y)) return;
                    }
                    h = !0;
                } else {
                    if (e._gestureFlag = 3, !this._isHoldAreaDone && (i = Math.abs(this._beginTouchPos.y - a.y)) < r && (i = Math.abs(this._beginTouchPos.x - a.x)) < r) return;
                    s = h = !0;
                }
                var n = Math.floor(this._containerPos.x + a.x - this._beginTouchPos.x), o = Math.floor(this._containerPos.y + a.y - this._beginTouchPos.y);
                s && (o > 0 ? this._bouncebackEffect ? null != this._header && 0 != this._header.maxHeight ? this._container.y = Math.floor(Math.min(.5 * o, this._header.maxHeight)) : this._container.y = Math.floor(Math.min(.5 * o, this._viewSize.y * e.PULL_RATIO)) : this._container.y = 0 : o < -this._overlapSize.y ? this._bouncebackEffect ? null != this._footer && this._footer.maxHeight > 0 ? this._container.y = Math.floor(Math.max(.5 * (o + this._overlapSize.y), -this._footer.maxHeight) - this._overlapSize.y) : this._container.y = Math.floor(Math.max(.5 * (o + this._overlapSize.y), -this._viewSize.y * e.PULL_RATIO) - this._overlapSize.y) : this._container.y = -this._overlapSize.y : this._container.y = o), 
                h && (n > 0 ? this._bouncebackEffect ? null != this._header && 0 != this._header.maxWidth ? this._container.x = Math.floor(Math.min(.5 * n, this._header.maxWidth)) : this._container.x = Math.floor(Math.min(.5 * n, this._viewSize.x * e.PULL_RATIO)) : this._container.x = 0 : n < 0 - this._overlapSize.x ? this._bouncebackEffect ? null != this._footer && this._footer.maxWidth > 0 ? this._container.x = Math.floor(Math.max(.5 * (n + this._overlapSize.x), -this._footer.maxWidth) - this._overlapSize.x) : this._container.x = Math.floor(Math.max(.5 * (n + this._overlapSize.x), -this._viewSize.x * e.PULL_RATIO) - this._overlapSize.x) : this._container.x = -this._overlapSize.x : this._container.x = n);
                var l = Laya.stage.frameRate == Laya.Stage.FRAME_SLOW ? 30 : 60, _ = Laya.timer.currTimer / 1e3, d = Math.max(_ - this._lastMoveTime, 1 / l), c = a.x - this._lastTouchPos.x, u = a.y - this._lastTouchPos.y;
                if (h || (c = 0), s || (u = 0), 0 != d) {
                    var g = d * l - 1;
                    if (g > 1) {
                    ...
                    this._velocity.x = t.ToolSet.lerp(this._velocity.x, 60 * c / l / d, 10 * d), this._velocity.y = t.ToolSet.lerp(this._velocity.y, 60 * u / l / d, 10 * d);
                }
                var f = this._lastTouchGlobalPos.x - Laya.stage.mouseX, y = this._lastTouchGlobalPos.y - Laya.stage.mouseY;
                0 != c ? this._velocityScale = Math.abs(f / c) : 0 != u && (this._velocityScale = Math.abs(y / u)), 
                this._lastTouchPos.setTo(a.x, a.y), this._lastTouchGlobalPos.setTo(Laya.stage.mouseX, Laya.stage.mouseY), 
                this._lastMoveTime = _, this._overlapSize.x > 0 && (this._xPos = t.ToolSet.clamp(-this._container.x, 0, this._overlapSize.x)), 
                this._overlapSize.y > 0 && (this._yPos = t.ToolSet.clamp(-this._container.y, 0, this._overlapSize.y)), 
                0 != this._loop && (n = this._container.x, o = this._container.y, this.loopCheckingCurrent() && (this._containerPos.x += this._container.x - n, 
                this._containerPos.y += this._container.y - o)), e.draggingPane = this, this._isHoldAreaDone = !0, 
        ...
        __mouseUp() {
            ...
            i = !0), i) {
                ...
                this._tweenChange.x = e.sEndPos.x - this._tweenStart.x, this._tweenChange.y = e.sEndPos.y - this._tweenStart.y; else if (this._footerLockedSize > 0 && e.sEndPos[this._refreshBarAxis] == -this._overlapSize[this._refreshBarAxis]) {
                    ...
                    e.sEndPos[this._refreshBarAxis] = -s, this._tweenChange.x = e.sEndPos.x - this._tweenStart.x, 
                ...
                if (this._inertiaDisabled) this._tweenDuration.setTo(e.TWEEN_TIME_DEFAULT, e.TWEEN_TIME_DEFAULT); else {
                    var h = Laya.stage.frameRate == Laya.Stage.FRAME_SLOW ? 30 : 60, r = (Laya.timer.currTimer / 1e3 - this._lastMoveTime) * h - 1;
                    if (r > 1) {
                        var a = Math.pow(.833, r);
        ...
        alignPosition(t, i) {
            if (this._pageMode) t.x = this.alignByPage(t.x, "x", i), t.y = this.alignByPage(t.y, "y", i); else if (this._snapToItem) {
                var s = 0, h = 0;
                i && (s = t.x - this._containerPos.x, h = t.y - this._containerPos.y);
                var r = this._owner.getSnappingPositionWithDir(-t.x, -t.y, s, h, e.sHelperPoint);
        ...
        updateTargetAndDuration2(t, i) {
            ...
            if (t > 0) t = 0; else if (t < -this._overlapSize[i]) t = -this._overlapSize[i]; else {
                ...
                0 != a) a > 1 && (a = 1), r *= a, s *= a, this._velocity[i] = s, h = Math.log(60 / r) / Math.log(this._decelerationRate) / 60, 
                t += Math.floor(s * h * .4);
            }
            return h < e.TWEEN_TIME_DEFAULT && (h = e.TWEEN_TIME_DEFAULT), this._tweenDuration[i] = h, 
            t;
        }
        fixDuration(t, i) {
            if (!(0 == this._tweenChange[t] || Math.abs(this._tweenChange[t]) >= Math.abs(i))) {
                var s = Math.abs(this._tweenChange[t] / i) * this._tweenDuration[t];
                s < e.TWEEN_TIME_DEFAULT && (s = e.TWEEN_TIME_DEFAULT), this._tweenDuration[t] = s;
            }
        }
        startTween(t) {
        ...
        checkRefreshBar() {
            if (null != this._header || null != this._footer) {
                ...
                if (null != this._footer) {
                    var s = this._overlapSize[this._refreshBarAxis];
                    t < -s || 0 == s && this._footerLockedSize > 0 ? (null == this._footer.displayObject.parent && this._maskContainer.addChildAt(this._footer.displayObject, 0), 
                    (i = e.sHelperPoint).setTo(this._footer.x, this._footer.y), i[this._refreshBarAxis] = s > 0 ? t + this._contentSize[this._refreshBarAxis] : Math.max(Math.min(t + this._viewSize[this._refreshBarAxis], this._viewSize[this._refreshBarAxis] - this._footerLockedSize), this._viewSize[this._refreshBarAxis] - this._contentSize[this._refreshBarAxis]), 
                    this._footer.setXY(i.x, i.y), i.setTo(this._footer.width, this._footer.height), 
                    i[this._refreshBarAxis] = s > 0 ? -s - t : this._viewSize[this._refreshBarAxis] - this._footer[this._refreshBarAxis], 
        ...
        runTween(t) {
            ...
            if (0 != this._tweenChange[t]) {
                ...
                this._tweenChange[t] = 0; else {
                    var s = e.easeFunc(this._tweenTime[t], this._tweenDuration[t]);
                    i = this._tweenStart[t] + Math.floor(this._tweenChange[t] * s);
                }
                var h = 0, r = -this._overlapSize[t];
                if (this._headerLockedSize > 0 && this._refreshBarAxis == t && (h = this._headerLockedSize), 
                ...
                2 == this._tweening && this._bouncebackEffect ? i > 20 + h && this._tweenChange[t] > 0 || i > h && 0 == this._tweenChange[t] ? (this._tweenTime[t] = 0, 
                this._tweenDuration[t] = e.TWEEN_TIME_DEFAULT, this._tweenChange[t] = -i + h, this._tweenStart[t] = i) : (i < r - 20 && this._tweenChange[t] < 0 || i < r && 0 == this._tweenChange[t]) && (this._tweenTime[t] = 0, 
                this._tweenDuration[t] = e.TWEEN_TIME_DEFAULT, this._tweenChange[t] = r - i, this._tweenStart[t] = i) : i > h ? (i = h, 
                this._tweenChange[t] = 0) : i < r && (i = r, this._tweenChange[t] = 0);
    ...
    class e {
        ...
        _play(e = null, s = 1, h = 0, r = 0, a = -1, n = !1) {
            ...
            for (var o = this._items.length, l = 0; l < o; l++) {
                ...
                null != _.target && _.type == i.Transition) {
                    ...
                    if (d == this && (d = null), null != d) if (0 == _.value.playTimes) {
                        var c;
                        for (c = l - 1; c >= 0; c--) {
                            var u = this._items[c];
                            if (u.type == i.Transition && u.value.trans == d) {
        ...
        setValue(t, ...e) {
            for (var s, h = this._items.length, r = !1, a = 0; a < h; a++) {
                var n = this._items[a];
                if (n.label == t) s = null != n.tweenConfig ? n.tweenConfig.startValue : n.value, 
                r = !0; else {
                    if (null == n.tweenConfig || n.tweenConfig.endLabel != t) continue;
                ...
                switch (n.type) {
                  ...
                  case i.Scale:
                  case i.Skew:
                    s.b1 = !0, s.b2 = !0, s.f1 = parseFloat(e[0]), s.f2 = parseFloat(e[1]);
                    break;
                  ...
                  case i.Animation:
                    s.frame = parseInt(e[0]), e.length > 1 && (s.playing = e[1]);
                    break;
                  ...
                  case i.Sound:
                    s.sound = e[0], e.length > 1 && (s.volume = parseFloat(e[1]));
                    break;

                  case i.Transition:
                    s.transName = e[0], e.length > 1 && (s.playTimes = parseInt(e[1]));
                    break;

                  case i.Shake:
                    s.amplitude = parseFloat(e[0]), e.length > 1 && (s.duration = parseFloat(e[1]));
                    break;

                  case i.ColorFilter:
                    s.f1 = parseFloat(e[0]), s.f2 = parseFloat(e[1]), s.f3 = parseFloat(e[2]), s.f4 = parseFloat(e[3]);
                    break;
        ...
        setDuration(t, e) {
            for (var i = this._items.length, s = !1, h = 0; h < i; h++) {
                var r = this._items[h];
                null != r.tweenConfig && r.label == t && (r.tweenConfig.duration = e, s = !0);
            }
            if (!s) throw new Error("this.label not exists");
        }
        getLabelTime(t) {
        ...
        set timeScale(e) {
            if (this._timeScale != e && (this._timeScale = e, this._playing)) for (var s = this._items.length, h = 0; h < s; h++) {
                var r = this._items[h];
                null != r.tweener ? r.tweener.setTimeScale(e) : r.type == i.Transition ? null != r.value.trans && (r.value.trans.timeScale = e) : r.type == i.Animation && null != r.target && r.target.setProp(t.ObjectPropID.TimeScale, e);
            }
        }
        updateFromRelations(t, e, s) {
            ...
            if (0 != h) for (var r = 0; r < h; r++) {
                ...
                a.tweenConfig.startValue.f2 += s), a.tweenConfig.endValue.b3 || (a.tweenConfig.endValue.f1 += e, 
                a.tweenConfig.endValue.f2 += s)) : a.value.b3 || (a.value.f1 += e, a.value.f2 += s));
            }
        }
        onOwnerAddedToStage() {
        ...
        onDelayedPlay() {
            if (this.internalPlay(), this._playing = this._totalTasks > 0, this._playing) {
                if (0 != (this._options & e.OPTION_IGNORE_DISPLAY_CONTROLLER)) for (var t = this._items.length, i = 0; i < t; i++) {
                    var s = this._items[i];
                    null != s.target && s.target != this._owner && (s.displayLockToken = s.target.addDisplayLock());
                }
        ...
        internalPlay() {
            ...
            if (this._reversed) for (h = e - 1; h >= 0; h--) null != (t = this._items[h]).target && this.playItem(t); else for (var h = 0; h < e; h++) null != (t = this._items[h]).target && (t.type == i.Animation && 0 != this._startTime && t.time <= this._startTime ? (s = !0, 
        ...
        playItem(e) {
            ...
            if (null != e.tweenConfig) {
                ...
                -1 == this._endTime || s <= this._endTime) {
                    var h, r;
                    switch (this._reversed ? (h = e.tweenConfig.endValue, r = e.tweenConfig.startValue) : (h = e.tweenConfig.startValue, 
                    r = e.tweenConfig.endValue), e.value.b1 = h.b1 || r.b1, e.value.b2 = h.b2 || r.b2, 
                    e.type) {
                      case i.XY:
                      case i.Size:
                      case i.Scale:
                      case i.Skew:
                        e.tweener = t.GTween.to2(h.f1, h.f2, r.f1, r.f2, e.tweenConfig.duration);
                        break;

                      case i.Alpha:
                      case i.Rotation:
                        e.tweener = t.GTween.to(h.f1, r.f1, e.tweenConfig.duration);
                        break;

                      case i.Color:
                        e.tweener = t.GTween.toColor(h.f1, r.f1, e.tweenConfig.duration);
                        break;

                      case i.ColorFilter:
                        e.tweener = t.GTween.to4(h.f1, h.f2, h.f3, h.f4, r.f1, r.f2, r.f3, r.f4, e.tweenConfig.duration);
                    }
        ...
        skipAnimations() {
            for (var e, s, h, r, a, n, o = this._items.length, l = 0; l < o; l++) if (!((n = this._items[l]).type != i.Animation || n.time > this._startTime || (r = n.value).flag)) {
                e = (a = n.target).getProp(t.ObjectPropID.Frame), s = a.getProp(t.ObjectPropID.Playing) ? 0 : -1, 
                h = 0;
                for (var _ = l; _ < o; _++) (n = this._items[_]).type != i.Animation || n.target != a || n.time > this._startTime || ((r = n.value).flag = !0, 
                -1 != r.frame ? (e = r.frame, s = r.playing ? n.time : -1, h = 0) : r.playing ? s < 0 && (s = n.time) : (s >= 0 && (h += n.time - s), 
                s = -1), this.callHook(n, !1));
                s >= 0 && (h += this._startTime - s), a.setProp(t.ObjectPropID.Playing, s >= 0), 
                a.setProp(t.ObjectPropID.Frame, e), h > 0 && a.setProp(t.ObjectPropID.DeltaTime, 1e3 * h);
            }
        }
        onDelayedPlayItem(t) {
            var e = t.target;
        ...
        onTweenStart(t) {
            var e, s, h = t.target;
            h.type != i.XY && h.type != i.Size || (this._reversed ? (e = h.tweenConfig.endValue, 
            s = h.tweenConfig.startValue) : (e = h.tweenConfig.startValue, s = h.tweenConfig.endValue), 
            h.type == i.XY ? h.target != this._owner ? (e.b1 ? e.b3 && (t.startValue.x = e.f1 * this._owner.width) : t.startValue.x = h.target.x, 
            e.b2 ? e.b3 && (t.startValue.y = e.f2 * this._owner.height) : t.startValue.y = h.target.y, 
            s.b1 ? s.b3 && (t.endValue.x = s.f1 * this._owner.width) : t.endValue.x = t.startValue.x, 
            s.b2 ? s.b3 && (t.endValue.y = s.f2 * this._owner.height) : t.endValue.y = t.startValue.y) : (e.b1 || (t.startValue.x = h.target.x - this._ownerBaseX), 
            e.b2 || (t.startValue.y = h.target.y - this._ownerBaseY), s.b1 || (t.endValue.x = t.startValue.x), 
            s.b2 || (t.endValue.y = t.startValue.y)) : (e.b1 || (t.startValue.x = h.target.width), 
            e.b2 || (t.startValue.y = h.target.height), s.b1 || (t.endValue.x = t.startValue.x), 
            ...
            switch (e.type) {
              ...
              case i.Transition:
                if (this._playing) {
                    ...
                    if (null != h) {
                        this._totalTasks++;
                        var r = this._startTime > e.time ? this._startTime - e.time : 0, a = this._endTime >= 0 ? this._endTime - e.time : -1;
                        s.stopTime >= 0 && (a < 0 || a > s.stopTime) && (a = s.stopTime), h.timeScale = this._timeScale, 
                        h._play(Laya.Handler.create(this, this.onPlayTransCompleted, [ e ]), s.playTimes, 0, r, a, this._reversed);
                    }
                }
                break;
        ...
        setup(e) {
            ...
            for (var i = e.getInt16(), r = 0; r < i; r++) {
                ...
                e.readBool()) {
                    if (e.seek(n, 1), o.tweenConfig = new h(), o.tweenConfig.duration = e.getFloat32(), 
    ...
    class h {
        constructor() {
            this.easeType = t.EaseType.QuadOut, this.startValue = new d(), this.endValue = new d();
        }
    }
    class r {}
    class a {}
    ...
    class e {
        ...
        static loadFromXML(t) {
            e.strings = {};
            for (var i = Laya.Utils.parseXMLFromString(t), s = e.findChildNode(i, "resources").childNodes, h = s.length, r = 0; r < h; r++) {
                var a = s[r];
                if ("string" == a.nodeName) {
                    var n = a.getAttribute("name"), o = a.textContent, l = n.indexOf("-");
                    if (-1 == l) continue;
                    var _ = n.substr(0, l), d = n.substr(l + 1), c = e.strings[_];
                    ...
                    for (o = 0; o < g; o++) {
                        ...
                        for (l = 0; l < y; l++) {
                            if (a = u.getInt16(), a += u.pos, 6 == u.readByte()) {
                                for (u.skip(2), c = u.getInt16(), w = 0; w < c; w++) null != u.readS() && (null != (r = s[h + "-texts_" + w]) ? u.writeS(r) : u.skip(2));
                        ...
                        if (p == t.ObjectType.Component && u.version >= 2) {
                            ...
                            for (var m = u.getUint16(), w = 0; w < m; w++) {
                                var v = u.readS();
                                0 == u.getUint16() && null != (r = s[h + "-cp-" + v]) ? u.writeS(r) : u.skip(2);
                            }
                        }
                        switch (f) {
                          ...
                          case t.ObjectType.Tree:
                            for (u.seek(d, 8), u.skip(2), n = u.getUint16(), l = 0; l < n; l++) {
                                ...
                                null != (r = s[h + "-" + l]) ? u.writeS(r) : u.skip(2), null != (r = s[h + "-" + l + "-0"]) && u.writeS(r), 
                                u.version >= 2) {
                                    u.skip(6), u.skip(4 * u.getUint16());
                                    for (m = u.getUint16(), w = 0; w < m; w++) {
                                        v = u.readS();
                                        0 == u.getUint16() && null != (r = s[h + "-" + l + "-" + v]) ? u.writeS(r) : u.skip(2);
                                    }
                                }
                                u.pos = a;
                            }
    ...
    class e {
        static setExtension(i, s) {
            ...
            null != h && (h.extensionType = s), e.packageItemExtensions[i] = s;
        }
    ...
    class e {
        ...
        static addPackage(i, s) {
            if (!(s || (s = t.AssetProxy.inst.getRes(i + "." + t.UIConfig.packageFileExtension)) && 0 != s.byteLength)) throw new Error("namespace sunnyboxs not ready: " + i);
            var h = new t.ByteBuffer(s), r = new e();
            return r.loadPackage(h, i), e._instById[r.id] = r, e._instByName[r.name] = r, r._customId = i, 
            r;
        }
        static loadPackage(i, s) {
            ...
            var r = Laya.Handler.create(this, function(h) {
                ...
                let a = r._items.length, n = [];
                for (var o = 0; o < a; o++) {
                    var l = r._items[o];
                    l.type == t.PackageItemType.Atlas ? n.push({
                        url: l.file,
                        type: Laya.Loader.IMAGE
                    }) : l.type == t.PackageItemType.Sound && n.push({
                        url: l.file,
                        type: Laya.Loader.SOUND
                    });
                }
                n.length > 0 ? t.AssetProxy.inst.load(n, Laya.Handler.create(this, function() {
                    e._instById[r.id] = r, e._instByName[r.name] = r, s.run();
                })) : s.run();
            });
        ...
        static removePackage(t) {
            ...
            i.dispose(), delete e._instById[i.id], null != i._customId && delete e._instById[i._customId], 
        ...
        loadPackage(s, h) {
            if (1179080009 != s.getUint32()) throw new Error("FairyGUI: old namespace sunnyboxs found in '" + h + "'");
            s.version = s.getInt32();
            var r = s.version >= 2, a = s.readBool();
            if (this._id = s.readUTFString(), this._name = s.readUTFString(), s.skip(20), a) {
                var n = new Uint8Array(s.buffer, s.pos, s.length - s.pos);
                n = new Zlib.RawInflate(n).decompress(), s = new t.ByteBuffer(n);
            }
            var o, l, _, d, c, u = s.pos;
            s.seek(u, 4), o = s.getInt32();
            var g, p = [];
            for (l = 0; l < o; l++) p[l] = s.readUTFString();
            for (s.stringTable = p, s.seek(u, 0), o = s.getInt16(), l = 0; l < o; l++) this._dependencies.push({
                id: s.readS(),
                name: s.readS()
            });
            for (r && ((o = s.getInt16()) > 0 && (this._branches = s.readSArray(o), e._branch && (this._branchIndex = this._branches.indexOf(e._branch))), 
            c = o > 0), s.seek(u, 1), h += "_", o = s.getUint16(), l = 0; l < o; l++) {
                switch (_ = s.getInt32(), _ += s.pos, (g = new t.PackageItem()).owner = this, g.type = s.readByte(), 
                g.id = s.readS(), g.name = s.readS(), s.readS(), (d = s.readS()) && (g.file = d), 
                s.readBool(), g.width = s.getInt32(), g.height = s.getInt32(), g.type) {
                  case t.PackageItemType.Image:
                    g.objectType = t.ObjectType.Image;
                    var f = s.readByte();
                    1 == f ? (g.scale9Grid = new Laya.Rectangle(), g.scale9Grid.x = s.getInt32(), g.scale9Grid.y = s.getInt32(), 
                    g.scale9Grid.width = s.getInt32(), g.scale9Grid.height = s.getInt32(), g.tileGridIndice = s.getInt32()) : 2 == f && (g.scaleByTile = !0), 
                    g.smoothing = s.readBool();
                    break;

                  case t.PackageItemType.MovieClip:
                    g.smoothing = s.readBool(), g.objectType = t.ObjectType.MovieClip, g.rawData = s.readBuffer();
                    break;
                  ...
                  case t.PackageItemType.Component:
                    var y = s.readByte();
                    g.objectType = y > 0 ? y : t.ObjectType.Component, g.rawData = s.readBuffer(), t.UIObjectFactory.resolvePackageItemExtension(g);
                    break;
                ...
                if (r) {
                    ...
                    var m = s.getUint8();
                    m > 0 && (c ? g.branches = s.readSArray(m) : this._itemsById[s.readS()] = g);
                    var w = s.getUint8();
            ...
            for (s.seek(u, 2), o = s.getUint16(), l = 0; l < o; l++) {
                ...
                var C = new i();
                C.atlas = g, C.rect.x = s.getInt32(), C.rect.y = s.getInt32(), C.rect.width = s.getInt32(), 
                C.rect.height = s.getInt32(), C.rotated = s.readBool(), r && s.readBool() ? (C.offset.x = s.getInt32(), 
                C.offset.y = s.getInt32(), C.originalSize.x = s.getInt32(), C.originalSize.y = s.getInt32()) : (C.originalSize.x = C.rect.width, 
                C.originalSize.y = C.rect.height), this._sprites[v] = C, s.pos = _;
            }
            if (s.seek(u, 3)) for (o = s.getUint16(), l = 0; l < o; l++) _ = s.getInt32(), _ += s.pos, 
            (g = this._itemsById[s.readS()]) && g.type == t.PackageItemType.Image && (g.pixelHitTestData = new t.PixelHitTestData(), 
            g.pixelHitTestData.load(s)), s.pos = _;
        }
        loadAllAssets() {
            for (var t = this._items.length, e = 0; e < t; e++) {
                var i = this._items[e];
        ...
        internalCreateObject(i, s) {
            var h;
            return null == (h = i.type == t.PackageItemType.Component && s ? new s() : t.UIObjectFactory.newObject(i)) ? null : (e._constructing++, 
            h.packageItem = i, h.constructFromResource(), e._constructing--, h);
        }
        getItemById(t) {
        ...
        loadMovieClip(e) {
            ...
            i.seek(0, 1);
            var s, h, r, a, n, o = i.getInt16();
            e.frames = [];
            for (var l = 0; l < o; l++) {
                var _ = i.getInt16();
                if (_ += i.pos, h = new t.Frame(), a = i.getInt32(), n = i.getInt32(), i.getInt32(), 
                i.getInt32(), h.addDelay = i.getInt32(), null != (s = i.readS()) && null != (r = this._sprites[s])) {
                    var d = this.getItemAsset(r.atlas);
                    h.texture = Laya.Texture.create(d, r.rect.x, r.rect.y, r.rect.width, r.rect.height, a, n, e.width, e.height);
                }
        ...
        loadFont(e) {
            ...
            var h, r, a = s.getInt32(), n = s.getInt32(), o = null, l = this._sprites[e.id];
            ...
            for (var _ = null, d = s.getInt32(), c = 0; c < d; c++) {
                ...
                if (_.x = s.getInt32(), _.y = s.getInt32(), h = s.getInt32(), r = s.getInt32(), 
                _.advance = s.getInt32(), _.channel = s.readByte(), 1 == _.channel ? _.channel = 3 : 2 == _.channel ? _.channel = 2 : 3 == _.channel && (_.channel = 1), 
                i.ttf) _.texture = Laya.Texture.create(o, f + l.rect.x, y + l.rect.y, h, r), _.lineHeight = n; else {
                    var m = this._itemsById[p];
                    m && (h = (m = m.getBranch()).width, r = m.height, m = m.getHighResolution(), this.getItemAsset(m), 
                    _.texture = m.texture), 0 == _.advance && (_.advance = 0 == a ? _.x + h : a), _.lineHeight = _.y < 0 ? r : _.y + r, 
    ...
    class i {
        constructor() {
            this.rect = new Laya.Rectangle(), this.offset = new Laya.Point(), this.originalSize = new Laya.Point();
        }
    }
}(fgui || (fgui = {})), function(t) {
    t.Window = class extends t.GComponent {
        constructor() {
            super(), this._requestingCmd = 0, this.focusable = !0, this._uiSources = [], this.bringToFontOnClick = t.UIConfig.bringWindowToFrontOnClick, 
    ...
    t.PlayTransitionAction = class extends t.ControllerAction {
        constructor() {
            super(), this.playTimes = 1, this.delay = 0, this.stopOnExit = !1;
        }
        enter(t) {
    ...
    t.BMGlyph = class {
        constructor() {
            this.x = 0, this.y = 0, this.xMax = 0, this.yMax = 0, this.advance = 0, this.lineHeight = 0, 
            this.channel = 0;
        }
    };
}(fgui || (fgui = {})), function(t) {
    class e {
        static fill(i, s, h, r, a, n) {
            if (n <= 0) return null;
            if (n >= .9999) return [ 0, 0, i, 0, i, s, 0, s ];
            var o;
            switch (h) {
        ...
        static fillRadial180(i, s, h, r, a) {
            ...
            switch (h) {
              case t.FillOrigin.Top:
                a <= .5 ? (a /= .5, n = e.fillRadial90(i / 2, s, r ? t.FillOrigin.TopLeft : t.FillOrigin.TopRight, r, a), 
                r && e.movePoints(n, i / 2, 0)) : (a = (a - .5) / .5, n = e.fillRadial90(i / 2, s, r ? t.FillOrigin.TopRight : t.FillOrigin.TopLeft, r, a), 
                r ? n.push(i, s, i, 0) : (e.movePoints(n, i / 2, 0), n.push(0, s, 0, 0)));
                break;

              case t.FillOrigin.Bottom:
                a <= .5 ? (a /= .5, n = e.fillRadial90(i / 2, s, r ? t.FillOrigin.BottomRight : t.FillOrigin.BottomLeft, r, a), 
                r || e.movePoints(n, i / 2, 0)) : (a = (a - .5) / .5, n = e.fillRadial90(i / 2, s, r ? t.FillOrigin.BottomLeft : t.FillOrigin.BottomRight, r, a), 
                r ? (e.movePoints(n, i / 2, 0), n.push(0, 0, 0, s)) : n.push(i, 0, i, s));
                break;

              case t.FillOrigin.Left:
                a <= .5 ? (a /= .5, n = e.fillRadial90(i, s / 2, r ? t.FillOrigin.BottomLeft : t.FillOrigin.TopLeft, r, a), 
                r || e.movePoints(n, 0, s / 2)) : (a = (a - .5) / .5, n = e.fillRadial90(i, s / 2, r ? t.FillOrigin.TopLeft : t.FillOrigin.BottomLeft, r, a), 
                r ? (e.movePoints(n, 0, s / 2), n.push(i, 0, 0, 0)) : n.push(i, s, 0, s));
                break;

              case t.FillOrigin.Right:
                a <= .5 ? (a /= .5, n = e.fillRadial90(i, s / 2, r ? t.FillOrigin.TopRight : t.FillOrigin.BottomRight, r, a), 
                r && e.movePoints(n, 0, s / 2)) : (a = (a - .5) / .5, n = e.fillRadial90(i, s / 2, r ? t.FillOrigin.BottomRight : t.FillOrigin.TopRight, r, a), 
                r ? n.push(0, s, i, s) : (e.movePoints(n, 0, s / 2), n.push(0, 0, i, 0)));
            }
            return n;
        }
        static fillRadial360(i, s, h, r, a) {
            ...
            switch (h) {
              case t.FillOrigin.Top:
                a <= .5 ? (a /= .5, n = e.fillRadial180(i / 2, s, r ? t.FillOrigin.Left : t.FillOrigin.Right, r, a), 
                r && e.movePoints(n, i / 2, 0)) : (a = (a - .5) / .5, n = e.fillRadial180(i / 2, s, r ? t.FillOrigin.Right : t.FillOrigin.Left, r, a), 
                r ? n.push(i, s, i, 0, i / 2, 0) : (e.movePoints(n, i / 2, 0), n.push(0, s, 0, 0, i / 2, 0)));
                break;

              case t.FillOrigin.Bottom:
                a <= .5 ? (a /= .5, n = e.fillRadial180(i / 2, s, r ? t.FillOrigin.Right : t.FillOrigin.Left, r, a), 
                r || e.movePoints(n, i / 2, 0)) : (a = (a - .5) / .5, n = e.fillRadial180(i / 2, s, r ? t.FillOrigin.Left : t.FillOrigin.Right, r, a), 
                r ? (e.movePoints(n, i / 2, 0), n.push(0, 0, 0, s, i / 2, s)) : n.push(i, 0, i, s, i / 2, s));
                break;

              case t.FillOrigin.Left:
                a <= .5 ? (a /= .5, n = e.fillRadial180(i, s / 2, r ? t.FillOrigin.Bottom : t.FillOrigin.Top, r, a), 
                r || e.movePoints(n, 0, s / 2)) : (a = (a - .5) / .5, n = e.fillRadial180(i, s / 2, r ? t.FillOrigin.Top : t.FillOrigin.Bottom, r, a), 
                r ? (e.movePoints(n, 0, s / 2), n.push(i, 0, 0, 0, 0, s / 2)) : n.push(i, s, 0, s, 0, s / 2));
                break;

              case t.FillOrigin.Right:
                a <= .5 ? (a /= .5, n = e.fillRadial180(i, s / 2, r ? t.FillOrigin.Top : t.FillOrigin.Bottom, r, a), 
                r && e.movePoints(n, 0, s / 2)) : (a = (a - .5) / .5, n = e.fillRadial180(i, s / 2, r ? t.FillOrigin.Bottom : t.FillOrigin.Top, r, a), 
                r ? n.push(0, s, i, s, i, s / 2) : (e.movePoints(n, 0, s / 2), n.push(0, 0, i, 0, i, s / 2)));
            }
            return n;
        }
    }
    ...
    t.Image = class extends Laya.Sprite {
        constructor() {
            super(), this._scaleByTile = !1, this._scale9Grid = null, this._tileGridIndice = 0, 
            this._needRebuild = 0, this._fillMethod = 0, this._fillOrigin = 0, this._fillAmount = 0, 
            this._fillClockwise = !1, this._mask = null, this.mouseEnabled = !1, this._color = "#FFFFFF";
        }
        set width(t) {
        ...
        doFill() {
            ...
            if (s.clear(), 0 != e && 0 != i) {
                var h = t.FillUtils.fill(e, i, this._fillMethod, this._fillOrigin, this._fillClockwise, this._fillAmount);
    ...
    t.MovieClip = class extends t.Image {
        constructor() {
            super(), this.interval = 0, this.swing = !1, this.repeatDelay = 0, this.timeScale = 1, 
            this._playing = !0, this._frameCount = 0, this._frame = 0, this._start = 0, this._end = 0, 
            this._times = 0, this._endAt = 0, this._status = 0, this._endHandler = null, this._frameElapsed = 0, 
            this._reversed = !1, this._repeatedCount = 0, this.mouseEnabled = !1, this.setPlaySettings(), 
            this.on(Laya.Event.DISPLAY, this, this.__addToStage), this.on(Laya.Event.UNDISPLAY, this, this.__removeFromStage);
        }
        get frames() {
            return this._frames;
        }
    ...
    t.GearAnimation = class extends t.GearBase {
        ...
        init() {
            this._default = new e(this._owner.getProp(t.ObjectPropID.Playing), this._owner.getProp(t.ObjectPropID.Frame)), 
            this._storage = {};
        }
        addStatus(t, i) {
            var s;
            null == t ? s = this._default : (s = new e(), this._storage[t] = s), s.playing = i.readBool(), 
            s.frame = i.getInt32();
        }
        apply() {
        ...
        updateState() {
            ...
            i || (i = new e(), this._storage[this._controller.selectedPageId] = i), i.playing = this._owner.getProp(t.ObjectPropID.Playing), 
    ...
    t.GearColor = class extends t.GearBase {
        ...
        init() {
            this._default = new e(this._owner.getProp(t.ObjectPropID.Color), this._owner.getProp(t.ObjectPropID.OutlineColor)), 
            this._storage = {};
        }
        addStatus(t, i) {
            var s;
            null == t ? s = this._default : (s = new e(), this._storage[t] = s), s.color = i.readColorS(), 
        ...
        updateState() {
            var i = this._storage[this._controller.selectedPageId];
            i || (i = new e(null, null), this._storage[this._controller.selectedPageId] = i), 
            i.color = this._owner.getProp(t.ObjectPropID.Color), i.strokeColor = this._owner.getProp(t.ObjectPropID.OutlineColor);
        }
    };
    class e {
    ...
    t.GearDisplay = class extends t.GearBase {
        constructor(t) {
            super(t), this._visible = 0, this._displayLockToken = 0, this._displayLockToken = 1;
        }
        init() {
            this.pages = null;
        }
    ...
    t.GearLook = class extends t.GearBase {
        ...
        addStatus(t, i) {
            var s;
            null == t ? s = this._default : (s = new e(), this._storage[t] = s), s.alpha = i.getFloat32(), 
            s.rotation = i.getFloat32(), s.grayed = i.readBool(), s.touchable = i.readBool();
        }
        apply() {
            var e = this._storage[this._controller.selectedPageId];
    ...
    t.GearSize = class extends t.GearBase {
        ...
        addStatus(t, i) {
            var s;
            null == t ? s = this._default : (s = new e(), this._storage[t] = s), s.width = i.getInt32(), 
            s.height = i.getInt32(), s.scaleX = i.getFloat32(), s.scaleY = i.getFloat32();
        }
        apply() {
            var e = this._storage[this._controller.selectedPageId];
            if (e || (e = this._default), null == this._tweenConfig || !this._tweenConfig.tween || t.UIPackage._constructing || t.GearBase.disableAllTweenEffect) this._owner._gearLocked = !0, 
        ...
        static evaluate(s, h, r, a, n) {
            switch (s) {
              ...
              case t.EaseType.ElasticIn:
                ...
                o = n / 4) : o = n / e._TwoPi * Math.asin(1 / a), -a * Math.pow(2, 10 * (h -= 1)) * Math.sin((h * r - o) * e._TwoPi / n));

              case t.EaseType.ElasticOut:
                var l;
                return 0 == h ? 0 : 1 == (h /= r) ? 1 : (0 == n && (n = .3 * r), a < 1 ? (a = 1, 
                l = n / 4) : l = n / e._TwoPi * Math.asin(1 / a), a * Math.pow(2, -10 * h) * Math.sin((h * r - l) * e._TwoPi / n) + 1);

              case t.EaseType.ElasticInOut:
                var _;
                return 0 == h ? 0 : 2 == (h /= .5 * r) ? 1 : (0 == n && (n = r * (.3 * 1.5)), a < 1 ? (a = 1, 
                _ = n / 4) : _ = n / e._TwoPi * Math.asin(1 / a), h < 1 ? a * Math.pow(2, 10 * (h -= 1)) * Math.sin((h * r - _) * e._TwoPi / n) * -.5 : a * Math.pow(2, -10 * (h -= 1)) * Math.sin((h * r - _) * e._TwoPi / n) * .5 + 1);
    ...
    class i {
        ...
        static easeInOut(t, e) {
            return t < .5 * e ? .5 * i.easeIn(2 * t, e) : .5 * i.easeOut(2 * t - e, e) + .5;
        }
    }
}(fgui || (fgui = {})), function(t) {
    class e {}
    ...
    class e {
        ...
        create2(t, e, i, s) {
            var h = new Array();
            h.push(t), h.push(e), i && h.push(i), s && h.push(s), this.create(h);
        }
        create(s) {
            ...
            if (0 != h) {
                ...
                r.length = 0;
                var a = s[0];
                a.curveType == t.CurveType.CRSpline && r.push(new Laya.Point(a.x, a.y));
                for (var n = 1; n < h; n++) {
                    var o = s[n];
                    if (a.curveType != t.CurveType.CRSpline) {
                        ...
                        this._points.push(new Laya.Point(a.x, a.y)), this._points.push(new Laya.Point(o.x, o.y))) : a.curveType == t.CurveType.Bezier ? (l.ptCount = 3, 
                        this._points.push(new Laya.Point(a.x, a.y)), this._points.push(new Laya.Point(o.x, o.y)), 
                        ...
                        l.length = t.ToolSet.distance(a.x, a.y, o.x, o.y), this._fullLength += l.length, 
                        this._segments.push(l);
                    }
                    o.curveType != t.CurveType.CRSpline ? r.length > 0 && (r.push(new Laya.Point(o.x, o.y)), 
                    this.createSplineSegment()) : r.push(new Laya.Point(o.x, o.y)), a = o;
                }
                r.length > 1 && this.createSplineSegment();
            }
        }
        createSplineSegment() {
            var s = e.helperPoints, h = s.length;
            s.splice(0, 0, s[0]), s.push(s[h]), s.push(s[h]), h += 3;
            var r = new i();
            r.type = t.CurveType.CRSpline, r.ptStart = this._points.length, r.ptCount = h, this._points = this._points.concat(s), 
            r.length = 0;
            for (var a = 1; a < h; a++) r.length += t.ToolSet.distance(s[a - 1].x, s[a - 1].y, s[a].x, s[a].y);
            this._fullLength += r.length, this._segments.push(r), s.length = 0;
        }
        clear() {
    ...
    class e {
        ...
        update() {
            if (this._ended = 0, 0 != this._valueSize) {
                ...
                if (this._normalizedTime = t.EaseManager.evaluate(this._easeType, i ? this._duration - s : s, this._duration, this._easeOvershootOrAmplitude, this._easePeriod), 
    ...
    class e {
        ...
        static isTweening(t, i) {
            ...
            for (var s = !i, h = 0; h < e._totalActiveTweens; h++) {
                ...
                if (null != r && r.target == t && !r._killed && (s || r._propType == i)) return !0;
            }
            return !1;
        }
        static killTweens(t, i, s) {
            if (null == t) return !1;
            for (var h = !1, r = e._totalActiveTweens, a = !s, n = 0; n < r; n++) {
                var o = e._activeTweens[n];
                null == o || o.target != t || o._killed || !a && o._propType != s || (o.kill(i), 
                h = !0);
            }
            return h;
        }
        static getTween(t, i) {
            ...
            for (var s = e._totalActiveTweens, h = !i, r = 0; r < s; r++) {
                ...
                if (null != a && a.target == t && !a._killed && (h || a._propType == i)) return a;
            }
            return null;
        }
        static update() {
            for (var i = Laya.timer.delta / 1e3, s = e._totalActiveTweens, h = -1, r = 0; r < s; r++) {
                var a = e._activeTweens[r];
                null == a ? -1 == h && (h = r) : a._killed ? (a._reset(), e._tweenerPool.push(a), 
                e._activeTweens[r] = null, -1 == h && (h = r)) : (a._target instanceof t.GObject && a._target.isDisposed ? a._killed = !0 : a._paused || a._update(i), 
                -1 != h && (e._activeTweens[h] = a, e._activeTweens[r] = null, h++));
            }
            if (h >= 0) {
                if (e._totalActiveTweens != s) {
                    var n = s;
                    for (s = e._totalActiveTweens - s, r = 0; r < s; r++) e._activeTweens[h++] = e._activeTweens[n++];
                }
    ...
    class e extends Laya.Byte {
        constructor(t = null, e = 0, i = -1) {
            -1 == i && (i = t.byteLength - e), 0 == e && i == t.byteLength ? super(t) : (super(), 
    ...
    class e {
        ...
        static setColorFilter(t, e) {
            ...
            if ("boolean" == typeof e) s = i ? i._color_ : null, h = e; else {
                if ("string" == typeof e) {
                    var o = Laya.ColorUtils.create(e).arrColor;
                    e = 1 == o[0] && 1 == o[1] && 1 == o[2] ? null : [ o[0], 0, 0, 0, 0, 0, o[1], 0, 0, 0, 0, 0, o[2], 0, 0, 0, 0, 0, 1, 0 ];
                }
                s = e, h = !!i && i._grayed_;
            }
            s || h ? (i || (i = new Laya.ColorFilter(), r ? r.push(i) : r = [ i ], t.filters = r), 
            i.reset(), i._color_ = s, i._grayed_ = h, h ? i.gray() : s && (20 == s.length ? i.setByMatrix(s) : (i.adjustBrightness(s[0]), 
            i.adjustContrast(s[1]), i.adjustSaturation(s[2]), i.adjustHue(s[3])))) : r && -1 != (a = r.indexOf(i)) && (r.splice(a, 1), 
