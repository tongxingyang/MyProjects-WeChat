!function(t, e) {
    ...
    class n {
        ...
        static _multiLineLayout(t) {
            ...
            U.y = I, U.h = L; else {
                if (r._isChar()) {
                    if ((_ = r).isWord) d = b || "\n" === _.char, U.wordStartIndex = U.elements.length; else {
                    ...
                    H = _.width + _.style.letterSpacing, v = _.height, b = !1, (d = d || w + H > m) && addLine(), 
                    U.minTextHeight = Math.min(U.minTextHeight, r.height);
