!function() {
    ...
    function n() {
        ...
        this.onStart = function(a) {
            ...
            if (e(n)) {
                ...
                "string" !== u(n.event) && Q.join(",").indexOf(n.event + ",") === -1) return void console.warn("关卡running状态中仅支持" + Q.join(",") + "事件类型，且为必传字段，详情请参考文档。");
                ...
                n.event.indexOf("pay") !== -1 && ("number" === u(n.params.itemMoney) && toString(n.params.itemMoney).length < 32 ? r.params.money = n.params.itemMoney : r.params.money = 0), 
            ...
            if (e(n)) {
                ...
                !u(n.event) && F.join(",").indexOf(n.event + ",") !== -1) return void F.join(",");
    ...
    "" === w.app_key && console.error("请在配置文件中填写您的app_key"), w.useOpen && console.warn("提示：开启了useOpen配置后，如果不上传用户opendId则不会上报数据。"), 
    ...
    var R = {
        aldSendEvent: function(e, t) {
            ...
            f(n, "event"); else if ("object" == typeof t) {
