define("engine/adapter-min.js", function(require, module, exports){ 			
  "use strict";
  ...
  !function i(a, c, u) {
    ...
    2: [function (e, t, n) {
      ...
      var r = window.fsUtils,
        ...
        _write: function _write() {
          g = !(m = null), u(this.cacheDir + "/" + this.cachedFileName, JSON.stringify({
            files: this.cachedFiles._map,
            version: this.version
          }), "utf8", function () {
            g = !1;
          ...
          for (var n in this.cacheQueue) {
            var e = function e(_e) {
              ...
              cc.js.isEmptyObject(t.cacheQueue) || (h = !0, setTimeout(t._cache.bind(t), t.cacheInterval));
                ...
                c = Date.now().toString(),
                u = "",
                u = a ? "".concat(this.cacheDir, "/").concat(a, "/").concat(c).concat(_++).concat(cc.path.extname(n)) : "".concat(this.cacheDir, "/").concat(c).concat(_++).concat(cc.path.extname(n));
        ...
        clearLRU: function clearLRU() {
          if (!b) {
            ...
            var n = [],
                r = this;
            this.cachedFiles.forEach(function (e, t) {
            ...
            }), n.length = Math.floor(this.cachedFiles.count / 3);
            ...
            this.writeCacheFile(function () {
              setTimeout(function e() {
                var t = n.pop();
                r._isZipFile(t.originUrl) ? (d(t.url, !0), r._deleteFileCB()) : f(t.url, r._deleteFileCB.bind(r)), 0 < n.length ? setTimeout(e, r.deleteInterval) : b = !1;
              }, r.deleteInterval);
            });
          }
        },
    ...
    3: [function (e, t, n) {
      ...
      var o,
          ...
          s = r.getUserDataPath,
          m = /^\w+:\/\/.*/,
          l = cc.assetManager.downloader,
          g = cc.assetManager.parser,
          y = cc.assetManager.presets,
          v = __globalAdapter.isSubContext;
      l.maxConcurrency = 8, l.maxRequestsPerFrame = 64, y.scene.maxConcurrency = 10, y.scene.maxRequestsPerFrame = 64;
      var b = {},
          w = {};
      ...
      var I = g.parsePVRTex,
          R = g.parsePKMTex;
      var j = v ? function (e, t, n) {
        n(null, e = F(e, t).url);
      } : A;
      l.downloadDomAudio = E, l.downloadScript = _, g.parsePVRTex = D, g.parsePKMTex = P, l.register({
        ".js": _,
        ".mp3": A,
        ".ogg": A,
        ".wav": A,
        ...
        bundle: function bundle(e, u, s) {
          var t,
              ...
              o = u.version || cc.assetManager.downloader.bundleVers[r];
          b[r] ? (n = "subpackages/".concat(r, "/config.").concat(o ? o + "." : "", "json"), h(r, u.onFileProgress, function (e) {
            e ? s(e, null) : O(n, u, function (e, t) {
              t && (t.base = "subpackages/".concat(r, "/")), s(e, t);
            });
          })) : (m.test(e) ? (l = e, t = "src/scripts/".concat(r, "/index.js"), f.makeBundleFolder(r)) : w[r] ? (l = "".concat(i, "remote/").concat(r), t = "src/scripts/".concat(r, "/index.js"), f.makeBundleFolder(r)) : (l = "assets/".concat(r), t = "assets/".concat(r, "/index.js")), __cocos_require__(t), u.cacheEnabled = !0, u.__cacheBundleRoot__ = r, n = "".concat(l, "/config.").concat(o ? o + "." : "", "json"), O(n, u, function (e, o) {
            var t, n, r, i, a, c;
            e ? s && s(e) : o.isZip ? (t = o.zipVersion, n = "".concat(l, "/res.").concat(t ? t + "." : "", "zip"), r = n, i = u, a = function a(e, t) {
              var n, r;
              e ? s && s(e) : (o.base = t + "/res/", (n = cc.sys).platform === n.ALIPAY_GAME && n.os === n.OS_ANDROID && (r = t + "res/", d.accessSync({
                path: r
              }) && (o.base = r)), s && s(null, o));
            }, (c = f.cachedFiles.get(r)) ? (f.updateLastTime(r), a && a(null, c.url)) : m.test(r) ? p(r, null, i.header, i.onFileProgress, function (e, t) {
        ...
        ".png": l.downloadDomImage,
        ".jpg": l.downloadDomImage,
        ".bmp": l.downloadDomImage,
        ".jpeg": l.downloadDomImage,
        ".gif": l.downloadDomImage,
        ".ico": l.downloadDomImage,
        ".tiff": l.downloadDomImage,
        ".image": l.downloadDomImage,
        ".webp": l.downloadDomImage,
        ".pvr": D,
        ".pkm": P,
        ".font": M,
        ".eot": M,
      ...
      var L,
        ...
        var n,
            ...
            o = !1,
            i = !1;
        return !e.startsWith(s()) && m.test(e) ? t.reload || ((n = f.cachedFiles.get(e)) ? (i = !0, e = n.url) : (r = f.tempFiles.get(e)) && (o = !0, e = r)) : o = !0, {
          url: e,
          inLocal: o,
          inCache: i
        };
      ...
      v ? (L = cc.assetManager.init, cc.assetManager.init = function (e) {
        ...
        for (var t = e.output = e.input, n = 0, r = t.length; n < r; n++) {
          var o = t[n],
              i = o.options;
          o.config ? i.__cacheBundleRoot__ = o.config.name : i.cacheEnabled = void 0 !== i.cacheEnabled && i.cacheEnabled;
        }
    ...
    7: [function (e, t, n) {
      ...
      var o, i, a, c, u;
      cc && cc.EditBox && (o = cc.EditBox, i = cc.js, a = o.KeyboardReturnType, c = null, u = o._ImplClass, i.extend(r, u), o._ImplClass = r, Object.assign(r.prototype, {
        init: function init(e) {
          e ? this._delegate = e : cc.error("EditBox init failed");
        },
        beginEditing: function beginEditing() {
          var e;
          c !== this && (e = this._delegate, c ? (c._eventListeners.onKeyboardComplete(), __globalAdapter.updateKeyboard && __globalAdapter.updateKeyboard({
            value: e._string
          })) : this._showKeyboard(), this._registerKeyboardEvent(), this._editing = !0, c = this, e.editBoxEditingDidBegan());
        },
        ...
        _registerKeyboardEvent: function _registerKeyboardEvent() {
          ...
          e.onKeyboardInput = function (e) {
            ...
            n._editing = !1, c = null, n._unregisterKeyboardEvent(), r.editBoxEditingDidEnded();
    ...
    8: [function (e, t, n) {
      ...
      Object.assign(i, {
        ...
        _runMainLoop: function _runMainLoop() {
          ...
          cc.debug.setDisplayStats(n.showFPS), _e2 = function e() {
            if (!t._paused) {
              if (t._intervalId = window.requestAnimFrame(_e2), 30 === i && !__globalAdapter.setPreferredFramesPerSecond && (o = !o)) return;
              r.mainLoop();
            }
          }, t._intervalId = window.requestAnimFrame(_e2), t._paused = !1;
        },
    ...
    12: [function (e, t, n) {
      ...
      t.exports = function (e, t) {
        ...
        var n = t.system.toLowerCase(),
            r = t.platform;
        "android" === (r = r.toLowerCase()) ? e.os = e.OS_ANDROID : "ios" === r && (e.os = e.OS_IOS), "android p" === n && (n = "android p 9.0");
        var o = /[\d\.]+/.exec(n);
        e.osVersion = o ? o[0] : n, e.osMainVersion = parseInt(e.osVersion), e.browserType = null, e.browserVersion = null;
        var i = t.windowWidth,
            a = t.windowHeight,
            c = t.pixelRatio || 1;
        ...
        var u = !__globalAdapter.isSubContext,
            s = !1;
    ...
    13: [function (e, t, n) {
      ...
      t.exports = function (e) {
        e._setupContainer = function (e, t, n) {
          var r,
              o = e._devicePixelRatio = 1;
          e.isRetinaEnabled() && (o = e._devicePixelRatio = Math.min(e._maxPixelRatio, window.devicePixelRatio || 1)), __globalAdapter.isSubContext || (t *= o, n *= o, (r = cc.game.canvas).width === t && r.height === n || (r.width = t, r.height = n));
        };
      };
    }, {}],
    14: [function (e, t, n) {
    ...
    19: [function (e, t, n) {
      ...
      r.prototype.parseFromString = function (e, t) {
        ...
        characters: function characters(e, t, n) {
          var r;
          (e = o.apply(this, arguments)) && (r = this.cdata ? this.doc.createCDATASection(e) : this.doc.createTextNode(e), this.currentElement ? this.currentElement.appendChild(r) : /^\s*$/.test(e) && this.doc.appendChild(r), this.locator && f(this.locator, r));
        },
        ...
        startDTD: function startDTD(e, t, n) {
          var r,
              o = this.doc.implementation;
          o && o.createDocumentType && (r = o.createDocumentType(e, t, n), this.locator && f(this.locator, r), p(this, r));
        },
    ...
    20: [function (e, t, n) {
      ...
      function m(e, t, n, r) {
        var o, i, a, c;
        r ? t[f(t, r)] = n : t[t.length++] = n, !e || (o = (n.ownerElement = e).ownerDocument) && (r && I(o, e, r), a = e, c = n, (i = o) && i._inc++, "http://www.w3.org/2000/xmlns/" == c.namespaceURI && (a._nsMap[c.prefix ? c.localName : ""] = c.value));
      }
      ...
      function j(e, t) {
        var n = t.previousSibling,
            r = t.nextSibling;
        return n ? n.nextSibling = r : e.firstChild = r, r ? r.previousSibling = n : e.lastChild = n, R(e.ownerDocument, e), t;
      }
      ...
      function L(e, t, n) {
        ...
        for (o.previousSibling = a, i.nextSibling = n, a ? a.nextSibling = o : e.firstChild = o, null == n ? e.lastChild = i : n.previousSibling = i; o.parentNode = e, o !== i && (o = o.nextSibling);) {
          ;
        }
  
        return R(e.ownerDocument || e, e), t.nodeType == O && (t.firstChild = t.lastChild = null), t;
      }
        ...
        switch (e.nodeType) {
          case v:
            ...
            for (var l, f, d, p, s = 0; s < a; s++) {
              J(l = i.item(s), 0, o) && (f = l.prefix || "", d = l.namespaceURI, p = f ? " xmlns:" + f : " xmlns", t.push(p, '="', d, '"'), o.push({
                prefix: f,
                namespace: d
              })), Q(l, t, n, r, o);
            }
  
            if (J(e, 0, o) && (f = e.prefix || "", d = e.namespaceURI, p = f ? " xmlns:" + f : " xmlns", t.push(p, '="', d, '"'), o.push({
              prefix: f,
              namespace: d
          ...
          case b:
            return t.push(" ", e.name, '="', e.value.replace(/[<&"]/g, A), '"');
  
          case w:
            return t.push(e.data.replace(/[<&]/g, A));
          ...
          case N:
            var h,
                m = e.publicId,
                g = e.systemId;
            return t.push("<!DOCTYPE ", e.name), void (m ? (t.push(' PUBLIC "', m), g && "." != g && t.push('" "', g), t.push('">')) : g && "." != g ? t.push(' SYSTEM "', g, '">') : ((h = e.internalSubset) && t.push(" [", h, "]"), t.push(">")));
      ...
      u.prototype = Error.prototype, r(a, u), p.prototype = {
        ...
        createDocument: function createDocument(e, t, n) {
          var r,
              o = new P();
          return o.implementation = this, o.childNodes = new p(), (o.doctype = n) && o.appendChild(n), t && (r = o.createElementNS(e, t), o.appendChild(r)), o;
        },
      ...
      }, r(i, C), r(i, C.prototype), P.prototype = {
        nodeName: "#document",
        nodeType: T,
        doctype: null,
        ...
        _inc: 1,
        insertBefore: function insertBefore(e, t) {
          if (e.nodeType != O) return null == this.documentElement && e.nodeType == v && (this.documentElement = e), L(this, e, t), e.ownerDocument = this, e;
      ...
      }, o(P, C), P.prototype.getElementsByTagName = (F.prototype = {
        nodeType: v,
        ...
        appendChild: function appendChild(e) {
          return e.nodeType === O ? this.insertBefore(e, null) : function (e, t) {
            ...
            var r = e.lastChild;
            return t.parentNode = e, t.previousSibling = r, t.nextSibling = null, r ? r.nextSibling = t : e.firstChild = t, e.lastChild = t, R(e.ownerDocument, e, t), t;
          }(this, e);
        },
      ...
      }).getElementsByTagName, P.prototype.getElementsByTagNameNS = F.prototype.getElementsByTagNameNS, o(F, C), k.prototype.nodeType = b, o(k, C), H.prototype = {
        data: "",
        ...
        nodeType: _
      }, o(W, H), V.prototype.nodeType = N, o(V, C), K.prototype.nodeType = 12, o(K, C), G.prototype.nodeType = 6, o(G, C), q.prototype.nodeType = E, o(q, C), z.prototype.nodeName = "#document-fragment", z.prototype.nodeType = O, o(z, C), $.prototype.nodeType = x, o($, C), X.prototype.serializeToString = function (e, t, n) {
        return Y.call(e, t, n);
      }, C.prototype.toString = Y;
      ...
      n.DOMImplementation = M, n.XMLSerializer = X;
    }, {}],
    21: [function (e, t, n) {
      "use strict";
      ...
      function H(e, t, n) {
        for (var r = e.tagName, o = null, i = e.length; i--;) {
          var a = e[i],
              c = a.qName,
              u = a.value,
              s = 0 < (f = c.indexOf(":")) ? (l = a.prefix = c.slice(0, f), d = c.slice(f + 1), "xmlns" === l && d) : (l = null, "xmlns" === (d = c) && "");
          a.localName = d, !1 !== s && (null == o && (o = {}, h(n, n = {})), n[s] = o[s] = u, a.uri = "http://www.w3.org/2000/xmlns/", t.startPrefixMapping(s, u));
        }
                        ...
                        default:
                          ...
                          if (1 < a && /!doctype/i.test(i[0][0])) {
                            var c = i[1][0],
                                ...
                                s = 4 < a && i[4][0],
                                l = i[a - 1];
                            return n.startDTD(c, u && u.replace(/^(['"])(.*?)\1$/, "$2"), s && s.replace(/^(['"])(.*?)\1$/, "$2")), n.endDTD(), l.index + l[0].length;
                          }
                  ...
                  default:
                    ...
                    var S = new B(),
                      ...
                      for (;;) {
                        ...
                        switch (s) {
                          ...
                          case "":
                            return i.error("unexpected end of input"), u == A && n.setTagName(e.slice(t, c)), c;
                    ...
                    "http://www.w3.org/1999/xhtml" !== S.uri || S.closed ? v++ : v = function (e, t, n, r, o) {
                      if (/^(?:script|textarea)$/i.test(n)) {
                        var i = e.indexOf("</" + n + ">", t),
                            a = e.substring(t + 1, i);
                        if (/[&<]/.test(a)) return /^script$/i.test(n) || (a = a.replace(/&#?\w+;/g, r)), o.characters(a, 0, a.length), i;
                      }
    ...
    24: [function (e, t, n) {
      ...
      function l(i) {
        ...
        return function () {
          var e,
              ...
              r,
              o = f(i);
          return t = a ? (e = f(this).constructor, Reflect.construct(o, arguments, e)) : o.apply(this, arguments), n = this, !(r = t) || "object" !== c(r) && "function" != typeof r ? function (e) {
      ...
      var d = 0,
        ...
        function o(e) {
          ...
          }(this, o), (t = r.call(this))._$sn = y++, t.HAVE_NOTHING = d, t.HAVE_METADATA = p, t.HAVE_CURRENT_DATA = h, t.HAVE_FUTURE_DATA = m, t.HAVE_ENOUGH_DATA = g, t.readyState = d;
          var n = wx.createInnerAudioContext();
          return v[t._$sn] = n, t._canplayEvents = ["load", "loadend", "canplay", "canplaythrough", "loadedmetadata"], n.onCanplay(function () {
            ...
            t._paused = v[t._$sn].paused, t.dispatchEvent({
              type: "play"
            });
          }), n.onPause(function () {
            t._paused = v[t._$sn].paused, t.dispatchEvent({
            ...
            t._paused = v[t._$sn].paused, !1 === v[t._$sn].loop && t.dispatchEvent({
              type: "ended"
            }), t.readyState = g;
          }), n.onError(function () {
            t._paused = v[t._$sn].paused, t.dispatchEvent({
        ...
        return e = o, (t = [{
          ...
          value: function value(e, t, n) {
            ...
            u(f(o.prototype), "addEventListener", this).call(this, e, t, r), e = String(e).toLowerCase(), this._loaded && -1 !== this._canplayEvents.indexOf(e) && this.dispatchEvent({
              type: e
            });
          }
        }, {
    ...
    25: [function (e, t, n) {
      ...
      Object.defineProperty(n, "__esModule", {
        ...
        var e = o && wx.__first__canvas ? wx.__first__canvas : wx.createCanvas();
        o = !1, e.type = "canvas";
        e.getContext;
      ...
      function a(i) {
        ...
        return function () {
          var e,
              ...
              r,
              o = u(i);
          return t = a ? (e = u(this).constructor, Reflect.construct(o, arguments, e)) : o.apply(this, arguments), n = this, !(r = t) || "object" !== c(r) && "function" != typeof r ? function (e) {
            if (void 0 !== e) return e;
            throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
          }(n) : r;
        };
      ...
      var i = new WeakMap(),
        ...
        return t = e, (n = [{
          ...
          value: function value(e, t, n) {
            var r = 2 < arguments.length && void 0 !== n ? n : {},
                o = i.get(this);
            o || (o = {}, i.set(this, o)), o[e] || (o[e] = []), o[e].push(t), r.capture, r.once, r.passive;
          }
        }, {
    ...
    32: [function (e, t, n) {
      ...
      var r,
          o = (r = e("./HTMLMediaElement")) && r.__esModule ? r : {
        default: r
      };
      ...
      function f(i) {
        ...
        return function () {
          var e,
              ...
              r,
              o = d(i);
          return t = a ? (e = d(this).constructor, Reflect.construct(o, arguments, e)) : o.apply(this, arguments), n = this, !(r = t) || "object" !== u(r) && "function" != typeof r ? function (e) {
            if (void 0 !== e) return e;
            throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
          }(n) : r;
        };
      ...
      function s(i) {
        ...
        return function () {
          var e,
              ...
              r,
              o = l(i);
          return t = a ? (e = l(this).constructor, Reflect.construct(o, arguments, e)) : o.apply(this, arguments), n = this, !(r = t) || "object" !== c(r) && "function" != typeof r ? function (e) {
            if (void 0 !== e) return e;
            throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
          }(n) : r;
        };
    ...
    42: [function (e, t, n) {
      ...
      var i = new WeakMap(),
        ...
        function o(e) {
          ...
          if (!function (e, t) {
            if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function");
          }(this, o), this.binaryType = "", this.bufferedAmount = 0, this.extensions = "", this.onclose = null, this.onerror = null, this.onmessage = null, this.onopen = null, this.protocol = "", this.readyState = 3, "string" != typeof e || !/(^ws:\/\/)|(^wss:\/\/)/.test(e)) throw new TypeError("Failed to construct 'WebSocket': The URL '".concat(e, "' is invalid"));
    ...
    44: [function (e, t, n) {
      ...
      var r,
          o = (r = e("./EventTarget.js")) && r.__esModule ? r : {
        default: r
      };
      ...
      function s(i) {
        ...
        return function () {
          var e,
              ...
              r,
              o = u(i);
          return t = a ? (e = u(this).constructor, Reflect.construct(o, arguments, e)) : o.apply(this, arguments), n = this, !(r = t) || "object" !== c(r) && "function" != typeof r ? l(n) : r;
        };
      }
          ...
          value: function value(e) {
            ...
            var n = wx.request({
              ...
              success: function success(e) {
                ...
                switch (c.status = n, h.set(c, r), g.call(c, "loadstart"), y.call(c, u.HEADERS_RECEIVED), y.call(c, u.LOADING), c.responseType) {
                  case "json":
                    c.responseText = t;
                ...
                y.call(c, u.DONE), g.call(c, "load"), g.call(c, "loadend");
              },
              fail: function fail(e) {
                var t = e.errMsg;
                -1 !== t.indexOf("abort") ? g.call(c, "abort") : -1 !== t.indexOf("timeout") ? g.call(c, "timeout") : g.call(c, "error", t), g.call(c, "loadend");
              }
            });
            m.set(this, n);
          }
    ...
    51: [function (e, t, n) {
      ...
      n.cancelAnimationFrame = D, n.requestAnimationFrame = A, n.clearInterval = C, n.clearTimeout = M, n.setInterval = O, n.setTimeout = N;
    }, {
      "./Audio": 24,
      "./Canvas": 25,
      "./EventIniter/index.js": 29,
    ...
    54: [function (e, t, n) {
      ...
      wx.onError && wx.onError(function e(t) {
        ...
        var n,
            ...
            i,
            a = Math.random() < .01;
        !__globalAdapter.isSubContext && a && (!(n = wx.getSystemInfoSync()) || (r = cc.Canvas.instance.node) && ((o = new cc.Node()).color = cc.Color.BLACK, i = o.addComponent(cc.Label), o.height = r.height - 60, o.width = r.width - 60, i.overflow = cc.Label.Overflow.SHRINK, i.horizontalAlign = cc.Label.HorizontalAlign.LEFT, i.verticalAlign = cc.Label.VerticalAlign.TOP, i.fontSize = 24, i.string = "出错了，请截屏发送给游戏开发者（Please send this screenshot to the game developer）\nPlatform: WeChat " + n.version + "\nEngine: Cocos Creator v" + window.CocosEngine + "\nDevice: " + n.brand + " " + n.model + " System: " + n.system + "\nError:\n" + t.message, cc.LabelOutline && (o.addComponent(cc.LabelOutline).color = cc.Color.WHITE), o.once("touchend", function () {
    ...
    55: [function (e, t, n) {
      ...
      var o = wx.getFileSystemManager ? wx.getFileSystemManager() : null,
        ...
        deleteFile: function deleteFile(e, t) {
          o.unlink({
            filePath: e,
            success: function success() {
              t && t(null);
            ...
            fail: function fail(e) {
              console.warn("Delete file failed: " + e.errMsg), t && t(new Error(e.errMsg));
            }
          });
        },
        downloadFile: function downloadFile(e, t, n, r, o) {
          var i = {
            url: e,
            success: function success(e) {
              200 === e.statusCode ? o && o(null, e.tempFilePath || e.filePath) : (e.filePath && c.deleteFile(e.filePath), console.warn("Download file failed: " + e.statusCode), o && o(new Error(e.statusCode), null));
            },
            fail: function fail(e) {
              console.warn("Download file failed: " + e.errMsg), o && o(new Error(e.errMsg), null);
            }
          };
          t && (i.filePath = t), n && (i.header = n);
        ...
        saveFile: function saveFile(e, t, n) {
          wx.saveFile({
            ...
            fail: function fail(e) {
              console.warn("Save file failed: " + e.errMsg), n && n(new Error(e.errMsg));
            }
          });
        },
        copyFile: function copyFile(e, t, n) {
          o.copyFile({
            ...
            fail: function fail(e) {
              console.warn("Copy file failed: " + e.errMsg), n && n(new Error(e.errMsg));
            }
          });
        },
        writeFile: function writeFile(e, t, n, r) {
          o.writeFile({
            ...
            fail: function fail(e) {
              console.warn("Write file failed: " + e.errMsg), r && r(new Error(e.errMsg));
            }
          });
        },
        writeFileSync: function writeFileSync(e, t, n) {
          try {
            ...
            return console.warn("Write file failed: " + e.message), new Error(e.message);
          }
        },
        readFile: function readFile(e, t, n) {
          o.readFile({
            filePath: e,
            encoding: t,
            success: function success(e) {
            ...
            fail: function fail(e) {
              console.warn("Read file failed: " + e.errMsg), n && n(new Error(e.errMsg), null);
            }
          });
        },
        readDir: function readDir(e, t) {
          o.readdir({
            ...
            fail: function fail(e) {
              console.warn("Read directory failed: " + e.errMsg), t && t(new Error(e.errMsg), null);
            }
          });
        },
        ...
        readJson: function readJson(e, r) {
          c.readFile(e, "utf8", function (t, e) {
            var n = null;
            if (!t) try {
              n = JSON.parse(e);
            } catch (e) {
              console.warn("Read json failed: " + e.message), t = new Error(e.message);
            }
            r && r(t, n);
          });
        },
        readJsonSync: function readJsonSync(e) {
          try {
            ...
            return console.warn("Read json failed: " + e.message), new Error(e.message);
          }
        },
        makeDirSync: function makeDirSync(e, t) {
          try {
            ...
            return console.warn("Make directory failed: " + e.message), new Error(e.message);
          }
        },
        rmdirSync: function rmdirSync(e, t) {
          try {
            ...
            return console.warn("rm directory failed: " + e.message), new Error(e.message);
          }
        },
        ...
        loadSubpackage: function loadSubpackage(t, e, n) {
          var r = wx.loadSubpackage({
            ...
            fail: function fail(e) {
              console.warn("Load Subpackage failed: " + e.errMsg), n && n(new Error("Failed to load subpackage ".concat(t, ": ").concat(e.errMsg)));
            }
          });
          return e && r.onProgressUpdate(e), r;
        },
        unzip: function unzip(e, t, n) {
          o.unzip({
            zipFilePath: e,
            targetPath: t,
            success: function success() {
            ...
            fail: function fail(e) {
              n && n(new Error("unzip failed: " + e.errMsg));
            }
          });
        }
      };
    ...
    56: [function (e, t, n) {
      ...
      Object.assign(a, {
        adaptSys: function adaptSys(e) {
          var t;
          o.call(this, e), "windows" === r.platform ? (e.isMobile = !1, e.os = e.OS_WINDOWS) : a.isDevTool && (-1 < (t = r.system.toLowerCase()).indexOf("android") ? e.os = e.OS_ANDROID : -1 < t.indexOf("ios") && (e.os = e.OS_IOS)), wx.getOpenDataContext ? e.platform = e.WECHAT_GAME : e.platform = e.WECHAT_GAME_SUB, e.glExtension = function (e) {
            ...
            return e.convertToLocationInView(r.x, r.y, i, r), e.convertToLocationInView(o.x, o.y, i, o), e._convertPointWithScale(r), e._convertPointWithScale(o), cc.rect(r.x, r.y, o.x - r.x, o.y - r.y);
          };
        }
      });
    }, {}],
    57: [function (e, t, n) {
      ...
      window.__globalAdapter && (u = window.__globalAdapter, r = (s = wx.getSystemInfoSync()).windowWidth, l = s.windowHeight, f = l < r, u.isSubContext = void 0 === wx.getOpenDataContext, u.isDevTool = "devtools" === s.platform, i.cloneMethod(u, wx, "getSystemInfoSync"), i.cloneMethod(u, wx, "onTouchStart"), i.cloneMethod(u, wx, "onTouchMove"), i.cloneMethod(u, wx, "onTouchEnd"), i.cloneMethod(u, wx, "onTouchCancel"), i.cloneMethod(u, wx, "createInnerAudioContext"), i.cloneMethod(u, wx, "onAudioInterruptionEnd"), i.cloneMethod(u, wx, "onAudioInterruptionBegin"), i.cloneMethod(u, wx, "createVideo"), i.cloneMethod(u, wx, "setPreferredFramesPerSecond"), i.cloneMethod(u, wx, "showKeyboard"), i.cloneMethod(u, wx, "hideKeyboard"), i.cloneMethod(u, wx, "updateKeyboard"), i.cloneMethod(u, wx, "onKeyboardInput"), i.cloneMethod(u, wx, "onKeyboardConfirm"), i.cloneMethod(u, wx, "onKeyboardComplete"), i.cloneMethod(u, wx, "offKeyboardInput"), i.cloneMethod(u, wx, "offKeyboardConfirm"), i.cloneMethod(u, wx, "offKeyboardComplete"), i.cloneMethod(u, wx, "getOpenDataContext"), i.cloneMethod(u, wx, "onMessage"), i.cloneMethod(u, wx, "getSharedCanvas"), i.cloneMethod(u, wx, "loadFont"), i.cloneMethod(u, wx, "onShow"), i.cloneMethod(u, wx, "onHide"), i.cloneMethod(u, wx, "onError"), i.cloneMethod(u, wx, "offError"), o = !1, a = 1, wx.onDeviceOrientationChange && wx.onDeviceOrientationChange(function (e) {
        ...
        var e,
            ...
            a = t.width,
            c = t.height;
        return "ios" === s.platform && !u.isDevTool && f && (n = l - (e = [i, n, r, o, a, c])[0], r = e[1], o = l - e[2], i = e[3], c = e[4], a = e[5]), {
          top: n,
          left: r,
          bottom: o,
          right: i,
