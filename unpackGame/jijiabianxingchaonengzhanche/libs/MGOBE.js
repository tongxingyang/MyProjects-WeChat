!function(e, t) {
    "object" == typeof exports && "object" == typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define([], t) : "object" == typeof exports ? exports.MGOBE = t() : t();
}(0, function() {
    return function(e) {
        var t = {};
        function n(r) {
        ...
        e.exports = r = r || function(e, t) {
            var n = Object.create || function() {
                ...
                _process: function(t) {
                    var n = this._data, r = n.words, i = n.sigBytes, o = this.blockSize, a = i / (4 * o), _ = (a = t ? e.ceil(a) : e.max((0 | a) - this._minBufferSize, 0)) * o, E = e.min(4 * _, i);
                    if (_) {
                        for (var l = 0; l < _; l += o) this._doProcessBlock(r, l);
                        var u = r.splice(0, _);
                        n.sigBytes -= E;
                    }
                    return new s.init(u, E);
                },
                clone: function() {
                    var e = o.clone.call(this);
        ...
        e.exports = JSON.parse('{"sdkType":1,"version":"1.3.0"}');
    }, function(e, t, n) {
        var r, i, o;
            ...
            parse: function(e) {
                ...
                return function(e, t, n) {
                    for (var r = [], o = 0, s = 0; s < t; s++) if (s % 4) {
                        var a = n[e.charCodeAt(s - 1)] << s % 4 * 2, _ = n[e.charCodeAt(s)] >>> 6 - s % 4 * 2;
        ...
        var r, i, o, s, a, _, E, l;
        e.exports = (i = (r = l = n(0)).lib, o = i.WordArray, s = i.Hasher, a = r.algo, 
        _ = [], E = a.SHA1 = s.extend({
            _doReset: function() {
            ...
            _doProcessBlock: function(e, t) {
                for (var n = this._hash.words, r = n[0], i = n[1], o = n[2], s = n[3], a = n[4], E = 0; E < 80; E++) {
                    ...
                    var u = (r << 5 | r >>> 27) + a + _[E];
                    u += E < 20 ? 1518500249 + (i & o | ~i & s) : E < 40 ? 1859775393 + (i ^ o ^ s) : E < 60 ? (i & o | i & s | o & s) - 1894007588 : (i ^ o ^ s) - 899497514, 
                    a = s, s = o, o = i << 30 | i >>> 2, i = r, r = u;
                }
        ...
        e.exports = (i = (r = n(0)).lib.Base, o = r.enc.Utf8, void (r.algo.HMAC = i.extend({
            init: function(e, t) {
                ...
                for (var i = this._oKey = t.clone(), s = this._iKey = t.clone(), a = i.words, _ = s.words, E = 0; E < n; E++) a[E] ^= 1549556828, 
                _[E] ^= 909522486;
        ...
        void 0 === (i = "function" == typeof (r = function(e) {
            ...
            var t = function() {
                function e() {
                    var t = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : "", n = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : 0, r = 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890";
                    !function(e, t) {
                    ...
                    }, this.seps = "cfhistuCFHISTU", this.minLength = 0 < parseInt(n, 10) ? n : 0, this.salt = "string" == typeof t ? t : "", 
                    "string" == typeof r && (this.alphabet = r);
                    ...
                    this.alphabet = this.alphabet.replace(/ /g, ""), this.seps = this.seps.replace(/ /g, ""), 
                    this.seps = this._shuffle(this.seps, this.salt), (!this.seps.length || 3.5 < this.alphabet.length / this.seps.length) && (i = Math.ceil(this.alphabet.length / 3.5)) > this.seps.length && (o = i - this.seps.length, 
                    this.seps += this.alphabet.substr(0, o), this.alphabet = this.alphabet.substr(o)), 
                    this.alphabet = this._shuffle(this.alphabet, this.salt);
                    var l = Math.ceil(this.alphabet.length / 12);
                    this.alphabet.length < 3 ? (this.guards = this.seps.substr(0, l), this.seps = this.seps.substr(l)) : (this.guards = this.alphabet.substr(0, l), 
                ...
                return (t = [ {
                    ...
                    value: function(e) {
                        ...
                        if (t.length < this.minLength) {
                            var u = (r + t[0].charCodeAt(0)) % this.guards.length, d = this.guards[u];
                            (t = d + t).length < this.minLength && (u = (r + t[2].charCodeAt(0)) % this.guards.length, 
                            t += d = this.guards[u]);
                        }
                        for (var h = parseInt(n.length / 2, 10); t.length < this.minLength; ) {
                            var R = (t = (n = this._shuffle(n, n)).substr(h) + t + n.substr(0, h)).length - this.minLength;
                            0 < R && (t = t.substr(R / 2, this.minLength));
                        }
                        return t;
                    }
                }, {
                    key: "_decode",
                    value: function(e, t) {
                        var n = [], r = 0, i = new RegExp("[".concat(this.escapeRegExp(this.guards), "]"), "g"), o = e.replace(i, " "), s = o.split(" ");
                        if (3 !== s.length && 2 !== s.length || (r = 1), void 0 !== (o = s[r])[0]) {
                            var a = o[0];
                            o = o.substr(1), i = new RegExp("[".concat(this.escapeRegExp(this.seps), "]"), "g"), 
                            s = (o = o.replace(i, " ")).split(" ");
                            for (var _ = 0; _ !== s.length; _++) {
                                var E = s[_], l = a + this.salt + t;
        ...
        (function(r) {
            ...
            o = [ n(10) ], void 0 === (s = "function" == typeof (i = function(e, t) {
                "use strict";
                var o, s = {};
                return s.ByteBuffer = e, s.Long = e.Long || null, s.VERSION = "5.0.3", s.WIRE_TYPES = {}, 
                s.WIRE_TYPES.VARINT = 0, s.WIRE_TYPES.BITS64 = 1, s.WIRE_TYPES.LDELIM = 2, s.WIRE_TYPES.STARTGROUP = 3, 
                s.WIRE_TYPES.ENDGROUP = 4, s.WIRE_TYPES.BITS32 = 5, s.PACKABLE_WIRE_TYPES = [ s.WIRE_TYPES.VARINT, s.WIRE_TYPES.BITS64, s.WIRE_TYPES.BITS32 ], 
                s.TYPES = {
                    int32: {
                        name: "int32",
                ...
                s.ID_MIN = 1, s.ID_MAX = 536870911, s.convertFieldsToCamelCase = !1, s.populateAccessors = !0, 
                s.populateDefaults = !0, s.Util = ((o = {}).IS_NODE = !("object" != typeof r || r + "" != "[object process]" || r.browser), 
                o.XHR = function() {
                    for (var e = [ function() {
                    ...
                    }, _ = a.prototype = Object.create(r.prototype);
                    _.getChildren = function(e) {
                        ...
                        for (var e, t = {}, n = this.children, r = 0, i = n.length; r < i; ++r) (e = n[r]) instanceof a && (t[e.name] = e.build());
                    ...
                    var h = function(e, t, n, r, i, o) {
                        a.call(this, e, t, n, r, o), this.className = "Message", this.extensions = void 0, 
                        this.clazz = null, this.isGroup = !!i, this._fields = null, this._fieldsById = null, 
                        this._fieldsByName = null;
                    }, R = h.prototype = Object.create(a.prototype);
                    function d(e, n) {
                    ...
                    R.build = function(n) {
                        ...
                        var r = function(t, n) {
                            var r = n.getChildren(t.Reflect.Message.Field), i = n.getChildren(t.Reflect.Message.OneOf), o = function(s, a) {
                                ...
                                var u;
                                if (arguments.length > 0) if (1 !== arguments.length || null === s || "object" != typeof s || !("function" != typeof s.encode || s instanceof o) || Array.isArray(s) || s instanceof t.Map || e.isByteBuffer(s) || s instanceof ArrayBuffer || t.Long && s instanceof t.Long) for (_ = 0, 
                                E = arguments.length; _ < E; ++_) void 0 !== (u = arguments[_]) && this.$set(r[_].name, u); else this.$set(s);
                            ...
                            function E(n, r, i, o) {
                                ...
                                var u = n.$type, d = void 0;
                                for (var h in n) n.hasOwnProperty(h) && (u && (d = u.getChild(h)) ? a[h] = E(n[h], r, i, d.resolvedType) : a[h] = E(n[h], r, i));
                                return a;
                            }
                        ...
                        for (var i, o = 0, s = this.children.length; o < s; o++) if ((i = this.children[o]) instanceof m || i instanceof h || i instanceof C) {
                        ...
                        this._fieldsByName[i.name] = i; else if (i instanceof h.OneOf) this._oneofsByName[i.name] = i; else if (!(i instanceof h.OneOf || i instanceof I)) throw Error("Illegal reflect child of " + this.toString(!0) + ": " + this.children[o].toString(!0));
                        return this.clazz = r;
                        ...
                        for (var i, o, s, a, _ = e.offset, E = new this.clazz(); e.offset < _ + n || -1 === n && e.remaining() > 0; ) {
                            ...
                            if (a = this._fieldsById[s]) {
                                if (a.repeated && !a.options.packed) E[a.name].push(a.decode(o, e)); else if (a.map) {
                                    ...
                                    var u = E[a.oneof.name];
                                    null !== u && u !== a.name && (E[u] = null), E[a.oneof.name] = a.name;
                                }
                            } else switch (o) {
                              case t.WIRE_TYPES.VARINT:
                                e.readVarint32();
                        ...
                        for (var R = 0, c = this._fields.length; R < c; ++R) if (null === E[(a = this._fields[R]).name]) if ("proto3" === this.syntax) E[a.name] = a.defaultValue; else {
                            if (a.required) {
                                var f = Error("Missing at least one required field for " + this.toString(!0) + ": " + a.name);
                                throw f.decoded = E, f;
                            }
                    ...
                    var c = function(e, n, i, o, s, a, _, E, l, u) {
                        ...
                        this.type = s, this.resolvedType = null, this.id = _, this.options = E || {}, this.defaultValue = null, 
                        this.oneof = l || null, this.syntax = u || "proto2", this.originalName = this.name, 
                    ...
                    }, f = c.prototype = Object.create(r.prototype);
                    f.build = function() {
                    ...
                    }, f.hasWirePresence = function(e, n) {
                        ...
                        try {
                            ...
                            if (this.repeated) if (this.options.packed && t.PACKABLE_WIRE_TYPES.indexOf(this.type.wireType) >= 0) {
                                ...
                                var a = r.offset - s, _ = e.calculateVarint32(a);
                                if (_ > 1) {
                        ...
                        if (this.map) {
                            ...
                            var _ = n.clone();
                            for (_.limit = _.offset + o, n.offset += o; _.remaining() > 0; ) {
                                var E = _.readVarint32();
                                e = 7 & E;
                                var u = E >>> 3;
                                if (1 === u) a = this.keyElement.decode(_, e, u); else {
                                    if (2 !== u) throw Error("Unexpected tag in map field key/value submessage");
                                    i = this.element.decode(_, e, u);
                                }
                            }
                            return [ a, i ];
                        }
                    ...
                    var m = function(e, t, n, r, i) {
                        a.call(this, e, t, n, r, i), this.className = "Enum", this.object = null;
                    };
                    m.getName = function(e, t) {
                        for (var n, r = Object.keys(e), i = 0; i < r.length; ++i) if (e[n = r[i]] === t) return n;
                        return null;
                    }, (m.prototype = Object.create(a.prototype)).build = function(e) {
                    ...
                    S.prototype = Object.create(r.prototype), n.Enum.Value = S;
                    var I = function(e, t, n, i) {
                        r.call(this, e, t, n), this.field = i;
                    };
                    I.prototype = Object.create(r.prototype), n.Extension = I;
                    var C = function(e, t, n, r) {
                        a.call(this, e, t, n, r), this.className = "Service", this.clazz = null;
                    };
                    (C.prototype = Object.create(a.prototype)).build = function(n) {
                    ...
                    (g.prototype = Object.create(r.prototype)).buildOpt = _.buildOpt, n.Service.Method = g;
                    var y = function(e, t, n, r, i, o, s, a) {
                        g.call(this, e, t, n, a), this.className = "Service.RPCMethod", this.requestName = r, 
                        this.responseName = i, this.requestStream = o, this.responseStream = s, this.resolvedRequestType = null, 
                        this.resolvedResponseType = null;
                    };
                    return y.prototype = Object.create(g.prototype), n.Service.RPCMethod = y, n;
                }(s), s.Builder = function(e, t, r) {
                    var i = function(e) {
                        this.ns = new r.Namespace(this, null, ""), this.ptr = this.ns, this.resolved = !1, 
                    ...
                    return i.isMessage = function(e) {
                            ...
                            for (;t.length > 0; ) {
                                ...
                                if (i.isMessage(o)) {
                                    ...
                                    o.oneofs && Object.keys(o.oneofs).forEach(function(e) {
                                        ...
                                        e = new r.Message.Field(this, s, e.rule, e.keytype, e.type, e.name, e.id, e.options, t, o.syntax), 
                                    ...
                                    this.ptr.addChild(s), _.length > 0) {
                                        n.push(t), t = _, _ = null, this.ptr = s, s = null;
                                        continue;
                                    }
                                    _ = null;
                                } else if (i.isEnum(o)) s = new r.Enum(this, this.ptr, o.name, o.options, o.syntax), 
                                o.values.forEach(function(e) {
                                    s.addChild(new r.Enum.Value(this, s, e.name, e.id));
                                }, this), this.ptr.addChild(s); else if (i.isService(o)) s = new r.Service(this, this.ptr, o.name, o.options), 
                                Object.keys(o.rpc).forEach(function(e) {
                                    ...
                                    if (s = this.ptr.resolve(o.ref, !0)) o.fields.forEach(function(t) {
                                        ...
                                        var o = new r.Message.ExtensionField(this, s, t.rule, t.type, this.ptr.fqn() + "." + i, t.id, t.options), a = new r.Extension(this, this.ptr, t.name, o);
                        ...
                        if ("string" == typeof r) {
                            ...
                            var o, s = r.root;
                            if (e.Util.IS_NODE && (s = n(1).resolve(s)), (s.indexOf("\\") >= 0 || r.file.indexOf("\\") >= 0) && (i = "\\"), 
                            o = e.Util.IS_NODE ? n(1).join(s, r.file) : s + i + r.file, !0 === this.files[o]) return this.reset();
                            this.files[o] = !0;
                        }
                        if (t.imports && t.imports.length > 0) {
                            var a, _ = !1;
                            "object" == typeof r ? (this.importRoot = r.root, _ = !0, a = this.importRoot, r = r.file, 
                            (a.indexOf("\\") >= 0 || r.indexOf("\\") >= 0) && (i = "\\")) : "string" == typeof r ? this.importRoot ? a = this.importRoot : r.indexOf("/") >= 0 ? "" === (a = r.replace(/\/[^\/]*$/, "")) && (a = "/") : r.indexOf("\\") >= 0 ? (a = r.replace(/\\[^\\]*$/, ""), 
                            i = "\\") : a = "." : a = null;
                            for (var E = 0; E < t.imports.length; E++) if ("string" == typeof t.imports[E]) {
                                ...
                                if (null === u) throw Error("failed to import '" + l + "' in '" + r + "': file not found");
                        ...
                        return "Builder";
                    }, i.Message = function() {}, i.Enum = function() {}, i.Service = function() {}, 
                    i;
                ...
                }(0, s.Reflect), s.loadProto = function(e, t, n) {
                    return ("string" == typeof t || t && "string" == typeof t.file && "string" == typeof t.root) && (n = t, 
                    t = void 0), s.loadJson(s.DotProto.Parser.parse(e), t, n);
                }, s.protoFromString = s.loadProto, s.loadProtoFile = function(e, t, n) {
                    if (t && "object" == typeof t ? (n = t, t = null) : t && "function" == typeof t || (t = null), 
                    t) return s.Util.fetch("string" == typeof e ? e : e.root + "/" + e.file, function(r) {
                        if (null !== r) try {
                            t(null, s.loadProto(r, n, e));
                        } catch (e) {
                            e = VM2_INTERNAL_STATE_DO_NOT_USE_OR_PROGRAM_WILL_FAIL.handleException(e);
                            t(e);
                    ...
                    return null === r ? null : s.loadProto(r, n, e);
                }, s.protoFromFile = s.loadProtoFile, s.newBuilder = function(e) {
                    return void 0 === (e = e || {}).convertFieldsToCamelCase && (e.convertFieldsToCamelCase = s.convertFieldsToCamelCase), 
                    void 0 === e.populateAccessors && (e.populateAccessors = s.populateAccessors), new s.Builder(e);
                }, s.loadJson = function(e, t, n) {
                    return ("string" == typeof t || t && "string" == typeof t.file && "string" == typeof t.root) && (n = t, 
                    t = null), t && "object" == typeof t || (t = s.newBuilder()), "string" == typeof e && (e = JSON.parse(e)), 
                    t.import(e, n), t.resolveAll(), t;
                }, s.loadJsonFile = function(e, t, n) {
                    if (t && "object" == typeof t ? (n = t, t = null) : t && "function" == typeof t || (t = null), 
                    t) return s.Util.fetch("string" == typeof e ? e : e.root + "/" + e.file, function(r) {
                        if (null !== r) try {
                            t(null, s.loadJson(JSON.parse(r), n, e));
                        } catch (e) {
                            e = VM2_INTERNAL_STATE_DO_NOT_USE_OR_PROGRAM_WILL_FAIL.handleException(e);
                            t(e);
                        } else t(Error("Failed to fetch file"));
                    ...
                    var r = s.Util.fetch("object" == typeof e ? e.root + "/" + e.file : e);
                    return null === r ? null : s.loadJson(JSON.parse(r), n, e);
                }, s;
        ...
        var _, E = [], l = !1, u = -1;
        function d() {
            l && _ && (l = !1, _.length ? E = _.concat(E) : u = -1, E.length && h());
        }
        function h() {
            if (!l) {
                var e = a(d);
        ...
        i.nextTick = function(e) {
            ...
            E.push(new R(e, t)), 1 !== E.length || l || a(h);
        }, R.prototype.run = function() {
            this.fun.apply(null, this.array);
        }, i.title = "browser", i.browser = !0, i.env = {}, i.argv = [], i.version = "", 
        i.versions = {}, i.on = c, i.addListener = c, i.once = c, i.off = c, i.removeListener = c, 
        i.removeAllListeners = c, i.emit = c, i.prependListener = c, i.prependOnceListener = c, 
        ...
        i = [ n(11) ], void 0 === (o = "function" == typeof (r = function(e) {
            ...
            function a(e, t, n, r, i) {
                var o, s, a = 8 * i - r - 1, _ = (1 << a) - 1, E = _ >> 1, l = -7, u = n ? i - 1 : 0, d = n ? -1 : 1, h = e[t + u];
                for (u += d, o = h & (1 << -l) - 1, h >>= -l, l += a; l > 0; o = 256 * o + e[t + u], 
                u += d, l -= 8) ;
                for (s = o & (1 << -l) - 1, o >>= -l, l += r; l > 0; s = 256 * s + e[t + u], u += d, 
                l -= 8) ;
                if (0 === o) o = 1 - E; else {
            ...
            function _(e, t, n, r, i, o) {
                var s, a, _, E = 8 * o - i - 1, l = (1 << E) - 1, u = l >> 1, d = 23 === i ? Math.pow(2, -24) - Math.pow(2, -77) : 0, h = r ? 0 : o - 1, R = r ? 1 : -1, c = t < 0 || 0 === t && 1 / t < 0 ? 1 : 0;
                for (t = Math.abs(t), isNaN(t) || t === 1 / 0 ? (a = isNaN(t) ? 1 : 0, s = l) : (s = Math.floor(Math.log(t) / Math.LN2), 
                t * (_ = Math.pow(2, -s)) < 1 && (s--, _ *= 2), (t += s + u >= 1 ? d / _ : d * Math.pow(2, 1 - u)) * _ >= 2 && (s++, 
                _ /= 2), s + u >= l ? (a = 0, s = l) : s + u >= 1 ? (a = (t * _ - 1) * Math.pow(2, i), 
                s += u) : (a = t * Math.pow(2, u - 1) * Math.pow(2, i), s = 0)); i >= 8; e[n + h] = 255 & a, 
                h += R, a /= 256, i -= 8) ;
                for (s = s << i | a, E += i; E > 0; e[n + h] = 255 & s, h += R, s /= 256, E -= 8) ;
                e[n + h - R] |= 128 * c;
            }
            t.accessor = function() {
                return Uint8Array;
                ...
                for (var o, s = 0, a = 0, _ = e.length; a < _; ++a) t.isByteBuffer(e[a]) || (e[a] = t.wrap(e[a], n)), 
                (o = e[a].limit - e[a].offset) > 0 && (s += o);
                if (0 === s) return new t(0, r, i);
                var E, l = new t(s, r, i);
                for (a = 0; a < _; ) (o = (E = e[a++]).limit - E.offset) <= 0 || (l.view.set(E.view.subarray(E.offset, E.limit), l.offset), 
                l.offset += o);
                ...
                t += 4;
                var r = this.buffer.byteLength;
                return t > r && this.resize((r *= 2) > t ? r : t), t -= 4, _(this.view, e, t, this.littleEndian, 23, 4), 
                n && (this.offset += 4), this;
                ...
                t += 8;
                var r = this.buffer.byteLength;
                return t > r && this.resize((r *= 2) > t ? r : t), t -= 8, _(this.view, e, t, this.littleEndian, 52, 8), 
                ...
                var o = t.calculateVarint64(n), s = n.toInt() >>> 0, a = n.shiftRightUnsigned(28).toInt() >>> 0, _ = n.shiftRightUnsigned(56).toInt() >>> 0;
                r += o;
                ...
                t += 4, l.encodeUTF16toUTF8(o(e), function(e) {
                    this.view[t++] = e;
                ...
                var i, s, a = n;
                i = l.calculateUTF16asUTF8(o(e), this.noAssert)[1], s = t.calculateVarint32(i), 
                n += s + i;
                var _ = this.buffer.byteLength;
                if (n > _ && this.resize((_ *= 2) > n ? _ : n), n -= s + i, n += this.writeVarint32(i, n), 
                ...
                var s = o - r;
                if (s > 0) {
                    var a = new ArrayBuffer(this.buffer.byteLength + s), _ = new Uint8Array(a);
                    _.set(this.view.subarray(r, this.buffer.byteLength), o), this.buffer = a, this.view = _, 
            ...
            n.toBase64 = function(e, t) {
                ...
                for (var i, o, s = e.length, a = new t((s + 1) / 3 | 0, n, r), _ = 0, E = 0, l = !1, u = !1, d = !1, h = !1, R = !1; _ < s; ) {
                    switch (i = e.charAt(_++)) {
                      case "!":
                        if (!r) {
                            if (u || d || h) {
                    ...
                    if (R) throw TypeError("Illegal str: Invalid symbol at " + _);
                }
                if (!r) {
                    if (!u || !h) throw TypeError("Illegal str: Missing offset or limit");
            ...
            return n.toUTF8 = function(e, t) {
                ...
                var i = new t(l.calculateUTF16asUTF8(o(e), !0)[1], n, r), s = 0;
        ...
        void 0 === (i = "function" == typeof (r = function() {
            ...
            function o(e, t) {
                if (isNaN(e) || !isFinite(e)) return t ? c : R;
                if (t) {
                    if (e < 0) return c;
                    if (e >= u) return I;
                } else {
            ...
            function _(e, t, n) {
                ...
                if ("NaN" === e || "Infinity" === e || "+Infinity" === e || "-Infinity" === e) return R;
                ...
                for (var i = o(a(n, 8)), s = R, E = 0; E < e.length; E += 8) {
                    var l = Math.min(8, e.length - E), u = parseInt(e.substring(E, E + l), n);
                    if (l < 8) {
                        var d = o(a(n, l));
                        s = s.mul(d).add(o(u));
                    } else s = (s = s.mul(i)).add(o(u));
                }
            ...
            var l = 4294967296, u = l * l, d = u / 2, h = i(1 << 24), R = i(0);
            e.ZERO = R;
            var c = i(0, !0);
            e.UZERO = c;
            var f = i(1);
            ...
            return g.toInt = function() {
                ...
                for (var i = o(a(e, 6), this.unsigned), s = this, _ = ""; ;) {
                    var E = s.div(i), l = (s.sub(E.mul(i)).toInt() >>> 0).toString(e);
                ...
                return !this.unsigned && this.eq(C) ? C : this.not().add(f);
            }, g.neg = g.negate, g.add = function(e) {
                t(e) || (e = E(e));
                var n = this.high >>> 16, r = 65535 & this.high, i = this.low >>> 16, o = 65535 & this.low, a = e.high >>> 16, _ = 65535 & e.high, l = e.low >>> 16, u = 0, d = 0, h = 0, R = 0;
                return h += (R += o + (65535 & e.low)) >>> 16, d += (h += i + l) >>> 16, u += (d += r + _) >>> 16, 
                u += n + a, s((h &= 65535) << 16 | (R &= 65535), (u &= 65535) << 16 | (d &= 65535), this.unsigned);
            }, g.subtract = function(e) {
                return t(e) || (e = E(e)), this.add(e.neg());
            }, g.sub = g.subtract, g.multiply = function(e) {
                if (this.isZero()) return R;
                if (t(e) || (e = E(e)), e.isZero()) return R;
                if (this.eq(C)) return e.isOdd() ? C : R;
                if (e.eq(C)) return this.isOdd() ? C : R;
                if (this.isNegative()) return e.isNegative() ? this.neg().mul(e.neg()) : this.neg().mul(e).neg();
                if (e.isNegative()) return this.mul(e.neg()).neg();
                if (this.lt(h) && e.lt(h)) return o(this.toNumber() * e.toNumber(), this.unsigned);
                var n = this.high >>> 16, r = 65535 & this.high, i = this.low >>> 16, a = 65535 & this.low, _ = e.high >>> 16, l = 65535 & e.high, u = e.low >>> 16, d = 65535 & e.low, c = 0, f = 0, p = 0, m = 0;
                return p += (m += a * d) >>> 16, f += (p += i * d) >>> 16, p &= 65535, f += (p += a * u) >>> 16, 
                c += (f += r * d) >>> 16, f &= 65535, c += (f += i * u) >>> 16, f &= 65535, c += (f += a * l) >>> 16, 
                c += n * d + r * u + i * l + a * _, s((p &= 65535) << 16 | (m &= 65535), (c &= 65535) << 16 | (f &= 65535), this.unsigned);
            }, g.mul = g.multiply, g.divide = function(e) {
                if (t(e) || (e = E(e)), e.isZero()) throw Error("division by zero");
                if (this.isZero()) return this.unsigned ? c : R;
                var n, r, i;
                if (this.unsigned) {
                    ...
                    if (this.eq(C)) return e.eq(f) || e.eq(m) ? C : e.eq(C) ? f : (n = this.shr(1).div(e).shl(1)).eq(R) ? e.isNegative() ? f : m : (r = this.sub(e.mul(n)), 
                    i = n.add(r.div(e)));
                    if (e.eq(C)) return this.unsigned ? c : R;
                ...
                for (r = this; r.gte(e); ) {
                    ...
                    for (var s = Math.ceil(Math.log(n) / Math.LN2), _ = s <= 48 ? 1 : a(2, s - 48), l = o(n), u = l.mul(e); u.isNegative() || u.gt(r); ) u = (l = o(n -= _, this.unsigned)).mul(e);
                    l.isZero() && (l = f), i = i.add(l), r = r.sub(u);
                }
                return i;
        ...
        }, E = _(e => new WebSocket(e)), l = e => {
            const t = (e.method + "").toLowerCase() || "get", n = new XMLHttpRequest();
            let r = "", i = "";
            if ("get" === t) {
                i = "?";
        ...
        }, u = e => null, d = e => null, h = e => null, R = e => null, c = {}, f = e => c[e], p = (e, t) => c[e] = t, m = e => delete c[e], S = ({fail: e}) => e && e("ERROR"), C = () => ({}), g = ({fail: e}) => e && e("ERROR"), y = ({fail: e}) => e && e("ERROR");
        function I(e, t) {
            const n = a;
            return t[e] || n[e];
        }
        a.connectSocket = E, a.request = l, a.onHide = u, a.offHide = d, a.onShow = h, a.offShow = R, 
        a.getStorageSync = f, a.setStorageSync = p, a.removeStorageSync = m, a.getUserInfo = S, 
        a.getSystemInfoSync = C, a.getLocation = g, a.getNetworkType = y, a.createUDPSocket = null, 
        a.channel = i.UNKNOWN, "undefined" != typeof window ? a.root = window : a.root = {};
        let O = {};
        function T() {
        ...
        T() && (O = wx);
        const A = {};
        A.connectSocket = I("connectSocket", O), A.request = I("request", O), A.onHide = I("onHide", O), 
        A.offHide = I("offHide", O), A.onShow = I("onShow", O), A.offShow = I("offShow", O), 
        A.getStorageSync = I("getStorageSync", O), A.setStorageSync = I("setStorageSync", O), 
        A.removeStorageSync = I("removeStorageSync", O), A.getUserInfo = I("getUserInfo", O), 
        A.getSystemInfoSync = I("getSystemInfoSync", O), A.getLocation = I("getLocation", O), 
        A.getNetworkType = I("getNetworkType", O), A.createUDPSocket = I("createUDPSocket", O), 
        A.channel = i.WX, "undefined" != typeof GameGlobal && (A.root = GameGlobal);
        let P = {};
        function M() {
        ...
        v.connectSocket = (e => {
            ...
            return {
                ...
                send: ({data: e, fail: n, success: r}) => t.send({
                    data: e,
                    fail: n,
                    success: r
                }),
        ...
        }), v.request = I("request", P), v.onHide = I("onHide", P), v.offHide = I("offHide", P), 
        v.onShow = I("onShow", P), v.offShow = I("offShow", P), v.getStorageSync = I("getStorageSync", P), 
        v.setStorageSync = I("setStorageSync", P), v.removeStorageSync = I("removeStorageSync", P), 
        v.getUserInfo = I("getUserInfo", P), v.getSystemInfoSync = I("getSystemInfoSync", P), 
        v.getLocation = I("getLocation", P), v.getNetworkType = I("getNetworkType", P), 
        v.createUDPSocket = I("createUDPSocket", P), v.channel = i.QQ, "undefined" != typeof GameGlobal && (v.root = GameGlobal);
        let b = {};
        function L() {
            ...
            try {
                if (!swan.getSystemInfoSync()) return !1;
                if (!(swan.getSystemInfoSync().host + "").toLowerCase().includes("baidu")) return !1;
            } catch (e) {
                e = VM2_INTERNAL_STATE_DO_NOT_USE_OR_PROGRAM_WILL_FAIL.handleException(e);
                return !1;
            }
        ...
        }), D.request = I("request", b), D.onHide = I("onHide", b), D.offHide = I("offHide", b), 
        D.onShow = I("onShow", b), D.offShow = I("offShow", b), D.getStorageSync = I("getStorageSync", b), 
        D.setStorageSync = I("setStorageSync", b), D.removeStorageSync = I("removeStorageSync", b), 
        D.getUserInfo = I("getUserInfo", b), D.getSystemInfoSync = I("getSystemInfoSync", b), 
        D.getLocation = I("getLocation", b), D.getNetworkType = I("getNetworkType", b), 
        D.createUDPSocket = null, D.channel = i.BD, "undefined" != typeof GameGlobal && (D.root = GameGlobal);
        let U = {};
        function G() {
        ...
        G() && (U = qg);
        const Y = {};
        Y.connectSocket = E, Y.request = l, Y.onHide = I("onHide", U), Y.offHide = I("offHide", U), 
        Y.onShow = I("onShow", U), Y.offShow = I("offShow", U), Y.getStorageSync = (e => {
            localStorage.getItem(e);
        }), Y.setStorageSync = ((e, t) => {
            localStorage.setItem(e, t);
        }), Y.removeStorageSync = (e => {
            localStorage.removeItem(e);
        }), Y.getUserInfo = S, Y.getSystemInfoSync = I("getSystemInfoSync", U), Y.getLocation = I("getLocation", U), 
        Y.getNetworkType = I("getNetworkType", U), Y.createUDPSocket = null, Y.channel = i.OP, 
        "undefined" != typeof window && (Y.root = window);
        let F = {};
        function k() {
            if ("undefined" == typeof qg) return !1;
            if (!qg.onHide) return !1;
        ...
        const H = {
            ...
            request: e => (e.data = "object" == typeof e.data ? JSON.stringify(e.data) : e.data, 
            qg.request(e))
        };
        H.onHide = I("onHide", F), H.offHide = I("offHide", F), H.onShow = I("onShow", F), 
        H.offShow = I("offShow", F), H.getStorageSync = (e => qg.getStorageSync({
            key: e
        })), H.setStorageSync = ((e, t) => qg.setStorageSync({
            key: e,
            value: t
        })), H.removeStorageSync = (e => qg.deleteStorageSync({
            key: e
        })), H.getUserInfo = S, H.getSystemInfoSync = I("getSystemInfoSync", F), H.getLocation = I("getLocation", F), 
        H.getNetworkType = (e => {
            qg.getNetworkType({
                success: t => {
                    e.success && e.success({
        ...
        }), H.createUDPSocket = null, H.channel = i.VV, "undefined" != typeof window && (H.root = window);
        let x = {};
        function q() {
            if ("undefined" == typeof wx) return !1;
        ...
        let B = u, V = d, Q = h, W = R;
        q() && (x = wx, B = wx.onAppHide, V = wx.offAppHide, Q = wx.onAppShow, W = wx.offAppShow);
        const K = {};
        K.connectSocket = I("connectSocket", x), K.request = I("request", x), K.onHide = B, 
        K.offHide = V, K.onShow = Q, K.offShow = W, K.getStorageSync = I("getStorageSync", x), 
        K.setStorageSync = I("setStorageSync", x), K.removeStorageSync = I("removeStorageSync", x), 
        K.getUserInfo = I("getUserInfo", x), K.getSystemInfoSync = I("getSystemInfoSync", x), 
        K.getLocation = I("getLocation", x), K.getNetworkType = I("getNetworkType", x), 
        K.createUDPSocket = I("createUDPSocket", x), K.channel = i.WXMP, K.root = {};
        let J = {};
        function j() {
            if ("undefined" == typeof qq) return !1;
            if ("undefined" == typeof App) return !1;
            ...
            try {
                if (!qq.getSystemInfoSync()) return !1;
                if ("qq" !== qq.getSystemInfoSync().AppPlatform) return !1;
            } catch (e) {
                e = VM2_INTERNAL_STATE_DO_NOT_USE_OR_PROGRAM_WILL_FAIL.handleException(e);
                return !1;
            }
        ...
        let X = u, z = d, $ = h, Z = R;
        j() && (J = qq, X = qq.onAppHide, z = qq.offAppHide, $ = qq.onAppShow, Z = qq.offAppShow);
        const ee = {}, te = I("connectSocket", J);
        ee.connectSocket = (e => {
            const t = te(e);
            let n = 0;
            return {
        ...
        }), ee.request = I("request", J), ee.onHide = X, ee.offHide = z, ee.onShow = $, 
        ee.offShow = Z, ee.getStorageSync = I("getStorageSync", J), ee.setStorageSync = I("setStorageSync", J), 
        ee.removeStorageSync = I("removeStorageSync", J), ee.getUserInfo = I("getUserInfo", J), 
        ee.getSystemInfoSync = I("getSystemInfoSync", J), ee.getLocation = I("getLocation", J), 
        ee.getNetworkType = I("getNetworkType", J), ee.createUDPSocket = I("createUDPSocket", J), 
        ee.channel = i.QQMP, ee.root = {};
        const ne = "mgobexs";
        var re, ie, oe, se, ae, _e, Ee, le, ue, de, he, Re, ce, fe, pe, me;
        !function(e) {
            e[e.COMMON = 0] = "COMMON", e[e.RELAY = 1] = "RELAY";
        }(re || (re = {})), function(e) {
            e[e.ET_Unknown = 0] = "ET_Unknown", e[e.ET_NetworkState = 1] = "ET_NetworkState";
        }(ie || (ie = {})), function(e) {
            e[e.E_PUSH_TYPE_TEST = 0] = "E_PUSH_TYPE_TEST", e[e.E_PUSH_TYPE_RELAY = 1] = "E_PUSH_TYPE_RELAY", 
            e[e.E_PUSH_TYPE_GAMESVR = 2] = "E_PUSH_TYPE_GAMESVR", e[e.E_PUSH_TYPE_JOIN_ROOM = 100] = "E_PUSH_TYPE_JOIN_ROOM", 
            e[e.E_PUSH_TYPE_LEAVE_ROOM = 101] = "E_PUSH_TYPE_LEAVE_ROOM", e[e.E_PUSH_TYPE_DISMISS_ROOM = 102] = "E_PUSH_TYPE_DISMISS_ROOM", 
            e[e.E_PUSH_TYPE_REMOVE_PLAYER = 103] = "E_PUSH_TYPE_REMOVE_PLAYER", e[e.E_PUSH_TYPE_MODIFY_ROOM_PROPERTY = 104] = "E_PUSH_TYPE_MODIFY_ROOM_PROPERTY", 
            e[e.E_PUSH_TYPE_NETWORK_STATE = 105] = "E_PUSH_TYPE_NETWORK_STATE", e[e.E_PUSH_TYPE_ROOM_CHAT = 106] = "E_PUSH_TYPE_ROOM_CHAT", 
            e[e.E_PUSH_TYPE_PLAYER_STATE = 107] = "E_PUSH_TYPE_PLAYER_STATE", e[e.E_PUSH_TYPE_START_GAME = 108] = "E_PUSH_TYPE_START_GAME", 
            e[e.E_PUSH_TYPE_STOP_GAME = 109] = "E_PUSH_TYPE_STOP_GAME", e[e.E_PUSH_TYPE_CREATE_ROOM = 110] = "E_PUSH_TYPE_CREATE_ROOM", 
            e[e.E_PUSH_TYPE_DESTROY_ROOM = 111] = "E_PUSH_TYPE_DESTROY_ROOM", e[e.E_PUSH_TYPE_MATCH_SUCCESS = 200] = "E_PUSH_TYPE_MATCH_SUCCESS", 
            e[e.E_PUSH_TYPE_MATCH_TIMEOUT = 201] = "E_PUSH_TYPE_MATCH_TIMEOUT", e[e.E_PUSH_TYPE_MATCH_CANCEL = 202] = "E_PUSH_TYPE_MATCH_CANCEL", 
            e[e.E_PUSH_TYPE_JOIN_GROUP = 500] = "E_PUSH_TYPE_JOIN_GROUP", e[e.E_PUSH_TYPE_LEAVE_GROUP = 501] = "E_PUSH_TYPE_LEAVE_GROUP", 
            e[e.E_PUSH_TYPE_DISMISS_GROUP = 502] = "E_PUSH_TYPE_DISMISS_GROUP", e[e.E_PUSH_TYPE_MODIFY_GROUP_PROPERTY = 503] = "E_PUSH_TYPE_MODIFY_GROUP_PROPERTY", 
            e[e.E_PUSH_TYPE_REMOVE_GROUP_PLAYER = 504] = "E_PUSH_TYPE_REMOVE_GROUP_PLAYER", 
            e[e.E_PUSH_TYPE_GROUP_PLAYER_STATE = 505] = "E_PUSH_TYPE_GROUP_PLAYER_STATE", e[e.E_PUSH_TYPE_GROUP_CHAT = 506] = "E_PUSH_TYPE_GROUP_CHAT";
        }(oe || (oe = {})), function(e) {
            e[e.E_CMD_INVALID = 0] = "E_CMD_INVALID", e[e.E_CMD_HEART_BEAT_REQ = 100] = "E_CMD_HEART_BEAT_REQ", 
            e[e.E_CMD_CHECK_LOGIN_REQ = 101] = "E_CMD_CHECK_LOGIN_REQ", e[e.E_CMD_LOGIN_TO_ROOM_REQ = 102] = "E_CMD_LOGIN_TO_ROOM_REQ", 
            e[e.E_CMD_FORWARD_TO_RELAY_REQ = 103] = "E_CMD_FORWARD_TO_RELAY_REQ", e[e.E_CMD_LOGIN_REQ = 1e3] = "E_CMD_LOGIN_REQ", 
            e[e.E_CMD_LOGOUT_REQ = 1001] = "E_CMD_LOGOUT_REQ", e[e.E_CMD_AUTH_REQ = 1002] = "E_CMD_AUTH_REQ", 
            e[e.E_CMD_QUERY_BY_PLAYER_ID_REQ = 1003] = "E_CMD_QUERY_BY_PLAYER_ID_REQ", e[e.E_CMD_QUERY_BY_GAME_ID_REQ = 1004] = "E_CMD_QUERY_BY_GAME_ID_REQ", 
            e[e.E_CMD_GET_ROOM_DETAIL_REQ = 2001] = "E_CMD_GET_ROOM_DETAIL_REQ", e[e.E_CMD_JOIN_ROOM_REQ = 2002] = "E_CMD_JOIN_ROOM_REQ", 
            e[e.E_CMD_QUIT_ROOM_REQ = 2003] = "E_CMD_QUIT_ROOM_REQ", e[e.E_CMD_CREATE_ROOM_REQ = 2004] = "E_CMD_CREATE_ROOM_REQ", 
            e[e.E_CMD_DESTORY_ROOM_REQ = 2005] = "E_CMD_DESTORY_ROOM_REQ", e[e.E_CMD_REMOVE_MEMBER_REQ = 2006] = "E_CMD_REMOVE_MEMBER_REQ", 
            e[e.E_CMD_CHANGE_ROOM_PROPERTIS_REQ = 2007] = "E_CMD_CHANGE_ROOM_PROPERTIS_REQ", 
            e[e.E_CMD_DISSMISS_ROOM_REQ = 2008] = "E_CMD_DISSMISS_ROOM_REQ", e[e.E_CMD_CHANGE_PLAYER_STATE_REQ = 2009] = "E_CMD_CHANGE_PLAYER_STATE_REQ", 
            e[e.E_CMD_CHANGE_PLAYER_NETWORK_STATE_REQ = 2010] = "E_CMD_CHANGE_PLAYER_NETWORK_STATE_REQ", 
            e[e.E_CMD_ROOM_CHAT_REQ = 2011] = "E_CMD_ROOM_CHAT_REQ", e[e.E_CMD_START_FRAME_SYNC_REQ = 2012] = "E_CMD_START_FRAME_SYNC_REQ", 
            e[e.E_CMD_STOP_FRAME_SYNC_REQ = 2013] = "E_CMD_STOP_FRAME_SYNC_REQ", e[e.E_CMD_GET_ROOM_LIST_REQ = 2014] = "E_CMD_GET_ROOM_LIST_REQ", 
            e[e.E_CMD_SVR_REMOVE_MEMBER_REQ = 2015] = "E_CMD_SVR_REMOVE_MEMBER_REQ", e[e.E_CMD_SVR_CHANGE_ROOM_PROPERTIS_REQ = 2016] = "E_CMD_SVR_CHANGE_ROOM_PROPERTIS_REQ", 
            e[e.E_CMD_SVR_CHANGE_PLAYER_STATE_REQ = 2017] = "E_CMD_SVR_CHANGE_PLAYER_STATE_REQ", 
            e[e.E_CMD_GET_ROOM_LIST_V2_REQ = 2018] = "E_CMD_GET_ROOM_LIST_V2_REQ", e[e.E_CMD_CREATE_ROOM_FOR_THIRD_PARTY_REQ = 2019] = "E_CMD_CREATE_ROOM_FOR_THIRD_PARTY_REQ", 
            e[e.E_CMD_MATCH_ROOM_SIMPLE_REQ = 3001] = "E_CMD_MATCH_ROOM_SIMPLE_REQ", e[e.E_CMD_MATCH_USER_SIMPLE_REQ = 3002] = "E_CMD_MATCH_USER_SIMPLE_REQ", 
            e[e.E_CMD_MATCH_CANCEL_MATCH_REQ = 3003] = "E_CMD_MATCH_CANCEL_MATCH_REQ", e[e.E_CMD_MATCH_ROOM_COMPLEX_REQ = 3004] = "E_CMD_MATCH_ROOM_COMPLEX_REQ", 
            e[e.E_CMD_MATCH_PLAYER_COMPLEX_REQ = 3005] = "E_CMD_MATCH_PLAYER_COMPLEX_REQ", e[e.E_CMD_MATCH_GROUP_REQ = 3006] = "E_CMD_MATCH_GROUP_REQ", 
            e[e.E_CMD_RELAY_SEND_FRAME_REQ = 4e3] = "E_CMD_RELAY_SEND_FRAME_REQ", e[e.E_CMD_RELAY_REQUEST_FRAME_REQ = 4001] = "E_CMD_RELAY_REQUEST_FRAME_REQ", 
            e[e.E_CMD_RELAY_CLIENT_SENDTO_GAMESVR_REQ = 4002] = "E_CMD_RELAY_CLIENT_SENDTO_GAMESVR_REQ", 
            e[e.E_CMD_RELAY_CLIENT_RECV_FROM_GAMESVR_REQ = 4003] = "E_CMD_RELAY_CLIENT_RECV_FROM_GAMESVR_REQ", 
            e[e.E_CMD_NOTIFY_JOIN_ROOM = 5e3] = "E_CMD_NOTIFY_JOIN_ROOM", e[e.E_CMD_NOTIFY_QUIT_ROOM = 5001] = "E_CMD_NOTIFY_QUIT_ROOM", 
            e[e.E_CMD_NOTIFY_DESTORY_ROOM = 5002] = "E_CMD_NOTIFY_DESTORY_ROOM", e[e.E_CMD_NOTIFY_NET_STATE = 5003] = "E_CMD_NOTIFY_NET_STATE", 
            e[e.E_CMD_NOTIFY_KICK_MEMBER = 5004] = "E_CMD_NOTIFY_KICK_MEMBER", e[e.E_CMD_GET_ADDR_BY_ROUTER_ID_REQ = 6e3] = "E_CMD_GET_ADDR_BY_ROUTER_ID_REQ", 
            e[e.E_CMD_GET_GROUP_DETAIL_REQ = 7001] = "E_CMD_GET_GROUP_DETAIL_REQ", e[e.E_CMD_JOIN_GROUP_REQ = 7002] = "E_CMD_JOIN_GROUP_REQ", 
            e[e.E_CMD_QUIT_GROUP_REQ = 7003] = "E_CMD_QUIT_GROUP_REQ", e[e.E_CMD_CREATE_GROUP_REQ = 7004] = "E_CMD_CREATE_GROUP_REQ", 
            e[e.E_CMD_REMOVE_GROUP_MEMBER_REQ = 7005] = "E_CMD_REMOVE_GROUP_MEMBER_REQ", e[e.E_CMD_CHANGE_GROUP_PROPERTIES_REQ = 7006] = "E_CMD_CHANGE_GROUP_PROPERTIES_REQ", 
            e[e.E_CMD_DISMISS_GROUP_REQ = 7007] = "E_CMD_DISMISS_GROUP_REQ", e[e.E_CMD_CHANGE_GROUP_PLAYER_STATE_REQ = 7008] = "E_CMD_CHANGE_GROUP_PLAYER_STATE_REQ", 
            e[e.E_CMD_CHANGE_GROUP_PLAYER_NETWORK_STATE_REQ = 7009] = "E_CMD_CHANGE_GROUP_PLAYER_NETWORK_STATE_REQ", 
            e[e.E_CMD_GROUP_CHAT_REQ = 7010] = "E_CMD_GROUP_CHAT_REQ", e[e.E_CMD_GET_GROUP_LIST_REQ = 7011] = "E_CMD_GET_GROUP_LIST_REQ";
        }(se || (se = {})), function(e) {
            e[e.EC_OK = 0] = "EC_OK", e[e.EC_REQ_BAD_PKG = 1] = "EC_REQ_BAD_PKG", e[e.EC_CMD_INVALID = 2] = "EC_CMD_INVALID", 
            e[e.EC_PARAMS_INVALID = 3] = "EC_PARAMS_INVALID", e[e.EC_INNER_ERROR = 4] = "EC_INNER_ERROR", 
            e[e.EC_TIME_OUT = 5] = "EC_TIME_OUT", e[e.EC_SERVER_BUSY = 6] = "EC_SERVER_BUSY", 
            e[e.EC_NO_RIGHT = 7] = "EC_NO_RIGHT", e[e.EC_ACCESS_CMD_INVALID_ERR = 200] = "EC_ACCESS_CMD_INVALID_ERR", 
            e[e.EC_ACCESS_CMD_GET_TOKEN_ERR = 201] = "EC_ACCESS_CMD_GET_TOKEN_ERR", e[e.EC_ACCESS_CMD_TOKEN_PRE_EXPIRE = 202] = "EC_ACCESS_CMD_TOKEN_PRE_EXPIRE", 
            e[e.EC_ACCESS_CMD_INVALID_TOKEN = 203] = "EC_ACCESS_CMD_INVALID_TOKEN", e[e.EC_ACCESS_PUSH_SERIALIZE_ERR = 204] = "EC_ACCESS_PUSH_SERIALIZE_ERR", 
            e[e.EC_ACCESS_LOGIN_BODY_PARSE_ERR = 205] = "EC_ACCESS_LOGIN_BODY_PARSE_ERR", e[e.EC_ACCESS_CONN_ERR = 206] = "EC_ACCESS_CONN_ERR", 
            e[e.EC_ACCESS_GET_RS_IP_ERR = 207] = "EC_ACCESS_GET_RS_IP_ERR", e[e.EC_ACCESS_ADD_COMM_CONN_ERR = 208] = "EC_ACCESS_ADD_COMM_CONN_ERR", 
            e[e.EC_ACCESS_ADD_HEART_CONN_ERR = 209] = "EC_ACCESS_ADD_HEART_CONN_ERR", e[e.EC_ACCESS_ADD_RELAY_CONN_ERR = 210] = "EC_ACCESS_ADD_RELAY_CONN_ERR", 
            e[e.EC_ACCESS_HEART_BODY_PARSE_ERR = 211] = "EC_ACCESS_HEART_BODY_PARSE_ERR", e[e.EC_ACCESS_GET_COMM_CONNECT_ERR = 212] = "EC_ACCESS_GET_COMM_CONNECT_ERR", 
            e[e.EC_ACCESS_GET_RELAY_CONNECT_ERR = 213] = "EC_ACCESS_GET_RELAY_CONNECT_ERR", 
            e[e.EC_ACCESS_ACCESS_INFO_EMPTY = 214] = "EC_ACCESS_ACCESS_INFO_EMPTY", e[e.EC_ACCESS_PLAYER_DUPLICATE_LOGIN = 215] = "EC_ACCESS_PLAYER_DUPLICATE_LOGIN", 
            e[e.EC_ACCESS_NOE_RELAY_OR_STATE_SVR = 216] = "EC_ACCESS_NOE_RELAY_OR_STATE_SVR", 
            e[e.EC_PLAYER_GAME_NOT_EXIST = 1e4] = "EC_PLAYER_GAME_NOT_EXIST", e[e.EC_PLAYER_SECRET_KEY_FAIL = 10001] = "EC_PLAYER_SECRET_KEY_FAIL", 
            e[e.EC_PLAYER_SIGN_ERR = 10002] = "EC_PLAYER_SIGN_ERR", e[e.EC_PLAYER_DUPLICATE_REQ = 10003] = "EC_PLAYER_DUPLICATE_REQ", 
            e[e.EC_PLAYER_TIMESTAMP_INVALID = 10004] = "EC_PLAYER_TIMESTAMP_INVALID", e[e.EC_PLAYER_QUERY_PLAYER_FAIL = 10005] = "EC_PLAYER_QUERY_PLAYER_FAIL", 
            e[e.EC_PLAYER_ADD_PLAYER_FAIL = 10006] = "EC_PLAYER_ADD_PLAYER_FAIL", e[e.EC_PLAYER_QUERY_GAME_FAIL = 10007] = "EC_PLAYER_QUERY_GAME_FAIL", 
            e[e.EC_PLAYER_RECORD_NUM_ERR = 10008] = "EC_PLAYER_RECORD_NUM_ERR", e[e.EC_PLAYER_GET_TOKEN_FAIL = 10009] = "EC_PLAYER_GET_TOKEN_FAIL", 
            e[e.EC_PLAYER_TOKEN_NOT_EXIST = 10010] = "EC_PLAYER_TOKEN_NOT_EXIST", e[e.EC_PLAYER_TOKEN_INVALID = 10011] = "EC_PLAYER_TOKEN_INVALID", 
            e[e.EC_PLAYER_CLEAR_TOKEN_FAIL = 10012] = "EC_PLAYER_CLEAR_TOKEN_FAIL", e[e.EC_PLAYER_LOCK_FAIL = 10013] = "EC_PLAYER_LOCK_FAIL", 
            e[e.EC_PLAYER_UNLOCK_FAIL = 10014] = "EC_PLAYER_UNLOCK_FAIL", e[e.EC_PLAYER_SAVE_TOKEN_FAIL = 10015] = "EC_PLAYER_SAVE_TOKEN_FAIL", 
            e[e.EC_PLAYER_GAME_OUT_OF_SERVICE = 10016] = "EC_PLAYER_GAME_OUT_OF_SERVICE", e[e.EC_ROOM_CREATE_NO_PERMISSION = 2e4] = "EC_ROOM_CREATE_NO_PERMISSION", 
            e[e.EC_ROOM_DESTORY_NO_PERMISSION = 20001] = "EC_ROOM_DESTORY_NO_PERMISSION", e[e.EC_ROOM_JOIN_NO_PERMISSION = 20002] = "EC_ROOM_JOIN_NO_PERMISSION", 
            e[e.EC_ROOM_REMOVE_PLAYER_NO_PERMISSION = 20003] = "EC_ROOM_REMOVE_PLAYER_NO_PERMISSION", 
            e[e.EC_ROOM_MODIFY_PROPERTIES_NO_PEMISSION = 20004] = "EC_ROOM_MODIFY_PROPERTIES_NO_PEMISSION", 
            e[e.EC_ROOM_DISSMISS_NO_PERMISSION = 20005] = "EC_ROOM_DISSMISS_NO_PERMISSION", 
            e[e.EC_ROOM_REMOVE_SELF_NO_PERMISSION = 20006] = "EC_ROOM_REMOVE_SELF_NO_PERMISSION", 
            e[e.EC_ROOM_CHECK_LOGIN_SESSION_ERR = 20007] = "EC_ROOM_CHECK_LOGIN_SESSION_ERR", 
            e[e.EC_ROOM_REMOVE_PLAYER_NOT_IN_ROOM = 20008] = "EC_ROOM_REMOVE_PLAYER_NOT_IN_ROOM", 
            e[e.EC_ROOM_PLAYER_ALREADY_IN_ROOM = 20010] = "EC_ROOM_PLAYER_ALREADY_IN_ROOM", 
            e[e.EC_ROOM_PLAYER_NOT_IN_ROOM = 20011] = "EC_ROOM_PLAYER_NOT_IN_ROOM", e[e.EC_ROOM_PLAYERS_EXCEED_LIMIT = 20012] = "EC_ROOM_PLAYERS_EXCEED_LIMIT", 
            e[e.EC_ROOM_JOIN_NOT_ALLOW = 20013] = "EC_ROOM_JOIN_NOT_ALLOW", e[e.EC_ROOM_MAX_PLAYERS_INVALID = 20014] = "EC_ROOM_MAX_PLAYERS_INVALID", 
            e[e.EC_ROOM_CREATE_FAIL = 20015] = "EC_ROOM_CREATE_FAIL", e[e.EC_ROOM_PLAYER_OFFLINE = 20016] = "EC_ROOM_PLAYER_OFFLINE", 
            e[e.EC_ROOM_PARAM_PAGE_INVALID = 20017] = "EC_ROOM_PARAM_PAGE_INVALID", e[e.EC_ROOM_GET_PLAYER_INFO_ERR = 20050] = "EC_ROOM_GET_PLAYER_INFO_ERR", 
            e[e.EC_ROOM_GET_ROOM_INFO_ERR = 20051] = "EC_ROOM_GET_ROOM_INFO_ERR", e[e.EC_ROOM_MODIFY_OWNER_ERR = 20052] = "EC_ROOM_MODIFY_OWNER_ERR", 
            e[e.EC_ROOM_MAX_ROOM_NUMBER_EXCEED_LIMIT = 20053] = "EC_ROOM_MAX_ROOM_NUMBER_EXCEED_LIMIT", 
            e[e.EC_ROOM_REMOVE_REDIS_PLAYER_ROOM_MATCH_ERR = -20052] = "EC_ROOM_REMOVE_REDIS_PLAYER_ROOM_MATCH_ERR", 
            e[e.EC_ROOM_REMOVE_REDIS_ROOM_INFO_ERR = -20053] = "EC_ROOM_REMOVE_REDIS_ROOM_INFO_ERR", 
            e[e.EC_ROOM_REDIS_UPDATE_ERR = -20054] = "EC_ROOM_REDIS_UPDATE_ERR", e[e.EC_ROOM_REDIS_GET_LOCK_ERR = -20055] = "EC_ROOM_REDIS_GET_LOCK_ERR", 
            e[e.EC_ROOM_REDIS_CHECK_LOCK_ERR = -20056] = "EC_ROOM_REDIS_CHECK_LOCK_ERR", e[e.EC_ROOM_REDIS_DEL_LOCK_ERR = -20057] = "EC_ROOM_REDIS_DEL_LOCK_ERR", 
            e[e.EC_ROOM_QUERY_PLAYER_ERR = 20060] = "EC_ROOM_QUERY_PLAYER_ERR", e[e.EC_ROOM_QUERY_GAME_ERR = 20061] = "EC_ROOM_QUERY_GAME_ERR", 
            e[e.EC_ROOM_PLAYER_INFO_NOT_EXIST = 20062] = "EC_ROOM_PLAYER_INFO_NOT_EXIST", e[e.EC_ROOM_GAME_INFO_NOT_EXIST = 20063] = "EC_ROOM_GAME_INFO_NOT_EXIST", 
            e[e.EC_ROOM_HISTORY_INFO_INSERT_ERR = -20064] = "EC_ROOM_HISTORY_INFO_INSERT_ERR", 
            e[e.EC_ROOM_REGION_INFO_NOT_EXIST = 20065] = "EC_ROOM_REGION_INFO_NOT_EXIST", e[e.EC_ROOM_QUERY_REGION_ERR = 20066] = "EC_ROOM_QUERY_REGION_ERR", 
            e[e.EC_ROOM_MODIFY_PLAYER_BUSY = 20070] = "EC_ROOM_MODIFY_PLAYER_BUSY", e[e.EC_ROOM_INFO_UNEXIST = 20080] = "EC_ROOM_INFO_UNEXIST", 
            e[e.EC_ROOM_ALLOCATE_RELAYSVR_IP_PORT_ERR = 20090] = "EC_ROOM_ALLOCATE_RELAYSVR_IP_PORT_ERR", 
            e[e.EC_ROOM_INVALID_PARAMS_TEAM_ID = 20100] = "EC_ROOM_INVALID_PARAMS_TEAM_ID", 
            e[e.EC_ROOM_TEAM_MEMBER_LIMIT_EXCEED = 20101] = "EC_ROOM_TEAM_MEMBER_LIMIT_EXCEED", 
            e[e.EC_ROOM_ALLOCATE_SERVICE_FAIL = -20200] = "EC_ROOM_ALLOCATE_SERVICE_FAIL", e[e.EC_MATCH_NO_ROOM = 3e4] = "EC_MATCH_NO_ROOM", 
            e[e.EC_MATCH_TIMEOUT = 30001] = "EC_MATCH_TIMEOUT", e[e.EC_MATCH_LOGIC_ERR = 30002] = "EC_MATCH_LOGIC_ERR", 
            e[e.EC_MATCH_ERR = 30010] = "EC_MATCH_ERR", e[e.EC_MATCH_PLAYER_IS_IN_MATCH = 30011] = "EC_MATCH_PLAYER_IS_IN_MATCH", 
            e[e.EC_MATCH_PLAYER_NOT_IN_MATCH = 30012] = "EC_MATCH_PLAYER_NOT_IN_MATCH", e[e.EC_MATCH_GET_MATCH_INFO_ERR = 30013] = "EC_MATCH_GET_MATCH_INFO_ERR", 
            e[e.EC_MATCH_UPDATE_MATCH_INFO_ERR = 30014] = "EC_MATCH_UPDATE_MATCH_INFO_ERR", 
            e[e.EC_MATCH_CANCEL_FAILED = 30015] = "EC_MATCH_CANCEL_FAILED", e[e.EC_MATCH_GET_PLAYER_LIST_INFO_ERR = 30016] = "EC_MATCH_GET_PLAYER_LIST_INFO_ERR", 
            e[e.EC_MATCH_CREATE_ROOM_ERR = 30041] = "EC_MATCH_CREATE_ROOM_ERR", e[e.EC_MATCH_JOIN_ROOM_ERR = 30042] = "EC_MATCH_JOIN_ROOM_ERR", 
            e[e.EC_MATCH_INVALID_PARAMS = 30043] = "EC_MATCH_INVALID_PARAMS", e[e.EC_MATCH_GROUP_NUM_EXCEED_LIMIT = 30044] = "EC_MATCH_GROUP_NUM_EXCEED_LIMIT", 
            e[e.EC_MATCH_PLAYER_ID_IS_REPEATED = 30045] = "EC_MATCH_PLAYER_ID_IS_REPEATED", 
            e[e.EC_MATCH_CREATE_ROOM_PLAYER_ALREADY_IN_ROOM = 30050] = "EC_MATCH_CREATE_ROOM_PLAYER_ALREADY_IN_ROOM", 
            e[e.EC_MATCH_QUERY_PLAYER_ERR = 30100] = "EC_MATCH_QUERY_PLAYER_ERR", e[e.EC_MATCH_PLAYER_INFO_NOT_EXIST = 30101] = "EC_MATCH_PLAYER_INFO_NOT_EXIST", 
            e[e.EC_MATCH_QUERY_GAME_ERR = 30102] = "EC_MATCH_QUERY_GAME_ERR", e[e.EC_MATCH_GAME_INFO_NOT_EXIST = 30103] = "EC_MATCH_GAME_INFO_NOT_EXIST", 
            e[e.EC_MATCH_QUERY_REGION_ERR = 30104] = "EC_MATCH_QUERY_REGION_ERR", e[e.EC_MATCH_REGION_INFO_NOT_EXIST = 30105] = "EC_MATCH_REGION_INFO_NOT_EXIST", 
            e[e.EC_MATCH_TEAM_FAIL = 30106] = "EC_MATCH_TEAM_FAIL", e[e.EC_MATCH_PLAY_RULE_NOT_RUNNING = 30107] = "EC_MATCH_PLAY_RULE_NOT_RUNNING", 
            e[e.EC_MATCH_PLAY_ATTR_NOT_FOUND = 30108] = "EC_MATCH_PLAY_ATTR_NOT_FOUND", e[e.EC_MATCH_PLAY_RULE_NOT_FOUND = 30109] = "EC_MATCH_PLAY_RULE_NOT_FOUND", 
            e[e.EC_MATCH_PLAY_RULE_ATTR_SEGMENT_NOT_FOUND = 30110] = "EC_MATCH_PLAY_RULE_ATTR_SEGMENT_NOT_FOUND", 
            e[e.EC_MATCH_PLAY_RULE_FUNC_ERR = 30111] = "EC_MATCH_PLAY_RULE_FUNC_ERR", e[e.EC_MATCH_GET_PLAYER_ATTR_FAIL = 30112] = "EC_MATCH_GET_PLAYER_ATTR_FAIL", 
            e[e.EC_MATCH_GET_TEAM_ATTR_FAIL = 30113] = "EC_MATCH_GET_TEAM_ATTR_FAIL", e[e.EC_MATCH_NONE_TEAM_TYPE_FIT = 30114] = "EC_MATCH_NONE_TEAM_TYPE_FIT", 
            e[e.EC_MATCH_TEAM_TYPE_INVALID = 30115] = "EC_MATCH_TEAM_TYPE_INVALID", e[e.EC_MATCH_PLAYER_ATTR_NOT_FOUND = 30116] = "EC_MATCH_PLAYER_ATTR_NOT_FOUND", 
            e[e.EC_MATCH_REQUEST_ID_NOT_EXIST = 30117] = "EC_MATCH_REQUEST_ID_NOT_EXIST", e[e.EC_MATCH_REQUEST_ID_IS_EXIST = 30118] = "EC_MATCH_REQUEST_ID_IS_EXIST", 
            e[e.EC_MATCH_TEAM_MATCH_FAIL = 30119] = "EC_MATCH_TEAM_MATCH_FAIL", e[e.EC_MATCH_INNER_LOGIC_ERR = -30150] = "EC_MATCH_INNER_LOGIC_ERR", 
            e[e.EC_MATCH_INNER_PARAMS_ERR = -30160] = "EC_MATCH_INNER_PARAMS_ERR", e[e.EC_MATCH_ROOM_INNER_ADD_NODE_ERR = -30170] = "EC_MATCH_ROOM_INNER_ADD_NODE_ERR", 
            e[e.EC_MATCH_ROOM_INNER_DEL_NODE_ERR = -30171] = "EC_MATCH_ROOM_INNER_DEL_NODE_ERR", 
            e[e.EC_RELAY_ALREADY_EXISTS = 4e4] = "EC_RELAY_ALREADY_EXISTS", e[e.EC_RELAY_NOT_EXISTS = 40001] = "EC_RELAY_NOT_EXISTS", 
            ...
            e[e.EC_RELAY_NO_MEMBERS = 40008] = "EC_RELAY_NO_MEMBERS", e[e.EC_RELAY_GAMESVR_SERVICE_NOT_OPEN = 40009] = "EC_RELAY_GAMESVR_SERVICE_NOT_OPEN", 
            e[e.EC_RELAY_REQ_POD_FAIL = 40010] = "EC_RELAY_REQ_POD_FAIL", e[e.EC_RELAY_NO_AVAILABLE_POD = 40011] = "EC_RELAY_NO_AVAILABLE_POD", 
            e[e.EC_RELAY_GET_FRAME_CACHE_FAIL = 40012] = "EC_RELAY_GET_FRAME_CACHE_FAIL", e[e.EC_RELAY_HKV_CACHE_ERROR = 40015] = "EC_RELAY_HKV_CACHE_ERROR", 
            e[e.EC_RELAY_REDIS_CACHE_ERROR = 40016] = "EC_RELAY_REDIS_CACHE_ERROR", e[e.EC_RELAY_NOTIFY_RELAYWORKER_FAIL = 40018] = "EC_RELAY_NOTIFY_RELAYWORKER_FAIL", 
            e[e.EC_RELAY_RESET_RELAY_ROOM_FAIL = 40019] = "EC_RELAY_RESET_RELAY_ROOM_FAIL", 
            e[e.EC_RELAY_CLEAN_RELAY_ROOM_FAIL = 40020] = "EC_RELAY_CLEAN_RELAY_ROOM_FAIL", 
            e[e.EC_RELAY_NO_PERMISSION = 40100] = "EC_RELAY_NO_PERMISSION", e[e.EC_RELAY_NOTIFY_GAMESVR_FAIL = 40200] = "EC_RELAY_NOTIFY_GAMESVR_FAIL", 
            e[e.EC_RELAY_FORWARD_TO_GAMESVR_FAIL = 40201] = "EC_RELAY_FORWARD_TO_GAMESVR_FAIL", 
            e[e.EC_RELAY_FORWARD_TO_CLIENT_FAIL = 40202] = "EC_RELAY_FORWARD_TO_CLIENT_FAIL", 
            e[e.EC_GROUP_OPERATION_FAILED = 7e4] = "EC_GROUP_OPERATION_FAILED", e[e.EC_INVALID_PARAMS_GROUP_NAME = 70001] = "EC_INVALID_PARAMS_GROUP_NAME", 
            e[e.EC_INVALID_PARAMS_GROUP_TYPE = 70002] = "EC_INVALID_PARAMS_GROUP_TYPE", e[e.EC_INVALID_PARAMS_GROUP_CUSTOM_PROPERTIES = 70003] = "EC_INVALID_PARAMS_GROUP_CUSTOM_PROPERTIES", 
            e[e.EC_INVALID_PARAMS_GROUP_PLAYER_NAME = 70004] = "EC_INVALID_PARAMS_GROUP_PLAYER_NAME", 
            e[e.EC_INVALID_PARAMS_GROUP_PLAYER_CUSTOM_STATUS = 70005] = "EC_INVALID_PARAMS_GROUP_PLAYER_CUSTOM_STATUS", 
            e[e.EC_INVALID_PARAMS_GROUP_PLAYER_CUSTOM_PROPERTIES = 70006] = "EC_INVALID_PARAMS_GROUP_PLAYER_CUSTOM_PROPERTIES", 
            e[e.EC_GROUP_MODIFY_OWNER_NO_PERMISSION = 70007] = "EC_GROUP_MODIFY_OWNER_NO_PERMISSION", 
            e[e.EC_INVALID_PARAMS_GROUP_ID = 70008] = "EC_INVALID_PARAMS_GROUP_ID", e[e.EC_INVALID_CHANGE_OPTION = 70009] = "EC_INVALID_CHANGE_OPTION", 
            e[e.EC_INVALID_PARAMS_GROUP_OWNER = 70010] = "EC_INVALID_PARAMS_GROUP_OWNER", e[e.EC_PLAYER_IS_EXIST_GROUP = 70011] = "EC_PLAYER_IS_EXIST_GROUP", 
            e[e.EC_PLAYER_IS_NOT_EXIST_GROUP = 70012] = "EC_PLAYER_IS_NOT_EXIST_GROUP", e[e.EC_REMOVE_PLAYER_ID_IS_EMPTY = 70013] = "EC_REMOVE_PLAYER_ID_IS_EMPTY", 
            e[e.EC_GROUP_REMOVE_PLAYER_NO_PERMISSION = 70014] = "EC_GROUP_REMOVE_PLAYER_NO_PERMISSION", 
            e[e.EC_INVALID_PARAMS_GROUP_RECV_TYPE = 70015] = "EC_INVALID_PARAMS_GROUP_RECV_TYPE", 
            e[e.EC_INVALID_PARAMS_RECV_PLAYER_ID = 70016] = "EC_INVALID_PARAMS_RECV_PLAYER_ID", 
            e[e.EC_INVALID_PARAMS_MESSAGE_LENGTH = 70017] = "EC_INVALID_PARAMS_MESSAGE_LENGTH", 
            e[e.EC_INVALID_PARAMS_MAX_PLAYER = 70018] = "EC_INVALID_PARAMS_MAX_PLAYER", e[e.PERSISTENCE_GROUP_NUM_EXCEED_THE_LIMIT = 70019] = "PERSISTENCE_GROUP_NUM_EXCEED_THE_LIMIT", 
            e[e.EC_INVALID_PARAMS_PLAYER_NOT_IN_GROUP = 70020] = "EC_INVALID_PARAMS_PLAYER_NOT_IN_GROUP", 
            ...
            e[e.EC_GROUP_CHAT_FREQUENCY_LIMIT = 70023] = "EC_GROUP_CHAT_FREQUENCY_LIMIT", e[e.EC_GROUP_PLAYER_NUM_LIMIT_EXCEED = 70024] = "EC_GROUP_PLAYER_NUM_LIMIT_EXCEED", 
            e[e.EC_PLAYER_GROUP_NUM_LIMIT_EXCEED = 70025] = "EC_PLAYER_GROUP_NUM_LIMIT_EXCEED", 
            e[e.EC_GROUP_NOT_EXIST = 70026] = "EC_GROUP_NOT_EXIST", e[e.EC_INVALID_PARAMS = 6e4] = "EC_INVALID_PARAMS", 
            e[e.EC_INVALID_PARAMS_PLAY_MODE_VERSION = 60001] = "EC_INVALID_PARAMS_PLAY_MODE_VERSION", 
            e[e.EC_INVALID_PARAMS_PLAY_MODE_RULETYPE = 60002] = "EC_INVALID_PARAMS_PLAY_MODE_RULETYPE", 
            e[e.EC_INVALID_PARAMS_PLAY_MODE_EXPRESSION = 60003] = "EC_INVALID_PARAMS_PLAY_MODE_EXPRESSION", 
            e[e.EC_INVALID_PARAMS_PLAY_MODE_TEAM = 60004] = "EC_INVALID_PARAMS_PLAY_MODE_TEAM", 
            e[e.EC_INVALID_PARAMS_MSGQ_ENCODE = 60020] = "EC_INVALID_PARAMS_MSGQ_ENCODE", e[e.EC_INVALID_PARAMS_MSGQ_DECODE = 60021] = "EC_INVALID_PARAMS_MSGQ_DECODE", 
            ...
            e[e.EC_INVALID_PARAMS_MAX_PLAYERS = 61002] = "EC_INVALID_PARAMS_MAX_PLAYERS", e[e.EC_INVALID_PARAMS_ROOM_TYPE = 61003] = "EC_INVALID_PARAMS_ROOM_TYPE", 
            e[e.EC_INVALID_PARAMS_PLAYER_ID = 61004] = "EC_INVALID_PARAMS_PLAYER_ID", e[e.EC_INVALID_PARAMS_MATCH_TYPE = 61005] = "EC_INVALID_PARAMS_MATCH_TYPE", 
            e[e.EC_INVALID_PARAMS_MATCH_CODE = 61006] = "EC_INVALID_PARAMS_MATCH_CODE", e[e.EC_INVALID_PARAMS_OPEN_ID = 61007] = "EC_INVALID_PARAMS_OPEN_ID", 
            e[e.EC_INVALID_PARAMS_PLATFORM = 61008] = "EC_INVALID_PARAMS_PLATFORM", e[e.EC_INVALID_PARAMS_TIMESTAMP = 61009] = "EC_INVALID_PARAMS_TIMESTAMP", 
            e[e.EC_INVALID_PARAMS_SIGN = 61010] = "EC_INVALID_PARAMS_SIGN", e[e.EC_INVALID_PARAMS_NONCE = 61011] = "EC_INVALID_PARAMS_NONCE", 
            e[e.EC_INVALID_PARAMS_TOKEN = 61012] = "EC_INVALID_PARAMS_TOKEN", e[e.EC_INVALID_PARAMS_NETWORK_STATE = 61013] = "EC_INVALID_PARAMS_NETWORK_STATE", 
            e[e.EC_INVALID_PARAMS_ROOM_NAME = 61014] = "EC_INVALID_PARAMS_ROOM_NAME", e[e.EC_INVALID_PARAMS_CREATE_ROOM_TYPE = 61015] = "EC_INVALID_PARAMS_CREATE_ROOM_TYPE", 
            e[e.EC_INVALID_PARAMS_DEVICE_ID = 61016] = "EC_INVALID_PARAMS_DEVICE_ID", e[e.EC_INVALID_PARAMS_PAGE_NO = 61017] = "EC_INVALID_PARAMS_PAGE_NO", 
            e[e.EC_INVALID_PARAMS_PAGE_SIZE = 61018] = "EC_INVALID_PARAMS_PAGE_SIZE", e[e.EC_INVALID_PARAMS_PLAYER_LIST = 61019] = "EC_INVALID_PARAMS_PLAYER_LIST", 
            e[e.EC_INVALID_PARAMS_MESSAGE = 61020] = "EC_INVALID_PARAMS_MESSAGE", e[e.EC_INVALID_CHANGE_ROOM_OPTION = 61021] = "EC_INVALID_CHANGE_ROOM_OPTION", 
            e[e.EC_INVALID_PARAMS_REGION = 61022] = "EC_INVALID_PARAMS_REGION", e[e.EC_INVALID_PARAMS_OWNER = 61023] = "EC_INVALID_PARAMS_OWNER", 
            e[e.EC_INVALID_PARAMS_OWNER_OPEN_ID = 61024] = "EC_INVALID_PARAMS_OWNER_OPEN_ID", 
            e[e.EC_INVALID_PARAMS_OPEN_ID_DUPLICATE = 61026] = "EC_INVALID_PARAMS_OPEN_ID_DUPLICATE", 
            e[e.EC_INVALID_PARAMS_ROOM_CREATE_TYPE = 61027] = "EC_INVALID_PARAMS_ROOM_CREATE_TYPE", 
            e[e.EC_MYSPP_SYSTEM_ERR = -1e3] = "EC_MYSPP_SYSTEM_ERR", e[e.EC_REDIS_KEY_NOT_EXIST = -66e3] = "EC_REDIS_KEY_NOT_EXIST", 
            e[e.EC_REDIS_SET_OP_ERR = -66001] = "EC_REDIS_SET_OP_ERR", e[e.EC_REDIS_GET_OP_ERR = -66002] = "EC_REDIS_GET_OP_ERR", 
            e[e.EC_REDIS_DEL_OP_ERR = -66003] = "EC_REDIS_DEL_OP_ERR", e[e.EC_REDIS_EXPIRE_OP_ERR = -66004] = "EC_REDIS_EXPIRE_OP_ERR", 
            e[e.EC_REDIS_LOCK_OP_ERR = -66005] = "EC_REDIS_LOCK_OP_ERR", e[e.EC_REDIS_LOCK_ALREADY_EXIST = -66006] = "EC_REDIS_LOCK_ALREADY_EXIST", 
            e[e.EC_REDIS_LIST_OP_ERR = -66020] = "EC_REDIS_LIST_OP_ERR", e[e.EC_REDIS_LIST_POP_EMPTY = -66021] = "EC_REDIS_LIST_POP_EMPTY", 
            e[e.EC_REDIS_POOL_GET_INSTANCE_FAIL = -66022] = "EC_REDIS_POOL_GET_INSTANCE_FAIL", 
            e[e.EC_REDIS_SET_IS_EMPTY = -66023] = "EC_REDIS_SET_IS_EMPTY", e[e.EC_REDIS_OP_INVALID_PARAMS = -66024] = "EC_REDIS_OP_INVALID_PARAMS", 
            e[e.EC_MYSQL_NO_ROW_FOUND = -66100] = "EC_MYSQL_NO_ROW_FOUND", e[e.EC_MYSQL_MULTI_ROW_FOUND = -66101] = "EC_MYSQL_MULTI_ROW_FOUND", 
            e[e.EC_MYSQL_INSERT_FAIL = -66102] = "EC_MYSQL_INSERT_FAIL", e[e.EC_MYSQL_DELETE_FAIL = -66103] = "EC_MYSQL_DELETE_FAIL", 
            e[e.EC_MYSQL_UPDATE_FAIL = -66104] = "EC_MYSQL_UPDATE_FAIL", e[e.EC_MYSQL_QUERYS_FAIL = -66105] = "EC_MYSQL_QUERYS_FAIL", 
            e[e.EC_PB_SERIALIZE_TO_STR_ERR = -66200] = "EC_PB_SERIALIZE_TO_STR_ERR", e[e.EC_PB_PARSE_FROM_STR_ERR = -66201] = "EC_PB_PARSE_FROM_STR_ERR", 
            e[e.EC_DATA_FORMAT_ERR = -66210] = "EC_DATA_FORMAT_ERR", e[e.EC_JSON_FORMAT_ERR = -66211] = "EC_JSON_FORMAT_ERR", 
            e[e.EC_JSON_PLAY_MODE_FORMAT_ERR = -66212] = "EC_JSON_PLAY_MODE_FORMAT_ERR", e[e.EC_JSON_PLAY_MODE_PARISE_ERR = -66213] = "EC_JSON_PLAY_MODE_PARISE_ERR", 
            e[e.EC_INVALID_PARAMS_RECORE_ID = -66601] = "EC_INVALID_PARAMS_RECORE_ID", e[e.EC_HASHID_ERR = -66700] = "EC_HASHID_ERR", 
            e[e.EC_HASHID_ENCODE_ERR = -66701] = "EC_HASHID_ENCODE_ERR", e[e.EC_HASHID_DECODE_ERR = -66702] = "EC_HASHID_DECODE_ERR", 
            e[e.EC_CONF_ROOM_ID_BUCKET_ERR = -66801] = "EC_CONF_ROOM_ID_BUCKET_ERR", e[e.EC_SDK_SEND_FAIL = 90001] = "EC_SDK_SEND_FAIL", 
            e[e.EC_SDK_UNINIT = 90002] = "EC_SDK_UNINIT", e[e.EC_SDK_RES_TIMEOUT = 90003] = "EC_SDK_RES_TIMEOUT", 
            e[e.EC_SDK_NO_LOGIN = 90004] = "EC_SDK_NO_LOGIN", e[e.EC_SDK_NO_CHECK_LOGIN = 90005] = "EC_SDK_NO_CHECK_LOGIN", 
            e[e.EC_SDK_SOCKET_ERROR = 90006] = "EC_SDK_SOCKET_ERROR", e[e.EC_SDK_SOCKET_CLOSE = 90007] = "EC_SDK_SOCKET_CLOSE", 
            e[e.EC_SDK_NO_ROOM = 90008] = "EC_SDK_NO_ROOM", e[e.EC_SDK_ENCODE_PARAM_FAIL = 90009] = "EC_SDK_ENCODE_PARAM_FAIL", 
            e[e.EC_SDK_INVALID_PARAMS = 90010] = "EC_SDK_INVALID_PARAMS";
        }(ae || (ae = {})), function(e) {
            e[e.COMMON_OFFLINE = 0] = "COMMON_OFFLINE", e[e.COMMON_ONLINE = 1] = "COMMON_ONLINE", 
            e[e.RELAY_OFFLINE = 2] = "RELAY_OFFLINE", e[e.RELAY_ONLINE = 3] = "RELAY_ONLINE";
        }(_e || (_e = {})), function(e) {
            e[e.COMMON_CREATE = 0] = "COMMON_CREATE", e[e.MATCH_CREATE = 1] = "MATCH_CREATE", 
            e[e.THIRD_PARTY_CREATE = 2] = "THIRD_PARTY_CREATE";
        }(Ee || (Ee = {})), function(e) {
            e[e.STOP = 0] = "STOP", e[e.START = 1] = "START";
        }(le || (le = {})), function(e) {
            e[e.COMMON_JOIN = 0] = "COMMON_JOIN", e[e.MATCH_JOIN = 1] = "MATCH_JOIN";
        }(ue || (ue = {})), function(e) {
            e[e.ROOM_NAME = 0] = "ROOM_NAME", e[e.OWNER = 1] = "OWNER", e[e.IS_VIEWED = 2] = "IS_VIEWED", 
            e[e.IS_INVITED = 3] = "IS_INVITED", e[e.IS_PRIVATE = 4] = "IS_PRIVATE", e[e.CUSTOM_PROPERTIES = 5] = "CUSTOM_PROPERTIES", 
            e[e.IS_FORBID_JOIN = 6] = "IS_FORBID_JOIN";
        }(de || (de = {})), function(e) {
            e[e.PENDING = 0] = "PENDING", e[e.MATCHING = 1] = "MATCHING", e[e.SUCCESS = 3] = "SUCCESS", 
            e[e.TIMEOUT = 4] = "TIMEOUT";
        }(he || (he = {})), function(e) {
            e[e.ROOM_SIMPLE = 1] = "ROOM_SIMPLE", e[e.PLAYER_COMPLEX = 2] = "PLAYER_COMPLEX";
        }(Re || (Re = {})), function(e) {
            e[e.E_GS_FORWARDTYPE_DEFAULT = 0] = "E_GS_FORWARDTYPE_DEFAULT", e[e.E_GS_FORWARDTYPE_NOTIFY_CONNECTION = 1] = "E_GS_FORWARDTYPE_NOTIFY_CONNECTION", 
            e[e.E_GS_FORWARDTYPE_NOTIFY_ROOM_EVENT = 2] = "E_GS_FORWARDTYPE_NOTIFY_ROOM_EVENT", 
            ...
            e[e.GROUP_NAME = 0] = "GROUP_NAME", e[e.GROUP_OWNER = 1] = "GROUP_OWNER", e[e.GROUP_CUSTOM_PROPERTIES = 2] = "GROUP_CUSTOM_PROPERTIES", 
            e[e.GROUP_IS_FORBID_JOIN = 3] = "GROUP_IS_FORBID_JOIN";
        }(pe || (pe = {})), function(e) {
        ...
        }, Ie = s.QAppProtoErrCode;
        var Ce;
        !function(e) {
            e.EC_SDK_SEND_FAIL = "发送失败", e.EC_SDK_UNINIT = "未初始化", e.EC_SDK_RES_TIMEOUT = "发送超时", 
            e.EC_SDK_NO_LOGIN = "未登录", e.EC_SDK_NO_CHECK_LOGIN = "CheckLogin失败", e.EC_SDK_SOCKET_ERROR = "Socket错误", 
            e.EC_SDK_SOCKET_CLOSE = "Socket断开", e.EC_SDK_NO_ROOM = "无房间信息";
        }(Ce || (Ce = {}));
        const ge = {};
        ge[Ie.EC_SDK_SEND_FAIL] = Ce.EC_SDK_SEND_FAIL, ge[Ie.EC_SDK_UNINIT] = Ce.EC_SDK_UNINIT, 
        ge[Ie.EC_SDK_RES_TIMEOUT] = Ce.EC_SDK_RES_TIMEOUT, ge[Ie.EC_SDK_NO_LOGIN] = Ce.EC_SDK_NO_LOGIN, 
        ge[Ie.EC_SDK_NO_CHECK_LOGIN] = Ce.EC_SDK_NO_CHECK_LOGIN, ge[Ie.EC_SDK_SOCKET_ERROR] = Ce.EC_SDK_SOCKET_ERROR, 
        ge[Ie.EC_SDK_SOCKET_CLOSE] = Ce.EC_SDK_SOCKET_CLOSE, ge[Ie.EC_SDK_NO_ROOM] = Ce.EC_SDK_NO_ROOM;
        var ye, Te = Ie;
        !function(e) {
            let t, n, r, i, o, s, a;
            !function(e) {
        ...
        var Oe = {
            ...
            get FrameSyncState() {
                return s.FrameSyncState;
            },
            get RecvType() {
                return ye.RecvType;
            },
            get GroupRecvType() {
                return ye.GroupRecvType;
            },
            get GroupType() {
                return ye.GroupType;
            }
        };
        const Ae = r(2), Me = (e, t) => void 0 === t ? null : t, Pe = {
            pingTimeout: 5e3,
            ...
            playerId: void 0,
            body: void 0
        }, Le = JSON.stringify(Ne, Me), be = {
            gameId: void 0,
            openId: void 0,
            secretKey: void 0,
            createSignature: void 0
        }, De = JSON.stringify(be, Me);
        var we, Ge, Ue, Ye;
        !function(e) {
            let t = {};
            ...
            let n = t.UNINIT;
            e.isInited = (() => n === t.INITED), e.isIniting = (() => n === t.INITING), e.isUnInit = (() => n === t.UNINIT), 
            e.setStatus = (e => n = e);
        }(Ge || (Ge = {})), function(e) {
            let t;
            !function(e) {
                e[e.LOGIN = 1] = "LOGIN", e[e.LOGINING = 2] = "LOGINING", e[e.LOGOUT = 3] = "LOGOUT", 
                e[e.LOGOUTING = 4] = "LOGOUTING";
            }(t = e.StatusType || (e.StatusType = {}));
            let n = t.LOGOUT, r = 0, i = "";
        ...
        const ke = s.ClientSendServerReqWrap2Cmd, Fe = s.ServerSendClientBstWrap2Type, qe = {
            initServerTime: 0,
            offset: 0,
            setServerTime(e) {
                qe.initServerTime = e, qe.offset = e - Date.now();
            },
            getServerTime_UTC_8: () => Date.now() + qe.offset
        };
        function He() {
        ...
        const xe = {};
        xe.connectSocket = _(e => new WebSocket(e, [], Pe.cacertNativeUrl)), xe.request = l, 
        xe.onHide = (e => cc.game.on(cc.game.EVENT_HIDE, e)), xe.offHide = (e => cc.game.off(cc.game.EVENT_HIDE, e)), 
        xe.onShow = (e => cc.game.on(cc.game.EVENT_SHOW, e)), xe.offShow = (e => cc.game.off(cc.game.EVENT_SHOW, e)), 
        xe.getStorageSync = f, xe.setStorageSync = p, xe.removeStorageSync = m, xe.getUserInfo = S, 
        xe.getSystemInfoSync = C, xe.getLocation = g, xe.getNetworkType = y, xe.createUDPSocket = null, 
        xe.channel = i.COCOS_NATIVE, "undefined" != typeof window ? xe.root = window : xe.root = {};
        let Be = a, Ve = i.UNKNOWN, Qe = o.UNKNOWN;
        L() ? (Be = D, Qe = function() {
            if (!L()) return o.UNKNOWN;
            const e = swan.getSystemInfoSync(), t = e ? e.system + "" : "";
            return t.includes("Android") ? o.ANDROID : t.includes("iOS") ? o.IOS : o.UNKNOWN;
        }()) : M() ? (Be = v, Qe = function() {
            if (!M()) return o.UNKNOWN;
            const e = qq.getSystemInfoSync(), t = e ? e.system + "" : "";
            return t.includes("Android") ? o.ANDROID : t.includes("iOS") ? o.IOS : o.UNKNOWN;
        }()) : j() ? (Be = ee, Qe = function() {
            if (!j()) return o.UNKNOWN;
            const e = qq.getSystemInfoSync(), t = e ? e.system + "" : "";
            return t.includes("Android") ? o.ANDROID : t.includes("iOS") ? o.IOS : o.UNKNOWN;
        }()) : T() ? (Be = A, Qe = function() {
            if (!T()) return o.UNKNOWN;
            const e = wx.getSystemInfoSync(), t = e ? e.system + "" : "";
            return t.includes("Android") ? o.ANDROID : t.includes("iOS") ? o.IOS : o.UNKNOWN;
        }()) : q() ? (Be = K, Qe = function() {
            if (!q()) return o.UNKNOWN;
            const e = wx.getSystemInfoSync(), t = e ? e.system + "" : "";
            return t.includes("Android") ? o.ANDROID : t.includes("iOS") ? o.IOS : o.UNKNOWN;
        }()) : G() ? (Be = Y, Qe = G() ? o.ANDROID : o.UNKNOWN) : k() ? (Be = H, Qe = k() ? o.ANDROID : o.UNKNOWN) : He() && (Be = xe, 
        Qe = He() ? cc.sys.os === cc.sys.OS_ANDROID ? o.ANDROID : cc.sys.os === cc.sys.OS_IOS ? o.IOS : o.UNKNOWN : o.UNKNOWN), 
        Be.globalData = {}, Ve = Be.channel;
        class We {
            constructor(e = -1) {
                this.id = e;
            }
        ...
        class Xe {}
        Xe.enable = !1, Xe.exclude = [], Xe.callback = (e => console.log(...e)), Xe.log = ((...e) => {
            if (!Xe.enable) return;
            if (Array.isArray(Xe.exclude) && Xe.exclude.findIndex(t => t === e[0]) >= 0) return;
            const t = [ `DEBUGGER_v${Je.version}_${Je.sdkType}_${Ve} ` + Date.now() ].concat(e);
            "function" == typeof Xe.callback && Xe.callback(t);
        }), Object.defineProperty(Xe, "log", {
            enumerable: !1,
            configurable: !1,
            writable: !1,
            value: Xe.log
        ...
        var ze = Xe;
        const $e = r(3), Ze = r(4), et = r(7).default, tt = new et(rt(), 16), nt = new et(rt(), 32);
        let it = 1;
        function rt() {
            let e = Date.now().toString(36);
            for (let t = 0; t < 6; t++) e += Math.ceil(1e6 * (Math.random() + 1)).toString(36);
            return e;
        }
        const ot = nt.encode(Date.now()), pt = (e, t) => (e < 0 && (t = `服务器内部错误[${e}]`, 
        e = Te.EC_INNER_ERROR), {
            errCode: e,
            errMsg: t
        });
        ...
        function ut(e = new Uint8Array(0)) {
            return {
                data: e
            };
        }
        ...
        function ct(e, t, n) {
            return e[t++] = 255 & n, e[t++] = n >> 8 & 255, e[t++] = n >> 16 & 255, e[t++] = n >> 24 & 255, 
            t;
        }
        function ft(e, t) {
            return [ e[t++] | e[t++] << 8 | e[t++] << 16 | e[t++] << 24, t ];
        }
        const mt = Math.min, Lt = Math.max;
        function St(e, t) {
            return e - t;
        }
        function Ct(e, t) {
        ...
        function gt(e) {
            let t = 0, n = new Uint8Array(0);
            if (lt(e.rcv_queue)) return n;
            if (function(e) {
                let t = 0;
                if (lt(e.rcv_queue)) return -1;
            ...
            for (let t = e.rcv_queue.next; t !== e.rcv_queue; ) {
                let r = t;
                t = t.next, n = dt(n, r.data);
                let i = r.frg;
                if (Et(r), e.nrcv_que--, 0 == i) break;
            }
            for (;!lt(e.rcv_buf); ) {
                let t = e.rcv_buf.next;
                if (!(t.sn == e.rcv_nxt && e.nrcv_que < e.rcv_wnd)) break;
                Et(t), e.nrcv_buf--, _t(t, e.rcv_queue), e.nrcv_que++, e.rcv_nxt++;
            }
        ...
        function It(e, t) {
            ...
            if (0 == e.rx_srtt) e.rx_srtt = t, e.rx_rttval = t / 2; else {
                let n = t - e.rx_srtt;
                n < 0 && (n = -n), e.rx_rttval = (3 * e.rx_rttval + n) / 4, e.rx_srtt = (7 * e.rx_srtt + t) / 8, 
                e.rx_srtt < 1 && (e.rx_srtt = 1);
            }
            var r;
            n = e.rx_srtt + Lt(e.interval, 4 * e.rx_rttval), e.rx_rto = (r = e.rx_minrto, mt(Lt(r, n), 6e4));
        }
        function yt(e) {
        ...
        function Tt(e, t) {
            if (!(St(t, e.snd_una) < 0 || St(t, e.snd_nxt) >= 0)) for (let n, r = e.snd_buf.next; r != e.snd_buf; r = n) {
                if (n = r.next, t == r.sn) {
                    Et(r), e.nsnd_buf--;
                    break;
                }
                if (St(t, r.sn) < 0) break;
            }
        }
        function Ot(e, t) {
            for (let n, r = e.snd_buf.next; r != e.snd_buf && (n = r.next, St(t, r.sn) > 0); r = n) Et(r), 
            e.nsnd_buf--;
        }
        function At(e, t, n) {
            let r = e.ackcount + 1;
            if (r > e.ackblock) {
                let t, n;
                for (n = 8; n < r; n <<= 1) ;
                if (t = new Uint32Array(2 * n), null != e.acklist) for (let n = 0; n < e.ackcount; n++) t[2 * n + 0] = e.acklist[2 * n + 0], 
                t[2 * n + 1] = e.acklist[2 * n + 1];
        ...
        function Pt(e, t) {
            let n, r, i = t.sn, o = 0;
            if (!(St(i, e.rcv_nxt + e.rcv_wnd) >= 0 || St(i, e.rcv_nxt) < 0)) {
                for (n = e.rcv_buf.prev; n != e.rcv_buf; n = r) {
                    if (r = n.prev, n.sn == i) {
                        o = 1;
                        break;
                    }
                    if (St(i, n.sn) > 0) break;
                }
                var s, a;
                for (0 == o && (at(t), a = n, (s = t).prev = a, s.next = a.next, a.next.prev = s, 
                a.next = s, e.nrcv_buf++); !lt(e.rcv_buf); ) {
                    let t = e.rcv_buf.next;
                    if (!(t.sn == e.rcv_nxt && e.nrcv_que < e.rcv_wnd)) break;
                    Et(t), e.nrcv_buf--, _t(t, e.rcv_queue), e.nrcv_que++, e.rcv_nxt++;
                }
        ...
        function vt(e, t, n) {
            var r, i, o;
            return t = ht(e, t = ct(e, t, n.conv), n.cmd), r = e, i = t = ht(e, t, n.frg), o = n.wnd, 
            r[i++] = 255 & o, r[i++] = o >> 8 & 255, t = ct(e, t = i, n.ts), t = ct(e, t, n.sn), 
            t = ct(e, t, n.una), ct(e, t, n.data.length);
        }
        function Nt(e) {
            let t = e.current;
            const n = e.buffer;
            let r = 0, i = 0, o = 0, s = ut();
            ...
            let a = e.ackcount;
            for (let t = 0; t < a; t++) r + 24 > e.mtu && (Ct(e, n.slice(0, r)), r = 0), [s.sn, s.ts] = Mt(e, t), 
            r = vt(n, r, s);
            e.ackcount = 0, 0 == e.rmt_wnd ? 0 == e.probe_wait ? (e.probe_wait = 7e3, e.ts_probe = e.current + e.probe_wait) : St(e.current, e.ts_probe) >= 0 && (e.probe_wait < 7e3 && (e.probe_wait = 7e3), 
            e.probe_wait += e.probe_wait / 2, e.probe_wait > 12e4 && (e.probe_wait = 12e4), 
            e.ts_probe = e.current + e.probe_wait, e.probe |= 1) : (e.ts_probe = 0, e.probe_wait = 0), 
            1 & e.probe && (s.cmd = 83, r + 24 > e.mtu && (Ct(e, n.slice(0, r)), r = 0), r = vt(n, r, s)), 
            2 & e.probe && (s.cmd = 84, r + 24 > e.mtu && (Ct(e, n.slice(0, r)), r = 0), r = vt(n, r, s)), 
            e.probe = 0;
            let _ = mt(e.snd_wnd, e.rmt_wnd);
            for (0 == e.nocwnd && (_ = mt(e.cwnd, _)); St(e.snd_nxt, e.snd_una + _) < 0 && !lt(e.snd_queue); ) {
                let n = e.snd_queue.next;
                Et(n), _t(n, e.snd_buf), e.nsnd_que--, e.nsnd_buf++, n.conv = e.conv, n.cmd = 81, 
                n.wnd = s.wnd, n.ts = t, n.sn = e.snd_nxt++, n.una = e.rcv_nxt, n.resendts = t, 
                n.rto = e.rx_rto, n.fastack = 0, n.xmit = 0;
            }
            let E = e.fastresend > 0 ? e.fastresend : 4294967295, l = 0 == e.nodelay ? e.rx_rto >> 3 : 0;
            for (let a = e.snd_buf.next; a != e.snd_buf; a = a.next) {
                let _ = 0;
                0 == a.xmit ? (_ = 1, a.xmit++, a.rto = e.rx_rto, a.resendts = t + a.rto + l) : St(t, a.resendts) >= 0 ? (_ = 1, 
                a.xmit++, e.xmit++, 0 == e.nodelay ? a.rto += e.rx_rto : a.rto += e.rx_rto / 2, 
                a.resendts = t + a.rto, o = 1) : a.fastack >= E && (a.xmit <= e.fastlimit || e.fastlimit <= 0) && (_ = 1, 
                a.xmit++, a.fastack = 0, a.resendts = t + a.rto, i++), _ && (a.ts = t, a.wnd = s.wnd, 
                a.una = e.rcv_nxt, r + (24 + a.data.length) > e.mtu && (Ct(e, n.slice(0, r)), r = 0), 
                r = vt(n, r, a), a.data.length > 0 && (n.set(a.data.slice(0, a.data.length), r), 
                r += a.data.length), a.xmit >= e.dead_link && (e.state = -1));
            }
            if (r > 0 && (Ct(e, n.slice(0, r)), r = 0), i) {
                let t = e.snd_nxt - e.snd_una;
                e.ssthresh = t / 2, e.ssthresh < 2 && (e.ssthresh = 2), e.cwnd = e.ssthresh + E, 
                e.incr = e.cwnd * e.mss;
            }
            o && (e.ssthresh = _ / 2, e.ssthresh < 2 && (e.ssthresh = 2), e.cwnd = 1, e.incr = e.mss), 
            e.cwnd < 1 && (e.cwnd = 1, e.incr = e.mss);
        }
        class bt {
            constructor(e, t) {
            ...
            input(e) {
                let t = function(e, t) {
                    let n = e.snd_una, r = 0, i = 0, o = 0, s = 0, a = t.length;
                    for (;;) {
                        let n, l, u, d, h, R, c, f;
                        if (a < 24) break;
                        if ([h, s] = ft(t, s), h != e.conv) return -1;
                        if ([c, s] = Rt(t, s), [f, s] = Rt(t, s), [R, s] = (E = s, [ (_ = t)[E++] | _[E++] << 8, E ]), 
                        [n, s] = ft(t, s), [l, s] = ft(t, s), [d, s] = ft(t, s), [u, s] = ft(t, s), (a -= 24) < u || u < 0) return -2;
                        if (81 != c && 82 != c && 83 != c && 84 != c) return -3;
                        if (e.rmt_wnd = R, Ot(e, d), yt(e), 82 == c) St(e.current, n) >= 0 && It(e, St(e.current, n)), 
                        Tt(e, l), yt(e), 0 == o ? (o = 1, r = l, i = n) : St(l, r) > 0 && St(n, i) > 0 && (r = l, 
                        i = n); else if (81 == c) {
                            if (St(l, e.rcv_nxt + e.rcv_wnd) < 0 && (At(e, l, n), St(l, e.rcv_nxt) >= 0)) {
                                let r = ut();
                                r.conv = h, r.cmd = c, r.frg = f, r.wnd = R, r.ts = n, r.sn = l, r.una = d, u > 0 && (r.data = t.slice(s, s + u)), 
                                Pt(e, r);
                            }
                        } else if (83 == c) e.probe |= 2; else if (84 != c) return -3;
                        s += u, a -= u;
                    }
                    var _, E;
                    if (0 != o && function(e, t, n) {
                        if (!(St(t, e.snd_una) < 0 || St(t, e.snd_nxt) >= 0)) for (let r, i = e.snd_buf.next; i != e.snd_buf && (r = i.next, 
                        !(St(t, i.sn) < 0)); i = r) t != i.sn && St(n, i.ts) >= 0 && i.fastack++;
                    }(e, r, i), St(e.snd_una, n) > 0 && e.cwnd < e.rmt_wnd) {
                        let t = e.mss;
                        e.cwnd < e.ssthresh ? (e.cwnd++, e.incr += t) : (e.incr < t && (e.incr = t), e.incr += t * t / e.incr + t / 16, 
                        (e.cwnd + 1) * t <= e.incr && e.cwnd++), e.cwnd > e.rmt_wnd && (e.cwnd = e.rmt_wnd, 
                        e.incr = e.rmt_wnd * t);
                    }
                    return 0;
                }(this._kcp, e);
            ...
            send(e) {
                return function(e, t) {
                    ...
                    if (0 != e.stream) {
                        if (!lt(e.snd_queue)) {
                            ...
                            if (o.data.length < e.mss) {
                                let s = e.mss - o.data.length, a = r < s ? r : s, _ = dt(o.data, t.slice(n, n + a));
                                n += a;
                                let E = ut(_);
                                _t(E, e.snd_queue), E.frg = 0, r -= a, Et(i = o), at(i);
                            }
                        }
                        if (r <= 0) return 0;
                    }
                    ...
                    0 == o && (o = 1);
                    for (let i = 0; i < o; i++) {
                        let s = r > e.mss ? e.mss : r, a = ut();
                        r > 0 && (a.data = t.slice(n, n + s), n += s), a.frg = 0 == e.stream ? o - i - 1 : 0, 
                        at(a), _t(a, e.snd_queue), e.nsnd_que++, r -= s;
                    }
                    return 0;
                }(this._kcp, e);
            }
            ...
            update(e = !1) {
                let t = Date.now(), n = t - this._ts;
                return n >= 4294967296 && (this._ts = t, n = 0), e ? (i = n, (r = this._kcp).current = i, 
                0 == r.updated && (r.updated = 1, r.ts_flush = r.current), r.ts_flush = r.current, 
                r.ts_flush += r.interval, St(r.current, r.ts_flush) >= 0 && (r.ts_flush = r.current + r.interval), 
                void Nt(r)) : function(e, t) {
                    e.current = t, 0 == e.updated && (e.updated = 1, e.ts_flush = e.current);
                    let n = St(e.current, e.ts_flush);
                    (n >= 1e4 || n < -1e4) && (e.ts_flush = e.current, n = 0), n >= 0 && (e.ts_flush += e.interval, 
                    St(e.current, e.ts_flush) >= 0 && (e.ts_flush = e.current + e.interval), Nt(e));
                }(this._kcp, n);
                var r, i;
            }
            nodelay(e, t, n, r) {
                return function(e, t, n, r, i) {
                    return t >= 0 && (e.nodelay = t, e.rx_minrto = t ? 30 : 100), n >= 0 && (n > 5e3 ? n = 5e3 : n < 1 && (n = 1), 
                    e.interval = n), r >= 0 && (e.fastresend = r), i >= 0 && (e.nocwnd = i), 0;
                }(this._kcp, e, t, n, r);
            }
            setWinSize(e, t) {
                return r = e, i = t, (n = this._kcp) && (r > 0 && (n.snd_wnd = r), i > 0 && (n.rcv_wnd = Lt(i, 128))), 
                0;
                var n, r, i;
            }
        }
        bt.asyncer = (e => new Promise(e => e()).then(e));
        const Dt = {
            get connectSocket() {
                let e = Be.connectSocket;
                return Pe.enableUDP && Be.createUDPSocket && (e = (e => {
                    let t, n = null, r = null, i = null, o = null, s = 0;
                    const a = e.url.toLowerCase().replace("wss://", "").replace("ws://", ""), _ = a.split(":")[0], E = parseInt(a.split(":")[1] || "443", 10), l = new bt(123, {
                        address: _,
                        port: E
                    });
                    l.nodelay(1, 10, 2, 1), l.setWinSize(1024, 1024);
                    const u = Be.createUDPSocket(), d = {
                        get readyState() {
                            return s;
                        },
                        CONNECTING: 0,
                        ...
                        onMessage: e => n = e,
                        close: e => {
                            u.close(), R(), e && e.success && e.success();
                        },
                        send: ({data: e, fail: t, success: n}) => {
                            l && (0 !== l.send(new Uint8Array(e)) ? st(() => t && t())() : st(() => n && n())(), 
                            l.updateAsync());
                        }
                    };
                    u.onClose(e => {
                        ...
                        s = 3, u.close(), st(() => o && o(e))();
                    }), u.onListening(e => {
                        ze.log("UDP_onListening"), s = 1, h(), st(() => i && i(e))();
                    }), u.onMessage(e => {
                    ...
                    return ze.log("UDP_bind", c), d;
                })), e;
            }
        }, wt = {
            connectSocket: Be.connectSocket
        }, Gt = {
            connect: "connect",
        ...
        var Yt = class {
            ...
            init(e) {
                ...
                let n = 0;
                const r = () => {
                    ze.log("SOCKET_OPEN", this.id, this.isConnect()), n = 0, l(), je(t);
                }, i = e => {
                    ze.log("SOCKET_CLOSE", e, this.id), E(), Ke(t, () => s("close"), Pe.reconnectInterval), 
                    this.forceClose && (n = 0, this.forceClose = !1, je(t));
                }, o = e => {
                    ze.log("SOCKET_ERROR", e, this.id, this.socketTask && this.socketTask.readyState), 
                    _(Gt.connectError, {
                        msg: "socket connectError",
                        data: e
                    }), Ke(t, () => s("error"), Pe.reconnectInterval);
                }, s = e => {
                    if (!this.url) throw new Error("socket.url = " + this.url);
                    if (!this.isConnect() && !this.isClose()) return Ke(t, () => s("open"), Pe.reconnectInterval);
                    if (!this.isClose()) return;
                    if (ze.log("SOCKET_TRY_OPEN", this.id, e, this.socketTask && this.socketTask.readyState, n, Pe.reconnectMaxTimes), 
                    ++n > Pe.reconnectMaxTimes) return n = 0, void ze.log("SOCKET_RECONNECT_TIMEOUT");
                    const a = "wss://" + this.url.replace("wss://", "").replace("ws://", "");
                    je(t), this.forceClose = !1, this.enableUdp ? this.socketTask = Dt.connectSocket({
                        url: a,
                        fail: () => console.error("connectSocket fail")
                    }) : this.socketTask = wt.connectSocket({
                        url: a,
                        fail: () => console.error("connectSocket fail")
                    }), this.socketTask.onOpen(r.bind(this)), this.socketTask.onClose(i.bind(this)), 
                    this.socketTask.onError(o.bind(this)), this.socketTask.onMessage((e => {
                        _(Gt.message, {
                            msg: "socket message",
                            data: e.data
                        });
                    ...
                    ze.log("SOCKET_CONNECT", this.id, e), !this.isConnect() && n > 0 && n < Pe.reconnectMaxTimes || (n = 0, 
                    s(e + " connect"));
                }, _ = (e, t = {}) => {
                ...
                this.connect = a, this.connectNewSocket = (e => {
                    ze.log("SOCKET_CONNECT_NEW", this.id, this.isClose()), this.url = e, n = 0;
                    const t = () => {
                        a("connectNewSocket");
                    };
                    this.close(t, t);
                }), this.send = ((e, {fail: t, success: n}) => {
                    ...
                    this.socketTask.send({
                        data: e.buffer,
                        fail: n => {
                            ze.log("SOCKET_SEND_FAIL", this.id, n), t({
                                data: e
                            });
                        },
                        success: () => {
                    ...
                    this.socketTask.close({
                        success: t => {
                            ze.log("SOCKET_CLOSE_SUCCESS", this.id, t), this.socketTask = null, e && e();
                        },
                        fail: e => {
                            ze.log("SOCKET_CLOSE_ERROR", this.id, e), this.socketTask = null, t && t();
                        }
                    });
                }), this.destory = (() => {
                    je(t), !this.isClose() && this.close(), this.offAll();
                }), this.isConnect = (() => this.socketTask && this.socketTask.readyState === this.socketTask.OPEN), 
                this.isConnecting = (() => this.socketTask && this.socketTask.readyState === this.socketTask.CONNECTING), 
                this.isClose = (() => !this.socketTask || this.socketTask && this.socketTask.readyState === this.socketTask.CLOSED), 
                this.isClosing = (() => this.socketTask && this.socketTask.readyState === this.socketTask.CLOSING), 
                this.on = ((e, t) => {
                    (Ut.includes(e) || "*" === e) && "function" == typeof t && (this.eventCallbacks.push([ e, t ]), 
                    e === Gt.message && (this.isMsgBind = !0));
                }), this.once = ((e, t) => {
                    Ut.includes(e) && "function" == typeof t && this.eventOnceCallbacks.set(e, t);
                }), this.emit = _, this.offAll = (() => {
                    this.eventCallbacks = [], this.eventOnceCallbacks.clear(), this.isMsgBind = !1;
                });
            }
        };
        const kt = [ ke.E_CMD_LOGIN_REQ, ke.E_CMD_LOGOUT_REQ ], Ft = [ ke.E_CMD_RELAY_SEND_FRAME_REQ, ke.E_CMD_RELAY_REQUEST_FRAME_REQ, ke.E_CMD_HEART_BEAT_REQ, ke.E_CMD_RELAY_CLIENT_SENDTO_GAMESVR_REQ ];
        var qt;
        !function(e) {
            e[e.CLIENT_PRE = parseInt("0x2", 16)] = "CLIENT_PRE", e[e.CLIENT_END = parseInt("0x3", 16)] = "CLIENT_END", 
            e[e.SERVER_PRE = parseInt("0x28", 16)] = "SERVER_PRE", e[e.SERVER_END = parseInt("0x29", 16)] = "SERVER_END";
        }(qt || (qt = {}));
        class Ht {
            constructor() {
            ...
            static startQueueLoop() {
                Ke(Ht.timer, () => {
                    const e = Date.now();
                    return Array.from(Ht.sendQueue).forEach(([t, n]) => {
                        if (e - n.time > Pe.resendTimeout) {
                            let e, t = "";
                            Ue.isStatus(Ue.StatusType.LOGIN) ? e = Te.EC_SDK_RES_TIMEOUT : Ue.getErrCode() === Te.EC_OK ? (e = Te.EC_SDK_NO_LOGIN, 
                            t = "登录失败") : (e = Ue.getErrCode(), t = "登录失败，" + Ue.getErrMsg()), n.sendFail(e, t);
                        } else !n.isSocketSend && e - n.time >= Pe.resendInterval && n.resend();
                    }), Ht.startQueueLoop();
                }, Pe.resendInterval);
            }
            static stopQueueLoop() {
                je(Ht.timer), Array.from(Ht.sendQueue).forEach(([e, t]) => {
                    t.remove();
                }), Ht.sendQueue.clear();
            }
            bindSocket(e, t, n) {
                return !(this.socket || !e || (this.socket = e, !this.socket.isMsgBind && this.socket.on(Gt.message, (e => {
                    if (!e.data) return;
                    const {body: r, pre: i, end: o} = this.unpackBody(new Uint8Array(e.data));
                    i === qt.CLIENT_PRE && o === qt.CLIENT_END && t(r), i === qt.SERVER_PRE && o === qt.SERVER_END && n(r);
                }).bind(this)), 0));
            }
            unbindSocket() {
            ...
            clearBdHandlers() {
                Array.from(this.bdHandlers).forEach(e => {
                    Ht.broadcastHandlers.delete(e), this.bdHandlers.delete(e);
                });
            }
            deleteSeqQueue(e) {
                Ht.sendQueue.delete(e), this.queue.delete(e);
            }
            addSeqQueue(e, t) {
                Ht.sendQueue.set(e, t), this.queue.add(e);
            }
            setBroadcastHandler(e, t) {
                Ht.broadcastHandlers.set(e, t), this.bdHandlers.add(e);
            }
            handleErrCode(e) {
                return !1;
            }
            send(e, t, n) {
                ...
                return Ht.sendQueue.size > 10 && ze.log("SENDQUEUE_size", Ht.sendQueue.size), 0 !== r ? this.handleSendFail(t, r) : this.socket.send(e, {
                    fail: e => this.handleSendFail(t, e),
                    success: () => this.handleSendSuccess(t)
                }), t;
            }
            buildData(e, t, n) {
                const r = 5 + t.length + 1, i = new Uint8Array(function(e, t) {
                    let n = [];
                    for (;e > 255; ) n.push(255 & e), e >>= 8;
                    for (0 !== e && n.push(e), n = n.slice(0, 4); n.length < 4; ) n.push(0);
                    return n.reverse();
                }(r)), o = new Uint8Array(r);
                return o.set(e), o.set(i, e.length), o.set(t, e.length + i.length), o.set(n, e.length + i.length + t.length), 
                o;
            }
            unpackBody(e) {
                const t = e.slice(1, 5), n = function(e) {
                    let t = 0;
                    const n = e.length;
            ...
            handleSendFail(e, t) {
                const n = Ht.sendQueue.get(e);
                if (n) return Date.now() - n.time > Pe.resendTimeout ? n.sendFail(Ue.getErrCode() || t) : t === Te.EC_SDK_UNINIT ? n.sendFail(t) : t === Te.EC_SDK_NO_LOGIN || t === Te.EC_SDK_NO_CHECK_LOGIN ? this.socket.emit(Gt.autoAuth, {}) : void 0;
            }
            handleSendSuccess(e) {
                Ht.sendQueue.has(e) && Ht.sendQueue.get(e).sendSuccess();
            }
            getReadyCode(e) {
                return Ge.isInited() || e === ke.E_CMD_LOGIN_REQ ? this.socket && this.socket.url ? Ue.isStatus(Ue.StatusType.LOGIN) || kt.includes(e) ? this.socket.id === s.ConnectionType.RELAY && !Ye.isChecked() && Ft.includes(e) ? Te.EC_SDK_NO_CHECK_LOGIN : 0 : Te.EC_SDK_NO_LOGIN : Te.EC_SDK_SEND_FAIL : (console.error("MGOBE.Listener 未初始化"), 
                we.setInfo({
                    id: ""
                }), Ue.setStatus(Ue.StatusType.LOGOUT), Te.EC_SDK_UNINIT);
            }
        }
        Ht.sendQueue = new Map(), Ht.broadcastHandlers = new Map(), Ht.timer = new We();
        var xt = Ht;
        let Bt = r(8);
        class Qt {
            constructor(e) {
                this.root = Bt.newBuilder({}).import(e).build();
            }
            lookupType(e) {
                let t = this.root;
            ...
            static numberify(e) {
                if (null == e) return e;
                if (e.constructor === Bt.Long) return Number(e);
                let t = Object.prototype.toString.apply(e);
                return e.constructor === Bt.ByteBuffer ? e.buffer.slice(e.offset, e.offset + e.limit) : ("[object Object]" !== t && "[object Array]" !== t || Object.keys(e).forEach(function(t) {
                    e[t] = Qt.numberify(e[t]);
                }), e);
            }
            bufferify(e, t) {
        ...
        function Vt(e, t, n, r) {
            return {
                ...
                bufferify: function(i) {
                    ...
                    return r.forEach(function(e) {
                        o[e.key] && (o[n] = e.IProto.bufferify(o[e.key]), void 0 !== e.value && (o[t] = e.value), 
                        delete o[e.key]);
                    }), e.bufferify(o);
                }
            };
        ...
        const Wt = {
            ...
            FrameExtInfo: [ "seed" ],
            Frame: [ "id", "items", "ext" ],
            RequestFrameReq: [ "roomId", "beginFrameId", "endFrameId" ],
            RequestFrameRsp: [ "frames" ],
            ...
            MatchGroupInfo: [ "id", "leader", "playerIdList", "playerInfoList", "matchAttributes", "region", "sdkVersion", "teamId", "teamType", "requestId" ],
            MatchTeamInfo: [ "teamId", "teamName", "teamLeader", "members", "matchAttributes", "memberSdkVersions", "groupIds", "groupSdkVersions", "teamType" ],
            ProgressPlayerInfo: [ "playerId", "teamName", "matchAttributes" ],
            ...
            MatchProgress: [ "requestId", "playerIdList", "playerInfoList", "status", "eventType", "playerInfoSuccessList", "teamInfoList", "completedTime" ],
            ...
            ApiDescribeMatchRsp: [ "matchProgressList", "gameId", "matchCode" ],
            ...
            let e;
            return () => e || (e = new Qt(Kt));
        })();
        Object.keys(Se).map(e => {
            return Se[e] = (t = jt, n = [ ne, e ].join("."), r = Wt[e], {
                bufferify: t().bufferify(n, r),
                objectify: t().objectify(n)
            });
            var t, n, r;
        }), Vt(Se.ClientSendServerReqWrap2, "cmd", "body", [ {
            value: se.E_CMD_LOGIN_REQ,
            key: "LoginReq",
            IProto: Se.LoginReq
        }, {
            value: se.E_CMD_LOGOUT_REQ,
            key: "LogoutReq",
            IProto: Se.LogoutReq
        }, {
            value: se.E_CMD_CHANGE_PLAYER_STATE_REQ,
            key: "ChangeCustomPlayerStatusReq",
            IProto: Se.ChangeCustomPlayerStatusReq
        }, {
            value: se.E_CMD_RELAY_CLIENT_SENDTO_GAMESVR_REQ,
            key: "SendToGameSvrReq",
            IProto: Se.SendToGameSvrReq
        }, {
            value: se.E_CMD_RELAY_SEND_FRAME_REQ,
            key: "SendFrameReq",
            IProto: Se.SendFrameReq
        }, {
            value: se.E_CMD_ROOM_CHAT_REQ,
            key: "SendToClientReq",
            IProto: Se.SendToClientReq
        }, {
            value: se.E_CMD_CHECK_LOGIN_REQ,
            key: "CheckLoginReq",
            IProto: Se.CheckLoginReq
        }, {
            value: se.E_CMD_RELAY_REQUEST_FRAME_REQ,
            key: "RequestFrameReq",
            IProto: Se.RequestFrameReq
        }, {
            value: se.E_CMD_START_FRAME_SYNC_REQ,
            key: "StartFrameSyncReq",
            IProto: Se.StartFrameSyncReq
        }, {
            value: se.E_CMD_STOP_FRAME_SYNC_REQ,
            key: "StopFrameSyncReq",
            IProto: Se.StopFrameSyncReq
        }, {
            value: se.E_CMD_CREATE_ROOM_REQ,
            key: "CreateRoomReq",
            IProto: Se.CreateRoomReq
        }, {
            value: se.E_CMD_JOIN_ROOM_REQ,
            key: "JoinRoomReq",
            IProto: Se.JoinRoomReq
        }, {
            value: se.E_CMD_QUIT_ROOM_REQ,
            key: "LeaveRoomReq",
            IProto: Se.LeaveRoomReq
        }, {
            value: se.E_CMD_DISSMISS_ROOM_REQ,
            key: "DismissRoomReq",
            IProto: Se.DismissRoomReq
        }, {
            value: se.E_CMD_CHANGE_ROOM_PROPERTIS_REQ,
            key: "ChangeRoomReq",
            IProto: Se.ChangeRoomReq
        }, {
            value: se.E_CMD_REMOVE_MEMBER_REQ,
            key: "RemovePlayerReq",
            IProto: Se.RemovePlayerReq
        }, {
            value: se.E_CMD_GET_ROOM_DETAIL_REQ,
            key: "GetRoomByRoomIdReq",
            IProto: Se.GetRoomByRoomIdReq
        }, {
            value: se.E_CMD_GET_ROOM_LIST_REQ,
            key: "GetRoomListReq",
            IProto: Se.GetRoomListReq
        }, {
            value: se.E_CMD_GET_ROOM_LIST_V2_REQ,
            key: "GetRoomListReq",
            IProto: Se.GetRoomListReq
        }, {
            value: se.E_CMD_HEART_BEAT_REQ,
            key: "HeartBeatReq",
            IProto: Se.HeartBeatReq
        }, {
            value: se.E_CMD_MATCH_PLAYER_COMPLEX_REQ,
            key: "MatchPlayersReq",
            IProto: Se.MatchPlayersReq
        }, {
            value: se.E_CMD_MATCH_ROOM_SIMPLE_REQ,
            key: "MatchRoomSimpleReq",
            IProto: Se.MatchRoomSimpleReq
        }, {
            value: se.E_CMD_MATCH_CANCEL_MATCH_REQ,
            key: "CancelPlayerMatchReq",
            IProto: Se.CancelPlayerMatchReq
        } ]), Se.ClientSendServerRspWrap2, se.E_CMD_LOGIN_REQ, Se.LoginRsp, se.E_CMD_LOGOUT_REQ, 
        Se.LogoutRsp, se.E_CMD_CHANGE_PLAYER_STATE_REQ, Se.ChangeCustomPlayerStatusRsp, 
        se.E_CMD_RELAY_CLIENT_SENDTO_GAMESVR_REQ, Se.SendToGameSvrRsp, se.E_CMD_RELAY_SEND_FRAME_REQ, 
        Se.SendFrameRsp, se.E_CMD_ROOM_CHAT_REQ, Se.SendToClientRsp, se.E_CMD_CHECK_LOGIN_REQ, 
        Se.CheckLoginRsp, se.E_CMD_RELAY_REQUEST_FRAME_REQ, Se.RequestFrameRsp, se.E_CMD_START_FRAME_SYNC_REQ, 
        Se.StartFrameSyncRsp, se.E_CMD_STOP_FRAME_SYNC_REQ, Se.StopFrameSyncRsp, se.E_CMD_CREATE_ROOM_REQ, 
        Se.CreateRoomRsp, se.E_CMD_JOIN_ROOM_REQ, Se.JoinRoomRsp, se.E_CMD_QUIT_ROOM_REQ, 
        Se.LeaveRoomRsp, se.E_CMD_DISSMISS_ROOM_REQ, Se.DismissRoomRsp, se.E_CMD_CHANGE_ROOM_PROPERTIS_REQ, 
        Se.ChangeRoomRsp, se.E_CMD_REMOVE_MEMBER_REQ, Se.RemovePlayerRsp, se.E_CMD_GET_ROOM_DETAIL_REQ, 
        Se.GetRoomByRoomIdRsp, se.E_CMD_GET_ROOM_LIST_V2_REQ, Se.GetRoomListRsp, se.E_CMD_HEART_BEAT_REQ, 
        Se.HeartBeatRsp, se.E_CMD_MATCH_PLAYER_COMPLEX_REQ, Se.MatchPlayersRsp, se.E_CMD_MATCH_ROOM_SIMPLE_REQ, 
        Se.MatchRoomSimpleRsp, se.E_CMD_MATCH_CANCEL_MATCH_REQ, Se.CancelPlayerMatchRsp;
        const Jt = Vt(Se.ServerSendClientBstWrap2, "type", "msg", [ {
            value: oe.E_PUSH_TYPE_GAMESVR,
            key: "RecvFromGameSvrBst",
            IProto: Se.RecvFromGameSvrBst
        }, {
            value: oe.E_PUSH_TYPE_ROOM_CHAT,
            key: "RecvFromClientBst",
            IProto: Se.RecvFromClientBst
        }, {
            value: oe.E_PUSH_TYPE_START_GAME,
            key: "StartFrameSyncBst",
            IProto: Se.StartFrameSyncBst
        }, {
            value: oe.E_PUSH_TYPE_STOP_GAME,
            key: "StopFrameSyncBst",
            IProto: Se.StopFrameSyncBst
        }, {
            value: oe.E_PUSH_TYPE_RELAY,
            key: "RecvFrameBst",
            IProto: Se.RecvFrameBst
        }, {
            value: oe.E_PUSH_TYPE_JOIN_ROOM,
            key: "JoinRoomBst",
            IProto: Se.JoinRoomBst
        }, {
            value: oe.E_PUSH_TYPE_LEAVE_ROOM,
            key: "LeaveRoomBst",
            IProto: Se.LeaveRoomBst
        }, {
            value: oe.E_PUSH_TYPE_DISMISS_ROOM,
            key: "DismissRoomBst",
            IProto: Se.DismissRoomBst
        }, {
            value: oe.E_PUSH_TYPE_MODIFY_ROOM_PROPERTY,
            key: "ChangeRoomBst",
            IProto: Se.ChangeRoomBst
        }, {
            value: oe.E_PUSH_TYPE_REMOVE_PLAYER,
            key: "RemovePlayerBst",
            IProto: Se.RemovePlayerBst
        }, {
            value: oe.E_PUSH_TYPE_PLAYER_STATE,
            key: "ChangeCustomPlayerStatusBst",
            IProto: Se.ChangeCustomPlayerStatusBst
        }, {
            value: oe.E_PUSH_TYPE_NETWORK_STATE,
            key: "ChangePlayerNetworkStateBst",
            IProto: Se.ChangePlayerNetworkStateBst
        }, {
            value: oe.E_PUSH_TYPE_MATCH_TIMEOUT,
            key: "MatchTimeoutBst",
            IProto: Se.MatchTimeoutBst
        }, {
            value: oe.E_PUSH_TYPE_MATCH_SUCCESS,
            key: "MatchPlayersBst",
            IProto: Se.MatchPlayersBst
        } ]), Xt = (Vt(Se.ClientSendServerReqWrap1, "cmd", "body", [ {
            value: void 0,
            key: "ClientSendServerReqWrap2",
            IProto: Se.ClientSendServerReqWrap2
        } ]), Vt(Se.ServerSendClientBstWrap1, "cmd", "body", [ {
            value: void 0,
            key: "ServerSendClientBstWrap2",
            IProto: Jt
        } ]), pt), zt = ke, $t = Fe, Zt = Se, en = new Map(), tn = new Map(), nn = new Map(), rn = Zt.ClientSendServerReqWrap1, on = Zt.ClientSendServerReqWrap2, sn = Zt.ClientSendServerRspWrap1, an = Zt.ClientSendServerRspWrap2, _n = Zt.ServerSendClientBstWrap1, En = Zt.ServerSendClientBstWrap2;
        var ln;
        en.set(zt.E_CMD_LOGIN_REQ, Zt.LoginReq), tn.set(zt.E_CMD_LOGIN_REQ, Zt.LoginRsp), 
        en.set(zt.E_CMD_LOGOUT_REQ, Zt.LogoutReq), tn.set(zt.E_CMD_LOGOUT_REQ, Zt.LogoutRsp), 
        en.set(zt.E_CMD_CHANGE_PLAYER_STATE_REQ, Zt.ChangeCustomPlayerStatusReq), tn.set(zt.E_CMD_CHANGE_PLAYER_STATE_REQ, Zt.ChangeCustomPlayerStatusRsp), 
        en.set(zt.E_CMD_RELAY_CLIENT_SENDTO_GAMESVR_REQ, Zt.SendToGameSvrReq), tn.set(zt.E_CMD_RELAY_CLIENT_SENDTO_GAMESVR_REQ, Zt.SendToGameSvrRsp), 
        en.set(zt.E_CMD_RELAY_SEND_FRAME_REQ, Zt.SendFrameReq), tn.set(zt.E_CMD_RELAY_SEND_FRAME_REQ, Zt.SendFrameRsp), 
        en.set(zt.E_CMD_ROOM_CHAT_REQ, Zt.SendToClientReq), tn.set(zt.E_CMD_ROOM_CHAT_REQ, Zt.SendToClientRsp), 
        en.set(zt.E_CMD_CHECK_LOGIN_REQ, Zt.CheckLoginReq), tn.set(zt.E_CMD_CHECK_LOGIN_REQ, Zt.CheckLoginRsp), 
        en.set(zt.E_CMD_RELAY_REQUEST_FRAME_REQ, Zt.RequestFrameReq), tn.set(zt.E_CMD_RELAY_REQUEST_FRAME_REQ, Zt.RequestFrameRsp), 
        en.set(zt.E_CMD_START_FRAME_SYNC_REQ, Zt.StartFrameSyncReq), tn.set(zt.E_CMD_START_FRAME_SYNC_REQ, Zt.StartFrameSyncRsp), 
        en.set(zt.E_CMD_STOP_FRAME_SYNC_REQ, Zt.StopFrameSyncReq), tn.set(zt.E_CMD_STOP_FRAME_SYNC_REQ, Zt.StopFrameSyncRsp), 
        en.set(zt.E_CMD_CREATE_ROOM_REQ, Zt.CreateRoomReq), tn.set(zt.E_CMD_CREATE_ROOM_REQ, Zt.CreateRoomRsp), 
        en.set(zt.E_CMD_JOIN_ROOM_REQ, Zt.JoinRoomReq), tn.set(zt.E_CMD_JOIN_ROOM_REQ, Zt.JoinRoomRsp), 
        en.set(zt.E_CMD_QUIT_ROOM_REQ, Zt.LeaveRoomReq), tn.set(zt.E_CMD_QUIT_ROOM_REQ, Zt.LeaveRoomRsp), 
        en.set(zt.E_CMD_DISSMISS_ROOM_REQ, Zt.DismissRoomReq), tn.set(zt.E_CMD_DISSMISS_ROOM_REQ, Zt.DismissRoomRsp), 
        en.set(zt.E_CMD_CHANGE_ROOM_PROPERTIS_REQ, Zt.ChangeRoomReq), tn.set(zt.E_CMD_CHANGE_ROOM_PROPERTIS_REQ, Zt.ChangeRoomRsp), 
        en.set(zt.E_CMD_REMOVE_MEMBER_REQ, Zt.RemovePlayerReq), tn.set(zt.E_CMD_REMOVE_MEMBER_REQ, Zt.RemovePlayerRsp), 
        en.set(zt.E_CMD_GET_ROOM_DETAIL_REQ, Zt.GetRoomByRoomIdReq), tn.set(zt.E_CMD_GET_ROOM_DETAIL_REQ, Zt.GetRoomByRoomIdRsp), 
        en.set(zt.E_CMD_GET_ROOM_LIST_REQ, Zt.GetRoomListReq), tn.set(zt.E_CMD_GET_ROOM_LIST_REQ, Zt.GetRoomListRsp), 
        en.set(zt.E_CMD_GET_ROOM_LIST_V2_REQ, Zt.GetRoomListReq), tn.set(zt.E_CMD_GET_ROOM_LIST_V2_REQ, Zt.GetRoomListRsp), 
        en.set(zt.E_CMD_HEART_BEAT_REQ, Zt.HeartBeatReq), tn.set(zt.E_CMD_HEART_BEAT_REQ, Zt.HeartBeatRsp), 
        en.set(zt.E_CMD_MATCH_PLAYER_COMPLEX_REQ, Zt.MatchPlayersReq), tn.set(zt.E_CMD_MATCH_PLAYER_COMPLEX_REQ, Zt.MatchPlayersRsp), 
        en.set(zt.E_CMD_MATCH_GROUP_REQ, Zt.MatchGroupReq), tn.set(zt.E_CMD_MATCH_GROUP_REQ, Zt.MatchGroupRsp), 
        en.set(zt.E_CMD_MATCH_ROOM_SIMPLE_REQ, Zt.MatchRoomSimpleReq), tn.set(zt.E_CMD_MATCH_ROOM_SIMPLE_REQ, Zt.MatchRoomSimpleRsp), 
        en.set(zt.E_CMD_MATCH_CANCEL_MATCH_REQ, Zt.CancelPlayerMatchReq), tn.set(zt.E_CMD_MATCH_CANCEL_MATCH_REQ, Zt.CancelPlayerMatchRsp), 
        en.set(zt.E_CMD_CREATE_GROUP_REQ, Zt.CreateGroupReq), tn.set(zt.E_CMD_CREATE_GROUP_REQ, Zt.CreateGroupRsp), 
        en.set(zt.E_CMD_JOIN_GROUP_REQ, Zt.JoinGroupReq), tn.set(zt.E_CMD_JOIN_GROUP_REQ, Zt.JoinGroupRsp), 
        en.set(zt.E_CMD_QUIT_GROUP_REQ, Zt.LeaveGroupReq), tn.set(zt.E_CMD_QUIT_GROUP_REQ, Zt.LeaveGroupRsp), 
        en.set(zt.E_CMD_DISMISS_GROUP_REQ, Zt.DismissGroupReq), tn.set(zt.E_CMD_DISMISS_GROUP_REQ, Zt.DismissGroupRsp), 
        en.set(zt.E_CMD_CHANGE_GROUP_PROPERTIES_REQ, Zt.ChangeGroupReq), tn.set(zt.E_CMD_CHANGE_GROUP_PROPERTIES_REQ, Zt.ChangeGroupRsp), 
        en.set(zt.E_CMD_REMOVE_GROUP_MEMBER_REQ, Zt.RemoveGroupPlayerReq), tn.set(zt.E_CMD_REMOVE_GROUP_MEMBER_REQ, Zt.RemoveGroupPlayerRsp), 
        en.set(zt.E_CMD_GET_GROUP_DETAIL_REQ, Zt.GetGroupByGroupIdReq), tn.set(zt.E_CMD_GET_GROUP_DETAIL_REQ, Zt.GetGroupByGroupIdRsp), 
        en.set(zt.E_CMD_GET_GROUP_LIST_REQ, Zt.GetMyGroupsReq), tn.set(zt.E_CMD_GET_GROUP_LIST_REQ, Zt.GetMyGroupsRsp), 
        en.set(zt.E_CMD_CHANGE_GROUP_PLAYER_STATE_REQ, Zt.ChangeCustomGroupPlayerStatusReq), 
        tn.set(zt.E_CMD_CHANGE_GROUP_PLAYER_STATE_REQ, Zt.ChangeCustomGroupPlayerStatusRsp), 
        en.set(zt.E_CMD_GROUP_CHAT_REQ, Zt.SendToGroupClientReq), tn.set(zt.E_CMD_GROUP_CHAT_REQ, Zt.SendToGroupClientRsp), 
        nn.set($t.E_PUSH_TYPE_GAMESVR, Zt.RecvFromGameSvrBst), nn.set($t.E_PUSH_TYPE_ROOM_CHAT, Zt.RecvFromClientBst), 
        nn.set($t.E_PUSH_TYPE_START_GAME, Zt.StartFrameSyncBst), nn.set($t.E_PUSH_TYPE_STOP_GAME, Zt.StopFrameSyncBst), 
        nn.set($t.E_PUSH_TYPE_RELAY, Zt.RecvFrameBst), nn.set($t.E_PUSH_TYPE_JOIN_ROOM, Zt.JoinRoomBst), 
        nn.set($t.E_PUSH_TYPE_LEAVE_ROOM, Zt.LeaveRoomBst), nn.set($t.E_PUSH_TYPE_DISMISS_ROOM, Zt.DismissRoomBst), 
        nn.set($t.E_PUSH_TYPE_MODIFY_ROOM_PROPERTY, Zt.ChangeRoomBst), nn.set($t.E_PUSH_TYPE_REMOVE_PLAYER, Zt.RemovePlayerBst), 
        nn.set($t.E_PUSH_TYPE_PLAYER_STATE, Zt.ChangeCustomPlayerStatusBst), nn.set($t.E_PUSH_TYPE_NETWORK_STATE, Zt.ChangePlayerNetworkStateBst), 
        nn.set($t.E_PUSH_TYPE_MATCH_TIMEOUT, Zt.MatchTimeoutBst), nn.set($t.E_PUSH_TYPE_MATCH_SUCCESS, Zt.MatchPlayersBst), 
        nn.set($t.E_PUSH_TYPE_MATCH_CANCEL, Zt.CancelMatchBst), nn.set($t.E_PUSH_TYPE_JOIN_GROUP, Zt.JoinGroupBst), 
        nn.set($t.E_PUSH_TYPE_LEAVE_GROUP, Zt.LeaveGroupBst), nn.set($t.E_PUSH_TYPE_DISMISS_GROUP, Zt.DismissGroupBst), 
        nn.set($t.E_PUSH_TYPE_MODIFY_GROUP_PROPERTY, Zt.ChangeGroupBst), nn.set($t.E_PUSH_TYPE_REMOVE_GROUP_PLAYER, Zt.RemoveGroupPlayerBst), 
        nn.set($t.E_PUSH_TYPE_GROUP_PLAYER_STATE, Zt.ChangeCustomGroupPlayerStatusBst), 
        nn.set($t.E_PUSH_TYPE_GROUP_CHAT, Zt.RecvFromGroupClientBst), function(e) {
        ...
        var pn = {
            get id() {
                return we.getInfo().id;
            },
            get openId() {
                return be.openId;
            },
            get name() {
                return we.getInfo().name;
            },
            get teamId() {
                return we.getInfo().teamId;
            },
            get customPlayerStatus() {
                return we.getInfo().customPlayerStatus;
            },
            get customProfile() {
                return we.getInfo().customProfile;
            },
            get commonNetworkState() {
                return we.getInfo().commonNetworkState;
            },
            get relayNetworkState() {
                return we.getInfo().relayNetworkState;
            }
        };
        function dn() {
            return qe.getServerTime_UTC_8();
        }
        function hn(e) {
            return (1e6 * dn() + Math.floor(1e6 * Math.random())).toString(e) || "";
        }
        function Rn() {
            mn.conf.getLocation && Be.getLocation({
                type: mn.conf.locationType || "wgs84",
                success(e) {
                    Be.setStorageSync(mn.prefix + mn.lt, JSON.stringify(e));
                }
            });
        }
        function cn() {
            mn.conf.getUserInfo && Be.getUserInfo({
                withCredentials: !1,
                success(e) {
                    const t = e.userInfo;
                    t.nickName = encodeURIComponent(t.nickName), Be.setStorageSync(mn.prefix + mn.ui, JSON.stringify(t));
                },
                fail(e) {}
            });
        }
        function fn(e, t, n, r, i) {
            ...
            const o = [ {
            ...
            } ], s = Be.getSystemInfoSync(), a = {
                deviceId: function() {
                    let e = Be.getStorageSync(mn.prefix + mn.u);
                    return e || (e = hn(36), Be.setStorageSync(mn.prefix + mn.u, e)), e;
                }(),
                appkey: mn.conf.appKey,
                versionCode: mn.conf.version,
                initTime: t,
                channelID: mn.conf.channelId,
                sdkVersion: mn.sdkVersion,
                pixel: void 0 === s.screenWidth ? "" : s.screenWidth + "*" + s.screenHeight + "*" + s.pixelRatio,
                language: s.language,
                model: encodeURIComponent(s.model),
                wxVersion: s.version,
                networkType: Be.getStorageSync(mn.prefix + mn.nt) || "4g",
                ...
                opid: mn.opid,
                unid: mn.unid,
                userInfo: mn.conf.getUserInfo && Be.getStorageSync(mn.prefix + mn.ui) || "",
                location: mn.conf.getLocation && Be.getStorageSync(mn.prefix + mn.lt) || "",
                msgs: o
            };
            Be.request({
                url: mn.serverUrl,
        ...
        const mn = {
            ...
            init() {
                var e;
                mn.conf.appKey && void 0 !== mn.conf.appKey && mn.conf.appKey.length > 0 && mn.conf.version && void 0 !== mn.conf.version && mn.conf.version.length > 0 && (mn.serverUrl = "https://" + (mn.conf.isDebug ? "jrlts" : "report") + ".wxlagame.com/analytics/upload?tp=weapp", 
                Rn(), cn(), Be.getNetworkType({
                    success(e) {
                        Be.setStorageSync(mn.prefix + mn.nt, e.networkType);
                    }
                }), mn.opid = Be.getStorageSync(mn.prefix + mn.oik), mn.unid = Be.getStorageSync(mn.prefix + mn.uik), 
                this.atl = dn(), (!(e = this.atl) || void 0 === e || 0 >= e) && (e = dn()), fn(1, e, 0, []));
            },
            onEvent(e, t, n) {
                const r = dn();
                fn(4, r, 0, [ {
            ...
            setOpenid(e) {
                e && e.length > 0 && (mn.opid = e, Be.setStorageSync(mn.prefix + mn.oik, e));
            },
            setUnionid(e) {
                e && e.length > 0 && (mn.unid = e, Be.setStorageSync(mn.prefix + mn.uik, e));
            },
            setGetLocation(e) {
                mn.conf.getLocation = !0 === e, !0 === e && Rn();
            },
            setGetUserInfo(e) {
                mn.conf.getUserInfo = !0 === e, !0 === e && cn();
            }
        }, Sn = {
            lastFrameTime: 0,
            deltaTime: 0,
            ...
            frameId: 0,
            trigger: (e, t) => {
                const n = Date.now(), r = Sn.roomId, i = Sn.frameId;
                Sn.roomId = e, Sn.frameId = t, 0 !== Sn.lastFrameTime && r === e && i + 1 === t ? (Sn.deltaTime = n - Sn.lastFrameTime, 
                un.onBstFrameRate && un.onBstFrameRate(Sn.deltaTime), function(e, t) {
                    if (!Cn || An.disableReport || An.disableFrameReport || t < 0) return;
                    const n = `{"reFt":${t},"frRt":${Mn.frameRate},"start":"${Tn()}"${e ? `,"rid":"${e + ""}"` : ""}}`;
                    gn.e5.push(n);
                }(e, Sn.deltaTime), Sn.lastFrameTime = n) : Sn.lastFrameTime = n;
            },
            clear: () => {
                Sn.lastFrameTime = 0, Sn.deltaTime = 0, Sn.roomId = "", Sn.frameId = 0;
            }
        }, In = r(2);
        let Cn = !1, gn = {
            e2: [],
        ...
        function Tn() {
            const e = 60 * (new Date().getTimezoneOffset() + 480) * 1e3, t = new Date(qe.getServerTime_UTC_8() + e), n = e => e < 10 ? "0" + e : e + "";
            return `${t.getFullYear()}-${n(t.getMonth() + 1)}-${n(t.getDate())} ${n(t.getHours())}:${n(t.getMinutes())}:${n(t.getSeconds())}`;
        }
        function On() {
            Sn.clear(), yn = Date.now();
        }
        setInterval(() => {
            Cn && gn.e2.length + gn.e5.length > An.minReportSize && function() {
                if (!Ge.isInited()) return;
                const e = {};
                e.sv = In.version || "", e.pi = pn.id || "", e.gi = be.gameId || "", e.sc = Ve || 0, 
                e.es = `{"e2":[${gn.e2.join(",")}],"e5":[${gn.e5.join(",")}]}`, mn.onEvents([ {
                    eventName: ln.batch,
                    param: e
                } ], () => null), gn = {
                    e2: [],
        ...
        const Mn = {
            ...
            callback: e => null,
            run: e => {
                Mn.callback && Mn.callback(e), "function" == typeof requestAnimationFrame && requestAnimationFrame(Mn.run);
            }
        };
        Mn.callback = (e => {
            if (0 === Mn.lastTime) return void (Mn.lastTime = e);
            const t = e, n = t - Mn.lastTime, r = Math.round(1e3 / (n + 1e-6));
            Mn.frameRate = r, Mn.lastTime = t, un.onRenderFrameRate && un.onRenderFrameRate(n);
        }), Mn.run(0);
        const Nn = Math.pow(2, 12);
        function Pn(e) {
            let t = !1;
            return [ Te.EC_ACCESS_CMD_GET_TOKEN_ERR, Te.EC_ACCESS_CMD_TOKEN_PRE_EXPIRE, Te.EC_ACCESS_CMD_INVALID_TOKEN, Te.EC_ACCESS_GET_COMM_CONNECT_ERR ].includes(e) && (t = !0), 
            t;
        }
        function vn(e) {
            let t = !1;
            return [ Te.EC_ACCESS_GET_RELAY_CONNECT_ERR ].includes(e) && (t = !0), t;
        }
        var Ln, bn = class extends xt {
            sendRequest(e, t, n, r, i, o = "") {
                if (!o) {
                    o = function() {
                        const e = tt.encode(it++);
                        return it >= Number.MAX_SAFE_INTEGER && (it = 1), e;
                    }();
                    const s = {
                        time: Date.now(),
                        isSocketSend: !1,
                ...
                try {
                    _ = function(e, t, n) {
                        const r = t.cmd, i = en.get(r);
                        if (!i || !i.bufferify) throw new Error("找不到该 cmd 编码方法: " + r);
                        const o = i.bufferify(n), s = on.bufferify(Object.assign({}, t, {
                            body: o
                        }));
                        return rn.bufferify(Object.assign({}, e, {
                            body: s
                        }));
                    }(s, a, e);
                } catch (e) {
                    e = VM2_INTERNAL_STATE_DO_NOT_USE_OR_PROGRAM_WILL_FAIL.handleException(e);
                    const t = Te.EC_SDK_ENCODE_PARAM_FAIL, n = e + "", r = xt.sendQueue.get(o);
                    return setTimeout(() => r && r.sendFail(t, n), 0), o;
                }
                if (_.length > Nn) {
                    const e = xt.sendQueue.get(o);
                    return setTimeout(() => e && e.sendFail(Te.EC_SDK_SEND_FAIL, "数据长度超限"), 0), o;
                }
                const E = this.buildData(_);
                return this.send(E, o, t);
            }
            buildData(e) {
                const t = new Uint8Array(1), n = new Uint8Array(1);
                return t[0] = qt.CLIENT_PRE, n[0] = qt.CLIENT_END, super.buildData(t, e, n);
            }
            handleMessage(e) {
                const t = function(e, t) {
                    const n = sn.objectify(e), r = an.objectify(n.body), i = (e => {
                    ...
                    const {errCode: a, errMsg: _} = Xt(n.errCode, n.errMsg);
                ...
                return n && (function(e, t) {
                    if (!Cn || An.disableReport || An.disableReqReport || e.time < 0) return;
                    if (t < yn) return;
                    e && e.rqCmd === ke.E_CMD_HEART_BEAT_REQ && un.onPingTime && un.onPingTime(e.time);
                    const n = Tn(), r = `{"rqCd":${e.rqCd},"rqSq":"${e.rqSq}","rqCmd":${e.rqCmd},"time":${e.time},"start":"${n}"}`;
                    gn.e2.push(r);
                }({
                    rqCmd: n.cmd,
                    rqSq: t.RspWrap1.seq,
                ...
                }, n.time), n.cmd === ke.E_CMD_HEART_BEAT_REQ || !this.handleErrCode(t.RspWrap1)) ? n.response(t) : void 0;
            }
            handleResponse(e) {
                return this.handleMessage(e);
            }
            handleErrCode(e) {
                return Pn(e.errCode) ? (this.handleTokenErr(), ze.log("TOKEN_ERROR", e), !0) : !(!vn(e.errCode) || this.socket.id !== s.ConnectionType.RELAY || (this.handleRelayConnectErr(), 
                ze.log("RELAY_CONNECT_ERROR", e), 0));
            }
            handleSuccess(e, t) {
                e === Te.EC_OK && t();
            }
            handleTokenErr() {
                Ue.setStatus(Ue.StatusType.LOGOUT), this.socket.emit(Gt.autoAuth, {});
            }
            handleRelayConnectErr() {
                Ye.setStatus(Ye.StatusType.OFFLINE), this.socket.emit(Gt.autoAuth, {});
            }
        }, Dn = class extends xt {
            constructor() {
                super();
            ...
            buildData(e) {
                const t = new Uint8Array(1), n = new Uint8Array(1);
                return t[0] = qt.SERVER_PRE, n[0] = qt.SERVER_END, super.buildData(t, e, n);
            }
            handleMessage(e) {
                const t = function(e) {
                    const t = _n.objectify(e), n = En.objectify(t.body);
                    let r = null;
                    const i = nn.get(n.type);
                ...
                }(e), n = xt.broadcastHandlers.get(t.BstWrap2.type);
        ...
        const wn = [ s.ClientSendServerReqWrap2Cmd.E_CMD_CREATE_ROOM_REQ, s.ClientSendServerReqWrap2Cmd.E_CMD_JOIN_ROOM_REQ, s.ClientSendServerReqWrap2Cmd.E_CMD_QUIT_ROOM_REQ, s.ClientSendServerReqWrap2Cmd.E_CMD_DISSMISS_ROOM_REQ, s.ClientSendServerReqWrap2Cmd.E_CMD_CHANGE_ROOM_PROPERTIS_REQ, s.ClientSendServerReqWrap2Cmd.E_CMD_REMOVE_MEMBER_REQ, s.ClientSendServerReqWrap2Cmd.E_CMD_CHANGE_PLAYER_STATE_REQ, s.ClientSendServerReqWrap2Cmd.E_CMD_START_FRAME_SYNC_REQ, s.ClientSendServerReqWrap2Cmd.E_CMD_STOP_FRAME_SYNC_REQ ];
        class Gn {
            constructor(e) {
                this.client = new bn(), this.server = new Dn(), this.bstCallbacks = e;
            }
            static startQueueLoop() {
                Gn.checkLoginQueue = [], Gn.roomQueue = [], xt.startQueueLoop();
            }
            static stopQueueLoop() {
                Gn.checkLoginQueue = [], Gn.roomQueue = [], xt.stopQueueLoop();
            }
            bindSocket(e) {
                const t = this.client.handleResponse.bind(this.client), n = this.server.handleBroadcast.bind(this.server);
            ...
            send(e, t, n, r) {
                let i = Ln.comm;
                this.client.socket.id === s.ConnectionType.RELAY && (i = Ln.relay);
                const o = {
                    body: e,
                    subcmd: t,
                    response: n,
                ...
                let a = null;
                return t === s.ClientSendServerReqWrap2Cmd.E_CMD_CHECK_LOGIN_REQ && (a = Gn.checkLoginQueue, 
                o.beforeRequest = (() => {
                    Ye.setStatus(Ye.StatusType.CHECKING);
                }), o.afterRequest = (e => {
                    ze.log("CHECKLOGIN", e);
                })), wn.includes(t) && (a = Gn.roomQueue), a ? this.pushQueue(o, a) : this.sendRequest(o);
            }
            pushQueue(e, t) {
                const n = e.callback;
        ...
        Gn.checkLoginQueue = [], Gn.roomQueue = [];
        var Un = Gn, Yn = class extends Un {
            constructor(e) {
                super(e), this.matchTimeoutBroadcastType = s.ServerSendClientBstWrap2Type.E_PUSH_TYPE_MATCH_TIMEOUT, 
                this.matchUsersBroadcastType = s.ServerSendClientBstWrap2Type.E_PUSH_TYPE_MATCH_SUCCESS, 
                this.cancelMatchBroadcastType = s.ServerSendClientBstWrap2Type.E_PUSH_TYPE_MATCH_CANCEL, 
                this.setBroadcastHandler(this.matchTimeoutBroadcastType, this.matchUsersTimeoutBroadcast.bind(this)), 
                this.setBroadcastHandler(this.matchUsersBroadcastType, this.matchUsersBroadcast.bind(this)), 
                this.setBroadcastHandler(this.cancelMatchBroadcastType, this.cancelMatchBroadcast.bind(this));
            }
            matchUsersComplex(e, t) {
                const n = ke.E_CMD_MATCH_PLAYER_COMPLEX_REQ, r = this.send(e, n, this.matchUsersComplexResponse.bind(this), t);
                return ze.log("MATCH_USERS_COMPLEX_Para", e, r), r;
            }
            matchGroup(e, t) {
                const n = ke.E_CMD_MATCH_GROUP_REQ, r = this.send(e, n, this.matchGroupResponse.bind(this), t);
                return ze.log("MATCH_GROUP_Para", e, r), r;
            }
            matchRoom(e, t) {
                const n = ke.E_CMD_MATCH_ROOM_SIMPLE_REQ, r = this.send(e, n, this.matchRoomResponse.bind(this), t);
                return ze.log("MATCH_ROOM_Para", e, r), r;
            }
            cancelMatch(e, t) {
                const n = ke.E_CMD_MATCH_CANCEL_MATCH_REQ, r = this.send(e, n, this.cancelMatchResponse.bind(this), t);
                return ze.log("CANCEL_MATCH_Para", e, r), r;
            }
            matchUsersComplexResponse(e, t, n) {
                const r = t.RspWrap1, i = {
                    code: r.errCode,
                    msg: r.errMsg,
                    seq: r.seq,
                    data: t.body
                };
                ze.log("matchPlayersRsp", i), n && n(i);
            }
            ...
            matchRoomResponse(e, t, n) {
                ...
                ze.log("matchRoomSimpleRsp", i), n && n(i);
            }
            cancelMatchResponse(e, t, n) {
                ...
                ze.log("cancelPlayerMatchRsp", i), n && n(i);
            }
            ...
            constructor(e) {
                super(e), this.joinRoomBroadcastType = s.ServerSendClientBstWrap2Type.E_PUSH_TYPE_JOIN_ROOM, 
                this.leaveRoomBroadcastType = s.ServerSendClientBstWrap2Type.E_PUSH_TYPE_LEAVE_ROOM, 
                this.dismissRoomBroadcastType = s.ServerSendClientBstWrap2Type.E_PUSH_TYPE_DISMISS_ROOM, 
                this.changeRoomBroadcastType = s.ServerSendClientBstWrap2Type.E_PUSH_TYPE_MODIFY_ROOM_PROPERTY, 
                this.removeUserBroadcastType = s.ServerSendClientBstWrap2Type.E_PUSH_TYPE_REMOVE_PLAYER, 
                this.changeUserStateBroadcastType = s.ServerSendClientBstWrap2Type.E_PUSH_TYPE_PLAYER_STATE, 
                this.roomUserNetworkBroadcastType = s.ServerSendClientBstWrap2Type.E_PUSH_TYPE_NETWORK_STATE, 
                this.setBroadcastHandler(this.joinRoomBroadcastType, this.onJoinRoom.bind(this)), 
                this.setBroadcastHandler(this.leaveRoomBroadcastType, this.onLeaveRoom.bind(this)), 
                this.setBroadcastHandler(this.dismissRoomBroadcastType, this.onDismissRoom.bind(this)), 
                this.setBroadcastHandler(this.changeRoomBroadcastType, this.onChangeRoom.bind(this)), 
                this.setBroadcastHandler(this.removeUserBroadcastType, this.onRemoveUser.bind(this)), 
                this.setBroadcastHandler(this.changeUserStateBroadcastType, this.onChangeUserState.bind(this)), 
                this.setBroadcastHandler(this.roomUserNetworkBroadcastType, this.onChangePlayerNetworkState.bind(this));
            }
            createRoom(e, t) {
                const n = ke.E_CMD_CREATE_ROOM_REQ, r = this.send(e, n, this.createRoomResponse.bind(this), t);
                return ze.log("CREATE_ROOM_Para", e, r), r;
            }
            joinRoom(e, t) {
                const n = ke.E_CMD_JOIN_ROOM_REQ, r = this.send(e, n, this.joinRoomResponse.bind(this), t);
                return ze.log("JOIN_ROOM_Para", e, r), r;
            }
            leaveRoom(e, t) {
                const n = ke.E_CMD_QUIT_ROOM_REQ, r = this.send(e, n, this.leaveRoomResponse.bind(this), t);
                return ze.log("LEAVE_ROOM_Para", e, r), r;
            }
            dismissRoom(e, t) {
                const n = ke.E_CMD_DISSMISS_ROOM_REQ, r = this.send(e, n, this.dismissRoomResponse.bind(this), t);
                return ze.log("DISMISS_ROOM_Para", e, r), r;
            }
            changeRoom(e, t) {
                const n = ke.E_CMD_CHANGE_ROOM_PROPERTIS_REQ, r = this.send(e, n, this.changeRoomResponse.bind(this), t);
                return ze.log("CHANGE_ROOM_Para", e, r), r;
            }
            removeUser(e, t) {
                const n = ke.E_CMD_REMOVE_MEMBER_REQ, r = this.send(e, n, this.removeUserResponse.bind(this), t);
                return ze.log("REMOVE_USER_Para", e, r), r;
            }
            getRoomByRoomId(e, t) {
                const n = ke.E_CMD_GET_ROOM_DETAIL_REQ, r = this.send(e, n, this.getRoomByRoomIdRsp().bind(this), t);
                return ze.log("GET_ROOM_BY_ROOM_ID_Para", e, r), r;
            }
            getRoomList(e, t) {
                const n = ke.E_CMD_GET_ROOM_LIST_V2_REQ, r = this.send(e, n, this.getRoomListResponse.bind(this), t);
                return ze.log("GET_ROOM_LIST_Para", e, r), r;
            }
            ...
            removeUserResponse(e, t, n) {
                ...
                ze.log("removePlayerRsp", i), n && n(i);
            }
            getRoomByRoomIdRsp() {
                return (e, t, n) => {
                    const r = t.RspWrap1, i = {
                    ...
                    ze.log("getRoomByRoomIdRsp", i), n && n(i);
                };
            }
            ...
            onChangePlayerNetworkState(e, t) {
                ...
                if (ze.log("onChangeNetworkState", n), n.data.roomInfo) {
            ...
            constructor(e) {
                this.netUtil1 = null, this.netUtil2 = null, this.frameBroadcastType = s.ServerSendClientBstWrap2Type.E_PUSH_TYPE_RELAY, 
                this.startGameBroadcastType = s.ServerSendClientBstWrap2Type.E_PUSH_TYPE_START_GAME, 
                this.stopGameBroadcastType = s.ServerSendClientBstWrap2Type.E_PUSH_TYPE_STOP_GAME, 
                this.sendMessageExtBroadcastType = s.ServerSendClientBstWrap2Type.E_PUSH_TYPE_GAMESVR, 
                this.bstCallbacks = e, this.netUtil1 = new Un(e), this.netUtil2 = new Un(e), this.netUtil1.setBroadcastHandler(this.startGameBroadcastType, this.onStartFrameSync.bind(this)), 
                this.netUtil1.setBroadcastHandler(this.stopGameBroadcastType, this.onStopFrameSync.bind(this)), 
                this.netUtil2.setBroadcastHandler(this.frameBroadcastType, this.onRecvFrame.bind(this)), 
                this.netUtil2.setBroadcastHandler(this.sendMessageExtBroadcastType, this.onRecvFromGameSvr.bind(this));
            }
            setFrameRoom(e) {
                ze.log("SETFRAMEROOM", e);
                const t = this.getFrameRoom();
                this.roomInfo = e || {
                    roomId: 0,
                    routeId: ""
                };
                const n = t.routeId, r = this.roomInfo.routeId;
                return r ? n !== r ? (Ye.setStatus(Ye.StatusType.OFFLINE), this.autoCheckLogin()) : n === r ? this.autoCheckLogin() : void 0 : this.netUtil2.client.socket && this.netUtil2.client.socket.close();
            }
            getFrameRoom() {
            ...
            startFrameSync(e, t) {
                ...
                const n = ke.E_CMD_START_FRAME_SYNC_REQ, r = this.netUtil1.send(e, n, this.startFrameSyncResponse.bind(this), t);
                return ze.log("START_FRAMESYNC_Para", e, r), r;
            }
            stopFrameSync(e, t) {
                if (!this.isRoomExist()) {
                    const e = {
                ...
                const n = ke.E_CMD_STOP_FRAME_SYNC_REQ, r = this.netUtil1.send(e, n, this.stopFrameSyncResponse.bind(this), t);
                return ze.log("STOP_FRAMESYNC_Para", e, r), r;
            }
            sendFrame(e, t) {
                if (!this.isRoomExist()) {
                    const e = {
                ...
                this.autoCheckLogin();
                const n = ke.E_CMD_RELAY_SEND_FRAME_REQ, r = this.netUtil2.send(e, n, this.sendFrameResponse.bind(this), t);
                return ze.log("SEND_FRAME_Para", e, r), r;
            }
            requestFrame(e, t) {
                if (!this.isRoomExist()) {
                    const e = {
                ...
                this.autoCheckLogin();
                const n = ke.E_CMD_RELAY_REQUEST_FRAME_REQ, r = this.netUtil2.send(e, n, this.requestFrameResponse.bind(this), t);
                return ze.log("REQUEST_FRAME_Para", e, r), r;
            }
            checkLogin(e, t) {
                if (!this.isRoomExist()) {
                    const t = {
                ...
                Ye.setStatus(Ye.StatusType.CHECKING);
                const n = ke.E_CMD_CHECK_LOGIN_REQ, r = {
                    token: Ne.authKey,
                    routeId: this.roomInfo.routeId
                }, i = this.netUtil2.send(r, n, this.checkLoginResponse.bind(this), e);
                return ze.log("CHECKLOGIN", i, t, r.routeId), Ye.setRouteId(r.routeId), i;
            }
            sendMessageExt(e, t) {
                if (!this.isRoomExist()) {
                    const e = {
                ...
                this.autoCheckLogin();
                const n = ke.E_CMD_RELAY_CLIENT_SENDTO_GAMESVR_REQ, r = this.netUtil2.send(e, n, this.sendMessageExtResponse.bind(this), t);
                return ze.log("SEND_TO_GAMESVR_Para", e, r), r;
            }
            startFrameSyncResponse(e, t, n) {
                ...
                ze.log("startFrameSyncRsp", i), n && n(i);
            }
            stopFrameSyncResponse(e, t, n) {
                ...
                ze.log("stopFrameSyncRsp", i), n && n(i);
            }
            autoCheckLogin() {
                this.connect(), this.netUtil2.client.socket.isConnect() && Ye.isOffline() && this.netUtil2.client.socket.emit(Gt.autoAuth, {});
            }
            connect() {
                !this.netUtil2.client.socket.isConnect() && this.roomInfo && (this.netUtil2.client.socket.url = Pe.url + ":" + (Pe.enableUDP ? 8585 : 5443), 
                this.netUtil2.client.socket.connect("framesender connect"));
            }
            sendFrameResponse(e, t, n) {
                ...
                ze.log("sendFrameRsp", i), n && n(i);
            }
            checkLoginResponse(e, t, n) {
                Ye.setStatus(Ye.StatusType.OFFLINE);
                const r = t.RspWrap1, i = {
                    code: r.errCode,
                    msg: r.errMsg,
                    seq: r.seq,
                ...
                return i.code === Te.EC_OK && Ye.setStatus(Ye.StatusType.CHECKED), ze.log("RESPONSE_CheckLoginResponse", i), 
                n && n(i);
            }
            requestFrameResponse(e, t, n) {
                ...
                ze.log("requestFrameRsp", i), n && n(i);
            }
            sendMessageExtResponse(e, t, n) {
                ...
                ze.log("sendToGameSvrRsp", i), n && n(i);
            }
            onRecvFrame(e, t) {
                const n = {
                    data: {
                ...
                return Sn.trigger(this.roomInfo.id || void 0, n.data.frame.id), this.bstCallbacks.room.onRecvFrame(n);
            }
            onStartFrameSync(e, t) {
                ...
                return Sn.clear(), this.bstCallbacks.room.onStartFrameSync(n);
            }
            onStopFrameSync(e, t) {
                const n = {
                    data: Object.assign({}, e),
                ...
                return this.netUtil2 && this.netUtil2.client.clearQueue(), Sn.clear(), this.bstCallbacks.room.onStopFrameSync(n);
            }
            ...
            constructor(e) {
                super(e), this.messageBroadcastType = s.ServerSendClientBstWrap2Type.E_PUSH_TYPE_ROOM_CHAT, 
                this.setBroadcastHandler(this.messageBroadcastType, this.onRecvFromClient.bind(this));
            }
            sendMessage(e, t) {
                const n = ke.E_CMD_ROOM_CHAT_REQ, r = this.send(e, n, this.sendMessageResponse.bind(this), t);
                return ze.log("SEND_MESSAGE_Para", e, r), r;
            }
            sendMessageResponse(e, t, n) {
                ...
                ze.log("sendToClientRsp", i), n && n(i);
            }
            ...
            login(e, t, n, r) {
                const i = ke.E_CMD_LOGIN_REQ;
                let o, s, a;
                Array.from(this.client.queue).forEach(e => {
                    const t = xt.sendQueue.get(e);
                    t && t.cmd === i && this.client.deleteSeqQueue(e);
                }), n ? (o = n.timestamp, s = n.nonce, a = n.sign) : (o = Math.floor(Date.now() / 1e3), 
                s = Math.floor(Math.random() * (Math.pow(2, 32) - 1)), a = function(e, t, n, r, i) {
                    const o = [ [ "game_id", t ], [ "open_id", n ], [ "nonce", i ], [ "timestamp", r ] ].sort().map(e => e.join("=")).join("&"), s = Ze(o, e || "");
                    return {
                        sign: $e.stringify(s)
                    };
                }(t, e.gameId, e.openId, o, s).sign);
                const _ = Qe, E = Ve, l = ot, u = {
                    gameId: e.gameId,
                    openId: e.openId,
                    sign: a,
                    timestamp: o,
                ...
                Ue.setStatus(Ue.StatusType.LOGINING);
                const d = this.send(u, i, this.loginResponse.bind(this), r);
                return ze.log("LOGIN_Para", u, d), Ue.setErrCode(0, ""), d;
            }
            logout(e, t) {
                const n = ke.E_CMD_LOGOUT_REQ, r = this.send(e, n, this.logoutResponse.bind(this), t);
                return ze.log("LOGOUT_Para", e, r), Ue.setStatus(Ue.StatusType.LOGOUTING), r;
            }
            changeUserState(e, t) {
                const n = ke.E_CMD_CHANGE_PLAYER_STATE_REQ, r = this.send(e, n, this.changeUserStateResponse.bind(this), t);
                return ze.log("CHANGE_USER_STATE_Para", e, r), r;
            }
            loginResponse(e, t, n) {
                e || Ue.setStatus(Ue.StatusType.LOGOUT);
                const r = t.RspWrap1, i = {
                    code: r.errCode,
                    msg: r.errMsg,
                    seq: r.seq,
                ...
                this.client.handleSuccess(i.code, () => {
                    Ne.authKey = t.body.token, Ne.playerId = t.body.playerId, Ue.setStatus(Ue.StatusType.LOGIN), 
                    !we.getInfo().id && we.setInfo({
                        id: i.data.playerId
                    }), qe.setServerTime(t.body.sdkConfig.serverTime);
                }), Ue.setErrCode(i.code, i.msg), n && n(i), ze.log("RESPONSE_LoginResponse", i);
            }
            logoutResponse(e, t, n) {
                ...
                return ze.log("RESPONSE_LogoutResponse", i), this.client.handleSuccess(i.code, () => {
                    Ne.authKey = void 0, Ne.playerId = void 0, Ue.setStatus(Ue.StatusType.LOGOUT), we.setInfo({
                        id: void 0
                    });
                }), n && n(i);
            }
            changeUserStateResponse(e, t, n) {
                ...
                ze.log("changeCustomPlayerStatusRsp", i), n && n(i);
            }
        }, xn = class extends Un {
            constructor(e) {
                super(e), this.joinGroupBstType = s.ServerSendClientBstWrap2Type.E_PUSH_TYPE_JOIN_GROUP, 
                this.leaveGroupBstType = s.ServerSendClientBstWrap2Type.E_PUSH_TYPE_LEAVE_GROUP, 
                this.dismissGroupBstType = s.ServerSendClientBstWrap2Type.E_PUSH_TYPE_DISMISS_GROUP, 
                this.changeGroupBstType = s.ServerSendClientBstWrap2Type.E_PUSH_TYPE_MODIFY_GROUP_PROPERTY, 
                this.removeGroupBstType = s.ServerSendClientBstWrap2Type.E_PUSH_TYPE_REMOVE_GROUP_PLAYER, 
                this.changeCustomGroupPlayerStatusBstType = s.ServerSendClientBstWrap2Type.E_PUSH_TYPE_GROUP_PLAYER_STATE, 
                this.recvFromGroupClientType = s.ServerSendClientBstWrap2Type.E_PUSH_TYPE_GROUP_CHAT, 
                this.setBroadcastHandler(this.joinGroupBstType, this.onJoinGroup.bind(this)), this.setBroadcastHandler(this.leaveGroupBstType, this.onLeaveGroup.bind(this)), 
                this.setBroadcastHandler(this.dismissGroupBstType, this.onDismissGroup.bind(this)), 
                this.setBroadcastHandler(this.changeGroupBstType, this.onChangeGroup.bind(this)), 
                this.setBroadcastHandler(this.removeGroupBstType, this.onRemoveGroupPlayer.bind(this)), 
                this.setBroadcastHandler(this.changeCustomGroupPlayerStatusBstType, this.onChangeCustomGroupPlayerStatus.bind(this)), 
                this.setBroadcastHandler(this.recvFromGroupClientType, this.onRecvFromGroupClient.bind(this));
            }
            createGroup(e, t) {
                const n = ke.E_CMD_CREATE_GROUP_REQ, r = this.send(e, n, this.createGroupResponse.bind(this), t);
                return ze.log("CREATE_GROUP_Para", e, r), r;
            }
            joinGroup(e, t) {
                const n = ke.E_CMD_JOIN_GROUP_REQ, r = this.send(e, n, this.joinGroupResponse.bind(this), t);
                return ze.log("JOIN_GROUP_Para", e, r), r;
            }
            leaveGroup(e, t) {
                const n = ke.E_CMD_QUIT_GROUP_REQ, r = this.send(e, n, this.leaveGroupResponse.bind(this), t);
                return ze.log("LEAVE_GROUP_Para", e, r), r;
            }
            dismissGroup(e, t) {
                const n = ke.E_CMD_DISMISS_GROUP_REQ, r = this.send(e, n, this.dismissGroupResponse.bind(this), t);
                return ze.log("DISMISS_GROUP_Para", e, r), r;
            }
            changeGroup(e, t) {
                const n = ke.E_CMD_CHANGE_GROUP_PROPERTIES_REQ, r = this.send(e, n, this.changeGroupResponse.bind(this), t);
                return ze.log("CHANGE_GROUP_Para", e, r), r;
            }
            removeGroupPlayer(e, t) {
                const n = ke.E_CMD_REMOVE_GROUP_MEMBER_REQ, r = this.send(e, n, this.removeGroupPlayerResponse.bind(this), t);
                return ze.log("REMOVE_GROUP_PLAYER_Para", e, r), r;
            }
            getGroupByGroupId(e, t) {
                const n = ke.E_CMD_GET_GROUP_DETAIL_REQ, r = this.send(e, n, this.getGroupByGroupIdResponse.bind(this), t);
                return ze.log("GET_GROUP_BY_GROUP_ID_Para", e, r), r;
            }
            getMyGroups(e, t) {
                const n = ke.E_CMD_GET_GROUP_LIST_REQ, r = this.send(e, n, this.getMyGroupsResponse.bind(this), t);
                return ze.log("GET_MY_GROUPS_Para", e, r), r;
            }
            changeCustomGroupPlayerStatus(e, t) {
                const n = ke.E_CMD_CHANGE_GROUP_PLAYER_STATE_REQ, r = this.send(e, n, this.changeCustomGroupPlayerStatusResponse.bind(this), t);
                return ze.log("CHANGE_CUSTOM_GROUP_PLAYER_STATUS_Para", e, r), r;
            }
            sendToGroupClient(e, t) {
                const n = ke.E_CMD_GROUP_CHAT_REQ, r = this.send(e, n, this.sendToGroupClientResponse.bind(this), t);
                return ze.log("SEND_TO_GROUP_CLIENT_Para", e, r), r;
            }
            ...
            dismissGroupResponse(e, t, n) {
                ...
                ze.log("dismissGroupRsp", i), n && n(i);
            }
            ...
            removeGroupPlayerResponse(e, t, n) {
                ...
                ze.log("removeGroupPlayerRsp", i), n && n(i);
            }
            getGroupByGroupIdResponse(e, t, n) {
                ...
                ze.log("getGroupByGroupIdRsp", i), n && n(i);
            }
            ...
            changeCustomGroupPlayerStatusResponse(e, t, n) {
                ...
                ze.log("changeCustomGroupPlayerStatusRsp", i), n && n(i);
            }
            sendToGroupClientResponse(e, t, n) {
                ...
                ze.log("sendToGroupClientRsp", i), n && n(i);
            }
            onJoinGroup(e, t) {
                const n = {
                    data: e,
            ...
            constructor(e, t, n) {
                super(e), this.pingTimer = new We(), this.pongTimer = new We(), this.currentSeq = "", 
                this.retry = 2, this.id = t, this.frameSender = n;
            }
            get timeout() {
                return this.id === s.ConnectionType.RELAY && Pe.enableUDP ? Pe.pingTimeout / 2 : Pe.pingTimeout;
            }
            unbindSocket() {
                this.stop(), super.unbindSocket();
            }
            ping(e) {
                if (je(this.pingTimer), !Ne.authKey) return;
                const t = Date.now(), n = this.frameSender && this.frameSender.roomInfo && this.frameSender.roomInfo.routeId ? this.frameSender.roomInfo.routeId : "", r = {
                    conType: this.id,
                    routeId: n
                }, i = this.send(r, ke.E_CMD_HEART_BEAT_REQ, (e, n) => this.handlePong(e, n, t), e);
                this.currentSeq = i, ze.log("PING", this.id, i), Ke(this.pongTimer, () => this.handlePongTimeout(i), this.timeout);
            }
            stop() {
                je(this.pingTimer, this.pongTimer);
            }
            handlePong(e, t, n) {
                if (ze.log("Pong", this.id, t.RspWrap1, "send", e), je(this.pongTimer), !e) return this.handlePongTimeout(t.RspWrap1.seq);
                this.retry = 2, this.client.clearQueue();
                const r = t.RspWrap1.errCode;
                return Pn(r) ? (Ue.setStatus(Ue.StatusType.LOGOUT), this.client.socket.emit(Gt.autoAuth, {})) : vn(r) && this.client.socket.id === s.ConnectionType.RELAY ? (Ye.setStatus(Ye.StatusType.OFFLINE), 
                this.client.socket.emit(Gt.autoAuth, {})) : void Ke(this.pingTimer, this.ping.bind(this), this.timeout);
            }
            handlePongTimeout(e) {
                if (this.client.deleteSeqQueue(e), this.retry--, e === this.currentSeq && this.client.socket) {
                    if (this.id === s.ConnectionType.RELAY && Pe.enableUDP) {
                        if (this.retry >= 0) return Ke(this.pingTimer, this.ping.bind(this), this.timeout);
                        this.retry = 2;
                    }
                    this.client.socket.connectNewSocket(this.client.socket.url), this.client.clearQueue(), 
                    ze.log("Pong_Timeout", this.id);
                }
            }
        };
        class Vn {
            ...
            bindCallbacks(e) {
                -1 === this.contexts.findIndex(t => t === e) && this.contexts.push(e), ze.log("BindCallbacks", this.contexts.length);
            }
            unbindCallbacks(e) {
                const t = this.contexts.findIndex(t => t === e);
                -1 !== t && this.contexts.splice(t, 1), ze.log("UnBindCallbacks", this.contexts.length);
            }
            clearCallbacks() {
                this.contexts = [], ze.log("ClearCallbacks", this.contexts.length);
            }
            handleBst(e, t) {
                "error" !== t && ze.log(t, e);
        ...
        let Kn, jn, Jn = null, Xn = null, zn = null, $n = null, Zn = null, er = null, tr = null, rr = null;
        function nr() {
            sr.instance.clearResponses(), Kn && Kn.destory(), jn && jn.destory(), ((...e) => {
                e.forEach(e => e && e.unbindSocket());
            })(zn, $n, Zn, er, tr.netUtil1, tr.netUtil2, Jn, Xn, rr), Be.offHide(sr.instance.onHide), 
            Be.offShow(sr.instance.onShow), Ge.setStatus(Ge.StatusType.UNINIT), Ue.setStatus(Ue.StatusType.LOGOUT), 
            sr.instance.group = null;
        }
        const or = {
            login(e) {
                const t = Object.assign({}, be), n = t => {
                    e && e(t), or.loginRsp(t);
                };
                return be.createSignature ? zn && be.createSignature(e => zn.login(t, void 0, e, n)) : zn && zn.login(t, be.secretKey, null, n);
            },
            loginRsp(e) {
                if (Ge.isIniting()) {
                    if (e.code !== Te.EC_OK) return ir(!1, {
                        code: e.code
                    });
                    let n = 5e3, r = !1, i = 0;
                    return e.data.sdkConfig && (e.data.sdkConfig.pingInterval && (n = e.data.sdkConfig.pingInterval), 
                    e.data.sdkConfig.reportInterval && (An.reportInterval = e.data.sdkConfig.reportInterval), 
                    e.data.sdkConfig.serverTime && (i = e.data.sdkConfig.serverTime), e.data.sdkConfig.enableUdp && (r = e.data.sdkConfig.enableUdp), 
                    e.data.sdkConfig.disableReport && (An.disableReport = e.data.sdkConfig.disableReport), 
                    e.data.sdkConfig.disableFrameReport && (An.disableFrameReport = e.data.sdkConfig.disableFrameReport), 
                    e.data.sdkConfig.disableReqReport && (An.disableReqReport = e.data.sdkConfig.disableReqReport), 
                    e.data.sdkConfig.minReportSize && (An.minReportSize = e.data.sdkConfig.minReportSize)), 
                    t = be.openId, Ne.playerId, ze.log("EventUploader"), mn.init(), mn.setOpenid(t || ""), 
                    Cn = !0, Pe.pingTimeout = n, Pe.enableUDP = !!r, ir(!0, {
                        code: Te.EC_OK,
                        data: {
                            serverTime: i
                        }
                ...
                var t;
                e.code === Te.EC_OK && Jn.ping();
            },
            logout: () => zn && zn.logout({}, or.logoutRsp),
            logoutRsp(e) {
                e.code === Te.EC_OK && Jn.stop();
            }
        };
        function ir(e, t) {
            if (Ge.isIniting()) {
                e && Ge.setStatus(Ge.StatusType.INITED), !e && Ge.setStatus(Ge.StatusType.UNINIT);
                let n = Ge.isInited() ? Te.EC_OK : Te.EC_SDK_UNINIT;
                !e && t && t.code !== Te.EC_OK && (n = t.code);
                const r = {
                    default: "初始化失败。请确认域名是否正确配置，以及网络是否顺畅。",
                    [Te.EC_ACCESS_PLAYER_DUPLICATE_LOGIN]: "初始化失败。用户已在其他客户端登录。",
                    [Te.EC_INVALID_PARAMS_TIMESTAMP]: "初始化失败。请检查本地时间是否正常。",
                    [Te.EC_INVALID_PARAMS_SIGN]: "初始化失败。签名校验失败，请检查初始化参数是否正确。",
                    [Te.EC_INVALID_PARAMS_GAME_ID]: "初始化失败。请检查 gameId 是否正确。",
                    [Te.EC_SDK_SEND_FAIL]: "初始化失败。消息发送失败，请检查网络是否正常。",
                    [Te.EC_SDK_RES_TIMEOUT]: "初始化失败。消息响应超时，请检查网络后重试。",
                    [Te.EC_SDK_SOCKET_ERROR]: "初始化失败。网络异常。" + (t.errMsg || ""),
                    [Te.EC_SDK_SOCKET_CLOSE]: "初始化失败。网络已断开。"
                }, i = Ge.isInited() ? "初始化成功" : r[n] || r.default, o = t.data && t.data.serverTime || void 0;
                sr.instance.initRsp && sr.instance.initRsp({
                    code: n,
                    msg: i,
                    seq: null,
                    data: {
        ...
        class sr {
            constructor(e, t) {
                if (this.ErrCode = sr.ErrCode, this.ENUM = sr.ENUM, this.group = null, !e.openId && (e.openId = ""), 
                e.openId = e.openId + "", Object.assign(be, e), Object.assign(Pe, t, {
                    pingTimeout: Pe.pingTimeout
                }), Ne.gameId = be.gameId, ze.log("CONSTRUCTOR", e, t), sr.instance instanceof sr) return sr.instance;
                sr.instance = this;
            }
            clearResponses() {
                sr.bstCallbacks.clearCallbacks();
            }
            onHide() {
                Ue.setStatus(Ue.StatusType.LOGOUT), Ye.setStatus(Ye.StatusType.OFFLINE), Jn && Jn.stop(), 
                Xn && Xn.stop(), Xn.client.socket.id === s.ConnectionType.RELAY && Pe.enableUDP && Xn.client.socket.close(), 
                On(), ze.log("SDK_onHide");
            }
            onShow() {
                Jn && Jn.stop(), Xn && Xn.stop(), Jn && Jn.client.socket.url && Jn.ping(), Xn && Xn.client.socket.url && Xn.ping(), 
                On(), ze.log("SDK_onShow", Jn.client.socket.url, Xn.client.socket.url);
            }
            getSocket(e) {
                return e === s.ConnectionType.COMMON ? Kn : e === s.ConnectionType.RELAY ? jn : void 0;
            }
            init(e) {
                this.initRsp = (t => {
                    e(t);
                    ...
                    var e, t;
                    Ge.isUnInit() && (zn && nr(), Ge.setStatus(Ge.StatusType.INITING), zn = new Hn(sr.bstCallbacks), 
                    Zn = new Yn(sr.bstCallbacks), er = new qn(sr.bstCallbacks), $n = new kn(sr.bstCallbacks), 
                    tr = new Fn(sr.bstCallbacks), rr = new xn(sr.bstCallbacks), Kn = new Yt(s.ConnectionType.COMMON, !1), 
                    jn = new Yt(s.ConnectionType.RELAY, !0), Jn = new Bn(sr.bstCallbacks, s.ConnectionType.COMMON, null), 
                    Xn = new Bn(sr.bstCallbacks, s.ConnectionType.RELAY, tr), e = [ Jn, zn, $n, Zn, er, tr.netUtil1, rr ], 
                    t = [ Xn, tr.netUtil2 ], e.forEach(e => e.bindSocket(Kn)), t.forEach(e => e.bindSocket(jn)), 
                    Un.stopQueueLoop(), Un.startQueueLoop(), Kn.url = Pe.url, Kn.on(Gt.connect, () => {
                        Ue.isStatus(Ue.StatusType.LOGINING) || or.login(), Kn.url && sr.bstCallbacks.onNetwork({
                            code: Te.EC_OK,
                            data: {
                                type: Kn.id
                            }
                        ...
                        tr.checkLogin(null, "connect " + !!jn.isConnect()), jn.url && sr.bstCallbacks.onNetwork({
                            code: Te.EC_OK,
                            data: {
                                type: jn.id
                            }
                        }), Xn.ping();
                    }), Kn.on(Gt.connectClose, () => {
                        ir(!1, {
                            code: Te.EC_SDK_SOCKET_CLOSE
                        }), Ge.isInited() && (Ue.setStatus(Ue.StatusType.LOGOUT), Kn.url && sr.bstCallbacks.onNetwork({
                            code: Te.EC_SDK_SOCKET_CLOSE,
                            msg: "Socket断开",
                            seq: null
                        }));
                    }), jn.on(Gt.connectClose, () => {
                        Ge.isInited() && (Ye.setStatus(Ye.StatusType.OFFLINE), jn.url && sr.bstCallbacks.onNetwork({
                            code: Te.EC_SDK_SOCKET_CLOSE,
                            msg: "Socket断开",
                            seq: null
                        }), Xn.stop());
                    }), Kn.on(Gt.connectError, e => {
                        ir(!1, {
                            code: Te.EC_SDK_SOCKET_ERROR,
                            errMsg: JSON.stringify(e)
                        }), Ge.isInited() && Kn.url && sr.bstCallbacks.onNetwork({
                            code: Te.EC_SDK_SOCKET_ERROR,
                            msg: "Socket错误",
                            seq: null
                        });
                    }), jn.on(Gt.connectError, e => {
                        Ge.isInited() && jn.url && sr.bstCallbacks.onNetwork({
                            code: Te.EC_SDK_SOCKET_ERROR,
                            msg: "Socket错误",
                            seq: null
                        });
                    }), Kn.on(Gt.autoAuth, () => {
                        Ge.isInited() && setTimeout(() => {
                            const e = Ue.isStatus(Ue.StatusType.LOGOUT);
                            Kn.url && e && or.login();
                        }, 1e3);
                    }), jn.on(Gt.autoAuth, () => {
                        Ge.isInited() && jn.url && setTimeout(() => {
                            Ue.isStatus(Ue.StatusType.LOGOUT) && or.login();
                            const e = tr.roomInfo || {
                                routeId: ""
                            };
                            (Ye.isOffline() || Ye.getRouteId() !== e.routeId) && tr.checkLogin(e => {
                                e.code === Te.EC_OK && Xn.ping();
                            }, "autoAuth");
                        }, 1e3);
                    }), Kn.connect("init sdk"), Be.onHide(sr.instance.onHide), Be.onShow(sr.instance.onShow), 
                    sr.instance.group = rr);
                }();
            }
            initRsp(e) {
                return null;
            ...
            unInit() {
                Ge.isUnInit() || (Un.stopQueueLoop(), Jn && Jn.stop(), Xn && Xn.stop(), Ue.setStatus(Ue.StatusType.LOGOUT), 
                Ye.setStatus(Ye.StatusType.OFFLINE), we.setInfo({
                    id: void 0
                }), nr(), Object.assign(be, JSON.parse(De)), Object.assign(Pe, JSON.parse(ve)), 
                Object.assign(Ne, JSON.parse(Le)), sr.instance = null);
            }
            isInited() {
                return Ge.isInited();
            }
            ...
            createTeamRoom(e, t) {
                "object" != typeof e && (e = {});
                const n = [];
                let r = (e = JSON.parse(JSON.stringify(e))).maxPlayers || 0, i = e.teamNumber || 0;
                if (r % i != 0) {
                    const e = "";
                    return t && t({
                        seq: e,
                        code: Te.EC_PARAMS_INVALID,
                ...
                }
                {
                    ...
                    for (let t = 0; t < i; t++) {
                        ...
                        !o.teamId && (o.teamId = s.id), t === i - 1 && (s.maxPlayers = r - (i - 1) * e), 
                        n.push(s);
                    }
                }
                const s = Object.assign({}, e, {
                    ...
                    region: void 0,
                    teamList: n,
                    createType: Oe.CreateRoomType.COMMON_CREATE,
                    playerInfo: o
                });
                return $n.createRoom(s, t);
            }
            joinRoom(e, t, n) {
                const r = Object.assign({}, e, {
                    teamId: "0",
                    joinType: s.JoinRoomType.COMMON_JOIN,
                    roomId: t,
            ...
            leaveRoom(e) {
                return $n.leaveRoom({}, e);
            }
            dismissRoom(e, t, n) {
                return $n.dismissRoom({}, n);
            }
            changeRoom(e, t, n) {
                const r = {
                    changeRoomOptionList: []
                };
                if (e.hasOwnProperty("roomName") && r.changeRoomOptionList.push(s.ChangeRoomOption.ROOM_NAME), 
                e.hasOwnProperty("owner") && r.changeRoomOptionList.push(s.ChangeRoomOption.OWNER), 
                e.hasOwnProperty("isPrivate") && r.changeRoomOptionList.push(s.ChangeRoomOption.IS_PRIVATE), 
                e.hasOwnProperty("customProperties") && r.changeRoomOptionList.push(s.ChangeRoomOption.CUSTOM_PROPERTIES), 
                e.hasOwnProperty("isForbidJoin") && r.changeRoomOptionList.push(s.ChangeRoomOption.IS_FORBID_JOIN), 
                0 !== r.changeRoomOptionList.length) return $n.changeRoom(Object.assign({}, e, r), n);
                {
                    const e = {
                        code: s.QAppProtoErrCode.EC_OK,
                        msg: "未修改房间信息",
                        seq: "",
                        data: t
                    };
            ...
            removePlayer(e, t) {
                ...
                return $n.removeUser(n, t);
            }
            getRoomByRoomId(e, t) {
                const n = Object.assign({}, e);
                return $n.getRoomByRoomId(n, t);
            }
            getRoomList(e, t) {
            ...
            matchPlayers(e, t) {
                ...
                return Zn.matchUsersComplex(n, t);
            }
            matchGroup(e, t) {
            ...
            matchRoom(e, t) {
                ...
                return Zn.matchRoom(n, t);
            }
            cancelMatch(e, t) {
                const n = Object.assign({}, e);
                return Zn.cancelMatch(n, t);
            }
            setFrameRoom(e) {
                return !(!e || !Array.isArray(e.playerList) || e.playerList.findIndex(e => e.id === Ne.playerId) < 0 || (tr.setFrameRoom(e), 
                0));
            }
            startFrameSync(e) {
                const t = tr.roomInfo;
                ...
                if (!t) return ze.log("STARTFRAMESYNC", "fail at roomInfo === null"), n({
                    code: sr.ErrCode.EC_SDK_NO_ROOM,
                    msg: "无房间信息",
                    seq: null
                });
                ze.log("STARTFRAMESYNC", tr.roomInfo), ze.log("STARTFRAMESYNC", "socket2 isConnect", jn.isConnect(), jn.socketTask), 
                tr.checkLogin(r => {
                    if (r.code === Te.EC_OK) {
                        ze.log("STARTFRAMESYNC", "start");
                        const n = {
                            roomId: t.id,
                            gameId: be.gameId
                        };
                        return tr.startFrameSync(n, e);
                    }
                    return ze.log("STARTFRAMESYNC", "fail at CheckLogin, seq=", r.seq, ", code=", r.code, t), 
                    n({
                        code: sr.ErrCode.EC_SDK_NO_CHECK_LOGIN,
            ...
            sendToGameSvr(e, t, n) {
                ...
                return tr.sendMessageExt(r, n);
            }
        }
        sr.instance = null, sr.bstCallbacks = new class {
            constructor() {
                this.room = new Qn(), this.group = new Wn();
            }
            clearCallbacks() {
            ...
            error(e) {}
        }(), sr.ErrCode = Te, sr.ENUM = Oe;
        class ar {
            constructor(e) {
                this.batch = [], this.isPolling = !1, this.pollTime = 0, this.group = e, this.batch = [], 
                this.isPolling = !1, this.pollTime = Date.now();
            }
            push(e) {
                const t = Object.assign({}, e, {
                    isPolling: !1
                });
                this.batch.push(t), Date.now() - this.pollTime > 3e4 && (this.isPolling = !1), !this.isPolling && this.poll();
            }
            poll() {
                if (this.pollTime = Date.now(), this.isPolling = !0, this.batch = this.batch.filter(e => !e.isPolling && e.groupId === this.group.groupInfo.id), 
                this.batch.forEach(e => e.isPolling = !0), 0 === this.batch.length || !this.group.groupInfo.id) return this.isPolling = !1;
                lr.getGroupByGroupId({
                    groupId: this.group.groupInfo.id
                }, e => {
                    let t = null;
                    e.data && e.data.groupInfo && (t = e.data.groupInfo), this.trigger(e.seq, t);
                });
            }
            trigger(e, t) {
                this.isPolling = !1, this.batch.forEach(n => {
                    if (!t) return;
                    if (!Array.isArray(t.groupPlayerList)) return;
                    if (t.groupPlayerList.length <= 0) return;
                    if (n.groupId !== this.group.groupInfo.id) return;
                    if (n.groupId !== t.id) return;
                    if (!t.groupPlayerList.find(e => e.id === n.changePlayerId)) return;
                    const r = {
                        seq: n.bstSeq + "_" + e,
                        data: {
                            changePlayerId: n.changePlayerId,
                            networkState: n.networkState,
                            groupInfo: t
                        }
                    };
                    setTimeout(() => n.callback && n.callback(r), 0);
                }), this.batch = this.batch.filter(e => !e.isPolling), this.batch.length > 0 && setTimeout(() => !this.isPolling && this.poll(), 0);
            }
        }
        class _r {
            constructor(e) {
                this.group = e, this.groupInfoPoller = new ar(e);
            }
            onNetwork(e) {
            ...
            onLeaveGroup(e) {
                this.saveAndInvoke("onLeaveGroup", e);
            }
            onDismissGroup(e) {
                this.matchGroupInfoAndInvoke("onDismissGroup", e, () => this.group.groupInfo = {});
            }
            onChangeGroup(e) {
            ...
            onChangeGroupPlayerNetworkState(e) {
                ...
                if (!this.group.groupInfo.id) return;
                if (!Array.isArray(t) || t.length <= 0) return;
                if (!t.find(e => e === this.group.groupInfo.id)) return;
                const n = {
                    bstSeq: e.seq,
                    groupId: this.group.groupInfo.id,
                    changePlayerId: e.data.changePlayerId,
                    networkState: e.data.networkState,
                    callback: e => this.saveAndInvoke("onChangeGroupPlayerNetworkState", e)
                };
                this.groupInfoPoller.push(n);
            }
            onChangeCustomGroupPlayerStatus(e) {
            ...
            saveAndInvoke(e, t) {
                this.matchGroupInfo(t) && (this.group.groupUtil.setGroupInfo(t.data.groupInfo), 
                this.invoke(e, t));
            }
        ...
        class Er {
            ...
            setGroupInfo(e) {
                !e && (e = {}), this.group.groupInfo = JSON.parse(JSON.stringify(e || {})), this.group.groupInfo.groupPlayerList = this.group.groupInfo.groupPlayerList || [], 
                this.group.onUpdate && this.group.onUpdate(this.group);
            }
            saveGroupInfo(e) {
                e.code === s.QAppProtoErrCode.EC_OK && this.setGroupInfo(e.data ? e.data.groupInfo : null);
            }
            addGroupParam() {
                return {
                    groupId: this.group.groupInfo.id || ""
            ...
            initBroadcast() {
                this.group.groupBroadcast || (this.group.groupBroadcast = new _r(this.group));
            }
        }
        class lr extends class {} {
            constructor(e) {
                super(), this.groupUtil = new Er(this), this.groupUtil.setGroupInfo(e || null);
            }
            initGroup(e) {
            ...
            static getGroupByGroupId(e, t) {
                t = st(t), sr.instance.group.getGroupByGroupId(e, t);
            }
            static getMyGroups(e) {
                e = st(e), sr.instance.group.getMyGroups({}, e);
            }
            createGroup(e, t) {
                const n = Object.assign({}, e, {
                    playerInfo: Object.assign({}, e.playerInfo, {
                ...
                sr.instance.group.createGroup(n, st(e => {
            ...
            getGroupDetail(e) {
                ...
                sr.instance.group.getGroupByGroupId(t, st(t => {
            ...
            joinGroup(e, t) {
                ...
                sr.instance.group.joinGroup(n, st(e => {
                    this.groupUtil.saveGroupInfo(e), t && t(e);
                }));
            }
            leaveGroup(e, t) {
                ...
                sr.instance.group.leaveGroup(n, st(e => {
                    this.groupUtil.saveGroupInfo(e), t && t(e);
                }));
            }
            dismissGroup(e, t) {
                ...
                sr.instance.group.dismissGroup(n, st(e => {
                    e.code === s.QAppProtoErrCode.EC_OK && this.groupUtil.setGroupInfo(null), t && t(e);
                }));
            }
            changeGroup(e, t) {
                const n = [];
                e.hasOwnProperty("groupName") && n.push(s.ChangeGroupOption.GROUP_NAME), e.hasOwnProperty("owner") && n.push(s.ChangeGroupOption.GROUP_OWNER), 
                e.hasOwnProperty("customProperties") && n.push(s.ChangeGroupOption.GROUP_CUSTOM_PROPERTIES), 
                e.hasOwnProperty("isForbidJoin") && n.push(s.ChangeGroupOption.GROUP_IS_FORBID_JOIN);
                const r = Object.assign({}, e, {
                    groupId: this.groupInfo.id,
                    changeGroupOptionList: n
                });
                sr.instance.group.changeGroup(r, st(e => {
                    this.groupUtil.saveGroupInfo(e), t && t(e);
                }));
            }
            removeGroupPlayer(e, t) {
                ...
                sr.instance.group.removeGroupPlayer(n, st(e => {
                    this.groupUtil.saveGroupInfo(e), t && t(e);
                }));
            }
            changeCustomGroupPlayerStatus(e, t) {
                ...
                sr.instance.group.changeCustomGroupPlayerStatus(n, st(e => {
                    this.groupUtil.saveGroupInfo(e), t && t(e);
                }));
            }
            sendToGroupClient(e, t) {
                ...
                sr.instance.group.sendToGroupClient(n, st(t));
            }
        }
        class ur {
            constructor(e, t) {
                this.frameIdFill = 0, this.frameIdSent = 0, this.autoReqFrameErrTimes = 0, this.lastFrameTime = 0, 
                this.beginFrameId = -1, this.endFrameId = -1, this.fillCache = {}, this.timer = new dr(e), 
                this.callback = t;
            }
            reset(e = 0) {
            ...
            push(e, t) {
                ...
                const r = this.frameIdSent, i = this.frameIdFill;
                return this.frameIdFill = n, Pe.isAutoRequestFrame ? n <= r + 1 ? this.send(e) : (this.fillCache[n] = {
                    endFrameId: n,
                    data: [ e.data.frame ]
                }, void (n > i + 1 && this.fill(i + 1, n - 1, t))) : this.send(e);
            }
            retryFill(e) {
                this.beginFrameId === this.endFrameId && this.beginFrameId < 0 || (this.autoReqFrameErrTimes = 0, 
                this.fill(this.beginFrameId, this.endFrameId, e));
            }
            send(e) {
                const t = e.data.frame.id;
                if (t <= this.frameIdSent) return;
                e.data.frame.time = this.timer.time(t), this.frameIdSent = t, this.callback(e), 
                !this.lastFrameTime && (this.lastFrameTime = e.data.frame.time);
                const n = e.data.frame.time - this.lastFrameTime;
                0 !== n && un.onFitFrameTime(n), Math.abs(n) > 300 && !e.data.frame.isReplay && (this.reset(t), 
                this.timer.push(t, Date.now())), this.lastFrameTime = e.data.frame.time;
            }
            fillSend(e) {
            ...
            fill(e, t, n) {
                n.isInRoom() && n.requestFrame({
                    ...
                    if (this.beginFrameId = e, this.endFrameId = t, r.code !== s.QAppProtoErrCode.EC_OK) {
                    ...
                    } else this.beginFrameId = -1, this.endFrameId = -1, this.autoReqFrameErrTimes = 0, 
                    this.fillCache[e] = {
                        endFrameId: t,
        ...
        class hr {
            constructor(e) {
                this.frameBroadcastFrameId = 0, this.room = e, this.frameBroadcast = new ur(this.room.roomInfo.frameRate ? Math.floor(1e3 / this.room.roomInfo.frameRate) : 66, e => {
                    e && e.data && e.data.frame && e.data.frame.items && e.data.frame.items.forEach(e => e.data = "object" == typeof e.data ? e.data : JSON.parse(e.data)), 
                    this.matchFrameBstAndInvoke("onRecvFrame", e);
                });
            }
            onNetwork(e) {
            ...
            onDismissRoom(e) {
                this.matchRoomInfoAndInvoke("onDismissRoom", e, () => this.room.roomInfo = {});
            }
            onChangeRoom(e) {
            ...
            onMatchPlayers(e) {
                this.room.roomUtil.setRoomInfo(e.data.roomInfo), e.data.roomInfo && e.data.roomInfo.playerList && e.data.roomInfo.playerList.find(e => mr.isMe(e.id)) && this.room.roomUtil.activeFrame();
            ...
            onMatchTimeout(e) {
                const t = e.data.matchType, n = e.data.errCode || s.QAppProtoErrCode.EC_MATCH_TIMEOUT, {errCode: r, errMsg: i} = pt(n, "");
                Rr.once(t, {
                    code: r,
                    msg: i,
                    seq: "",
            ...
            onRecvFrame(e) {
                this.room.roomInfo.frameSyncState !== s.FrameSyncState.STOP && this.frameBroadcast.push(e, this.room);
            }
        ...
        const Rr = new class {
            ...
            onCancelMatch(e) {
                ...
                pr.onCancelMatch && pr.onCancelMatch(t);
            }
        }();
        class fr {
            constructor(e) {
            ...
            setRoomInfo(e) {
                ...
                this.room.roomInfo = JSON.parse(JSON.stringify(e || {})), this.room.roomInfo.playerList = this.room.roomInfo.playerList || [], 
                this.room.isInRoom() && we.setInfo(this.room.roomInfo.playerList.find(e => e.id === Ne.playerId)), 
                t.id === this.room.roomInfo.id && this.room.roomInfo.id && this.room.isInRoom() && t.startGameTime === this.room.roomInfo.startGameTime || this.room.roomBroadcast && this.room.roomBroadcast.frameBroadcastFrameIdReset(), 
                this.room.roomInfo && Array.isArray(this.room.roomInfo.playerList) && this.room.roomInfo.playerList.find(e => mr.isMe(e.id)) && this.activeFrame(), 
                this.room.onUpdate && this.room.onUpdate(this.room);
            }
            saveRoomInfo(e) {
                e.code === s.QAppProtoErrCode.EC_OK && this.setRoomInfo(e.data ? e.data.roomInfo : null);
            }
            setParam(e) {
            ...
            initBroadcast() {
                this.room.roomBroadcast || (this.room.roomBroadcast = new hr(this.room));
            }
            activeFrame() {
                return sr.instance.setFrameRoom(this.room.roomInfo);
            }
        }
        class pr extends class {} {
            constructor(e) {
                super(), this.roomUtil = new fr(this), this.roomUtil.setRoomInfo(e || null);
            }
            static getRoomList(e, t) {
                sr.instance.getRoomList(e, st(t));
            }
            static getRoomByRoomId(e, t) {
                sr.instance.getRoomByRoomId(e, st(t));
            }
            static getMyRoom(e) {
                sr.instance.getRoomByRoomId({
                    roomId: ""
                }, st(e));
            }
            isInRoom() {
                return !!this.roomInfo.playerList.find(e => e.id === Ne.playerId);
            }
            initRoom(e) {
                this.roomUtil.setRoomInfo(e);
                let t = e;
                t && t.id && t.routeId && Array.isArray(t.playerList) && t.playerList.find(e => e.id && mr.isMe(e.id)) && this.roomUtil.activeFrame();
            }
            onUpdate(e) {}
            get networkState() {
                let e = !1, t = !1;
                const n = sr.instance.getSocket(s.ConnectionType.COMMON), r = sr.instance.getSocket(s.ConnectionType.RELAY);
                return {
            ...
            createRoom(e, t) {
                sr.instance.createRoom(e, st(e => {
                    this.roomUtil.saveRoomInfo(e), t && t(e);
                }));
            }
            createTeamRoom(e, t) {
                sr.instance.createTeamRoom(e, st(e => {
                    this.roomUtil.saveRoomInfo(e), t && t(e);
                }));
            }
            joinRoom(e, t) {
                sr.instance.joinRoom(Object.assign({}, e), this.roomInfo.id, st(e => {
                    this.roomUtil.saveRoomInfo(e), t && t(e);
                }));
            }
            joinTeamRoom(e, t) {
                sr.instance.joinTeamRoom(Object.assign({}, e), this.roomInfo.id, st(e => {
                    this.roomUtil.saveRoomInfo(e), t && t(e);
                }));
            }
            leaveRoom(e, t) {
                this.roomUtil.setParam(e), sr.instance.leaveRoom(st(e => {
                    this.roomUtil.saveRoomInfo(e), t && t(e);
                }));
            }
            dismissRoom(e, t) {
                sr.instance.dismissRoom(e, this.roomInfo.id, st(e => {
                    e.code === s.QAppProtoErrCode.EC_OK && this.roomUtil.setRoomInfo(null), t && t(e);
                }));
            }
            changeRoom(e, t) {
                sr.instance.changeRoom(e, this.roomInfo, st(e => {
                    this.roomUtil.saveRoomInfo(e), t && t(e);
                }));
            }
            changeCustomPlayerStatus(e, t) {
                sr.instance.changeCustomPlayerStatus(Object.assign({}, e), this.roomInfo.id, st(e => {
                    this.roomUtil.saveRoomInfo(e), t && t(e);
                }));
            }
            removePlayer(e, t) {
                sr.instance.removePlayer(e, st(e => {
                    this.roomUtil.saveRoomInfo(e), t && t(e);
                }));
            }
            getRoomDetail(e) {
                sr.instance.getRoomByRoomId(Object.assign({}, this.roomUtil.addRoomParam()), st(t => {
                    this.roomUtil.saveRoomInfo(t), e && e(t);
                }));
            }
            matchPlayers(e, t) {
                let n = t;
                ze.log("typeof_Room.onMatch", typeof pr.onMatch), "function" != typeof pr.onMatch && (Rr.push(s.MatchType.PLAYER_COMPLEX, t), 
                n = (e => {
                    if (e.code !== s.QAppProtoErrCode.EC_OK) return e.data = null, Rr.once(s.MatchType.PLAYER_COMPLEX, e);
                })), sr.instance.matchPlayers(e, st(n));
            }
            matchGroup(e, t) {
                sr.instance.matchGroup(e, st(t));
            }
            matchRoom(e, t) {
                sr.instance.matchRoom(e, st(e => {
                    this.roomUtil.saveRoomInfo(e), t && t(e);
                }));
            }
            cancelPlayerMatch(e, t) {
                let n = t;
                e.matchType === Oe.MatchType.PLAYER_COMPLEX && (n = (n => {
                    n.code === Te.EC_OK && Rr.removeCallbacksByTag(e.matchType), t && t(n);
                })), sr.instance.cancelMatch(e, st(n));
            }
            startFrameSync(e, t) {
                this.roomUtil.activeFrame(), sr.instance.startFrameSync(st(t));
            }
            stopFrameSync(e, t) {
                this.roomUtil.activeFrame(), sr.instance.stopFrameSync(st(t));
            }
            sendFrame(e, t) {
                this.roomUtil.activeFrame(), sr.instance.sendFrame(e, st(t));
            }
            requestFrame(e, t) {
                this.roomUtil.activeFrame(), sr.instance.requestFrame(e, st(e => {
            ...
            sendToClient(e, t) {
                ...
                e.recvType === Oe.RecvType.ROOM_ALL ? n = this.roomInfo.playerList.map(e => e.id) : e.recvType === Oe.RecvType.ROOM_OTHERS && (n = this.roomInfo.playerList.filter(e => e.id !== Ne.playerId).map(e => e.id));
                const r = {
                    recvType: void 0,
                    recvPlayerList: n,
                    msg: e.msg
                };
                sr.instance.sendToClient(r, this.roomInfo.id, st(t));
            }
            sendToGameSvr(e, t) {
                sr.instance.sendToGameSvr(e, this.roomInfo.id, st(t));
            }
        }
        class mr {
            static isMe(e) {
                return Ne.playerId === e;
            }
            static get isInited() {
                return !!sr.instance && sr.instance.isInited();
            }
            static init(e, t, n) {
                sr.instance = new sr(e, t), sr.instance.init(st(n)), sr.bstCallbacks.room.bindCallbacks(cr);
            }
            static add(e) {
                if (e instanceof pr) {
                    const t = e;
                    return t.roomUtil.initBroadcast(), void sr.bstCallbacks.room.bindCallbacks(t.roomBroadcast);
                }
                if (e instanceof lr) {
                    const t = e;
                    return t.groupUtil.initBroadcast(), void sr.bstCallbacks.group.bindCallbacks(t.groupBroadcast);
                }
            }
            static remove(e) {
                if (e instanceof pr) {
                    const t = e;
                    sr.bstCallbacks.room.unbindCallbacks(t.roomBroadcast);
                } else if (e instanceof lr) {
                    const t = e;
                    sr.bstCallbacks.group.unbindCallbacks(t.groupBroadcast);
                }
            }
            static clear() {
                sr.bstCallbacks.room.clearCallbacks(), sr.bstCallbacks.room.bindCallbacks(cr), sr.bstCallbacks.group.clearCallbacks();
            }
        }
        let Sr = 0;
        const Ir = Math.pow(2, 32) - 1;
        var Cr = {
            init(e) {
                Sr = e;
            },
            random() {
                const e = (1103515245 * Sr + 123456789) % Ir;
                return Sr = e, e / Ir;
            }
        };
        class gr {}
        gr.Listener = null, gr.Room = null, gr.Group = null, gr.ENUM = null, gr.ErrCode = null, 
        gr.RandomUtil = null, gr.DebuggerLog = null, gr.Player = null, gr.StatCallbacks = null, 
        gr.Listener = mr, gr.Room = pr, gr.Group = lr, gr.ENUM = Oe, gr.ErrCode = Te, gr.RandomUtil = Cr, 
        gr.DebuggerLog = ze, gr.Player = pn, gr.StatCallbacks = un, (Be.root || {}).MGOBE = gr, 
        gr.types = Oe, gr.Adapter = {
            channel: Ve,
            platform: Qe
        }, t.default = gr;
    } ]).default;
