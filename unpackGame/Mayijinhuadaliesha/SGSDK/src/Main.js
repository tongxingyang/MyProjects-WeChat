...
let cv = cc.director.getScene().getChildByName('Canvas-High');
window.myRoot = new cc.Node();
window.myRoot.layer = cc.Layers.Enum.UI_2D;
window.myRoot.setSiblingIndex(9999);
window.myRoot.addComponent(cc.UITransformComponent);
window.myScheduler = window.myRoot.addComponent(cc.SpriteComponent);
