...
var t = E(require("./Canvas")), r = E(require("./navigator")), n = E(require("./XMLHttpRequest")), o = E(require("./WebSocket")), a = E(require("./Image")), u = E(require("./ImageBitmap")), i = E(require("./Audio")), l = E(require("./FileReader")), c = E(require("./HTMLElement")), m = E(require("./HTMLImageElement")), s = E(require("./HTMLCanvasElement")), p = E(require("./HTMLMediaElement")), d = E(require("./HTMLAudioElement")), f = E(require("./HTMLVideoElement")), b = E(require("./WebGLRenderingContext")), v = require("./EventIniter/index.js"), x = E(require("./localStorage")), g = E(require("./location")), M = require("./WindowProperties");
