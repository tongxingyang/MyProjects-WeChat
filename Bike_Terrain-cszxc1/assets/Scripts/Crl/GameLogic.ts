...
import { _decorator, Component, Node, director, Prefab, instantiate, v3, Animation, game, DirectionalLight } from 'cc';
...
export class GameLogic extends Component {
    ...
    start() {
        ...
        if (!FdMgr.isVersionValid) {
            this.startCam.getComponent(Animation).play()
            director.getScene().getChildByName('Main Light').getComponent(DirectionalLight).illuminance = 65000000
        }
    }
