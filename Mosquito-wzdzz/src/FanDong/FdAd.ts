...
export default class FdAd {
    static bannerIdArr: string[] = ["adunit-16a35519f35328f0", "adunit-5537ccffe5089e5c"];
    static videoId = "adunit-52288ae43a30597b";
    static fullGridId = "adunit-2707a8c0d38ab44f";
    static bottomGridId = "adunit-dce12284d42d3f3f";
    static sideGridId = "adunit-b0cb6b50398cc60c";
    static singleGridId = "adunit-fe32ee1f72eb22a2";
