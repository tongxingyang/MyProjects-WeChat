import { _decorator, Component, Node, EventTouch, UITransform, v3, Vec3, DistanceJoint2D, RigidBody2D, dragonBones, tween, BoxCollider } from 'cc';
    ...
    touchMove(evt: EventTouch) {
        ...
        if (!this.hadCatch) {
            ...
            if (Vec3.distance(p1, p2) <= 100) {
                ...
                this.faceDB.getComponent(dragonBones.ArmatureDisplay).playAnimation('fruits_1_process')
