...
export default class FireWork8 extends Laya.Script {
    constructor() {
        super()
    }
    ...
    createFW(pos: Laya.Vector3) {
        ...
        let res = GameLogic.Share._scene.getChildByName('PtNode').getChildAt(Utility.GetRandom(0, 7)) as Laya.Sprite3D;
