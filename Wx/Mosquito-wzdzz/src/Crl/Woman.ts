...
export default class Woman extends Laya.Script {
    ...
    onAwake() {
        ...
        if (!FdMgr.isVersionValid) {
            ((this.myOwner.getChildAt(1) as Laya.SkinnedMeshSprite3D).skinnedMeshRenderer.material as Laya.BlinnPhongMaterial).albedoColor = new Laya.Vector4(1, 0, 0, 1);
            ((this.myOwner.getChildAt(2) as Laya.SkinnedMeshSprite3D).skinnedMeshRenderer.material as Laya.BlinnPhongMaterial).albedoColor = new Laya.Vector4(1, 0, 0, 1);
        }
