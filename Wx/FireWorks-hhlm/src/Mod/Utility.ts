...
export default class Utility {
    ...
    public static RotateWithPoint(nodePos: Laya.Vector3, dir: Laya.Vector3, angle: number): Laya.Vector3 {
        let desPos = new Laya.Vector3()
        let p: Laya.Vector3 = nodePos.clone()
    ...
    public static coinCollectAnim(skinDir, startPos, endPos, parent, amount = 10, callBack?: Function) {
        let am = amount;
