...
export default class FireWork9 extends Laya.Script {
    constructor() {
        super()
    }
    ...
    createFW(pos: Laya.Vector3) {
        ...
        let res = GameLogic.Share._scene.getChildByName('PtNode').getChildAt(Utility.GetRandom(0, 8)) as Laya.Sprite3D;
