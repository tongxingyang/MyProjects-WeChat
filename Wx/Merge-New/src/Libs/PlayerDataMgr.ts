...
export default class PlayerDataMgr {
    ...
    public static getFreeBody() {
        for (let i = 0; i < this._playerData.skinArr.length; i++) {
            if (this._playerData.skinArr[i] == 0) return i
        }
        return -1
    }

    public static getFreeItem() {
        for (let i = 0; i < this._playerData.itemArr.length; i++) {
            if (this._playerData.itemArr[i] == 0) return i
        }
        return -1
    }
    ...
    public static getIsNearByHandId(id: number) {
