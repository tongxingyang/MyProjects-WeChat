...
export default class FdAd {
    static bannerIdArr: string[] = ["adunit-f26a393d4d0fe992", "adunit-080b7a9f9b386bf3"];
    ...
    static sideGridId = "adunit-17f621002e1857ef";
    static singleGridId = "adunit-d878c92289274fe9";
