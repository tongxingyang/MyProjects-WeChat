(function () {
    ...
    FdAd.bannerIdArr = ["adunit-f26a393d4d0fe992", "adunit-080b7a9f9b386bf3"];
    FdAd.videoId = "adunit-3cb6f551837ef0ef";
    FdAd.fullGridId = "adunit-dd997ab011667e02";
    FdAd.bottomGridId = "adunit-bebd9bd44872b65b";
    FdAd.sideGridId = "adunit-17f621002e1857ef";
    FdAd.singleGridId = "adunit-d878c92289274fe9";
    FdAd.bannerAds = [];
    FdAd.bannerIndex = 0;
    FdAd.bannerTimesArr = [];
    ...
    class FdMgr {
        ...
        static getConfig(cb) {
            ...
            window['wxsdk'].onInit(() => {
                ...
                conf.change_color = window['wxsdk'].conf.change_color;
        ...
        static get change_color() {
            if (!Laya.Browser.onWeiXin)
                return false;
            return this.jsonConfig.change_color;
        }
    ...
    class Woman extends Laya.Script {
        ...
        onAwake() {
            ...
            if (FdMgr.jsonConfig.change_color) {
                this.myOwner.getChildAt(1).skinnedMeshRenderer.material.albedoColor = new Laya.Vector4(0, 0, 0, 1);
                this.myOwner.getChildAt(2).skinnedMeshRenderer.material.albedoColor = new Laya.Vector4(0, 0, 0, 1);
            }
    ...
    class GameLogic {
        ...
        createProp(data) {
            ...
            if (name.search('Floor_1') != -1) {
                ...
                if (FdMgr.jsonConfig.change_color) {
                    res.meshRenderer.material.albedoColor = new Laya.Vector4(0, 0, 0, 1);
                }
            }
