...
import { _decorator, Component, Node, RigidBody, v2, v3, Vec3, geometry, PhysicsSystem, SkeletalAnimation, SphereCollider, Tween, tween, BoxCollider, ITriggerEvent, Animation, SkinnedMeshRenderer } from 'cc';
