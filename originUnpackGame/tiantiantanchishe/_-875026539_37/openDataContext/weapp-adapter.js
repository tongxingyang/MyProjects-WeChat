var e = require("../openDataContext/@babel/runtime/helpers/typeof");
...
!function(e) {
    ...
    var l = new WeakMap(), s = new WeakMap(), f = (new WeakMap(), new WeakMap(), function(t) {
        function n(e) {
            !function(e, t) {
                if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function");
            }(this, n);
            ...
            return l.set(t, o), o.onCanplay(function() {
                t.dispatchEvent({
                    type: "load"
                }), t.dispatchEvent({
                    type: "loadend"
        ...
        return function(t, n) {
            ...
            key: "play",
            value: function() {
                (0, u.isSubContext)() || l.get(this).play();
            }
        }, {
            key: "pause",
            value: function() {
                (0, u.isSubContext)() || l.get(this).pause();
            }
        }, {
            key: "canPlayType",
            value: function() {
            ...
            value: function() {
                var e = new n();
                return (0, u.isSubContext)() || (e.loop = l.get(this).loop, e.autoplay = l.get(this).loop, 
                e.src = this.src), e;
            }
        }, {
            key: "currentTime",
            get: function() {
                return (0, u.isSubContext)() ? 0 : l.get(this).currentTime;
            },
            set: function(e) {
                (0, u.isSubContext)() || l.get(this).seek(e);
            }
        }, {
            key: "src",
            get: function() {
            ...
            set: function(e) {
                s.set(this, e), (0, u.isSubContext)() || (l.get(this).src = e);
            }
        }, {
            key: "loop",
            get: function() {
                return !(0, u.isSubContext)() && l.get(this).loop;
            },
            set: function(e) {
                (0, u.isSubContext)() || (l.get(this).loop = e);
            }
        }, {
            key: "autoplay",
            get: function() {
                return !(0, u.isSubContext)() && l.get(this).autoplay;
            },
            set: function(e) {
                (0, u.isSubContext)() || (l.get(this).autoplay = e);
            }
        }, {
            key: "paused",
            get: function() {
                return !(0, u.isSubContext)() && l.get(this).paused;
            }
        } ]), n;
    }());
    n.default = f;
