...
if (cc.internal.VideoPlayer) {
    var a = cc.internal.VideoPlayer.EventType, s = cc.Vec3, c = cc.mat4(), u = new s(), l = new s();
    ...
    var h = function(e) {
        ...
        }(f, cc.internal.VideoPlayerImpl);
        var o, r, h, d = n(f);
        function f(e) {
            return function(e, t) {
                if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function");
            }(this, f), d.call(this, e);
        }
        return o = f, (r = [ {
            key: "syncClip",
            value: function(e) {
                ...
                if (this._video && this._component && this._uiTrans) {
                    ...
                    if (e) {
                        ...
                        if (this._forceUpdate || this._m00 !== c.m00 || this._m01 !== c.m01 || this._m04 !== c.m04 || this._m05 !== c.m05 || this._m12 !== c.m12 || this._m13 !== c.m13 || this._w !== i || this._h !== n) {
                            ...
                            var o = cc.game.canvas.height, r = cc.view._devicePixelRatio, a = this._uiTrans.anchorPoint;
                            s.set(u, -a.x * this._w, (1 - a.y) * this._h, 0), s.set(l, (1 - a.x) * this._w, -a.y * this._h, 0), 
                            s.transformMat4(u, u, c), s.transformMat4(l, l, c), e.worldToScreen(u, u), e.worldToScreen(l, l);
                            var h = l.x - u.x, d = u.y - l.y;
                            this._video.x = u.x / r, this._video.y = (o - u.y) / r, this._actualWidth = this._video.width = h / r, 
                            this._video.height = d / r, this._forceUpdate = !1;
                        }
                    }
                }
            }
        } ]) && t(o.prototype, r), h && t(o, h), f;
    }();
}