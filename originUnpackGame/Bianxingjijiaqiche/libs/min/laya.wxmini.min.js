window.wxMiniGame = function(e, t) {
    ...
    class i {
        ...
        static readFile(e, a = "utf8", n = null, s = "", o = !1, l = "", d = !0) {
            e = t.URL.getAdptedFilePath(e), i.fs.readFile({
                ...
                encoding: a,
                success: function(t) {
                    -1 == e.indexOf("http://") && -1 == e.indexOf("https://") || -1 != e.indexOf(r.window.wx.env.USER_DATA_PATH) ? null != n && n.runWith([ 0, t ]) : r.AutoCacheDownFile || o ? (null != n && n.runWith([ 0, t ]), 
    ...
    class r {
        ...
        static sendAtlasToOpenDataContext(e) {
            if (!r.isZiYu) {
                ...
                if (i.meta.image.split(","), i.meta && i.meta.image) for (var a = i.meta.image.split(","), n = e.indexOf("/") >= 0 ? "/" : "\\", s = e.lastIndexOf(n), o = s >= 0 ? e.substr(0, s + 1) : "", l = 0, d = a.length; l < d; l++) a[l] = o + a[l]; else a = [ e.replace(".json", ".png") ];
    ...
    u._watchDic = {}, u._curID = 0, e.MiniAccelerator = d, e.MiniAdpter = r, e.MiniFileMgr = i, 
    e.MiniInput = s, e.MiniLoader = o, e.MiniLocalStorage = l, e.MiniLocation = u, e.MiniSound = n, 
    e.MiniSoundChannel = a, e.MiniVideo = class {
