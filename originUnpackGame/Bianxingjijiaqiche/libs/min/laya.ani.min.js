!function(t, e) {
    ...
    class h {
        ...
        static parse(t, e) {
            h._templet = t, h._reader = e, e.__getBuffer(), h.READ_DATA(), h.READ_BLOCK(), h.READ_STRINGS();
                ...
                switch (this._diyTexture && (n = this._diyTexture), this.currDisplayData.type) {
                  ...
                  case 1:
                    ...
                    if (null == this.currDisplayData.bones) {
                        ...
                        p = this._curDiyUV) : p = this.currDisplayData.uvs, this._mVerticleArr = d, this.currDisplayData.triangles.length, 
                        ...
                        this._parentMatrix && x && (e.Matrix.mul(x, this._parentMatrix, e.Matrix.TEMP), 
    ...
    class F extends e.Sprite {
        ...
        _createGraphics(t = -1) {
            ...
            if (this._pathDic) for (g += d[3]; m < g; m++) if (v = n[m], T = this._pathDic[v.name]) switch (new e.Byte(v.extenData).getByte()) {
              case 1:
                T.position = M[c++];
                break;
