...
!function(e) {
    ...
    var i = _interopRequireDefault(n(9)), a = n(17), u = _interopRequireDefault(n(10)), l = _interopRequireDefault(n(18)), c = _interopRequireDefault(n(19)), s = _interopRequireDefault(n(20)), f = _interopRequireDefault(n(11)), p = _interopRequireDefault(n(12)), d = _interopRequireDefault(n(21)), h = _interopRequireDefault(n(4)), y = _interopRequireDefault(n(22)), v = _interopRequireDefault(n(23));
    ...
    t.Image = f.default, t.Audio = p.default, t.FileReader = d.default, t.HTMLElement = h.default, 
    ...
    var l = 0, c = 1, s = 2, f = 3, p = 4, d = new WeakMap(), h = new WeakMap(), y = (new WeakMap(), 
    new WeakMap(), function(e) {
        function Audio(e) {
            ...
            if (t.HAVE_NOTHING = l, t.HAVE_METADATA = c, t.HAVE_CURRENT_DATA = s, t.HAVE_FUTURE_DATA = f, 
            t.HAVE_ENOUGH_DATA = p, t.readyState = l, (0, u.isSubContext)()) return console.warn("HTMLAudioElement is not supported in SubContext."), 
            _possibleConstructorReturn(t);
            h.set(t, "");
            var n = wx.createInnerAudioContext();
            return d.set(t, n), n.onCanplay(function() {
                t.dispatchEvent({
                    type: "load"
                }), t.dispatchEvent({
                    type: "loadend"
        ...
        return function(e, t) {
            ...
            key: "play",
            value: function() {
                (0, u.isSubContext)() || d.get(this).play();
            }
        }, {
            key: "pause",
            value: function() {
                (0, u.isSubContext)() || d.get(this).pause();
            }
        }, {
            key: "canPlayType",
            value: function() {
            ...
            value: function() {
                var e = new Audio();
                return (0, u.isSubContext)() || (e.loop = d.get(this).loop, e.autoplay = d.get(this).loop, 
                e.src = this.src), e;
            }
        }, {
            key: "currentTime",
            get: function() {
                return (0, u.isSubContext)() ? 0 : d.get(this).currentTime;
            },
            set: function(e) {
                (0, u.isSubContext)() || d.get(this).seek(e);
            }
        }, {
            key: "src",
            get: function() {
            ...
            set: function(e) {
                h.set(this, e), (0, u.isSubContext)() || (d.get(this).src = e);
            }
        }, {
            key: "loop",
            get: function() {
                return !(0, u.isSubContext)() && d.get(this).loop;
            },
            set: function(e) {
                (0, u.isSubContext)() || (d.get(this).loop = e);
            }
        }, {
            key: "autoplay",
            get: function() {
                return !(0, u.isSubContext)() && d.get(this).autoplay;
            },
            set: function(e) {
                (0, u.isSubContext)() || (d.get(this).autoplay = e);
            }
        }, {
            key: "paused",
            get: function() {
                return !(0, u.isSubContext)() && d.get(this).paused;
            }
        } ]), Audio;
    }());
    t.default = y;
                ...
                wx.request({
                    ...
                    success: function(t) {
                        ...
                        _changeReadyState.call(e, XMLHttpRequest.LOADING), e.response = n, n instanceof ArrayBuffer) {
                            e.responseText = "";
                            for (var i = new Uint8Array(n), u = i.byteLength, l = 0; l < u; l++) e.responseText += String.fromCharCode(i[l]);
