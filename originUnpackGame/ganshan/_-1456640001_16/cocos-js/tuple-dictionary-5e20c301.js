            ...
            t("T", function() {
                ...
                return e.get = function(t, e) {
                    ...
                    if (null == a) {
                        ...
                        if (-1 !== s) return this.data.keys.splice(s, 1), delete this.data[n], a;
                    }
                    return this.get(t, e) || this.data.keys.push(n), this.data[n] = a, this.data[n];
                }, e.reset = function() {
                    this.data = {
                        keys: []
                    };
