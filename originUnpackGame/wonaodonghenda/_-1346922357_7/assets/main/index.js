    ...
    1: [ function() {
        ...
        (function(e) {
            ...
            window.GA = e, e.PA = null, e.init = function(i) {
                ...
                e.Info.isPreview = i.isPreview, e.Info.engine = i.engine, t.isAPP(i.platform) && (i.platform = t.getPlatform()), 
            ...
            var t = new (/* */ function() {
                ...
                _createClass2(_class9, [ {
                    ...
                    key: "showInterstitialAd",
                    value: function showInterstitialAd() {
                        var t = e.PA.createInterstitialAd({
            ...
            var n = new (/* */ function() {
                ...
                _createClass2(_class10, [ {
                    ...
                    value: function onClose(n) {
                        ...
                        this.showOption = null, this.status = t.End, (null == n ? void 0 : n.isEnded) || this.closeTip && "" != this.closeTip && e.PA.showToast({
                            title: this.closeTip,
                            mask: !0,
                            icon: "none"
                        });
                    ...
                    value: function initNextAd() {
                        ...
                        this.status = t.Loading, e.isPlatform(e.Platform.Hago)) {
                            var _t16 = window.hg.createRewardedVideoAd({
        ...
        var o = cc._decorator, i = o.ccclass, a = (o.property, function(e) {
            ...
            return __extends(t, e), n = t, t.instance = function() {
                ...
                var e = ks.createInterstitialAd({
                    adUnitId: this.interstitialUnitId
                });
