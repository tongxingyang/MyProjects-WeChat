...
function core_md5(d, _) {
    ...
    for (var m = 1732584193, r = -271733879, n = -1732584194, h = 271733878, f = 0; f < d.length; f += 16) {
        ...
        n = md5_ff(n, h, m, r, d[f + 14], 17, -1502002290), m = md5_gg(m, r = md5_ff(r, n, h, m, d[f + 15], 22, 1236535329), n, h, d[f + 1], 5, -165796510), 
        h = md5_gg(h, m, r, n, d[f + 6], 9, -1069501632), n = md5_gg(n, h, m, r, d[f + 11], 14, 643717713), 
        r = md5_gg(r, n, h, m, d[f + 0], 20, -373897302), m = md5_gg(m, r, n, h, d[f + 5], 5, -701558691), 
        h = md5_gg(h, m, r, n, d[f + 10], 9, 38016083), n = md5_gg(n, h, m, r, d[f + 15], 14, -660478335), 
        r = md5_gg(r, n, h, m, d[f + 4], 20, -405537848), m = md5_gg(m, r, n, h, d[f + 9], 5, 568446438), 
        h = md5_gg(h, m, r, n, d[f + 14], 9, -1019803690), n = md5_gg(n, h, m, r, d[f + 3], 14, -187363961), 
        r = md5_gg(r, n, h, m, d[f + 8], 20, 1163531501), m = md5_gg(m, r, n, h, d[f + 13], 5, -1444681467), 
        h = md5_gg(h, m, r, n, d[f + 2], 9, -51403784), n = md5_gg(n, h, m, r, d[f + 7], 14, 1735328473), 
        m = md5_hh(m, r = md5_gg(r, n, h, m, d[f + 12], 20, -1926607734), n, h, d[f + 5], 4, -378558), 
        h = md5_hh(h, m, r, n, d[f + 8], 11, -2022574463), n = md5_hh(n, h, m, r, d[f + 11], 16, 1839030562), 
        r = md5_hh(r, n, h, m, d[f + 14], 23, -35309556), m = md5_hh(m, r, n, h, d[f + 1], 4, -1530992060), 
        h = md5_hh(h, m, r, n, d[f + 4], 11, 1272893353), n = md5_hh(n, h, m, r, d[f + 7], 16, -155497632), 
        r = md5_hh(r, n, h, m, d[f + 10], 23, -1094730640), m = md5_hh(m, r, n, h, d[f + 13], 4, 681279174), 
        h = md5_hh(h, m, r, n, d[f + 0], 11, -358537222), n = md5_hh(n, h, m, r, d[f + 3], 16, -722521979), 
        r = md5_hh(r, n, h, m, d[f + 6], 23, 76029189), m = md5_hh(m, r, n, h, d[f + 9], 4, -640364487), 
        h = md5_hh(h, m, r, n, d[f + 12], 11, -421815835), n = md5_hh(n, h, m, r, d[f + 15], 16, 530742520), 
        m = md5_ii(m, r = md5_hh(r, n, h, m, d[f + 2], 23, -995338651), n, h, d[f + 0], 6, -198630844), 
        h = md5_ii(h, m, r, n, d[f + 7], 10, 1126891415), n = md5_ii(n, h, m, r, d[f + 14], 15, -1416354905), 
        r = md5_ii(r, n, h, m, d[f + 5], 21, -57434055), m = md5_ii(m, r, n, h, d[f + 12], 6, 1700485571), 
        h = md5_ii(h, m, r, n, d[f + 3], 10, -1894986606), n = md5_ii(n, h, m, r, d[f + 10], 15, -1051523), 
        r = md5_ii(r, n, h, m, d[f + 1], 21, -2054922799), m = md5_ii(m, r, n, h, d[f + 8], 6, 1873313359), 
        h = md5_ii(h, m, r, n, d[f + 15], 10, -30611744), n = md5_ii(n, h, m, r, d[f + 6], 15, -1560198380), 
        r = md5_ii(r, n, h, m, d[f + 13], 21, 1309151649), m = md5_ii(m, r, n, h, d[f + 4], 6, -145523070), 
        h = md5_ii(h, m, r, n, d[f + 11], 10, -1120210379), n = md5_ii(n, h, m, r, d[f + 2], 15, 718787259), 
        r = md5_ii(r, n, h, m, d[f + 9], 21, -343485551), m = safe_add(m, i), r = safe_add(r, c), 
        n = safe_add(n, e), h = safe_add(h, t);
    }
...
function core_hmac_md5(d, _) {
    ...
    for (var r = Array(16), n = Array(16), h = 0; h < 16; h++) {
        r[h] = 909522486 ^ m[h], n[h] = 1549556828 ^ m[h];
    }
