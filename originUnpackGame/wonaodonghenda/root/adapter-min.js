...
!function r(o, i, a) {
    ...
    2: [ function(e, t, n) {
        "use strict";
        var r = window.fsUtils, o = r.getUserDataPath, i = r.readJsonSync, c = r.makeDirSync, a = r.writeFileSync, s = r.copyFile, l = r.downloadFile, u = r.writeFile, f = r.deleteFile, d = r.rmdirSync, p = r.unzip, h = r.isOutOfStorage, m = !1, g = null, y = !1, v = [], b = [], _ = !1, w = 0, E = /^https?:\/\/.*/, r = {
            cacheDir: "gamecaches",
            ...
            _cache: function _cache() {
                ...
                for (t in this.cacheQueue) {
                    ...
                    }, r = this.cacheQueue[t], o = r.srcUrl, i = r.isCopy, a = r.cacheBundleRoot, c = Date.now().toString(), u = "", u = (a ? "".concat(this.cacheDir, "/").concat(a, "/") : "".concat(this.cacheDir, "/")).concat(c).concat(w++).concat(cc.path.extname(t));
                    ...
                    if (this.cachedFiles.forEach(function(t, e) {
                        ...
                        this.writeCacheFile(function() {
                            setTimeout(function e() {
                                ...
                                0 < n.length ? setTimeout(e, r.deleteInterval) : _ = !1;
                            }, r.deleteInterval);
                        });
                    }
                }
    ...
    3: [ function(e, t, n) {
        "use strict";
        var r, s, l = e("../cache-manager"), o = window.fsUtils, f = o.fs, d = o.downloadFile, i = o.readText, a = o.readArrayBuffer, c = o.readJson, p = o.loadSubpackage, h = o.getUserDataPath, u = o.exists, m = /^https?:\/\/.*/, g = {}, y = cc.assetManager.downloader, v = cc.assetManager.parser, b = cc.assetManager.presets, _ = __globalAdapter.isSubContext;
        ...
        var I = v.parsePVRTex, e = function e(_e2, n, r) {
            a(_e2, function(e, t) {
                return e ? r(e) : void I(t, n, r);
            });
        }, R = v.parsePKMTex, o = function o(e, n, r) {
            a(e, function(e, t) {
        ...
        y.downloadDomAudio = S, y.downloadScript = x, v.parsePVRTex = e, v.parsePKMTex = o, 
        y.register({
            ".js": x,
            ".mp3": P,
            ".ogg": P,
            ...
            bundle: function bundle(e, t, a) {
                ...
                if (w[r]) {
                    ...
                    m.test(e) || !_ && e.startsWith(h()) ? (c = e, n = "src/scripts/".concat(r, "/index.js"), 
                    l.makeBundleFolder(r)) : E[r] ? (c = "".concat(s, "remote/").concat(r), n = "src/scripts/".concat(r, "/index.js"), 
        ...
        _ ? (j = cc.assetManager.init, cc.assetManager.init = function(e) {
    ...
    12: [ function(e, t, n) {
        ...
        t.exports = function(e, t) {
            ...
            r = r.toLowerCase(), o = /[\d\.]+/.exec(r = "android p" === r ? "android p 9.0" : r), 
    ...
    20: [ function(e, t, n) {
        ...
        function f(e) {
            ...
            if (e._inc != t) {
                ...
                for (n in W(e, "length", r.length), r) {
                    e[n] = r[n];
                }
                e._inc = t;
            }
        ...
        function O(e, t, n) {
            ...
            return S(e.ownerDocument || e, e), 11 == t.nodeType && (t.firstChild = t.lastChild = null), 
            t;
        }
        function N() {
            this._nsMap = {};
        ...
        function B(e, t) {
            ...
            return V(this, r, e, t, n = a && null == i && null == (i = o.lookupPrefix(a)) ? [ {
                namespace: a,
                prefix: null
            } ] : n), r.join("");
        }
              ...
              case 1:
                ...
                o.push({
                    ...
                    if (t.push(">"), n && /^script$/i.test(u)) for (;c; ) {
                        c.data ? t.push(c.data) : V(c, t, n, r, o), c = c.nextSibling;
                    } else for (;c; ) {
                        V(c, t, n, r, o), c = c.nextSibling;
                    }
                    t.push("</", u, ">");
                } else t.push("/>");
                return;
        ...
        s.prototype = Error.prototype, r(c, s), p.prototype = {
            ...
            setNamedItem: function setNamedItem(e) {
                ...
                return g(this._ownerElement, this, e, t), t;
            },
            setNamedItemNS: function setNamedItemNS(e) {
                var t = e.ownerElement;
                if (t && t != this._ownerElement) throw new s(10);
                return t = this.getNamedItemNS(e.namespaceURI, e.localName), g(this._ownerElement, this, e, t), 
                t;
            },
            ...
            removeNamedItemNS: function removeNamedItemNS(e, t) {
                ...
                return y(this._ownerElement, this, t), t;
            },
        ...
        }, r(a, b), r(a, b.prototype), E.prototype = {
            nodeName: "#document",
            nodeType: 9,
            doctype: null,
            ...
            insertBefore: function insertBefore(e, t) {
                ...
                O(this, e, t), e.ownerDocument = this, e;
        ...
        }, o(E, b), E.prototype.getElementsByTagName = (N.prototype = {
            nodeType: 1,
            ...
            appendChild: function appendChild(e) {
                return 11 === e.nodeType ? this.insertBefore(e, null) : function(e, t) {
                    ...
                    e.lastChild = t, S(e.ownerDocument, e, t), t;
                }(this, e);
            },
        ...
        o(N, b), M.prototype.nodeType = 2, o(M, b), A.prototype = {
            data: "",
            ...
            nodeType: 4
        }, o(P, A), I.prototype.nodeType = 10, o(I, b), R.prototype.nodeType = 12, o(R, b), 
        j.prototype.nodeType = 6, o(j, b), L.prototype.nodeType = 5, o(L, b), F.prototype.nodeName = "#document-fragment", 
        F.prototype.nodeType = 11, o(F, b), k.prototype.nodeType = 7, o(k, b), H.prototype.serializeToString = function(e, t, n) {
            return B.call(e, t, n);
        }, b.prototype.toString = B;
        try {
        ...
        n.DOMImplementation = v, n.XMLSerializer = H;
    }, {} ],
    21: [ function(e, t, n) {
        "use strict";
        n.entityMap = {
        ...
        a.prototype = {
            parse: function parse(e, t, n) {
                ...
                r.startDocument(), p(t, t = {}), function(n, e, r, o, i) {
                    ...
                    for (;;) {
                        try {
                            var m, g, y = n.indexOf("<", h);
                            if (y < 0) return n.substr(h).match(/^\s*$/) || (m = o.doc, g = m.createTextNode(n.substr(h)), 
                            m.appendChild(g), o.currentElement = g);
                            switch (h < y && t(y), n.charAt(y + 1)) {
                              case "/":
                                var v = n.indexOf(">", y + 3), b = n.substring(y + 2, v), _ = d.pop();
                                v < 0 ? (b = n.substring(y + 2).replace(/[\s<].*/, ""), i.error("end tag name: " + b + " is not complete:" + _.tagName), 
                                v = y + 1 + b.length) : b.match(/\s</) && (b = b.replace(/[\s<].*/, ""), i.error("end tag name: " + b + " maybe not complete"), 
                                v = y + 1 + b.length);
                              ...
                              default:
                                f && c(y);
                                var S = new B(), T = d[d.length - 1].currentNSMap, v = function(e, t, n, r, o, i) {
                                    var a, c = ++t, u = C;
                                    for (;;) {
                                        var s = e.charAt(c);
                                        switch (s) {
                                ...
                                }(n, y, S, T, a, i), O = S.length;
                                if (!S.closed && function(e, t, n, r) {
                                    var o = r[n];
                                    null == o && ((o = e.lastIndexOf("</" + n + ">")) < t && (o = e.lastIndexOf("</" + n)), 
                                    r[n] = o);
                                    return o < t;
                                }(n, v, S.tagName, p) && (S.closed = !0, r.nbsp || i.warning("unclosed xml attribute")), 
                                f && O) {
    ...
    23: [ function(e, t, n) {
        ...
        "./wrapper/builtin": 46,
        "./wrapper/engine": 54,
        "./wrapper/error-reporter": 56,
        "./wrapper/fs-utils": 57,
        "./wrapper/sub-context-adapter": 1,
        "./wrapper/systemInfo": 58,
        "./wrapper/unify": 59
    } ],
    24: [ function(e, t, n) {
        "use strict";
    ...
    26: [ function(e, t, n) {
        ...
        function c(n) {
            ...
            return function() {
                ...
                }(this, r ? (e = u(this).constructor, Reflect.construct(t, arguments, e)) : t.apply(this, arguments));
            };
        }
        function u(e) {
    ...
    51: [ function(e, t, n) {
        ...
        var o = x(e("./Canvas")), i = x(e("./navigator")), a = x(e("./XMLHttpRequest")), c = x(e("./WebSocket")), u = x(e("./Image")), s = x(e("./ImageBitmap")), l = x(e("./Audio")), f = x(e("./FileReader")), d = x(e("./HTMLElement")), p = x(e("./HTMLImageElement")), h = x(e("./HTMLCanvasElement")), m = x(e("./HTMLMediaElement")), g = x(e("./HTMLAudioElement")), y = x(e("./HTMLVideoElement")), v = x(e("./WebGLRenderingContext")), b = e("./EventIniter/index.js"), _ = x(e("./localStorage")), w = x(e("./location")), E = e("./WindowProperties");
        function x(e) {
            return e && e.__esModule ? e : {
                default: e
            };
        ...
        n.canvas = S;
        var T = GameGlobal, O = T.setTimeout, N = T.setInterval, e = T.clearTimeout, o = T.clearInterval, S = T.requestAnimationFrame, T = T.cancelAnimationFrame;
        n.cancelAnimationFrame = T, n.requestAnimationFrame = S, n.clearInterval = o, n.clearTimeout = e, 
        n.setInterval = N, n.setTimeout = O;
    }, {
        "./Audio": 24,
        "./Canvas": 25,
        "./EventIniter/index.js": 29,
    ...
    53: [ function(e, t, n) {
        "use strict";
        var s, l, f, r, o;
        cc && cc.VideoPlayer && cc.VideoPlayer.Impl && __globalAdapter.createVideo && (s = cc.Mat4, 
        l = cc.mat4(), f = cc.mat4(), r = cc.VideoPlayer.Impl, o = cc.VideoPlayer.Impl.prototype, 
        cc.VideoPlayer.prototype._updateVideoSource = function() {
            ...
            var t, n, r, o, i, a, c, u;
            this._video && this._visible && (i = cc.Camera.findCamera(e)) && (e.getWorldMatrix(l), 
            this._m00 === l.m[0] && this._m01 === l.m[1] && this._m04 === l.m[4] && this._m05 === l.m[5] && this._m12 === l.m[12] && this._m13 === l.m[13] && this._w === e._contentSize.width && this._h === e._contentSize.height || (this._m00 = l.m[0], 
            this._m01 = l.m[1], this._m04 = l.m[4], this._m05 = l.m[5], this._m12 = l.m[12], 
            this._m13 = l.m[13], this._w = e._contentSize.width, this._h = e._contentSize.height, 
            i.getWorldToScreenMatrix2D(f), s.multiply(f, f, l), t = cc.view._scaleX, n = cc.view._scaleY, 
            u = cc.view._devicePixelRatio, c = f.m[0] * (t /= u), a = f.m[5] * (n /= u), r = this._w * c, 
            o = this._h * a, i = r * e._anchorPoint.x, c = o * e._anchorPoint.y, e = (a = cc.view._viewportRect).x / u, 
            u = a.y / u, e = f.m[12] * t - i + e, c = f.m[13] * n - c + u, u = cc.view.getFrameSize().height, 
            this._video.x = e, this._video.y = u - o - c, this._actualWidth = this._video.width = r, 
            this._video.height = o));
        });
    }, {} ],
    54: [ function(e, t, n) {
        "use strict";
